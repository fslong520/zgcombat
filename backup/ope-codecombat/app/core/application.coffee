...
Application = {
  isProduction: -> document.location.href.search('https?://localhost') is -1 and document.location.href.search('https?://192.168.') is -1
...
#      document.location.href = '//lenovogamestate.com/login/'
  ...
  # Mirrors app/core/application.js so the .js views (e.g. CampaignView.js,
  # TeacherCoursesView.js) that call application.setHocCampaign(...) resolve.
