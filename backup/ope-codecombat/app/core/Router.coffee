...
module.exports = class CocoRouter extends Backbone.Router
  ...
  routes:
    ...
    'play(/)': go('play/CampaignView', { redirectTeachers: true }) # extra slash is to get Facebook app to work; allow students to browse campaigns
  ...
  tryToLoadModule: (path) ->
    try
      ...
      # Under webpack, ES-module views are exported as {default: Class}; unwrap
      # to match Brunch's `require()` which returned the constructor directly.
