...
As stated on [CodeCombat's legal page](https://flsong.iok.la/legal), CodeCombat Inc. reserves all rights to the Levels, which are not open source, not made publicly available, and not permissible to use on other servers. This has been true since the beginning, when CodeCombat's code was [first uploaded to GitHub on January 3, 2014](https://github.com/codecombat/codecombat/blob/6009df26de7c7938c0af2122ffba72c07123d172/app/templates/legal.jade#L71-L84). The only authorized CodeCombat servers are operated by CodeCombat at [flsong.iok.la](https://flsong.iok.la/), and our China business unit at [koudashijie.com](https://koudashijie.com). We can't abide flagrant pirate servers.
