...
#### **Student Licenses**
In order for teachers to be able to assign the required zgcombat courses to students in their class, each student will need a License. Information on license pricing and structure can be obtained by speaking to zgcombat’s school specialists (email schools@flsong.iok.la). We recommend that licenses are obtained by early August of the coming school year so students can begin as early as the first day of the fall semester. 
