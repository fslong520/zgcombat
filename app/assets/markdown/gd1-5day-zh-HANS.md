...
游戏开发1中，学生将通过课堂讨论学习游戏思想和游戏设计。他们将会把这些知识用到zgcombat游戏开发关卡中，他们需要用特定的命令来创建游戏。最后，学生们需要完成一个最终项目，设计并创建出他们自己独特的游戏，并从同学那里获得反馈意见。
...
游戏开发1课程期间，学生将学会使用元素、机制和目标(PIECES, MECHANICS, GOALS)来创建自己的游戏。
  ...
  - 第1-3天：学习游戏设计的基本概念，以及在zgcombat中创建游戏所需的命令
  - 第4天：开发和实现自己的游戏！
...
**讨论问题\#3b：你最喜爱的游戏中有哪些目标？**
  ...
  - 一些典型例子：
      ...
      - 夺取旗帜并带它返回基地
      - 将球投入圈中
  - 在zgcombat中设计游戏时，我们提供了一些你可以使用的基础目标。在更进阶的课程中，学生们将会创建自定义目标！
