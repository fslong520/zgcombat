...
Para obter informações adicionais sobre como ajudar os alunos a criar uma conta, Veja nosso [Guia de Iniciação do Professor](https://files.flsong.iok.la/docs/resources/TeacherGettingStartedGuide-pt-BR.pdf).

Permita que os alunos participem do jogo em seu próprio ritmo, anotando todos os níveis em papel ou documento digital. Recomendamos o uso do seguinte formato, que você também pode imprimir como modelos: [Diário de Progresso [PDF]](https://files.flsong.iok.la/docs/resources/ProgressJournal-pt-BR.pdf)
...
Se o aluno tiver dificuldade em resolver o problema, consulte a [Planilha de Ciclo de Engenharia [PDF]](https://files.flsong.iok.la/docs/resources/EngineeringCycleWorksheet-pt-BR.pdf) para reforçar os passos para resolver cada quebra-cabeça.
...
Se o aluno tiver dificuldade em resolver o problema, consulte a [Planilha de Ciclo de Engenharia [PDF]](https://files.flsong.iok.la/docs/resources/EngineeringCycleWorksheet-pt-BR.pdf) como uma ferramenta de ajuda, ou peça-lhes para seguir esta lista:
