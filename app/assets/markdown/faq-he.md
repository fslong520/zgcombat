...
*   [מה זה zgcombat?](#header-0)
*   [לאילו גילאים zgcombat מתאים?](#header-1)
*   [לאילו כיתות zgcombat מתאים?](#header-2)
*   [אילו שפות תכנות זמינות?](#header-3)
*   [האם ניתן להשתמש ב-zgcombat בתור תכנית הלימודים העיקרית של הכיתה?](#header-4)
...
*   [האם zgcombat פועל ב-iPad?](#header-10)
*   [האם zgcombat תומך בהתחברות מיידית חכמה?](#header-11)
*   [האם מומלץ להשתמש בדפדפן ובמערכת הפעלה מסוימים?](#header-12)
*   [לתלמידים בכיתה שלי יש ידע מאוד שונה זה מזה במדעי המחשב, כיצד zgcombat יעזור לי באתגר זה?](#header-13)
*   [מה אם אני מעוניין ברישיונות שנמשכים סמסטר אחד בלבד, במקום שנה שלמה?](#header-14)
*   [מהו שלב הזירה שבסוף הקורס?](#header-15)
*   [האם zgcombat כולל פרויקטים שהתלמידים יכולים לעבוד עליהם ולשתף?](#header-16)
...
*   [כיצד להתחיל ולהשתמש ב-zgcombat?](#header-20)
...
zgcombat הוא משחק תכנות, שמשתמש בקוד מוקלד אמיתי ובלימוד בהתאמה אישית על מנת ללמד את מדעי המחשב, ללא צורך בשום הדרכה למורה.

### לאילו גילאים zgcombat מתאים?

zgcombat מומלץ לתלמידים מגיל 9 ומעלה.

### לאילו כיתות zgcombat מתאים?

zgcombat מומלץ לבתי ספר עם תלמידים מגיל 9 ומעלה, כלומר מכיתה ד'.
...
### האם ניתן להשתמש ב-zgcombat בתור תכנית הלימודים העיקרית של הכיתה?

בהחלט כן! השקענו זמן בהתייעצות עם מומחים פדגוגיים על מנת לבנות תכנית לימודים וחומרים המותאמים במיוחד למורים המשתמשים ב-zgcombat ללא שום ניסיון קודם משל עצמם בתחום מדעי המחשב. בתי ספר רבים מטמיעים את zgcombat בתור תכנית הלימודים העיקרית במדעי המחשב.

פרסמנו ב[מרכז המשאבים שלנו](https://flsong.iok.la/teachers/resources) אוסף של משאבים לתכנית הלימודים, הכלול תכניות שיעור, תרגילים, פעילויות והנחיות כתיבה על מנת לעודד חשיבה ושימור חומר. אנו מכינים גם מדריכים להדפסה הזמינים לעיונם של התלמידים במהלך התקדמותם בשלבים. בנוסף, אנו מספקים פתרונות שלבים לכל קורס, כדי שהמורים יוכלו לסייע באיתור ובתיקון של שגיאות בקוד של התלמידים תוך כדי עבודה.

### כמה עולה הגישה לכל הקורסים והמשאבים הזמינים?

אנו יוצרים פתרונות בהתאמה אישית לבתי ספר ולמחוזות, ופועלים מולכם על מנת להבין את מקרה השימוש, ההקשר והתקציב שלכם. לפרטים נוספים, צרו קשר עם schools@flsong.iok.la!
...
כן \- התלמידים הנרשמים עם קוד כיתה או כתובת URL של כיתה מקבלים את האפשרות לבחור שם משתמש ולדלג על שדה הדואר האלקטרוני (השדה מסומן כשדה בחירה). למידע נוסף על הוספת תלמידים לכיתה, עיינו ב[מדריך ההתחלה המהירה למורה](https://flsong.iok.la/teachers/resources/getting-started).
...
### האם zgcombat פועל ב-iPad?

בשלב זה, אנו לא תומכים ב-iPad או במחשבי לוח של Android.

### האם zgcombat תומך בהתחברות מיידית חכמה?

כן! לפרטים נוספים על צעדים ראשונים,עיינו ב[שאלות נפוצות לאינטגרציה חכמה](https://flsong.iok.la/teachers/resources/clever-faq).

### האם מומלץ להשתמש בדפדפן ובמערכת הפעלה מסוימים?

מומלץ להפעיל את zgcombat במחשבים עם 4GB זיכרון RAM לכל הפחות, בדפדפן מודרני כגון Chrome,‏ Safari,‏ Firefox או Edge. מחשבי Chromebook עם 2GB RAM זיכרון עשויים לחוות בעיות גרפיקה קלות בקורסים מתקדמים יותר. נדרש רוחב פס של 200 Kbps לפחות לכל תלמיד, אולם מומלץ להשתמש ב-1 Mbps או יותר.

### לתלמידים בכיתה שלי יש ידע מאוד שונה זה מזה במדעי המחשב, כיצד zgcombat יעזור לי באתגר זה?

מורים רבים מתמודדים עם האתגר של מילוי צורכי התלמידים השונים בכיתה. אתם לא לבד. zgcombat פותר לכם את הבעיה, ומספק חוויית לימוד שמותאמת באמת לכל תלמיד ותלמיד.
...
משך רישיון התלמיד הרגיל הוא שנה אחת, אך ניתן לחלק אותו לסמסטרים במידת הצורך. שוחחו עם [המומחים שלנו לבית הספר](mailto:schools@flsong.iok.la) כדי לדון עמם בצרכים הספציפיים שלכם.

### מהו שלב הזירה שבסוף הקורס?

[זירות](https://flsong.iok.la/teachers/resources/arenas) הן שלבי תרגול פתוחים, שבהם התלמידים יכולים לתגבר את המיומנויות שלמדו בקורסים השונים. ניתן להשתמש בזירה כדי לאפשר לתלמידים מהירים יותר לחקור אסטרטגיות עמוקות יותר למשחקים מרובי-משתתפים, בעוד התלמידים האיטיים יותר מדביקים אותם בחומר. לאחר מכן, לאחר שכולם הגיעו לשלב הזירה, ניתן להקדיש זמן כיתה לטורניר כיתתי. כך תוכלו להקצות את הקורס הבא לכל התלמידים בבת אחת, כדי שכולם יישארו פחות או יותר באותה נקודה בקורס המסוים.

לפרטים נוספים, עיינו ב[מדריך שלבי הזירה](https://flsong.iok.la/teachers/resources/arenas).

### האם zgcombat כולל פרויקטים שהתלמידים יכולים לעבוד עליהם ולשתף?
...
**פיתוח משחקים** מה עוד יותר כיף מאשר לשחק משחק? להמציא משחק משלכם! בקורסים שלנו לפיתוח משחקים, התלמידים לומדים כיצד לבנות שלבי משחק משלהם בסגנון zgcombat ולתת לחברים ולמשפחה לשחק בהם באמצעות עכבר ומקלדת. עם הזמן, ייפתחו בפניהם הכלים הנחוצים ליצירה של חידות מאתגרות ולתרגול מיומנויות עיצוב המשחקים שלהם, כדי שיוכלו להפוך למעצבי המשחקים המובילים של המחר. את הפרויקטים הסופיים של כל קורס ניתן לפרסם בכתובת URL בהתאמה אישית, כך שהתלמידים יוכלו לשתף בקלות את המשחקים שלהם עם חברים ומשפחה.

המורים יכולים לקבל תצוגה מקדימה של כל השלבים בפיתוח אינטרנט ומשחקים, על-ידי מעבר אל הדף [מדריכים לקורס](http://flsong.iok.la/teachers/courses) ובחירת השלב מהתפריטים הנפתחים.
...
לא. המורים יכולים לקבל תצוגה מקדימה של כל שלבי המשחק ולשחק בהם, על-ידי מעבר אל הדף [מדריכים לקורס](http://flsong.iok.la/teachers/courses) ובחירת השלב מהתפריטים הנפתחים. ההתקדמות בשלב לא תישמר.

### כיצד להתחיל ולהשתמש ב-zgcombat?
...
להוראות על כל שלב ושלב, עיינו ב[מדריך ההתחלה המהירה למורה](https://flsong.iok.la/teachers/resources/getting-started).
...
ניתן להסיר רישיון מלא מתלמיד בכל עת לפני תפוגת הרישיון ולהקצות אותו לתלמיד אחר. לשם כך, עברו אל הכיתה של אותו תלמיד, לחצו על הכרטיסייה "מצב רישיון", ולחצו על "שלול רישיון" מהתלמיד שממנו ברצונכם לשלול את הרישיון. תלמיד זה לא יוכל לשחק בשום שלבים חדשים שלהם נדרש רישיון (הוא עדיין יוכל לגשת לכל שלב שבו כבר התחיל לשחק). הרישיון יהיה זמין להקצאה לתלמיד אחר (תאריך תפוגת הרישיון יישאר ללא שינוי) \- לכל הרישיונות הזמינים שלכם, עיינו בדף [רישיונות תלמיד](https://flsong.iok.la/teachers/licenses).

### כיצד לשתף רישיונות עם מורים אחרים בארגון שלי?

אם יש ברשותכם רישיונות מלאים, תוכלו לשתף עם מורים נוספים בארגון שלכם את הגישה אליהם. עברו אל [כרטיסיית רישיונות התלמיד](https://flsong.iok.la/teachers/licenses), ולאחר מכן לחצו על הקישור "שיתוף רישיונות" מחת לקבוצת רישיונות כלשהי. תופיע תיבת דו-שיח המאפשרת לכם להוסיף מורים לרישיונות המשותפים.

תוכלו להוסיף אך ורק מורים בארגון שלכם אשר כבר יצרו חשבון מורה ([כך](https://flsong.iok.la/teachers/resources/getting-started)). לאחר הוספה של מורה למאגר הרישיונות המשותפים, הוא יוכל להשתמש בכל רישיון שאתם משתפים עמו.
