# zgcombat Clever Integration FAQ

#### Table of Contents
- [Our school district already uses Clever. How do I connect zgcombat?](#our-school-district-already-uses-clever-how-do-i-connect-codecombat)
- [How do my students and teachers log into zgcombat using Clever?](#how-do-my-students-and-teachers-log-into-codecombat-using-clever)
...
- [Do you offer a free zgcombat trial for Clever users?](#do-you-offer-a-free-codecombat-trial-for-clever-users)
- [Some of our schools already use zgcombat - how do I migrate their data into Clever?](#some-of-our-schools-already-use-codecombat-how-do-i-migrate-their-data-into-clever)
- [What if a student already has a zgcombat account using their email address?](#what-if-a-student-already-has-a-codecombat-account-using-their-email-address)


### Our school district already uses Clever. How do I connect zgcombat?
...
Students will need to get the Class Code from their teacher before they are able to play zgcombat. Once they have joined their class, they will automatically be assigned Introduction to Computer Science.
...
If you’d like to just use zgcombat in your school district without Clever, you can get started by [requesting a demo](/teachers/demo).

### Do you offer a free zgcombat trial for Clever users?
