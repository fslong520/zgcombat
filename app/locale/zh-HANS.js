module.exports = {
  ...
  translation: {
    ...
    ozaria_home: {
      ...
      back_cta_1_a: '免费体验',
      speech_bubble_testimonial_1_blockquote: '“智国战役团队带给我们堪称惊艳的AI编程学习和教学平台，在我用过的众多程序教学平台中，奥佳睿完美平衡了知识性和趣味性，交互式故事沉浸体验寓教于乐，完备的教学资源让我们中小学计算机教师事半功倍，AI教学面板可以有针对性因材施教，扎实落实国家信息学课标要求的学生信息化核心素养培养要求，我和我的学生都非常喜欢这个平台。”',
      ...
      back_cta_2_a: '免费体验',
      faq_header: '常见问题',
      faq_row1_header: '奥佳睿和智国战役是什么关系？',
      faq_row1_p: '奥佳睿是基于享誉全球的游戏化编程平台 - 智国战役开发而成，奥佳睿平台由国内中关村清华北大谷歌团队和美国硅谷斯坦福哈佛团队共同开发。奥佳睿是建立在智国战役平台巨人的肩膀上，平台吸收了全球超过3万所学校的14多万教师的教学实践经验，以及2000多万中小学和各类学校学生在Python、C++、JavaScript、HTML/CSS等真实代码的学习经验。奥佳睿平台整合了当今最流行的国际STEAM教学法理论模型设计，采用沉浸式故事驱动的叙事方式，为线下代码编程教学和线上远程辅导提供优质超值的教学内容和管理工具。',
      faq_row2_header: '最适合奥佳睿平台学习的学生年龄和年级？',
      faq_row2_p: '奥佳睿教学平台匹配了面向中学生的CSTA、ISTE和国家中小学信息学核心素养标准等权威教学标准，适用于0基础的小学生和有一定编程基础的初高中生，对于0基础的成人学习者快速掌握编程技能也非常有效。未来，智国战役团队还将开发面向幼儿园大班和小学低年级少儿阶段的模块化竞技编程学习内容，让我们拭目以待！',
      faq_row3_header: '使用奥佳睿平台所有的模块和教学资源需要多少费用？',
      faq_row3_p_part1: '我们根据学校或培训机构的使用情况、学生规模和预算情况为你提供定制化方案，具体费用请联系智国战役/奥佳睿负责人王老师 [联系方式 - 13810906731/电话同微信号]，我们将和分布在全国各地的合作伙伴一起为你提供优质的教学内容和服务，开发编程竞赛挑战活动，并保证平台使用费用非常合理。',
    ...
    new_home: {
      title_coco: '智国战役|zgcombat中国|AI世青赛|少儿编程等级认证',
      title_ozar: '奥佳睿 - 引人入胜的计算机科学课程',
      title_cn_home: 'zgcombat - 玩游戏学编程|零基础Python, Javascript入门|zgcombat 个人版',
      meta_keywords_coco: '智国战役, 青少年编程, 少儿编程, 信息学奥赛, zgcombat官网,zgcombat中文,游戏化编程,AI世青赛,信息学奥赛,奥佳睿,zgcombat中国',
      meta_keywords_ozar: 'zgcombat,青少年编程,少儿编程,奥佳睿官网,Ozaria,游戏化编程,AI世青赛,信息学奥赛,奥佳睿,Ozaria中文',
      meta_description_coco: '智国战役是教育部白名单赛事平台，信奥CSP-J/S学习平台，AI世青赛、图灵计划和Code Quest官方竞赛平台，支持Python, C++, JavaScript。',
      meta_description_ozar: 'zgcombat原创作品，支持Python, JavaScript 和编程英语学习，奥佳睿（Ozaria）既是计算机科学程序，扣人心弦的冒险游戏，也是一个让学生们掌握计算机代码魔法来拯救世界的科幻故事。',
      meta_og_url: 'https://koudashijie.com',
      become_investor: '成为 zgcombat 的投资者',
      built_for_teachers_title: '赋能编程教师的专业课程体系',
      built_for_teachers_blurb: '智国战役提供专业、丰富的编程教案和教学活动设计、大数据教学管理平台和学生知识评估体系，可以帮助无计算机专业背景的教师轻松掌握Python, C++, JavaScript等代码编程入门和进阶阶段教学。智国战役和著名师资培训中心共同设置“扣哒名师奖”，培养中小学阶段编程和人工智能专业师资。',
      ...
      century_skills_subblurb1: '伴随着智国战役越来越具挑战性的编程关卡，孩子们始终都在挑战逻辑思维训练。',
      century_skills_quote2: '其他人都在创建迷宫，所以我想做点其它的，“抢夺旗帜”，这就是我做的。',
      century_skills_subtitle2: '创造',
      century_skills_subblurb2: '智国战役鼓励学生通过创建和分享自己的游戏和网页来展示他们的创造力。',
      ...
      click_here: '点击这里',
      creativity_rigor_title: '智国战役与众不同',
      creativity_rigor_subtitle1: '寓教于乐，轻松入门',
      creativity_rigor_blurb1: '智国战役让学习编程充满趣味，通过游戏闯关、竞技场排行、项目设计和生成式人工智能开发等创新模式，学生在做中学，可以有效培养算法思维、创意思维、逻辑思维和跨学科综合能力。',
      creativity_rigor_subtitle2: '智能匹配，因材施教',
      creativity_rigor_blurb2: '智国战役每个关卡都是依据权威标准(CSTA/CCSS/AP等)并根据数百万用户学习反馈数据搭建，并不断优化迭代，个性化呈现每一个学习者的状况便于制定个性化教学方案。',
      creativity_rigor_subtitle3: '支持青少年编程竞赛',
      creativity_rigor_blurb3: '智国战役自带竞赛系统(多人算法编程竞技场和创意编程顶峰项目)。已被中国、美国、新加坡、以色列等多个国家采用，是多个知名青少年编程竞赛指定平台。',
      ...
      for_leaders_subblurb3: '无论是少儿编程机构、中小学编程选修课、大学编程入门基础，智国战役都可以根据合作伙伴需求定制课程。',
      ...
      quotes_quote1: '智国战役寓教于乐，教学设计循序渐进，并且有AI世青赛全球官方竞赛，我和同学们都非常喜欢，我推荐老师们用这个平台开展编程兴趣班入门和进阶教学。',
      quotes_quote2: '我很惊讶智国战役让学习计算机科学变得如此轻松和主动。学生们的AP考试成绩远远超出我的预期，我相信这都是智国战役的功劳。',
      quotes_quote3: '智国战役是教授学生编写真实代码的最佳途径。我的丈夫是一名软件工程师，他测试了我所有的计算机科学备选课程，智国战役是他的首选。',
      quotes_quote4: '学生们的反馈非常积极，我们正在构建围绕智国战役的计算机科学课程。寓教于乐，真正让学生参与其中。再接再厉，智国战役！',
      quotes_quote5: '[AI_TRANSLATION]即使每周六早上7点开课，我儿子也兴奋得比我早起！zgcombat为我儿子的编程技能进步铺平了道路。',
      quotes_quote5_author: '[AI_TRANSLATION]Latthaphon Pohpon, 家长',
      see_example: '查看示例',
      slogan: '青少年人工智能学习平台',
      slogan_power_of_play: '玩游戏 学编程',
      teach_cs1_free: '免费教授计算机科学入门',
      teachers_love_codecombat_title: '教师们喜欢智国战役',
      teachers_love_codecombat_blurb1: '反馈学生们喜欢使用智国战役来学习编程',
      teachers_love_codecombat_blurb2: '会向其他计算机科学教师推荐智国战役',
      teachers_love_codecombat_blurb3: '认为智国战役帮助提高学生解决问题的能力',
      ...
      top_banner_blurb_roblox: '[AI_TRANSLATION]新的！zgcombat 即将登陆 Roblox！  ',
      top_banner_blurb_roblox_teachers: '[AI_TRANSLATION]新的！zgcombat 已与 Roblox Education 合作！  ',
      ...
      top_banner_blurb_demo_day_10_20: '[AI_TRANSLATION]10月20日星期四下午4:00 CDT加入我们恐怖的zgcombat和Ozaria演示会',
      ...
      im_an_educator: '我是老师',
      im_an_educator_description: '用智国战役教授编程',
      im_a_teacher: '我是老师',
      im_a_student: '我是学生',
      ...
      codecombat_is: '智国战役是一个让<strong>学生</strong>通过与游戏互动学习计算机科学的平台。',
      our_courses: '我们的编程课程体系尤其<strong>适用于教室教学的需求</strong>。无编程经验的教师也可轻松授课。',
      watch_how: '了解智国战役如何改变学生们学习计算机科学的方式。',
      ...
      builds_concepts_up: '我喜欢智国战役的产品概念。这个游戏逻辑很容易理解，学习的过程十分快乐。',
      ...
      agency: '智国战役是一个这样的课堂：它通过完善的代码引擎，给学习者提供帮助，树立自信，初学者和高年级学生都能找到适合自己水平的关卡。',
      ...
      try_codecombat: '试用智国战役',
      try_ozaria: '试试奥佳睿',
      explore_codecombat: ' zgcombat探秘',
      explore_ai_league: '参加AI世青赛',
      explore_ozaria: 'Ozaria探秘',
      explore_online_classes: '扣哒学堂探秘',
      explore_pd: '[AI_TRANSLATION]探索专业发展',
      new_adventure_game_blurb: 'Ozaria是zgcombat团队开发的新一代青少年创客和人工智能教学平台，融合奇幻的探索故事让STEM学习过程充满趣味性，智能化教学管理和丰富的教学资源让学校和机构老师可以轻松驾驭。',
      lesson_slides: '学习资料',
      ...
      online_classes_blurb: '我们的官方课程采用清华北大等顶级名校计算机专业毕业的优秀讲师开展教学，结合zgcombat寓教于乐的闯关学习，非常适合青少年学生在线远程学习或线下班课学习。',
      ...
      codecombat_home: '[AI_TRANSLATION]zgcombat 家庭版  ',
      ...
      for_partners_title: '[AI_TRANSLATION]与 zgcombat 合作\n',
      for_partners_blurb: '[AI_TRANSLATION]通过与zgcombat合作，加入我们的使命，让编程变得人人可学且有趣。我们的合作模式包括教育业务、电子竞技赞助商、国际分销商和社会影响力伙伴。合作伙伴可以使用我们易于操作的程序、实施资源和培训选项，确保成功和愉快的体验。',
      for_partners_button: '[AI_TRANSLATION]探索合作伙伴关系',
      for_libraries_title: '[AI_TRANSLATION]图书馆整合',
      for_libraries_blurb: '[AI_TRANSLATION]作为一个完全自学和自主的数字资源，zgcombat 是希望赋予各个年龄段成员编程能力的图书馆的最佳选择。我们的平台提供了学习者体验高水平编程教育所需的一切，通过独特的游戏化课程让学习变得令人兴奋。从三年级的学习者到想掌握大学级别编程概念的成人都非常适用。',
      ...
      million: '2000万',
      billion: '10亿',
      meta_keywords_podcast: '[AI_TRANSLATION]zgcombat, python, javascript, 编程游戏, 播客, 教育科技',
      coco_worlds_header: '[AI_TRANSLATION]zgcombat 世界  ',
      coco_worlds_description: '[AI_TRANSLATION]在Roblox中开始一段3D编程冒险，你可以编程宠物，与朋友一起玩，并开发游戏，同时享受游戏的乐趣。加入zgcombat社区，在元宇宙中释放你的创造力！',
      coco_worlds_button: '[AI_TRANSLATION]探索 zgcombat 世界',
      promo_modal_title: 'zgcombat',
    ...
    nav: {
      ...
      codecombat_classroom: '智国战役课程',
      ozaria_dashboard: '奥佳睿班级',
      ozaria_teacher_dashboard: '奥佳睿老师面板',
      ozaria_admin_dashboard: '奥佳睿管理员面板',
      codecombat_dashboard: '智国战役班级',
      codecombat_teacher_dashboard: '智国战役老师面板',
      codecombat_admin_dashboard: '智国战役管理员面板',
      ...
      codecombat_worlds_on_roblox: '[AI_TRANSLATION]zgcombat 世界 在 Roblox 上  ',
      //    pricing: "Pricing",
    ...
    diplomat_suggestion: {
      ...
      pitch_body: '我们开发了英文版的zgcombat，但是zgcombat学习者遍布全球。对于不熟悉英语的中文玩家，他们希望能使用简体中文版本；如果您中英文都很熟练，请考虑加入我们的“外交官”团队，汉化zgcombat网站和所有关卡。感谢！',
    ...
    new_home_faq: {
      ...
      python_and_javascript: '目前个人版zgcombat支持Python和JavaScript，高级订阅版本支持 C++，教学版智国战役同时支持以上语言和信息学奥赛.',
      ...
      main_curriculum: '我可以用 智国战役 或 奥佳睿 作为校本课程吗?',
      main_curriculum_blurb: '当然可以! 我们的教研团队来自清华大学、北京大学、斯坦福大学、哈佛大学等世界一流名校，在计算机基础教育方面具有扎实的理论知识和丰富的实践经验。国内部分省市如山东省中小学330科创教育平台、苏州市青少年数字公民计划等已经采用zgcombat教学版智国战役作为校本课程，如果你希望在学校开展以我们平台为主的编程教学活动，请联系我们的教育专家寻求建议.',
      clever_instant_login: '[AI_TRANSLATION]zgcombat 和 Ozaria 支持 Clever 实时登录吗？',
      ...
      how_much_does_it_cost_blurb: 'zgcombat个人版或智国战役教学版都提供5个关卡的免费试用。zgcombat个人版支持季度付费 (299元/月)和年度付费 (999元/年)，费用包括所有的关卡学习内容和AI世青赛的竞赛学习内容。',
      recommended_systems: '有没有推荐的浏览器或操作系统?',
      recommended_systems_blurb: '只需要流畅的网络和合适的浏览器即可运行zgcombat和Ozaria。国内推荐最低电脑内存4GB，浏览器推荐使用谷歌Chrome浏览器或Safari, Firefox和Edge，不推荐国内低版本浏览器特别是360浏览器。支持Windows系统和Mac苹果系统电脑或笔记本，不支持手机，如果你使用Pad，推荐配置键盘。网络带宽至少需要200 Kbps/学生，最好能达到1Mbps以上带宽/学生。',
      other_questions: '如果你还有其它问题, 请联系微信客服安小风，或者联系平台负责人欧卡王，电子邮箱 bill@flsong.iok.la.',
      see_faq_prefix: '[AI_TRANSLATION]查看更多',
      see_faq_link: '[AI_TRANSLATION]我们帮助中心的常见问题',
      //    see_faq_suffix: ".",
      ai_bot_faq_title: '[AI_TRANSLATION]什么是 AI Level Help Bot？有什么措施来确保安全？',
      ai_bot_faq_blurb: '[AI_TRANSLATION]zgcombat中的AI Chat Level帮助机器人为学习者提供基于AI提示的编码挑战，确保引导但独立的学习体验。安全性是最重要的，因为AI会过滤个人数据并经过训练以处理不当请求。   ',
    },

    play: {
      title: '挑战zgcombat关卡 - 学习Python，JavaScript和C++',
      ...
      anon_signup_title_1: 'zgcombat 有一个 ',
      ...
      teacher_button: '带到学校',
      get_more_codecombat: '获取跟过zgcombat游戏的信息',
      ...
      cchome_button_hover: 'zgcombat 原版冒险游戏',
    ...
    share_progress_modal: {
      blurb: '您的进度真快！快告诉您的家长, 您从zgcombat学到了什么！',
      email_invalid: '邮件地址不可用。',
      form_blurb: '输入他们的邮件地址，让他们了解zgcombat的趣味',
      form_label: '您的邮件地址',
      placeholder: '邮件地址',
      title: '做的很好，学徒',
    },
    ...
    login: {
      ...
      already_have_account1: '已有zgcombat教师或学生账号？',
      already_have_account2: '你可以直接使用那个账号登录',
      sign_into_ozaria: '登录Ozaria.com',
      individual_users_not_supported: '[AI_TRANSLATION]Ozaria 只适用于课堂！请访问 zgcombat 继续游戏！\n',
    ...
    signup: {
      ...
      teacher_additional_questions: '如果需要额外帮助或遇到问题，请联系 china@flsong.iok.la。',
      dont_use_our_email_silly: '请填写家长的邮箱地址。',
      want_codecombat_in_school: '想接着玩zgcombat?',
      ...
      already_have_account: '[AI_TRANSLATION]已经有 zgcombat 或 Ozaria 账户\n',
      ...
      with: '与',
      want_to_play_codecombat: '不，我没有，但我想玩 zgcombat!',
    ...
    common: {
      default_title_coco: '智国战役 - 在场景化编程中学习Python，JavaScript和C++',
    ...
    play_level: {
      ...
      tip_open_source: '「zgcombat」青少年编程领导品牌！',
      tip_tell_friends: '喜欢zgcombat？那就赶快把它安利给朋友！',
      tip_beta_launch: 'zgcombat开始于2013的10月份。',
      ...
      tip_open_source_contribute: '您可以帮助「zgcombat」进步！',
    ...
    play_game_dev_level: {
      ...
      restart: '重新开始关卡',
      play: '开始关卡',
      play_more_codecombat: '玩更多的 zgcombat 关卡',
    ...
    subscribe: {
      best_deal: '最佳优惠!',
      confirmation: '恭喜你！你已经获得了zgcombat的高级订阅版本',
      premium_already_subscribed: '你已经订阅了高级版本',
      subscribe_modal_title: 'zgcombat 订阅',
      comparison_blurb: '亲，想要成为编程高手，那么现在就订阅zgcombat！',
      ...
      support_part2: 'china@flsong.iok.la',
      go_prepaid: '付款后请点这里',
      forever: '终生',
    ...
    premium_features: {
      get_premium: '获取<br>zgcombat<br>高级订阅',
      ...
      everything_in_premium: '您在zgcombat高级订阅中获得的内容:',
      ...
      ai_bot_description: '[AI_TRANSLATION]zgcombat 的 AI 提示功能可以评估代码，指出错误并解释如何修复它们。最重要的是，它提供了所有理解"为什么"所需的背景信息，而不会提供完整的解决方案。在当前代码问题帮助的情况下，小朋友们仍需完成每一关的编程挑战。高级订阅用户每天可获得 10 个 AI 提示配额，确保他们始终能获得所需支持。',
    ...
    about: {
      ...
      sism_title: '高级内部销售经理',
      shan_title: '首席营销官，zgcombat 大中华区',
      run_title: '首席运营官，zgcombat 大中华区',
      lance_title: '研发负责人，zgcombat 大中华区',
      zhiran_title: '课研负责人，zgcombat 大中华区',
      yuqiang_title: '创新负责人，zgcombat 大中华区',
      swe_title: '软件工程师',
      sswe_title: '高级软件工程师',
      css_title: '客户支持专家',
      ...
      bill_title: '首席执行官，zgcombat 大中华区',
      pvd_title: '产品和视觉设计师',
      ...
      community_subtitle: '超过 450 个志愿者帮助我们建设 zgcombat，每周都有新成员加入！',
      community_description_3: 'zgcombat 是一个',
      community_description_link_2: '开源的社区项目',
      community_description_1: '上百名玩家创建了各种关卡，给我们的源代码添砖加瓦，添加新功能、修复Bug、测试、甚至是将其翻译为50种语言。职员、贡献者以及网站本身都在分享创意并奋斗中成长，这就是开源社区的力量。此网站在众多开源项目之上建立，我们为表感恩，也将网站开源奉献给社区，给好奇源码的玩家提供探索和实验的项目。每个人都能加入zgcombat社区！看一下我们的',
      ...
      story_subtitle: '从2013年至今，zgcombat已经从一组小草图成长为一个生动的、蓬勃发展的教育产品。',
      story_statistic_1a: '20,000,000+',
      story_statistic_1b: '总玩家',
      story_statistic_1c: '已经通过zgcombat开始了他们的编程之旅',
      ...
      jobs_title: '和我们一起工作，一起书写 zgcombat 的历史！',
      ...
      jobs_custom_description: '对 zgcombat 充满激情却没找到适合自己的职业？给我们写信说明你该如何做出贡献。我们期待你的建议！',
    ...
    teachers: {
      ...
      free_course_blurb_junior: '[AI_TRANSLATION]适合K-5年级，zgcombat Junior可以为不熟练的读者提供基于块和移动化的选择，也可以为高年级的小学生提供Python或JavaScript文本代码，或者并行块与代码，协助过渡。  ',
      'free_course_blurb_introduction-to-computer-science': '[AI_TRANSLATION]适合6-12年级，zgcombat的核心计算机科学课程从适合初学者的计算机科学入门课程开始，贯穿AP计算机科学原理，并延伸到高级计算机科学课程。中学生和高中生可从这里开始。  ',
      ...
      import_codecombat_classroom: '[AI_TRANSLATION]导入 zgcombat 课堂  ',
    ...
    no_licenses_page: {
      ...
      join_our_community_desc: '超过1200万用户使用智国战役学习Python和JavaScript。现在我们欢迎您加入我们的奥佳睿社区，这里有超过82000名老师和25000个学校。奥佳睿为激励新一代学习计算机科学的学生而设计开发。',
    ...
    special_offer: {
      ...
      license_limit_description: '老师最多可以购买 __maxQuantityStarterLicenses__ 个许可证. 你已经购买了 __quantityAlreadyPurchased__ 个. 如果你需要更多, 请联系 china@flsong.iok.la. 学生入门许可证有效期为 __starterLicenseLengthMonths__ 个月.',
    ...
    teachers_quote: {
      ...
      subtitle_ozar: '将 zgcombat 带到您的班级、俱乐部、学校甚至地区！',
      ...
      state: '省/直辖市',
      country: '国家/地区',
      num_students_help: '您估计有多少学生加入zgcombat？',
      ...
      thanks_header: '申请已发送！',
      thanks_sub_header_coco: '感谢您为您的学校表达对 zgcombat 的兴趣。',
      thanks_sub_header_ozar: '感谢您为您的学校表达对 zgcombat 的兴趣。',
      ...
      learn_more_modal: '在 zgcombat 中，老师账号可以观察学生进度、分配名额以及管理教室。老师账号不能加入班级 - 如果您使用当前账号加入了班级，升级后将不能访问所加入的班级。',
      create_account: '创建老师账号',
      create_account_subtitle: '在 zgcombat 班级中使用老师专用工具。 <strong>创建班级</strong>添加学生、<strong>观察学生进度</strong>！',
    ...
    contact: {
      ...
      subscribe: '订阅zgcombat',
      subscribe_suffix: '并且我们很乐意给您提供代码相关的帮助',
      subscriber_support: '既然您已经订阅了zgcombat，我们将给您提供优先帮助',
      screenshot_included: '包含截屏',
      where_reply: '我们应该回复谁？',
      send: '反馈意见',
      ooo_blurb: '[AI_TRANSLATION]zgcombat 团队将从6月5日到6月9日休假，这段时间内我们对邮件的访问将受到限制。我们会尽快回复您的询问，请注意可能的等待时间。\n',
    },
    ...
    account_settings: {
      ...
      roblox_not_connected: '[AI_TRANSLATION]连接你的zgcombat和Roblox账号。',
      ...
      email_announcements_description: '接收关于zgcombat的邮件。',
      email_notifications: '通知',
      email_notifications_summary: '私人定制, 自动通知与您有关的zgcombat活动。',
    ...
    community: {
      ...
      thang_editor_suffix: '来改良zgcombat中的原材料。让游戏中的东西可以被捡起来扔出去，改变游戏动画的指向，调整一些东西的生命值，或上传您自制的素材。',
      ...
      social_blog: '阅读zgcombat在Sett上面的博客',
      social_discource: '在我们的论坛参与讨论',
      social_facebook: '关注zgcombat的Facebook主页',
      social_twitter: '关注zgcombat的Twitter',
      social_slack: '在公共 zgcombat Slack 聊天频道与我们交谈',
      contribute_to_the_project: '为项目做贡献',
    },

    clans: {
      title: '加入 zgcombat Clans - 学会用 Python、JavaScript 和 HTML 编程',
      clan_title: '__clan__ - 加入 zgcombat 部落，学习编码。',
    ...
    courses: {
      ...
      join_class: '加入班级',
      join_class_2: '加入班级',
      ask_teacher_for_code_coco: '从你的老师那里领取zgcombat班级代码！领取后请在下方输入：',
      ask_teacher_for_code_ozar: '从你的老师那里领取zgcombat班级代码！领取后请在下方输入：',
      ...
      update_account_individuals_warning_ozaria: '[AI_TRANSLATION]警告：个人账户不能玩 Ozaria，只能玩 zgcombat。',
      ...
      update_account_confirm_update_student2: '你将不能再创建新班级或管理已创建的班级。你在 zgcombat 创建的班级将会被删除且无法恢复！',
      instructor: '邀请人: ',
      youve_been_invited_1: '您被邀请加入 ',
      youve_been_invited_2: '，在 zgcombat 中与您的同学一起学习 ',
      ...
      license_required_to_play_ozar: '询问你的老师来注册一个许可证，之后你可以继续玩zgcombat游戏！',
    ...
    teacher: {
      ...
      not_assigned_modal_full_body_3: '请适量减少选定的学生数量, 或联系china@flsong.iok.la寻求帮助。',
      assigned: '已添加',
      ...
      pacing_guides_desc: '了解如何整合智国战役的所有资源来制定您的教学计划！',
      ...
      educator_faq: '常见问题',
      educator_faq_desc: '在您的学校或教室使用智国战役的常见问题。',
      teacher_getting_started: '老师入门指南',
      teacher_getting_started_desc: '第一次使用智国战役？下载此老师入门指南开始设置您的账号，创建第一个课堂并邀请学生参加第一门课程。',
      student_getting_started: '学生快速入门指南',
      student_getting_started_desc: '您可以在讲解智国战役之前先将此入门指南发布给学生，以便他们熟悉代码编辑器。本指南可用于 Python 和 JavaScript 语言教室。',
      ...
      hoc_intro: '您的班级可以通过三种方式参加 zgcombat 的“编码一小时”活动。',
      hoc_self_led: '自导自演的游戏玩法',
      hoc_self_led_desc: '学生可以通过两个小时的 zgcombat 教程自己玩。',
      hoc_game_dev: '游戏开发',
      hoc_and: '和',
      ...
      hoc_additional_desc1: '关于更多的 zgcombat 资源和活动，请参见我们的',
      ...
      teacher_quest_teach_methods_step2: '打印资源中心的 [学生快速入门指南](https://files.flsong.iok.la/docs/resources/StudentQuickStartGuide.pdf) ',
      ...
      teacher_quest_kithgard_gates_100_step2: '引导学生通过思考来解决难题 [Engineering Cycle Worksheet](https://files.flsong.iok.la/docs/resources/EngineeringCycleWorksheet.pdf).',
      ...
      teacher_quest_done: '希望你的学生学习更多的代码? 现在就请联系我们的 [校园专家](mailto:schools@flsong.iok.la) !',
    ...
    teacher_ozaria_encouragement_modal: {
      ...
      sub_title: '邀请您体验 zgcombat 出品的最新冒险编程产品',
      cancel: '返回 zgcombat',
      accept: '免费试用序章',
      ...
      bullet3: '在顶点项目释放创意',
      bullet4: '提供教研资料指导',
      you_can_return: '您可以随时回到 zgcombat',
    },
    ...
    educator_signup_ozaria_encouragement: {
      ...
      homeschoolers: '家庭教育者',
      educators_continue_coco: '想在课堂上继续使用 zgcombat 的教育工作者。',
      continue_coco: '继续进行 zgcombat',
    },
    ...
    classes: {
      ...
      archmage_summary: '如果您是对教育类游戏感兴趣的程序开发者，那么就选择大法师来为zgcombat编写代码吧！',
      artisan_title: '工匠师',
      ...
      diplomat_summary: 'zgcombat已经被我们的外交官们翻译成45多种世界语言。在翻译的同时体验翻译的乐趣吧！',
      ambassador_title: '使节',
      ambassador_title_description: '(用户支持人员)',
      ambassador_summary: '指导我们亲爱的论坛用户并为他们的问题引出一个正确的方向。我们的使节将zgcombat带到这个世界上。',
      teacher_title: '老师',
    },

    editor: {
      main_title: 'zgcombat编辑器',
    ...
    contribute: {
      page_title: '贡献',
      intro_blurb: 'zgcombat是完全开源的软件！上千个玩家帮助了我们建设了这整个游戏，就是您今天看到的一样！快加入我们然后为zgcombat打开新的章节，将世界带领进入编程世代前进吧！',
      ...
      scribe_introduction_pref: 'zgcombat不只是拥有一堆等级或关卡。它也是个知识的源泉，一个编程的宝典，一个人人都可以参与的，有趣的游戏。比起每个工匠都要详细解释其中的奥秘，他们可以以更简单的方式将自己的东西连接到一篇已经准备好的文章给玩家阅读。 有些东西就像 ',
      ...
      diplomat_introduction_suf: '中得到了什么启发：那就是全世界的人都很喜欢zgcombat。我们召集了一群翻译者，希望能尽快地把网站上的信息翻译成各国文字。如果您对zgcombat的内容很感兴趣，想让世界上的每一个人都有机会一同体验，就快来成为外交官吧。',
      ...
      diplomat_join_suf_github: '找到中文语言文件 (简体中文的是:zgcombat/app/locale/zh-HANS.coffee)，在线编辑它，完成后提交一个合并请求。您也可以勾上下面这个复选框来关注最新的国际化开发！',
      diplomat_subscribe_desc: '接受有关国际化开发和翻译任务的邮件',
      ambassador_introduction: '这是一个正在成长的社区，而您将成为我们与世界的联结点。大家可以通过各种即时聊天平台、邮件、或是参与者众多的社交网络来认识及讨论我们的游戏。如果您喜欢帮助大家，一起参与各类项目，一起获得乐趣。与我们同行，一起感受zgcombat的脉搏，绝对是一个适合您的职业。',
    ...
    user: {
      user_title: '__name__ - 用 zgcombat 学习编码',
      stats: '成就',
    ...
    account: {
      ...
      status_unsubscribed: '只要一个zgcombat订阅，您就可以玩转全部新关卡，用遍全部英雄，物品，以及获得更多的宝石哦！',
      ...
      unsubscribe_from_marketing: '取消订阅所有 zgcombat 营销邮件的 __email__？',
    ...
    account_prepaid: {
      purchase_code: '购买激活码',
      purchase_code1: '订阅码可以为一个或多个zgcombat账号兑换额外的订阅时间。',
      purchase_code2: '每个zgcombat账号每次只能兑换一个订阅码。',
      purchase_code3: '订阅码时间会在账号现有的订阅时间基础上延长。',
      purchase_code4: '订阅码适用于玩独立版zgcombat的账号，不能代替“课堂”版本的学生许可。',
    ...
    impact: {
      ...
      teacher_quote: '当我开始接触 zgcombat 并开始让我的学生使用它时，就像点亮了我脑子里的一盏灯一样。这与与我接触的其他编程产品有着日与夜的差别，没有比 zgcombat 更好的产品。',
      ...
      ozaria_impact_blurb: '[AI_TRANSLATION]zgcombat 的姊妹课程 Ozaria 已经证明对学生学习成果有积极影响，这些成果对学生和教育者都很重要。',
    ...
    anonymous_teacher: {
      ...
      teachers_section: '老师:',
      students_section: '学生:',
      teacher_notified: '已经通知给你的老师，你想要在课堂上玩更多zgcombat游戏。',
    },
    ...
    legal: {
      page_title: '法律',
      opensource_introduction: 'zgcombat是开源社区的一部分',
      opensource_description_prefix: '查看 ',
      github_url: '我们的GitHub',
      opensource_description_center: '并做您想做的修改吧！zgcombat是构筑在几十个开源项目之上的，然后我们都喜欢它们。看 ',
      ...
      cost_title: '花费',
      cost_description: '[AI_TRANSLATION]zgcombat 的入门关卡是免费的，额外关卡和每月 __gems__ 额外宝石的订阅费用为 $__price__ 美元/月。你可以一键取消，并且我们提供 100% 的退款保证。  ',
      ...
      code_title: '代码 - MIT',
      client_code_description_prefix: 'flsong.iok.la 在 GitHub 公共仓库和 flsong.iok.la 数据库中的所有客户端代码，都是根据以下协议授权的',
      mit_license_url: 'MIT 许可证',
      code_description_suffix: '这包括所有zgcombat公开的制作关卡用的系统和组件代码。',
      art_title: '美术和音乐 - Creative Commons',
      art_description_prefix: '所有共通的内容都在',
      cc_license_url: 'Creative Commons Attribution 4.0 International License',
      art_description_suffix: '条款下公开。共通内容是指所有zgcombat发布出来用于制作关卡的内容。这包括：',
      art_music: '音乐',
      art_sound: '声效',
      art_artwork: '图画',
      art_sprites: '精灵',
      ...
      art_paragraph_1: '关于署名，请说明并在使用处附近，或对媒体形式来说合适的地方提供一个flsong.iok.la 的链接。举例：',
      use_list_1: '如果是用在电影里或者其他游戏里，请在制作人员表中加入flsong.iok.la。',
      use_list_2: '如果用在网站上，将链接在使用的地方附近，比如图片下面，或者一个您放置其他 Creative Commons 署名和开源软件协议的专门页面。如果您的内容明确提到关于zgcombat，那您就不需要额外署名。',
      art_paragraph_2: '如果您使用的内容不是由zgcombat制作，而是由flsong.iok.la 上其他的用户制作的，那您应该给他们署名。如果相应资源的页面上有署名指示，那您应该遵循那些指示。',
      rights_title: '版权所有',
      ...
      nutshell_title: '简而言之',
      nutshell_description: '我们在关卡编辑器里公开的任何资源，您都可以在制作关卡时随意使用，但我们保留限制在flsong.iok.la 之上创建的关卡本身传播的权利，因为我们以后可能决定为它们收费。',
      nutshell_see_also: '参见:',
      canonical: '这篇说明的英文版本是权威版本。如果各个翻译版本之间有任何冲突，请以英文版为准。',
      third_party_title: '第三方服务',
      third_party_description: 'zgcombat使用了下列第三方服务（除了别的以外）：',
      cookies_message: 'zgcombat使用了必要和非必要的cookies.',
    ...
    ladder_prizes: {
      ...
      total_value: '总价值',
      in_cash: '现金',
      custom_wizard: '定制zgcombat巫师',
      custom_avatar: '定制zgcombat头像',
    ...
    apcsp: {
      ...
      meta_description: 'zgcombat 的综合课程和专业发展计划是你为学生提供 College Board 最新的计算机科学课程所需要的一切。',
      syllabus: 'AP CS 原理教学大纲',
      syllabus_description: '使用此资源为你的 AP 计算机科学原理课规划 zgcombat 课程。',
    ...
    apcsp_marketing: {
      ...
      icons_coding_levels: '[AI_TRANSLATION]150+个zgcombat编程关卡',
      ...
      course_outline_description: '[AI_TRANSLATION]以下描述是对 zgcombat AP CSP 课程内容的概述。\n',
      ...
      professional_development: '[AI_TRANSLATION]专业发展',
      professional_development_description: '[AI_TRANSLATION]zgcombat 为各个层次的 AP CSP 教育者提供一个在线的、自定进度的专业发展课程。参与者将探索 zgcombat 的课程，并了解如何使用它来帮助学生成功通过 AP CSP 考试。通过与其他教师的异步讨论和与 zgcombat 学习设计师的视频会议，你将掌握支持所有学生参与 AP CSP 的工具和技巧。课程结束后，您将获得一张完成证明，可以用于更新您的教学资格。',
      ...
      question_2: '[AI_TRANSLATION]zgcombat 的 AP CSP 课程对技术有什么要求？',
      ...
      coco_requirements: '[AI_TRANSLATION]zgcombat 的系统要求',
      coco_recognized_blurb: '[AI_TRANSLATION]zgcombat 被大学理事会认定为 AP® 计算机科学原理（AP CSP）课程和专业发展认证提供者。此认证确认 zgcombat 的课程符合所有 AP 课程框架标准和 AP CSP 评估。这使学校能够访问包括经过大学理事会课程审核预批准的 AP CSP 教学大纲和正式认可的教师专业发展资源，这些资源帮助教师教授该课程。',
    ...
    apcsp_curriculum: {
      ...
      professional_development_description: '[AI_TRANSLATION]zgcombat 为各个层次的 AP CSP 教育者提供一个在线的、自定进度的专业发展课程。参与者将探索 zgcombat 的课程，并了解如何使用它来帮助学生成功通过 AP CSP 考试。通过与其他教师的异步讨论和与 zgcombat 课程开发人员的视频会议，你将掌握支持所有学生参与 AP CSP 的工具和技巧。课程结束后，您将获得一张完成证明，可以用于更新您的教学资格。我们在 __edapp__ 上提供我们的课程。',
      ...
      no_license: '[AI_TRANSLATION]我们的 AP CSP 课程需要付费许可方可查看。访问如下链接的关于页面了解更多 zgcombat 的 AP CSP 课程信息。',
      ...
      step_1_subtitle: '[AI_TRANSLATION]将 zgcombat 的 AP CSP 教程大纲上传到 College Board 的课程审核中。',
    ...
    hoc_2019: {
      ...
      already_have_account: '[AI_TRANSLATION]已经有 zgcombat 或 Ozaria 账户？请登录。\n',
    ...
    parents_landing_1: {
      ...
      codecombat_intro: '[AI_TRANSLATION]zgcombat 将游戏玩法与个性化教学结合在一起，每周为孩子们提供令人期待的在线编程课程！  ',
      ...
      quote_1: '[AI_TRANSLATION]即使每周六早上7点开课，我儿子也兴奋得比我早起！zgcombat为我儿子的编程技能进步铺平了道路。',
      ...
      private_instructions: '[AI_TRANSLATION]所有课程都是私人、个性化的教学。要为一组学生报名，请联系 <a href="mailto:classes@flsong.iok.la">classes@flsong.iok.la</a> 获取定制方案。',
      ...
      benefit_3: '[AI_TRANSLATION]包含 zgcombat 高级许可证',
      ...
      subscription_details: '[AI_TRANSLATION]所有订阅都是按月计费，暂停、取消或恢复都没有费用。您的订阅购买在前30天内是100%无风险的。如果您决定不继续，只需在购买后30天内<a href="mailto:classes@flsong.iok.la">联系我们</a>，我们将立即全额退款，毫无疑问。所有计划都会自动按同级别和计费周期续约，除非有所更改或取消。  ',
      ...
      grit_description: '[AI_TRANSLATION]zgcombat 鼓励学生接受并从错误中学习。内置提示帮助学生发现并修复错误，提升编程自信。  ',
      ...
      faq_a_1: '[AI_TRANSLATION]我们的每位导师都是精挑细选来代表zgcombat，并为每个学生提供有趣且个性化的学习体验。我们相信您的孩子会喜欢和我们的任何一位导师学习，但如果您有任何原因想换导师，我们也很乐意为您安排。\n',
      ...
      faq_a_4: '[AI_TRANSLATION]你的订阅购买在前30天内是100%无风险的。如果你决定不继续使用，购买后的30天内<a href="mailto:classes@flsong.iok.la">联系我们</a>，我们会立即全额退款，绝不问任何问题。你也可以随时冻结你的订阅，并在合适的时间重新激活。',
      faq_q_5: '[AI_TRANSLATION]如果我需要重新安排课程怎么办？',
      faq_a_5: '[AI_TRANSLATION]一旦你预约了我们的每周课程，我们会专门为你预留时间，所以重新安排课程需要提前48小时通知。你可以通过发送邮件给 <a href="mailto:classes@flsong.iok.la">classes@flsong.iok.la</a> 来重新安排课程。少于48小时通知的缺课或取消将不被重新安排也不予退款。',
      ...
      other_questions: '[AI_TRANSLATION]如果你对我们的在线课程有任何疑问，请 <a href="mailto:classes@flsong.iok.la">联系我们。</a>\n',
    },
    ...
    parents_landing_2: {
      ...
      live_classes: '在线直播课程',
      live_classes_offered: 'zgcombat 现在为在家学习的学生提供实时在线计算机科学课程，对于那些在 1:1 或小组环境中学习效果最好的学生来说，这是非常好的。',
      ...
      best_seller: '畅销产品',
      best_value: '极具价值',
      codecombat_premium: 'zgcombat 高级版',
      ...
      premium_need_help: "需要帮助或喜欢 Paypal？电子邮件 <a href='mailto:support@flsong.iok.la'>support@flsong.iok.la</a>。",
      not_sure_kid: '不确定 zgcombat 是否适合您的孩子？ 问问他们！',
      share_trailer: '与您的孩子分享我们的游戏预告片，并让他们创建一个帐户开始。',
      why_kids_love: '为什么孩子们喜欢 zgcombat？',
      ...
      why_parents_love: '家长为什么喜欢 zgcombat？',
      ...
      critical_skills_detail: '你的孩子将学会如何驾驭数字世界，成为数字世界的一员。zgcombat 是一个解决方案，可以提高你孩子的批判性思维、创造力和韧性，赋予他们从事任何行业所需要的技能。',
      parent_support: '由您这样的家长支持',
      parent_support_detail: '在zgcombat，我们是父母、我们是编码者、我们是教育工作者，但最重要的是，我们相信，无论孩子们决定做什么，我们都会给他们最好的机会，让他们获得成功。',
      ...
      get_started: '开始使用',
      quotes_title: '家长和孩子们对 zgcombat 的评价是什么？',
      quote_1: '"这是给孩子们的下一级编码，很有趣，我也从中学到一些东西。"',
      quote_2: '"我喜欢学习一项我以前没学过的新技能，我喜欢当我艰难的时候，我可以找到目标，我还喜欢您可以看到代码正常工作。"',
      quote_3: '"Oliver 的 Python 正在进行中，他正在使用 zgcombat 制作自己的电子游戏。他在用 zgcombat 制作自己的电子游戏，他挑战我玩他的游戏，然后在我输的时候大笑。"',
      quote_4: '"这是我最喜欢做的事情之一，每天早上醒来，我都会玩 zgcombat。如果要给 zgcombat 打分的话，从 1到 10，我会给它 10 分！"',
      parent: '家长',
      student: '学生',
      grade: '级别',
      subscribe_error_user_type: '看来你已经注册了一个账户。如果您对 zgcombat 高级版感兴趣，请联系我们 team@flsong.iok.la。',
      subscribe_error_already_subscribed: '您已经注册了一个高级账户。',
      start_free_trial_today: '今天开始免费试用',
      live_classes_title: 'zgcombat 的实时编码课程！',
    ...
    modal_timetap_confirmation: {
      ...
      paragraph_5: '感谢你选择 zgcombat，并祝你在计算机科学的旅途中好运!',
      back_to_coco: '返回 zgcombat',
    },
    ...
    hoc_2018: {
      ...
      about: '关于 zgcombat 游戏',
      about_copy: 'zgcombat 是一个基于游戏的计算机科学程序，用于教真正的 Python 和 JavaScript。zgcombat 的标准课程是围绕学生喜欢的游戏进行设计。超过1200万的学生已经学会在 zgcombat 上编程!',
      point1: '✓ 搭建完毕',
      point2: '✓ 分区完毕',
      point3: '✓ 过程和总结评价',
      point4: '✓ 基于项目的课程',
      ...
      featured_title_1: '[AI_TRANSLATION]zgcombat：妖精与荣耀',
    ...
    school_administrator: {
      ...
      add_additional_teacher: '需要添加其他的教师吗？请联系您的zgcombat客户经理或发送电子邮件至china@flsong.iok.la。 ',
      license_stat_description: '可用许可证是教师可用的许可证总数，包括共享的许可证。',
      students_stat_description: '学生总数是所有教室的所有学生数，不管他们是否使用了许可证，都会被计算在内。',
      active_students_stat_description: '活跃学生数是在过去60天登录zgcombat的学生人数。',
    ...
    browser_recommendation: {
      title: 'zgcombat 在 Chrome 浏览器上效果最好',
      pitch_body: '为保证 zgcombat 的所有功能正常运行，建议使用 Chrome 浏览器进行学习。',
    ...
    events: {
      title: '扣哒大事记',
      main_title: '扣哒大事记',
      main_description: '智国战役是创建于首都教育腹地中关村的中小学科创教育项目。团队成员来自清华大学、北京大学、哈佛大学、斯坦福大学、耶鲁大学等全国及世界顶级名校以及谷歌、微软、宝洁、麦肯锡等世界级名企，硕士及以上学历占90% 以上，部分成员在ACM、ICM、NOIP和全国数学联赛上取得优异成绩。学高为师、行正致远，这是一支积极向上、兼容并包、业务精湛的队伍，致力于为国内青少年创建世界一流的计算机科学和人工智能通识课程，面向世界，成就未来。',
      ...
      sync_to_google_desc: '[AI_TRANSLATION]将此事件同步到你的 Google 日历，而不是拥有者的日历。仅在 zgcombat 邮箱上运行',
    ...
    teacher_dashboard: {
      ...
      see_also_our: '[AI_TRANSLATION]还可以看看我们的',
      for_more_funding_resources: '[AI_TRANSLATION]如何利用CARES Act的资金来源，如ESSER和GEER',
      support_oz: 'china@flsong.iok.la',
      ...
      want_to_save_tooltip_coco: '[AI_TRANSLATION]<h3>想要保存你的进度吗？</h3><p>请创建一个学生账号，或者前往 <i>我的账号 / 以学生身份测试</i>，如果你想要保存你的进度，请以学生身份玩zgcombat。</p>',
      ...
      ozaria_hs_modal_title: '[AI_TRANSLATION]在zgcombat上独家访问AI Hackstack  ',
      ozaria_hs_modal_blurb: '[AI_TRANSLATION]教育工作者现在可以直接在 **[https://flsong.iok.la/teachers/classes]zgcombat** 上访问 AI Hackstack，使用与 Ozaria 相同的凭证。为了方便起见，您可以轻松地将您的课程从 Ozaria 导入到 zgcombat。',
    ...
    outcomes: {
      ...
      key_concepts: '核心概念',
      code_languages: '编程语言',
      using_codecombat: '使用智国战役的个性化学习引擎...',
      wrote: '编写了...',
      ...
      coverage_p1_coco: '完整的智国战役课程涵盖国际上广泛采用框架中的主要编程标准，包括国际教育技术学会 (ISTE)、计算机科学教师协会 (CSTA) 和 K-12 计算机科学框架的标准。',
      coverage_p1_ozar: '完整的智国战役课程涵盖国际上广泛采用框架中的主要编程标准，包括国际教育技术学会 (ISTE)、计算机科学教师协会 (CSTA) 和 K-12 计算机科学框架的标准。',
      coverage_p2_coco: '在智国战役，我们相信通过使用真实的代码编程，学生将为市场上计算机领域的工作和计算机科学的进一步学习做好最充分的准备，因此我们不为初学者提供基于模块的可视化编程语言，而是讲授 Python、JavaScript 和 C++ 这些今天被各大互联网公司广泛使用的编程语言。',
      coverage_p2_ozar: '在智国战役，我们相信通过使用真实的代码编程，学生将为市场上计算机领域的工作和计算机科学的进一步学习做好最充分的准备，因此我们不为初学者提供基于模块的可视化编程语言，而是讲授 Python、JavaScript 和 C++ 这些今天被各大互联网公司广泛使用的编程语言。',
    ...
    efficacy: {
      ...
      commitment_title: '[AI_TRANSLATION]zgcombat 致力于提供有效学习体验',
      ...
      teachers_love_description: '[AI_TRANSLATION]探索我们的姐妹产品 zgcombat 对计算机科学教学和学习的影响！',
    ...
    league: {
      ...
      summary: '[AI_TRANSLATION]zgcombat AI League 独特地既是一个竞争性的AI战斗模拟器，又是一个学习真实 Python 和 JavaScript 代码的游戏引擎。\n',
      join_now: '[AI_TRANSLATION]现在加入',
      tagline: '[AI_TRANSLATION]zgcombat AI League 将我们基于项目的标准化课程、有趣的冒险编码游戏和我们年度的全球AI代码比赛结合成了一场有组织的学术竞赛。\n',
      ...
      comprehensive_curr_subheader: '[AI_TRANSLATION]zgcombat 是一个符合标准的计算机科学解决方案，帮助教育工作者无论经验如何，都能教授 JavaScript 和 Python 的真实编码。  ',
      ...
      season1_prize_3: '[AI_TRANSLATION]自定义 zgcombat 头像',
      season1_prize_4: '[AI_TRANSLATION]还有更多！',
      season1_prize_hyperx: '[AI_TRANSLATION]HyperX高端外设',
      codecombat_ai_league: '[AI_TRANSLATION]zgcombat AI 联赛  ',
      register: '注册',
      ...
      contact_sales_custom: '[AI_TRANSLATION]你定制的比赛等着你。选择你想用的比赛场地，然后联系zgcombat销售代表确认详情。',
      ...
      codecombat_ai_league_description: '[AI_TRANSLATION]zgcombat AI League 将我们基于项目的标准化课程、有趣的冒险编码游戏和我们年度的全球AI代码比赛结合成了一场独一无二的学术竞赛。\n',
    ...
    payments: {
      ...
      most_popular: '[AI_TRANSLATION]最受欢迎  ',
      best_value: '[AI_TRANSLATION]最佳性价比',
      purchase_licenses: '[AI_TRANSLATION]轻松购买许可证，全面访问 zgcombat 和 Ozaria',
      ...
      implementation_info: '[AI_TRANSLATION]60分钟的zgcombat和Ozaria使用入门培训，以支持特定的机构和教学目标。',
      ...
      full_access_coco: '[AI_TRANSLATION]完全访问 zgcombat',
      ...
      bd_subheading: '[AI_TRANSLATION]对于至少有 10 名学生的商业合作伙伴，可获得 zgcombat 的计算机科学和编码游戏的高级访问权限：',
      bd_info_list_heading: '[AI_TRANSLATION]zgcombat 是数十家编程教育企业首选合作伙伴，因为：',
      bd_info_list_1: '[AI_TRANSLATION]学生们喜欢我们以奇幻和冒险为基础的游戏课程，并且一次次地回来参加更多的课程',
      bd_info_list_2: '[AI_TRANSLATION]任何人都可以用 zgcombat 教编程；游戏是主老师，我们提供大量的支持资源',
      //    bd_info_list_3: "you will receive over 200 hours of curriculum, providing years of educational content for your business",
      bd_includes_1: '[AI_TRANSLATION]完全访问 zgcombat 和 Ozaria，提供超过200小时的高级游戏内容',
    ...
    partners: {
      ...
      below_headline_blurb: '[AI_TRANSLATION]在 zgcombat，我们开发了全面的工具，使得编程的学习变得有趣，教学也很简单。我们的即插即用解决方案可在许多执行中利用。',
      ...
      esports_blurb: '[AI_TRANSLATION]我们正在重新定义电竞的可能性，吸引成千上万的学生学习编程。知名电竞品牌 __hyperx__ 自首个赛季以来一直支持 zgcombat AI 联赛，围绕这个独特的电竞项目推出了引人注目的促销计划。\n',
    ...
    podcast: {
      ...
      learn_more_coco: '[AI_TRANSLATION]想了解更多关于zgcombat编程体验的信息吗？',
      //    subscribe: "Subscribe",
    ...
    library: {
      ...
      communication_limit_blurb: '[AI_TRANSLATION]为了确保会员的安全，我们不提供游戏内聊天或其他玩家之间的通信功能，但我们允许会员安全地与朋友、家人和zgcombat社区分享他们的编码项目。我们限制任何追加销售或营销信息，以提供不中断的体验。',
      ...
      library_signup_promotion: '[AI_TRANSLATION]注册以保存进度，并从你在zgcombat停止的地方继续进行！！',
    ...
    related_accounts: {
      subtitle: '[AI_TRANSLATION]添加不同 zgcombat 账户之间的连接，以便快速切换。例如，作为家长，可以切换到你孩子的账户查看 zgcombat；或者，作为老师，可以添加一个测试学生账户来了解学生的视角。',
    ...
    modal_free_class: {
      paragraph_1: '[AI_TRANSLATION]感谢选择zgcombat。  ',
    ...
    roblox_landing: {
      meta_title: '[AI_TRANSLATION]zgcombat 世界 在 Roblox 上：玩，编程和创造  ',
      ...
      box_play_blurb_player: '[AI_TRANSLATION]探索 zgcombat 世界的 3D 沉浸式体验。编程你的宠物，与朋友一起进入创意和共享体验的宇宙。',
      ...
      bottom_blurb_parent: '[AI_TRANSLATION]无需等待 - 立即 __sign-up__ 我们的在线直播课程，让你的孩子今天就开始编程！用 zgcombat 网页版让他们第一个体验 zgcombat Worlds Roblox 游戏。',
      bottom_blurb_sign_up: '[AI_TRANSLATION]注册',
      bottom_blurb_partner: '[AI_TRANSLATION]想把新的zgcombat Worlds Roblox体验用于你的教育业务、社会影响计划或国际分销机会吗？__reach-out__ 讨论合作事宜吧。',
      ...
      connect_button_blurb: '[AI_TRANSLATION]将你的 zgcombat 和 Roblox 账号关联起来，享受无缝体验！',
      ...
      faq_bottom: '[AI_TRANSLATION]查看更多 <a href="https://codecombat.zendesk.com/hc/en-us/categories/18084251471383-zgcombat-Worlds-Roblox-" target="_blank">帮助中心的常见问题</a>。 <br />如果你还有其他问题，请 <a href="mailto:support@flsong.iok.la">联系我们</a>。',
      modal_title: '[AI_TRANSLATION]zgcombat 世界<br> 现已在 Roblox 上线！  ',
    ...
    ai: {
      ...
      hackstack_promotion_blurb: '[AI_TRANSLATION]不懂 AI？探索 <b>zgcombat AI HackStack</b> ——最简单的 AI 入门路径。解锁 ChatGPT-4、Claude、Stable Diffusion 和 DALL-E 的潜力。这个创新工具提供动手 AI 培训，让创作变得轻松。',
    ...
    home_v3: {
      ...
      testimonals_2_title: '[AI_TRANSLATION]“网上的任何程序，我都试过了。没有一个能与 zgcombat 和 Ozaria 匹敌。任何想要学生学习编程的老师……从这里开始！”',
      ...
      testimonals_4_title: '[AI_TRANSLATION]“我最喜欢 zgcombat 的一点就是它没有简化编程。学生们在学习编写实际的代码，同时在这样做的过程中也玩得很开心。”',
      ...
      engaging_boxes_2_text: '[AI_TRANSLATION]一整套计算机科学课程，从核心概念一直到网页开发、游戏开发和**[https://flsong.iok.la/apcsp]AP CSP**。',
      engaging_boxes_3_title: '[AI_TRANSLATION]zgcombat 世界 在 Roblox 上  ',
      engaging_boxes_3_text: '[AI_TRANSLATION]与Roblox教育合作，这个启用AI的体验大大提升了学生的编码能力，并提供了一个创建精彩游戏和体验的真实平台。\n',
      engaging_boxes_4_title: '[AI_TRANSLATION]zgcombat AI 联赛电子竞技  ',
      ...
      engaging_boxes_6_title: '[AI_TRANSLATION]zgcombat 家庭版  ',
      ...
      young_learners_1_title: '[AI_TRANSLATION]zgcombat 初学者',
      ...
      solutions_8_text: '[AI_TRANSLATION]作为一个完全自学和自主的数字资源，zgcombat 是希望赋予各个年龄段成员编程能力的图书馆的最佳选择。我们的平台提供了学习者体验高水平编程教育所需的一切，通过独特的游戏化课程让学习变得令人兴奋。非常适合初学者以及那些想掌握大学级别编程概念的人。',
    ...
    schools_page: {
      meta_title: '[AI_TRANSLATION]zgcombat：学校最有效的计算机科学解决方案',
      ...
      flexible_standards_aligned_curriculum_text: '[AI_TRANSLATION]我们的分级方法涵盖了从计算机科学基础到高级课程，并且拥有 **[https://flsong.iok.la/apcsp]College Board 认可的AP CSP**, 网站和游戏开发课程。我们构建了个性化的学习路径，以提供符合 **[https://flsong.iok.la/standards]CSTA、ISTE和Common Core State标准**的定制化学习体验。灵活的课程可以教授Python、JavaScript、C++、Luau等多种编程语言。\n',
      ...
      ai_support_acceleration_text: '[AI_TRANSLATION]我们使用AI让教学时间更有效率。zgcombat现在支持AI提示功能，可以评估代码，指出错误，并解释如何修复。最重要的是，它提供理解原因所需的全部上下文，而不会揭示完整解决方案。学生仍然需要完成每个关卡的编程挑战，但现在你不需要停下课堂来应对单个需求。**老师每天可以获得100次AI提示的配额**，**每个学生每天获得5次AI提示**，确保他们总是得到所需支持。',
      codecombat_ai_hackstack_text: '[AI_TRANSLATION]对于AI新手，我们提供 **zgcombat AI HackStack**。这个创新工具不仅教学生如何使用AI，还提供了安全访问许多最新的大型语言模型(LLM)，包括ChatGPT-4、Claude、Stable Diffusion、DALL-E等。经过短时间的训练模式后，用户可以解锁工具的全部创意潜力，在几分钟内完成从提示到代码再到发布的项目。这个AI驱动的应用程序让用户可以生成游戏、艺术、网站、代码等。**教师每月可获得100个AI提示配额**， **每个学生每周有10个AI提示**，以创建多个AI项目。',
      pathways_for_success: '[AI_TRANSLATION]成功路径\n',
      for_your_custom_pathway: '[AI_TRANSLATION]适合你的个性化路径',
      elementary_school: '小学',
      codecombat_jr: '[AI_TRANSLATION]zgcombat 初学者',
      ...
      our_k_5_implementation_pathway: '[AI_TRANSLATION]我们的 K-5 实施路径将引入两个新的**适合初学者的**平台，包括 zgcombat Junior，我们的小学旗舰课程特色是一系列循序渐进的学习水平，**以较慢的速度教授基础编码概念**，以及 AI Junior，一个**多模式的 AI 工具**，允许学生绘制、写作和设计自己的数字产品。这种层次化的进展将让学生随我们的沉浸式内容成长，并探索各种计算思维和计算机科学概念。  ',
      middle_school: '初中',
      high_school: '高中',
      ozaria: '奥佳睿',
      ai_hackstack: '生成式AI',
      ...
      first_year_high_school_curriculum: '[AI_TRANSLATION]我们高中的第一个学年课程重点是 **AP CS Principles**，包括我们的 zgcombat 课程，CS1−CS4 和考试课程内容，比如 **数据科学** 和 **计算系统**。更高级的学年让学生可以探索更多高级计算机科学课程，并在我们的三个平台间提供声音和选择。\n',
      ...
      privacy_security_text: '[AI_TRANSLATION]我们非常重视学生的安全、网络安全和数据隐私，并遵循严格的学校级隐私法规，包括 COPPA、FERPA、SOPIPA、加州 AB 1584、CalOPPA、公正信息实践、CAN-SPAM 和 GDPR。所有数据都安全地存储在美国的亚马逊网络服务上。我们的 AI 集成有保护措施以保护个人可识别信息并限制敏感内容。项目共享受到控制，并且限制了点对点通信。可以提供数据处理协议，更多信息请访问 **https://flsong.iok.la/privacy**。',
      ...
      faq_1_answer: '[AI_TRANSLATION]美国的职业技术教育（CTE）项目注重为学生提供行业认可的技能，并可以通向职业学校或大学教育。根据州和联邦法律的要求，CTE项目必须为学生提供研究生学分、行业认证或实习时间。尽管某些领域（如网络安全）提供有价值的认证考试，而其他领域（如软件工程）更注重四年制学位，但通过 AP 计算机科学原理考试是获得高等教育学分的一个认可途径，使学生能够避开昂贵且费时的大学课程。为了帮助学生备考，zgcombat 提供了由 College Board 认证的**[https://flsong.iok.la/apcsp]AP CSP 课程**。',
      ...
      faq_6_answer: '[AI_TRANSLATION]计算机科学教育已成为学生学术旅程中的重要组成部分，然而，很多学校在提供全面的计算机科学课程时面临资源短缺的挑战。在 zgcombat，我们了解学校在资金方面的困难，热衷于帮助学校克服这些障碍。资助可能是一个宝贵的资源，但很难找到和申请。查看我们全面的 **[https://flsong.iok.la/grants]资助资金指南** 或与我们的团队联系以了解更多。',
      ...
      core_curriculum_2_text: '[AI_TRANSLATION]一整套计算机科学课程，从核心概念一直到网页开发、游戏开发和**[http://flsong.iok.la/apcsp]AP CSP**。',
      core_curriculum_2_link_text: '[AI_TRANSLATION]立即试用',
      practice_enrichment_1_title: '[AI_TRANSLATION]zgcombat AI 联赛电子竞技  ',
      ...
      practice_enrichment_2_title: '[AI_TRANSLATION]zgcombat 世界 在 Roblox 上  ',
    ...
    hackstack_page: {
      ...
      faq_1_answer: 'AI HackStack 非常适合初中和高中阶段的学生。我们的安全与隐私实践让年轻用户（如您的学生）能够安全地与 AI 互动。如果您教授的是小学生，请**[mailto:team@flsong.iok.la]联系我们的团队**，了解更多关于 zgcombat AI Junior 的信息，这是一个专为 K-5 学生设计的简单直观的多模态生成式 AI 平台。',
      ...
      faq_4_answer: '计算机科学教育已成为学生学业生涯的重要组成部分，然而，许多学校在获取必要资源以提供全面计算机科学课程方面面临挑战。在 zgcombat，我们了解学校遇到的资金瓶颈，并热衷于帮助他们克服这些障碍。资助金（Grants）是宝贵的资源，但往往难以发现和申请。请查看我们的**[https://flsong.iok.la/grants]资助金申请全面指南**，或**[mailto:team@flsong.iok.la]咨询我们的团队**以了解更多信息。',
      ...
      faq_6_answer: '我们提供 Clever 和 Google Classroom 的集成支持。查看我们的 **[https://flsong.iok.la/teachers/resources/clever-faq]Clever 集成常见问题解答** 以获取更多入门细节。如果您使用的是 Google Classroom，请务必使用 Google 单点登录 (SSO) 弹窗注册教师账户。如果您已有使用 Google 邮箱注册的账户，下次请通过 Google SSO 登录。在“创建班级”弹窗中，您会看到“链接 Google Classroom”的选项。目前我们仅支持通过 Google Classroom 导入名册。注意：您必须至少使用一次 Google SSO 进行注册或登录，才能看到 Google Classroom 的集成选项。',
      ...
      promo_modal_text: '**AI 新手？探索 zgcombat AI HackStack** —— 开启 AI 素养教育最简单的方式。解锁 **ChatGPT-4**、**Claude**、**Stable Diffusion** 和 **DALL-E** 等顶尖模型的力量。借助实用的工具，创作游戏、艺术品、网站和代码变得前所未有的简单。它是任何创意项目的完美伴侣，无需任何经验！',
    ...
    standards_page: {
      ...
      curriculum_description: '[AI_TRANSLATION]zgcombat 提供强大的课程路径，符合多个国家和州的标准框架，涵盖从幼儿园到十二年级的编程课程，包括多种语言的 AP 级编程课程。我们的课程通过符合标准的课程让学生探索和学习计算机科学。',
      most_effective_computer_science_solution: '[AI_TRANSLATION]**[https://flsong.iok.la/schools]schools** 最有效的计算机科学解决方案\n',
      comprehensive_implementation: '[AI_TRANSLATION]我们全面的实施方案赋能教师，吸引学生，并带来成功的结果。',
      carousel_1_title: '[AI_TRANSLATION]计算机科学教师协会 (CSTA)',
      carousel_1_text: '[AI_TRANSLATION]**[https://csteachers.org/k12standards/]计算机科学教师协会K-12计算机科学标准** 列出了一组核心学习目标，旨在为完整的计算机科学课程及其在K-12中的实施提供基础。[NEWLINE]zgcombat被CSTA认可为课程和专业发展供应商。通过我们自导的、获得CSTA认证的 **[https://www.ozaria.com/professional-development]专业发展** 课程，学习如何有效地教授计算机科学。从任何设备随时获得最多40个学分小时。[NEWLINE]了解下面详细的CSTA标准对齐方式：  ',
      ...
      carousel_2_text: '[AI_TRANSLATION]zgcombat 被 College Board 认可为 AP® 计算机科学原理（AP CSP）课程和专业发展的认证提供商。此认证确认 zgcombat 的课程符合所有 AP 课程框架标准和 AP CSP 评估。这使学校可以访问包括 College Board 预先批准的 AP CSP 课程审核大纲和正式认可的专业发展资源，帮助教师教授这一课程。[NEWLINE]了解更多关于我们的 zgcombat AP CSP 课程：  ',
      carousel_2_button_1_text: '[AI_TRANSLATION]zgcombat AP CSP  ',
      carousel_3_title: '[AI_TRANSLATION]国际教育技术协会 (ISTE)',
      carousel_3_text: '[AI_TRANSLATION]专注于教学法，而不是工具，**[https://iste.org/standards]ISTE 标准** 是一个框架，指导教育工作者使用技术为所有学生创建有重大影响、可持续且可扩展的学习体验。[NEWLINE]zgcombat 的课程旨在满足所有 ISTE 标准的需求，适用于学生和教师。[NEWLINE]了解下面详细的 ISTE 标准对齐方式：',
      //    carousel_3_button_1_text: "Ozaria",
      //    carousel_3_button_2_text: "zgcombat",
      carousel_4_title: '[AI_TRANSLATION]常见核心州标准',
      carousel_4_text: '[AI_TRANSLATION]**[https://corestandards.org/]共同核心州标准** 是一套统一的K-12数学和英语语言艺术学术标准。[NEWLINE]zgcombat在整个课程中综合了各种跨学科的核心科目连接。[NEWLINE]了解下面详细的共同核心标准对齐方式：  ',
      //    carousel_4_button_1_text: "Ozaria",
      //    carousel_4_button_2_text: "zgcombat",
      carousel_5_title: '[AI_TRANSLATION]下一代科学标准 (NGSS)',
      carousel_5_text: '[AI_TRANSLATION]**[https://www.nextgenscience.org/]下一代科学标准（NGSS）** 是K-12科学内容标准，设定了学生应了解和能够做什么的期望。这些标准由各州制定，以改善所有学生的科学教育。[NEWLINE]zgcombat是引入NGSS关键科学和工程概念的完美课程伙伴。[NEWLINE]了解下面详细的NGSS标准对齐方式：  ',
    ...
    codequest_page: {
      ...
      core_curriculum_text_1: '全球首个专门为AIGC生成式编程项目式学习工具，支持GPT-4, Claude, Stability AI, Dall-e-3等多个大语言模型，适合智国战役高阶学生晋级学习人工智能。<br /><br />比赛将采用项目式学习（PBL）的形式，借助大语言模型完成项目任务，并向名校专家和技术大咖汇报和答辩。',
      ...
      core_curriculum_title_23: '[AI_TRANSLATION]Nick Winter，zgcombat 首席执行官',
      core_curriculum_text_23: '[AI_TRANSLATION]Nick是zgcombat的创始人兼首席执行官。作为教育技术行业的证明领导者，Nick将他对教育的热情与他的技术专长相结合，使全球的学生学习编程变得更加容易和有趣。在zgcombat之前，他共同创立了Skritter，一个学习中文和日文字符的平台。Nick致力于革新教育领域，积极贡献于使编码成为未来一代的基础技能。他的奉献和愿景继续激励和影响教育技术领域。',
    ...
    hackstack: {
      ...
      'HowItWorksPage_codecombat-ai-hackstack-is-an-all-in-one': '[AI_TRANSLATION]zgcombat AI HackStack 是一个集成 AI 工具，只需聊天就能创建游戏、艺术作品、歌曲、应用等。它为你运行一切，托管项目，并帮助编写代码。CORE 模式是免费的，通过多项选择提示教学。PRO+ 模式每月 $9.99 美元，提供自由格式的提示。项目是安全的，不会向大科技公司提供数据。这是由 zgcombat 团队制作的，目的是让 AI 变得对所有人都易于接触。现在，让我们开始创作吧。  ',
      ...
      'HowItWorksPage_learn-anything-create-something-do-every': '[AI_TRANSLATION]用 zgcombat AI HackStack 学习任何东西，创造某些东西，做所有事情。为所有人提供 AI 赋能！',
      ...
      'HowItWorksPage_the-codecombat-team-they-got-really-good': '[AI_TRANSLATION]zgcombat 团队在通过游戏化学习教会了2000万初学者编程后，变得非常擅长让人轻松学习难的内容，所以当技术足够成熟，他们想为AI做同样的事情。如果AI是创造的未来，那么我们需要让任何人都能轻松使用它！\n',
      ...
      'NewProjectPage_prompt-the-ai-to-create-websites-games-w': '[AI_TRANSLATION]用 zgcombat AI HackStack 提示 AI 创建网站、游戏、网页应用、故事、艺术等等。',
    ...
    parents_v2: {
      ...
      grid_ai_hints_allowance: '[AI_TRANSLATION]zgcombat AI 每日提示限额***',
      grid_prompts_allowance: '[AI_TRANSLATION]zgcombat AI HackStack 每月提示限额***',
      ...
      enroll_now: '[AI_TRANSLATION]或者，[https://flsong.iok.la/payments/initial-online-classes-71]立即报名**',
      ...
      teach_child: '[AI_TRANSLATION]如果你计划教你的孩子，我们可以提供一站式解决方案，使您能够在家中教授我们的课程。我们提供所有教学资源来帮助你和你的孩子成功，包括课程解决方案指南。联系团队了解更多信息 - 发送邮件给 **[mailto:classes@flsong.iok.la]classes@flsong.iok.la** 来与学习顾问联系。',
      ...
      carousel_items_1_text: '[AI_TRANSLATION]对于没有编程经验的学生，大部分课堂将通过 Ozaria 来建立基础技能，然后通过 zgcombat 来深化编程知识。AI HackStack 将用于帮助加速孩子的编程能力，并展示他们新学技能的实际应用。zgcombat Worlds 和 AI League 将提供偶尔的练习和创造性游戏机会。',
      carousel_items_2_title: '[AI_TRANSLATION]游戏[NEWLINE]开发',
      carousel_items_2_title_prefix: '[AI_TRANSLATION]**专注：**  ',
      carousel_items_2_text: '[AI_TRANSLATION]如果你的孩子喜欢游戏并想制作游戏，我们专注于游戏开发的课程将以 zgcombat 为 核心进行初期的游戏开发活动和项目。在不久的将来，你的孩子将在 zgcombat 世界构建和发布真实的游戏到 Roblox 平台。参加我们的 AI 联赛可以深入了解成功的游戏动力学和开发，而 AI HackStack 将是迭代游戏开发的强大工具。  ',
      carousel_items_3_title: '[AI_TRANSLATION]Web[NEWLINE]开发',
      carousel_items_3_title_prefix: '[AI_TRANSLATION]**专注：**  ',
      carousel_items_3_text: '[AI_TRANSLATION]面向网络的开发不断演变，保持领先很重要。在此课程中，最初的网络开发活动将在 zgcombat 进行，而 Ozaria 将用于新手编程者。将广泛实施 AI HackStack 作为构建和发布到网络的平台，有限使用 zgcombat Worlds 和 AI League 来帮助强化关键编程概念。  ',
      carousel_items_4_title: '[AI_TRANSLATION]竞技[NEWLINE]编程电竞  ',
      carousel_items_4_title_prefix: '[AI_TRANSLATION]**专注：**  ',
      carousel_items_4_text: '[AI_TRANSLATION]电竞爱好者一定会喜欢这个课程的竞争精神。在 zgcombat 的基础上，你的孩子将全年参加我们的 AI 联赛全球电竞比赛，争夺奖学金和奖品。通过强调创意编程和迭代，你的孩子将学习如何使用我们的 AI HackStack 工具在比赛中提升自己的能力。  ',
      carousel_items_5_title: '[AI_TRANSLATION]AI[NEWLINE]Applications  ',
      carousel_items_5_title_prefix: '[AI_TRANSLATION]**专注：**  ',
      carousel_items_5_text: '[AI_TRANSLATION]AI无处不在，那些能利用其力量的人将能够最大化他们的潜力。这个课程重点从zgcombat开始，但AI HackStack将帮助教授撰写最强AI提示的艺术，并在安全和安全的环境中使用所有最新的生成AI工具。内置在zgcombat Worlds中的生成AI功能将提供另一个现实世界的机会，看看您的孩子可以用AI做什么。  ',
      ...
      faq_5_answer: '[AI_TRANSLATION]你的订阅购买在前30天内是100%无风险的。如果由于任何原因你决定不继续，请在购买后30天内通过**[mailto:classes@flsong.iok.la]classes@flsong.iok.la**联系我们，我们会立即全额退款，无需解释。  ',
      //    faq_6_question: "What if I need to reschedule a class?",
      faq_6_answer: '[AI_TRANSLATION]一旦你预约了我们的每周课程，我们会专门为你预留时间，所以重新安排课程需要提前48小时通知。你可以通过发送邮件给 **[mailto:classes@flsong.iok.la]classes@flsong.iok.la** 来重新安排课程。少于48小时通知的缺课或取消将不被重新安排也不予退款。',
      ...
      faq_9_answer: '[AI_TRANSLATION]我们为兄弟姐妹和团体课程提供折扣。我们不组织或分配团体课程，但如果你有一组学生想要一起学习，我们会为他们安排团体课程。如需了解具体价格详情，请联系 **[mailto:classes@flsong.iok.la]classes@flsong.iok.la**。\n',
      ...
      faq_11_answer: '[AI_TRANSLATION]我们非常重视学生安全、网络安全和数据隐私，并遵循严格的学校级隐私法规，包括COPPA、FERPA、SOPIPA、加州AB 1584、CalOPPA、公平信息实践、CAN-SPAM和GDPR。所有学生数据都安全存储在美国的亚马逊网络服务中。我们的AI集成有护栏以保护个人可识别信息（PII）并限制敏感内容。项目共享受到控制，点对点交流受到限制。更多信息请访问 **[https://flsong.iok.la/privacy]https://flsong.iok.la/privacy**。\n',
      faq_12_question: '[AI_TRANSLATION]你们有其他语言的课程吗？',
      faq_12_answer: '[AI_TRANSLATION]我们提供英语和西班牙语的完整课程体验。不过，我们优秀的教师团队会讲多种语言。如果你有具体的语言偏好，请联系 **[mailto:classes@flsong.iok.la]classes@flsong.iok.la**，看看我们能否满足你孩子的语言需求。\n',
    ...
    roblox: {
      ...
      link_reward_desc: '[AI_TRANSLATION]把你的 zgcombat 和 Roblox 账户连接起来，以解锁功能和奖励',
      ...
      faq_3_answer: '[AI_TRANSLATION]是的。玩家可以在 zgcombat Worlds 内分享他们的体验，并通过插件将他们的体验导入到 Studio 中进行发布，保持与 Studio 的兼容性。',
      faq_4_question: '[AI_TRANSLATION]我需要Roblox账户吗？  ',
      faq_4_answer: '[AI_TRANSLATION]是的，所有玩家都可以在 roblox.com 上免费注册。别忘了关联你的 zgcombat 账号和 Roblox 账号，以访问所有功能和奖励。',
      faq_5_question: '[AI_TRANSLATION]它能在我的 Chromebook 或手机上运行吗？  ',
      faq_5_answer: '[AI_TRANSLATION]是的。zgcombat Worlds 允许你在 PC、Mac、Chromebooks、平板电脑、手机和游戏机上玩、编码和创造游戏。',
    ...
    pd_page: {
      ...
      implementation_training_blurb: '[AI_TRANSLATION]教育工作者将获得一次60分钟的在线直播培训，并获得关于如何使用 zgcombat 或 Ozaria 支持特定机构和教学目标的指导。该实施重点是全面的教师仪表板演练，其中包括：',
      ...
      ap_csp_professional_development_title: '[AI_TRANSLATION]AP CSP 专业发展[NEWLINE]（使用 zgcombat）  ',
      ap_csp_professional_development_blurb: '[AI_TRANSLATION]这个 40 多小时的在线、主要是自学的课程，非常适合想帮助学生通过 AP 计算机科学原理考试的教师，使用 zgcombat。',
      list_7: '[AI_TRANSLATION]本课程和 zgcombat AP CSP 课程均获得了大学理事会的认可。本课程中完成的小时数可用于获得有价值的专业教育学分。  ',
      list_8: '[AI_TRANSLATION]本课程利用来自全球的AP CSP教师进行同步的小组讨论，以深化你的计算机科学知识并丰富你的课堂实践。  ',
      list_9: '[AI_TRANSLATION]通过zgcombat与南新罕布什尔大学（SNHU）的合作，你在学习如何最好地准备学生参加AP CSP考试的同时，可以获得最多3个研究生级别的学分。  ',
    ...
    junior_page: {
      testimonials_1_quote: '未来是可编程的，你需要具备编程能力才能参与其中……我认为 zgcombat 拥有市面上最好的计算机科学课程……而教师工具包才是它脱颖而出的关键。',
      ...
      no_matter_the_coding_experience: '无论编程经验如何，zgcombat Junior 都能满足学生的需求。他们可以使用图标块、单词块、块和文本代码并行编程，或者使用行业标准语言进行基于文本的编程。',
      ...
      codecombat_junior_automatically_assesses: 'zgcombat Junior 会自动评估学习者的编程水平，并在他们需要额外支持时推荐**自定义练习级别**。这为每位学生提供了个性化的学习路径，同时也让家长和教育工作者能够跟踪他们的学习进度。',
      ...
      meta_title: 'zgcombat Junior：面向学校的 K-5 年级计算机科学',
      our_comprehensive_implementation: '我们的全面实施',
      trends_1_title: '在 K-5 课堂中快速启动计算机科学',
      trends_1_text: '观看 zgcombat 的教育总监 Charlotte Cheng 和 STEM 项目总监 Jacob Kaminski 探讨如何将 **zgcombat Junior** 和 **zgcombat Worlds** 融入您的课堂。他们分享实用策略、成功案例，并解答其他教育工作者的疑问。',
      trends_1_linkText: '了解更多',
      trends_2_title: 'zgcombat Junior：K-5 年级编程的全新动态方法',
      trends_2_text: '了解更多关于如何**zgcombat Junior** 为 K-5 课堂带来编程教育。从基于图标的拖放式积木编程到基于 Python 和 JavaScript 的文本编程，这个适应性强的平台支持各个阶段的学生。zgcombat Junior 拥有超过 1,100 个关卡，并且还有更多关卡正在开发中，提供无限可能。',
      trends_2_linkText: '阅读博客',
      get_a_headstart: '在家即可获得领先优势',
      parents_junior_perfect: '家长们，zgcombat Junior 是让您的孩子不仅接触计算机科学，还能从中获益，包括解决问题、逻辑推理、坚持不懈、计算思维和创造性探索。',
