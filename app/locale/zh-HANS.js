module.exports = {
  ...
  translation: {
    ...
    new_home: {
      title_coco: '扣哒世界|zgcombat中国|AI世青赛|少儿编程等级认证',
      title_ozar: '奥佳睿 - 引人入胜的计算机科学课程',
      title_cn_home: 'zgcombat - 玩游戏学编程|零基础Python, Javascript入门|zgcombat 个人版',
      meta_keywords_coco: '扣哒世界, 青少年编程, 少儿编程, 信息学奥赛, zgcombat官网,zgcombat中文,游戏化编程,AI世青赛,信息学奥赛,奥佳睿,zgcombat中国',
    ...
    new_home_faq: {
      ...
      python_and_javascript: '目前个人版zgcombat支持Python和JavaScript，高级订阅版本支持 C++，教学版扣哒世界同时支持以上语言和信息学奥赛.',
      ...
      main_curriculum_blurb: '当然可以! 我们的教研团队来自清华大学、北京大学、斯坦福大学、哈佛大学等世界一流名校，在计算机基础教育方面具有扎实的理论知识和丰富的实践经验。国内部分省市如山东省中小学330科创教育平台、苏州市青少年数字公民计划等已经采用zgcombat教学版扣哒世界作为校本课程，如果你希望在学校开展以我们平台为主的编程教学活动，请联系我们的教育专家寻求建议.',
      ...
      how_much_does_it_cost_blurb: 'zgcombat个人版或扣哒世界教学版都提供5个关卡的免费试用。zgcombat个人版支持季度付费 (299元/月)和年度付费 (999元/年)，费用包括所有的关卡学习内容和AI世青赛的竞赛学习内容。',
