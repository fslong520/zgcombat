module.exports = {
  ...
  translation: {
    ...
    legal: {
      ...
      art_paragraph_1: '关于署名，请说明并在使用处附近，或对媒体形式来说合适的地方提供一个zgcombat.com 的链接。举例：',
      use_list_1: '如果是用在电影里或者其他游戏里，请在制作人员表中加入zgcombat.com。',
      use_list_2: '如果用在网站上，将链接在使用的地方附近，比如图片下面，或者一个您放置其他 Creative Commons 署名和开源软件协议的专门页面。如果您的内容明确提到关于zgcombat，那您就不需要额外署名。',
      art_paragraph_2: '如果您使用的内容不是由zgcombat制作，而是由zgcombat.com 上其他的用户制作的，那您应该给他们署名。如果相应资源的页面上有署名指示，那您应该遵循那些指示。',
      rights_title: '版权所有',
      ...
      nutshell_title: '简而言之',
      nutshell_description: '我们在关卡编辑器里公开的任何资源，您都可以在制作关卡时随意使用，但我们保留限制在zgcombat.com 之上创建的关卡本身传播的权利，因为我们以后可能决定为它们收费。',
    ...
    parents_landing_2: {
      ...
      student: '学生',
      grade: '级别',
      subscribe_error_user_type: '看来你已经注册了一个账户。如果您对 zgcombat 高级版感兴趣，请联系我们 team@codecombat.com。',
    ...
    school_administrator: {
      ...
      add_additional_teacher: '需要添加其他的教师吗？请联系您的zgcombat客户经理或发送电子邮件至china@codecombat.com。 ',
    ...
    teacher_dashboard: {
      ...
      ozaria_hs_modal_blurb: '[AI_TRANSLATION]教育工作者现在可以直接在 **[https://codecombat.com/teachers/classes]zgcombat** 上访问 AI Hackstack，使用与 Ozaria 相同的凭证。为了方便起见，您可以轻松地将您的课程从 Ozaria 导入到 zgcombat。',
    ...
    roblox_landing: {
      ...
      faq_bottom: '[AI_TRANSLATION]查看更多 <a href="https://codecombat.zendesk.com/hc/en-us/categories/18084251471383-zgcombat-Worlds-Roblox-" target="_blank">帮助中心的常见问题</a>。 <br />如果你还有其他问题，请 <a href="mailto:support@codecombat.com">联系我们</a>。',
    ...
    schools_page: {
      ...
      faq_1_answer: '[AI_TRANSLATION]美国的职业技术教育（CTE）项目注重为学生提供行业认可的技能，并可以通向职业学校或大学教育。根据州和联邦法律的要求，CTE项目必须为学生提供研究生学分、行业认证或实习时间。尽管某些领域（如网络安全）提供有价值的认证考试，而其他领域（如软件工程）更注重四年制学位，但通过 AP 计算机科学原理考试是获得高等教育学分的一个认可途径，使学生能够避开昂贵且费时的大学课程。为了帮助学生备考，zgcombat 提供了由 College Board 认证的**[https://codecombat.com/apcsp]AP CSP 课程**。',
      ...
      faq_6_answer: '[AI_TRANSLATION]计算机科学教育已成为学生学术旅程中的重要组成部分，然而，很多学校在提供全面的计算机科学课程时面临资源短缺的挑战。在 zgcombat，我们了解学校在资金方面的困难，热衷于帮助学校克服这些障碍。资助可能是一个宝贵的资源，但很难找到和申请。查看我们全面的 **[https://codecombat.com/grants]资助资金指南** 或与我们的团队联系以了解更多。',
    ...
    hackstack_page: {
      ...
      faq_1_answer: 'AI HackStack 非常适合初中和高中阶段的学生。我们的安全与隐私实践让年轻用户（如您的学生）能够安全地与 AI 互动。如果您教授的是小学生，请**[mailto:team@codecombat.com]联系我们的团队**，了解更多关于 zgcombat AI Junior 的信息，这是一个专为 K-5 学生设计的简单直观的多模态生成式 AI 平台。',
      ...
      faq_4_answer: '计算机科学教育已成为学生学业生涯的重要组成部分，然而，许多学校在获取必要资源以提供全面计算机科学课程方面面临挑战。在 zgcombat，我们了解学校遇到的资金瓶颈，并热衷于帮助他们克服这些障碍。资助金（Grants）是宝贵的资源，但往往难以发现和申请。请查看我们的**[https://codecombat.com/grants]资助金申请全面指南**，或**[mailto:team@codecombat.com]咨询我们的团队**以了解更多信息。',
