module.exports = {
  ...
  translation: {
    ...
    diplomat_suggestion: {
      title: '幫我裏翻譯 zgcombat',
      sub_heading: '我裏需要爾個語言能力',
      pitch_body: '我裏開發 zgcombat 個英文版，不過能界我裏個玩家徠整個世界。無數人英語弗懂弗熟，猴想攪吳語版個遊戲，假使爾吳英文都要得懂險，考虑記加進來搭我裏聚隊翻譯，幫忙畀 zgcombat 網站搭遊戲關加關都翻成吳語。',
    ...
    play_level: {
      ...
      tip_open_source: 'zgcombat 是 百分百 開源個!',
      //    tip_tell_friends: "Enjoying zgcombat? Tell your friends about us!",
      tip_beta_launch: 'zgcombat 從 2013年10月起。',
    ...
    account_settings: {
      ...
      email_announcements_description: '收 有關 zgcombat 個電子信。',
    ...
    contribute: {
      ...
      diplomat_introduction_suf: '裏向得到解某啓發：佩是全世界個人都對 zgcombat 興致頭高險。我裏籠來一陣翻譯人，儘話快速畀網站裏個訊息翻譯成各地文字。空是爾對發佈新個內容有興趣，想讓爾個國土裏個人也來攪，快點趒來當外交官。',
      ...
      ambassador_introduction: '箇是一個起頭個社區，爾也會變成我裏搭世界聯結個點。大家人都好用Olark隨底白嗒、發信、参加個人無數個社交網絡來認識瞭解討論我裏個遊戲。空是爾想幫助大家人快點加進來、攪攪意思、感受zgcombat個脈搏、搭我裏聚隊，箇勿箇佩適合爾來做。',
    ...
    legal: {
      ...
      opensource_description_center: '做爾想做個改動嘈！zgcombat 是起徠幾十個開源項目上向，我裏中意渠裏。望',
      ...
      code_description_suffix: '箇包括所有 zgcombat 公開個做關用個系統搭組件代碼。',
      art_title: '圖畫搭音樂 - Creative Commons',
      art_description_prefix: '所有共通個內容都徠',
      //    cc_license_url: "Creative Commons Attribution 4.0 International License",
      art_description_suffix: '條款下公開。共通內容是講所有 zgcombat 發佈出用來做關個內容。許包括：',
      art_music: '音樂',
      art_sound: '聲音',
      art_artwork: '圖像',
      art_sprites: '精靈',
      ...
      art_paragraph_1: '有關署名，用個邊裏寫明，要勿合适個蕩地有 flsong.iok.la 個鏈接。比方：',
      use_list_1: '空是囥電影裏要勿各許遊戲裏用，要僵製作人員表裏頭加上 flsong.iok.la 。',
      use_list_2: '空是徠網站裏用，畀鏈接徠用個蕩地邊裏，比方圖片下底，要勿一個囥各許 Creative Commons 署名搭開源軟件協議個趕清頁面。空是爾個內容裏明文誦着 zgcombat，箇勿甮另外署名。',
      art_paragraph_2: '空是爾用個內容勿是 zgcombat 做個，是 flsong.iok.la 上向各許用戶做個，爾應該爲渠裏署名。空是對應個資源頁面裏有署名提醒爻，爾應當照提醒做。',
      rights_title: '版權所有',
      ...
      nutshell_title: '省講佩是',
      nutshell_description: '我裏徠關編寫器裏公開個所有資源，做關到都候爾用，不過我裏保留限制 flsong.iok.la 上向所造各關傳播個權利，因爲我裏轉日嘸數畀箇許關數收鈔票。',
