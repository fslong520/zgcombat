module.exports = {
  ...
  translation: {
    ...
    new_home: {
      title_coco: 'zgcombat - Jogos de programação para aprender Python e JavaScript',
      title_ozar: 'zgcombat - Jogos de programação para aprender Python e JavaScript',
      title_cn_home: '[AI_TRANSLATION]zgcombat|Python, Javascript',
      meta_keywords_coco: 'zgcombat, python, javascript, Jogos de programação',
      meta_keywords_ozar: 'zgcombat, python, javascript, Jogos de programação',
      ...
      become_investor: 'torna-te um investidor do zgcombat',
      built_for_teachers_title: 'Um Jogo de Programação Construído Tendo os Professores em Mente',
      built_for_teachers_blurb: 'Ensinar crianças a programar pode, muitas vezes, tornar-se esmagador. zgcombat ajuda todos os educadores a ensinar estudantes como programar em JavaScript e Python, duas das mais populares linguagens de programação. Com um currículo completo que inclui seis unidades de ciência da computação e reforça a aprendizagem através de unidades de desenvolvimento de jogos e páginas web como projeto-base, as crianças irão progredir através de uma aventura que começa na sintaxe básica e termina na recursão!',
      ...
      century_skills_subblurb1: 'Com puzzles de código cuja armação é naturalmente erguida em níveis de dificuldade crescente, a programação do jogo zgcombat assegura que as crianças estão continuamente a praticar o seu pensamento crítico.',
      ...
      century_skills_subblurb2: 'zgcombat  encoraja os estudantes a demonstrar a sua criativdade ao construirem e partilharem os seus jogos e páginas web.',
      ...
      creativity_rigor_blurb2: 'Cada nível de zgcombat é montado com base em milhões de pontos de dados e optimizado para se adaptar a cada aluno. Níveis de prática e dicas ajudam os estudantes quando ficam presos, e níveis desafiantes avaliam a aprendizagem dos estudantes ao longo do jogo.',
      creativity_rigor_subtitle3: 'Construído para todos os professores, independentemente da sua experiência',
      creativity_rigor_blurb3: 'O currículo autogerido e alinhado com as normas do zgcombat torna o ensino das ciências da computação acessível a todos. zgcombat fornece aos professores a formação, os recursos didácticos e o apoio dedicado para se sentirem confiantes e bem sucedidos na sala de aula.',
      ...
      for_leaders_subblurb3: 'Quer pretendas aprender a programar de uma forma elegível para o Ensino Secundário, ou curso Técnico-profissional, o zgcombat é adaptado às tuas necessidades.',
      ...
      game_based_blurb: 'zgcombat é um programa informático com base num jogo onde os estudantes escrevem código real e vêem os seus personagens reagir em tempo real.',
      get_started: 'Começar',
      ...
      quotes_quote1: 'Diga o nome de qualquer programa online, já o experimentei. Nenhum deles se compara ao zgcombat. Qualquer professor que queira que os seus alunos aprendam a programar... deve começar aqui!',
      quotes_quote2: 'Fiquei surpreendido com a forma como o zgcombat se torna tão intuitivo e facilita a aprendizagem da programação. As notas que tirei no exame foram muito mais altas do que estava à espera e acredito que o zgcombat é responsável por isso.',
      quotes_quote3: 'zgcombat tem sido o mais benéfico para ensinar aos meus alunos competências de programação práticas. O meu marido é engenheiro de software e já testou todos os meus programas. Ele colocou este jogo como a sua melhor escolha.',
      quotes_quote4: 'O feedback ... tem sido tão positivo que estamos a estruturar uma aula de Ciência da Computação em torno do zgcombat. O programa envolve efectivamente os alunos, com uma plataforma de estilo de jogo que é divertida e instrutiva ao mesmo tempo. Continuem o bom trabalho, zgcombat!',
      quotes_quote5: '[AI_TRANSLATION]Embora a aula comece todos os sábados às 7h, o meu filho está tão entusiasmado que acorda antes de mim! O zgcombat cria um caminho para o meu filho melhorar as suas habilidades de programação.',
      ...
      teachers_love_codecombat_title: 'Os professores adoram o zgcombat',
      teachers_love_codecombat_blurb1: 'Informar que os seus alunos gostam de utilizar o zgcombat para aprender a programar',
      teachers_love_codecombat_blurb2: 'Recomendaria o zgcombat a outros professores de ciências da computação',
      teachers_love_codecombat_blurb3: 'Dizer que o zgcombat ajuda-os a apoiar as capacidades de resolução de problemas dos seus alunos',
      ...
      top_banner_blurb_roblox: '[AI_TRANSLATION]NOVO! zgcombat está a chegar à Roblox!',
      top_banner_blurb_roblox_teachers: '[AI_TRANSLATION]NOVO! zgcombat fez parceria com a Roblox Education!',
      ...
      top_banner_blurb_demo_day_10_20: '[AI_TRANSLATION]Junta-te a nós para uma demo assombrosa de zgcombat & Ozaria na quinta-feira, 20 de outubro às 16:00 CDT.',
      ...
      im_an_educator_description: '[AI_TRANSLATION]Ensina Ciência da Computação com zgcombat',
      ...
      codecombat_is: 'O zgcombat é uma plataforma <strong>para estudantes</strong> para aprender ciências da computação enquanto se joga um jogo real.',
      ...
      watch_how: 'Vê como o zgcombat está a transformar o modo como as pessoas aprendem ciências da computação.',
      ...
      builds_concepts_up: 'Gosto da forma como o zgcombat desenvolve os conceitos. É muito fácil compreendê-los e é divertido descobri-los.',
      ...
      agency: 'zgcombat é um jogo que dá aos jogadores essa diligência e confiança com o nosso robusto motor de código digitado, que ajuda tanto os principiantes como os estudantes avançados a escrever um código válido e adequado.',
      ...
      want_coco: 'Queres o zgcombat na tua escola?',
      ...
      //    ozaria_china_blurb: "",
      try_codecombat: 'Experimenta zgcombat',
      try_ozaria: 'Experimenta Ozaria',
      explore_codecombat: '[AI_TRANSLATION]Explora o zgcombat',
      ...
      codecombat_live_online_classes: '[AI_TRANSLATION]Aulas Online ao Vivo do zgcombat',
      ...
      codecombat_home: '[AI_TRANSLATION]Página Inicial do zgcombat',
      ...
      meta_keywords_podcast: '[AI_TRANSLATION]zgcombat, python, javascript, Jogos de Programação, podcast, edtech',
      coco_worlds_header: '[AI_TRANSLATION]Mundos do zgcombat',
      coco_worlds_description: '[AI_TRANSLATION]Embarca numa aventura de codificação 3D no Roblox, onde podes programar animais de estimação, jogar com amigos e desenvolver jogos enquanto jogas. Junta-te à comunidade zgcombat e liberta a tua criatividade no metaverso!',
      coco_worlds_button: '[AI_TRANSLATION]Explora os Mundos do zgcombat',
    ...
    nav: {
      ...
      return_coco: '[AI_TRANSLATION]Voltar para zgcombat.',
      ...
      codecombat_classroom: '[AI_TRANSLATION]zgcombat Sala de Aula',
      ...
      codecombat_dashboard: '[AI_TRANSLATION]Painel de Controlo do zgcombat',
      codecombat_teacher_dashboard: '[AI_TRANSLATION]Painel de Controlo do Professor zgcombat',
      codecombat_admin_dashboard: '[AI_TRANSLATION]Painel de Administração do zgcombat',
      ...
      codecombat_worlds_on_roblox: '[AI_TRANSLATION]Mundos do zgcombat no Roblox',
      ...
      coco_junior_beta: '[AI_TRANSLATION]zgcombat Júnior (Beta)',
    ...
    diplomat_suggestion: {
      title: 'Ajuda a traduzir o zgcombat!',
      sub_heading: 'Precisamos das tuas habilidades linguísticas.',
      pitch_body: 'Desenvolvemos o zgcombat em Inglês, mas já temos jogadores de todo o mundo. Muitos deles querem jogar em Português, mas não falam Inglês, por isso, se sabes falar ambas, por favor considera registar-te como Diplomata para ajudares a traduzir o sítio do zgcombat e todos os níveis para Português.',
    ...
    new_home_faq: {
      ...
      main_curriculum: '[AI_TRANSLATION]Posso usar o zgcombat ou Ozaria como o meu currículo principal?',
      main_curriculum_blurb: '[AI_TRANSLATION]Sem dúvida! Consultámos especialistas em educação para criar um currículo e materiais de sala de aula específicos para professores que estão a usar o zgcombat ou Ozaria, mesmo sem experiência prévia em ciências da computação. Muitas escolas estão a implementar o zgcombat e/ou Ozaria como currículo principal de ciências da computação.',
      clever_instant_login: '[AI_TRANSLATION]O zgcombat e o Ozaria suportam Clever Instant Login?',
      ...
      recommended_systems_blurb: '[AI_TRANSLATION]zgcombat e Ozaria funcionam melhor em computadores com pelo menos 4GB de RAM, num navegador moderno como Chrome, Safari, Firefox ou Edge. Chromebooks com 2GB de RAM podem ter pequenos problemas gráficos em cursos mais avançados. É necessário um mínimo de 200 Kbps de largura de banda por aluno, embora seja recomendado 1+ Mbps.',
      ...
      ai_bot_faq_blurb: '[AI_TRANSLATION]O AI Chat Level Help Bot no zgcombat capacita os aprendizes com dicas impulsionadas por IA para desafios de codificação, garantindo uma experiência de aprendizado guiada mas independente. A segurança é primordial, pois a IA filtra dados pessoais e é treinada para lidar com pedidos inadequados.',
    },

    play: {
      title: 'Joga os níveis de zgcombat - Aprende Python, JavaScript, e HTML',
      ...
      anon_signup_title_1: 'O zgcombat tem uma',
      ...
      get_more_codecombat: 'Obter mais do zgcombat',
      ...
      play_codecombat: '[AI_TRANSLATION]Jogar zgcombat',
      play_codecombat_junior: '[AI_TRANSLATION]Jogar zgcombat Junior',
    ...
    share_progress_modal: {
      blurb: 'Estás a fazer grandes progressos! Conta ao teu educador o quanto aprendeste com o zgcombat.',
    ...
    login: {
      ...
      already_have_account1: '[AI_TRANSLATION]Já tens uma conta de Professor ou Aluno no zgcombat?',
      ...
      individual_users_not_supported: '[AI_TRANSLATION]Ozaria é só para salas de aula! Visita o zgcombat para continuar a jogar!',
    ...
    signup: {
      ...
      email_announcements: 'Receber anúncios sobre níveis e funcionalidades novos do zgcombat!',
      ...
      teacher_type_1: 'Ensina programção usando o zgcombat!',
      ...
      want_codecombat_in_school: 'Queres jogar zgcombat o tempo inteiro?',
      eu_confirmation: 'Concordo em permitir que a zgcombat armazene os meus dados em servidores dos EUA.',
      ...
      already_have_account: '[AI_TRANSLATION]Já tens uma conta no zgcombat ou Ozaria?',
      ...
      //    with: "with",
      want_to_play_codecombat: '[AI_TRANSLATION]Não, não tenho uma, mas quero jogar zgcombat!',
    ...
    common: {
      default_title_coco: 'zgcombat - Jogos de programação para aprender Python e JavaScript',
      default_title_ozar: 'zgcombat - Jogos de programação para aprender Python e JavaScript',
      //    ozaria: "Ozaria",
    ...
    play_level: {
      ...
      explore_codecombat: 'Explorar o zgcombat',
      ...
      tip_open_source: 'O zgcombat faz parte da comunidade open source!',
      tip_tell_friends: 'Estás a gostar do zgcombat? Fala de nós aos teus amigos!',
      tip_beta_launch: 'O zgcombat lançou o seu beta em outubro de 2013.',
      ...
      tip_open_source_contribute: 'Podes ajudar a melhorar o zgcombat!',
    ...
    play_game_dev_level: {
      ...
      play: 'Jogar Nível',
      play_more_codecombat: 'Jogar Mais zgcombat',
    ...
    subscribe: {
      ...
      confirmation: 'Parabéns! Tens agora uma Subscrição Premium zgcombat!',
      ...
      thank_you: 'Obrigado por apoiares o zgcombat.',
    ...
    premium_features: {
      get_premium: 'Obtém<br>zgcombat<br>Premium',
      ...
      everything_in_premium: 'Tudo o que se recebe no zgcombat Premium:',
    ...
    about: {
      title: 'Sobre o zgcombat - Envolver os estudantes, Capacitar os professores, Inspirar a criação',
      ...
      main_description: 'No zgcombat, o nosso trabalho é certificarmo-nos de que estás a fazer isso com um sorriso na cara.',
      mission_link: 'Missão',
      team_link: 'Equipa',
      story_link: 'História',
      press_link: 'Imprensa',
      mission_title: 'A nossa missão: tornar a programação acessível a todos os estudantes da Terra.',
      mission_description_1: '<strong>A programação é mágica</strong>. É a capacidade de criar coisas a partir de imaginação pura. Começamos o zgcombat para dar aos utilizadores a sensação de terem poderes mágicos nas pontas dos dedos ao usarem <strong>código escrito</strong>.',
      ...
      team_title: 'Conhece a equipa do zgcombat',
      ...
      shan_title: 'Chefe de Marketing, zgcombat, China',
      run_title: 'Chefe de Operações, zgcombat, China',
      lance_title: 'Chefe de Tecnologia, zgcombat, China',
      zhiran_title: 'Chefe de Curriculum, zgcombat, China',
      yuqiang_title: 'Chefe de Inovação, zgcombat, China',
      ...
      bill_title: 'Director Geral, zgcombat, China',
      ...
      story_subtitle: 'Desde 2013, o zgcombat cresceu de um mero conjunto de esboços para um jogo palpável e próspero.',
      story_statistic_1a: '20,000,000+',
      story_statistic_1b: 'jogadores no total',
      story_statistic_1c: 'começaram a jornada de programação deles pelo zgcombat',
      ...
      jobs_title: 'Vem trabalhar connosco e ajudar a escrever a história do zgcombat!',
      ...
      jobs_custom_description: 'É apaixonado pelo zgcombat mas não vê um emprego que corresponda às suas qualificações? Escreva-nos e mostre como pensa que pode contribuir para a nossa equipa. Gostaríamos muito de ouvir a sua opinião!',
      ...
      about_codecombat: 'Sobre o zgcombat',
      logo: 'Logótipo',
    ...
    teachers: {
      ...
      free_course_blurb_junior: '[AI_TRANSLATION]Ótimo para o pré-escolar ao 5º ano, o zgcombat Junior pode adaptar-se a opções de blocos e móveis para pré-leitores, até código de texto Python ou JavaScript para os anos superiores do ensino básico, ou a blocos-e-código paralelos para ajudar na transição.  ',
      'free_course_blurb_introduction-to-computer-science': '[AI_TRANSLATION]Ótimo para o 6º ao 12º ano, os cursos principais de CS do zgcombat progridem desde a Introdução à Ciência da Computação, focada em iniciantes, até aos Princípios de Ciência da Computação AP, e além, com cursos avançados de CS. Começa aqui para alunos do ensino básico e secundário.  ',
    ...
    teachers_quote: {
      subtitle_coco: '[AI_TRANSLATION]Aprende mais sobre zgcombat com uma visita guiada interativa do produto, preços e implementação!',
      ...
      state: 'Estado',
      country: 'País',
      num_students_help: 'Quantos estudantes vão usar o zgcombat?',
      ...
      thanks_sub_header_coco: '[AI_TRANSLATION]Obrigado por demonstrares interesse no zgcombat para a tua escola.',
      ...
      learn_more_modal: '[AI_TRANSLATION]Contas de Professor no zgcombat têm a capacidade de monitorizar o progresso dos alunos, atribuir licenças e gerir turmas. Contas de Professor não podem fazer parte de uma turma - se estás atualmente inscrito numa turma com esta conta, deixarás de conseguir aceder a esta uma vez que atualizes para uma Conta de Professor.  ',
      create_account: 'Criar uma Conta de Professor',
      create_account_subtitle: 'Obtém acesso a ferramentas reservadas a professores para usares o zgcombat na sala de aula. <strong>Cria uma turma</strong>, adiciona os teus estudantes e <strong>monitoriza o progresso deles</strong>!',
    ...
    contact: {
      contact_us: 'Contacta o zgcombat',
      ...
      subscribe: 'compra uma subscrição do zgcombat',
      subscribe_suffix: 'e nós ficaremos felizes por ajudar-te com o teu código.',
      subscriber_support: 'Como és um subscritor do zgcombat, os teus e-mails terão prioridade no nosso suporte.',
      screenshot_included: 'Captura de ecrã incluída.',
      where_reply: 'Para onde devemos enviar a resposta?',
      send: 'Enviar Feedback',
      ooo_blurb: '[AI_TRANSLATION]A equipa do zgcombat estará fora do escritório de 5 a 9 de junho, e durante este período terá acesso limitado aos emails. Responderemos à tua pergunta assim que possível, por favor esteja ciente do tempo de espera antecipado.',
    },
    ...
    account_settings: {
      ...
      roblox_not_connected: '[AI_TRANSLATION]Liga as tuas contas do zgcombat e Roblox.',
      ...
      email_announcements_description: 'Recebe e-mails sobre as últimas novidades e desenvolvimentos no zgcombat.',
      email_notifications: 'Notificações',
      email_notifications_summary: 'Controla, de uma forma personalizada e automática, os e-mails de notificações relacionados com a tua atividade no zgcombat.',
    ...
    community: {
      main_title: 'Comunidade do zgcombat',
      ...
      level_editor_suffix: 'do zgcombat para criares e editares níveis. Os utilizadores já criaram níveis para aulas, amigos, maratonas hacker, estudantes e familiares. Se criar um nível novo parece intimidante, podes começar por bifurcar um dos nossos!',
      thang_editor_prefix: "Chamamos 'thangs' às unidades do jogo. Usa o",
      thang_editor_suffix: 'para modificares a arte do zgcombat. Faz as unidades lançarem projéteis, altera a direção de uma animação, altera os pontos de vida de uma unidade ou anexa as tuas próprias unidades.',
      ...
      article_editor_suffix: 'e ajuda os jogadores do zgcombat a obter o máximo do tempo de jogo deles.',
      ...
      social_blog: 'Lê o blog do zgcombat no Sett',
      social_discource: 'Junta-te à discussão no nosso fórum Discourse',
      social_facebook: 'Gosta do zgcombat no Facebook',
      social_twitter: 'Segue o zgcombat no Twitter',
      social_slack: 'Fala connosco no canal público do zgcombat no Slack',
      contribute_to_the_project: 'Contribui para o projeto',
    },

    clans: {
      title: '[AI_TRANSLATION]Junta-te a Clãs no zgcombat - Aprende a programar em Python, JavaScript e HTML',
      clan_title: '[AI_TRANSLATION]__clan__ - Junta-te aos Clãs do zgcombat e Aprende a Programar',
    ...
    courses: {
      ...
      ask_teacher_for_code_coco: 'Pergunta ao teu professor se tens um código de turma do zgcombat! Se tiveres, introdu-lo abaixo:',
      ask_teacher_for_code_ozar: 'Pergunta ao teu professor se tens um código de turma do zgcombat! Se tiveres, introdu-lo abaixo:',
      ...
      update_account_individuals_warning_ozaria: '[AI_TRANSLATION]Aviso: contas individuais não podem jogar Ozaria, apenas zgcombat.',
      ...
      update_account_confirm_update_student2: '[AI_TRANSLATION]Não poderás gerir nenhuma das classes que já criaste nem criar novas classes. As tuas classes existentes serão removidas do zgcombat e não poderão ser recuperadas.',
      ...
      youve_been_invited_3: '[AI_TRANSLATION]com os teus colegas no zgcombat.',
      ...
      license_required_to_play_coco: '[AI_TRANSLATION]Pede ao teu professor para te atribuir uma licença para que possas continuar a jogar zgcombat!',
    ...
    teacher: {
      ...
      teacher_account_explanation: '[AI_TRANSLATION]Uma conta de Professor do zgcombat permite-te configurar salas de aula, monitorizar o progresso dos alunos enquanto trabalham nos cursos, gerir licenças e aceder a recursos para ajudar na construção do teu currículo.',
      ...
      pacing_guides_desc: '[AI_TRANSLATION]Aprende a incorporar todos os recursos de zgcombat no planeamento do teu ano letivo!',
      ...
      student_getting_started_desc: '[AI_TRANSLATION]Podes distribuir este guia aos teus alunos antes de começarem o zgcombat para que se possam familiarizar com o editor de código. Este guia pode ser usado tanto para aulas de Python como de JavaScript.',
      ...
      hoc_meta_description: '[AI_TRANSLATION]Faz o teu próprio jogo ou codifica a tua saída de uma masmorra! O zgcombat tem quatro atividades diferentes de Hora de Código e mais de 60 níveis para aprender a programar, jogar e criar.',
      hoc_intro: '[AI_TRANSLATION]Existem três maneiras para a tua turma participar na Hora do Código com zgcombat',
      hoc_self_led: '[AI_TRANSLATION]Jogo Autodirigido',
      hoc_self_led_desc: '[AI_TRANSLATION]Os alunos podem percorrer nossos tutoriais de Hour of Code zgcombat sozinhos',
      ...
      hoc_additional_desc1: '[AI_TRANSLATION]Para recursos e atividades adicionais do zgcombat, vê o nosso',
      ...
      teacher_quest_teach_methods_step2: '[AI_TRANSLATION]Imprime o [Guia de Início Rápido para Estudantes](https://files.flsong.iok.la/docs/resources/StudentQuickStartGuide.pdf) na Caixa de Ferramentas do Professor.',
      ...
      teacher_quest_kithgard_gates_100_step2: '[AI_TRANSLATION]Guia os alunos a resolver problemas difíceis usando o [Engineering Cycle Worksheet](https://files.flsong.iok.la/docs/resources/EngineeringCycleWorksheet.pdf).',
      ...
      teacher_quest_done: '[AI_TRANSLATION]Queres que os teus alunos aprendam ainda mais sobre código? Fala com os nossos [especialistas em escolas](mailto:schools@flsong.iok.la) hoje!',
    ...
    teacher_ozaria_encouragement_modal: {
      ...
      sub_title: '[AI_TRANSLATION]És convidado a experimentar o novo jogo de aventura do zgcombat.',
      cancel: '[AI_TRANSLATION]De Volta ao zgcombat',
      ...
      you_can_return: '[AI_TRANSLATION]Podes sempre voltar ao zgcombat.',
    },
    ...
    educator_signup_ozaria_encouragement: {
      ...
      educators_continue_coco: '[AI_TRANSLATION]Educadores que querem continuar a usar o zgcombat na sua aula',
      continue_coco: '[AI_TRANSLATION]Continua com zgcombat',
    },
    ...
    classes: {
      ...
      archmage_summary: 'Se és um programador interessado em programar jogos educacionais, torna-te um Arcomago para nos ajudares a construir o zgcombat!',
      ...
      diplomat_summary: 'O zgcombat está traduzido em 45+ idiomas graças aos nossos Diplomatas. Ajuda-nos e contribui com traduções.',
      ambassador_title: 'Embaixador',
      ambassador_title_description: '(Suporte)',
      ambassador_summary: 'Amansa os nossos utilizadores do fórum e direciona aqueles que têm questões. Os nossos Embaixadores representam o zgcombat perante o mundo.',
      teacher_title: 'Professor',
    },

    editor: {
      main_title: 'Editores do zgcombat',
    ...
    contribute: {
      ...
      intro_blurb: 'O zgcombat faz parte da comunidade open source! Centenas de jogadores dedicados ajudaram-nos a transformar o jogo naquilo que ele é hoje. Junta-te a nós e escreve o próximo capítulo da aventura do zgcombat para ensinar o mundo a programar!',
      ...
      diplomat_introduction_suf: 'é que há um interesse considerável no zgcombat noutros países! Estamos a construir um exército de tradutores dispostos a transformar um conjunto de palavras num outro conjuto de palavras, para conseguir que o zgcombat fique o mais acessível quanto posível em todo o mundo. Se gostas de dar espreitadelas a conteúdos futuros e disponibilizar os níveis para os teus colegas nacionais o mais depressa possível, então esta classe talvez seja para ti.',
      ...
      ambassador_introduction: '[AI_TRANSLATION]Esta é uma comunidade que estamos a construir, e tu és as ligações. Temos fóruns, emails, e redes sociais com muitas pessoas para conversar e ajudar a conhecer o jogo e aprender. Se quiseres ajudar as pessoas a envolverem-se e a divertirem-se, e captar o pulsar do zgcombat e para onde estamos a ir, então esta aula pode ser para ti.',
    ...
    user: {
      user_title: '[AI_TRANSLATION]__name__ - Aprende a Programar com o zgcombat',
      stats: 'Estatísticas',
    ...
    account: {
      ...
      status_unsubscribed: 'Ganha acesso a novos níveis, heróis, itens e gemas de bónus com uma subscrição do zgcombat!',
      ...
      unsubscribe_from_marketing: '[AI_TRANSLATION]Cancelar subscrição __email__ de todos os e-mails de marketing da zgcombat?',
    ...
    account_prepaid: {
      ...
      purchase_code1: '[AI_TRANSLATION]Códigos de Subscrição podem ser resgatados para adicionar tempo de subscrição premium a uma ou mais contas na versão Home do zgcombat.',
      purchase_code2: '[AI_TRANSLATION]Cada conta de zgcombat só pode resgatar um Código de Assinatura específico uma vez.',
      ...
      purchase_code4: '[AI_TRANSLATION]Códigos de Assinatura são para contas que jogam a versão doméstica do zgcombat, não podem ser usados em vez de Licenças de Estudante para a versão de Sala de Aula.',
    ...
    impact: {
      ...
      teacher_quote: '[AI_TRANSLATION]Quando tive acesso ao zgcombat [e] comecei a usá-lo com os meus alunos, fez-se luz. Era uma diferença abissal em comparação com todos os outros programas que já tínhamos usado. Nem sequer têm comparação.',
      ...
      ozaria_impact_blurb: '[AI_TRANSLATION]O currículo complementar do zgcombat, Ozaria, provou ter um impacto positivo nos resultados de aprendizagem dos alunos que mais importam tanto para alunos quanto para educadores.',
    ...
    anonymous_teacher: {
      ...
      teacher_notified: '[AI_TRANSLATION]Notificámos o teu professor que queres jogar mais zgcombat na sala de aula!',
    },
    ...
    legal: {
      page_title: 'Legal',
      opensource_introduction: 'O zgcombat faz parte da comunidade open source.',
      opensource_description_prefix: 'Confere ',
      github_url: 'o nosso GitHub',
      opensource_description_center: 'e ajuda se quiseres! O zgcombat é construído tendo por base dezenas de projetos open source, os quais nós amamos. Vê ',
      ...
      cost_title: 'Custo',
      cost_description: '[AI_TRANSLATION]O zgcombat é grátis para jogar nos seus níveis introdutórios, com uma assinatura de $__price__ USD/mês para acesso a níveis extras e __gems__ gemas de bónus por mês. Podes cancelar com um clique, e oferecemos uma garantia de reembolso de 100%.  ',
      ...
      client_code_description_prefix: '[AI_TRANSLATION]Todo o código do lado do cliente para flsong.iok.la no repositório público do GitHub e na base de dados do flsong.iok.la é licenciado sob a',
      mit_license_url: 'Licença do MIT',
      code_description_suffix: 'Isto inclui todo o código dentro dos Sistemas e dos Componentes, o qual é disponibilizado pelo zgcombat para a criação de níveis.',
      ...
      art_description_suffix: 'Conteúdo comum é, geralmente, qualquer coisa disponibilizada pelo zgcombat com o propósito de criar Níveis. Isto inclui:',
      art_music: 'Música',
      art_sound: 'Som',
      art_artwork: 'Arte',
      art_sprites: 'Sprites',
      ...
      art_paragraph_1: '[AI_TRANSLATION]Para atribuição, por favor nomeia e linka para flsong.iok.la perto de onde a fonte é usada ou onde for apropriado para o meio. Por exemplo:',
      use_list_1: "Se usado num filme ou noutro jogo, inclui 'flsong.iok.la' nos créditos.",
      use_list_2: '[AI_TRANSLATION]Se usado num site, inclua um link perto do uso, por exemplo, embaixo de uma imagem, ou numa página de atribuições onde poderia também mencionar outras obras Creative Commons e software de código aberto utilizados no site. Algo que já esteja claramente a referenciar o zgcombat, como um post no blog a mencionar o zgcombat, não precisa de uma atribuição separada.',
      art_paragraph_2: '[AI_TRANSLATION]Se o conteúdo a ser usado não for criado pelo zgcombat, mas sim por um utilizador do flsong.iok.la, atribui-lhes o crédito e segue as instruções de atribuição fornecidas na descrição desse recurso, se houver.',
      ...
      nutshell_description: 'Qualquer um dos recursos que fornecemos no Editor de Níveis são de uso livre para criares Níveis. Mas reservamos o direito de distribuição restrita dos próprios Níveis (que são criados em flsong.iok.la) pelo que podemos cobrar por eles no futuro, se for isso que acabar por acontecer.',
      ...
      third_party_description: 'O zgcombat usa os seguintes serviços de terceiros (entre outros):',
      cookies_message: 'O zgcombat usa alguns cookies essenciais e não-essenciais.',
    ...
    ladder_prizes: {
      ...
      in_cash: 'em dinheiro',
      custom_wizard: 'Um Feiticeiro do zgcombat Personalizado',
      custom_avatar: 'Um Avatar do zgcombat Personalizado',
    ...
    apcsp: {
      ...
      meta_description: '[AI_TRANSLATION]O abrangente currículo e programa de desenvolvimento profissional do zgcombat são tudo o que precisas para oferecer o mais novo curso de ciências da computação da College Board aos teus alunos.  ',
      syllabus: '[AI_TRANSLATION]Plano de Estudos de Princípios de AP CS',
      syllabus_description: '[AI_TRANSLATION]Usa este recurso para planear o currículo do zgcombat para a tua aula de Princípios de Ciência da Computação AP.',
    ...
    apcsp_marketing: {
      ...
      icons_coding_levels: '[AI_TRANSLATION]150+ Níveis de Codificação no zgcombat',
      ...
      course_outline_description: '[AI_TRANSLATION]As descrições a seguir são uma visão geral do conteúdo explorado no curso AP CSP do zgcombat.',
      ...
      question_2: '[AI_TRANSLATION]Quais são os requisitos tecnológicos para o currículo AP CSP do zgcombat?',
    ...
    apcsp_curriculum: {
      ...
      professional_development_description: '[AI_TRANSLATION]O zgcombat oferece um curso online e autoguiado de desenvolvimento profissional para educadores de todos os níveis de experiência em AP CSP. Os participantes irão explorar o currículo do zgcombat e aprender como pode ser usado para preparar os alunos para o sucesso no exame AP CSP. Através de discussões assíncronas com outros professores e videoconferências com os desenvolvedores do currículo do zgcombat, estarás equipado com as ferramentas e técnicas necessárias para apoiar todos os teus alunos no AP CSP. No final do curso, receberás um Certificado de Conclusão que pode ser usado para a renovação da tua credencial de ensino. Oferecemos o nosso Currículo no __edapp__.  ',
      ...
      no_license: '[AI_TRANSLATION]O nosso currículo AP CSP exige uma licença paga para ser visualizado. Saiba mais sobre o currículo AP CSP do zgcombat visitando a nossa página "Sobre", link abaixo.',
      ...
      step_1_subtitle: '[AI_TRANSLATION]Carrega o programa AP CSP do zgcombat para a Auditoria de Curso da College Board.  ',
    ...
    hoc_2019: {
      ...
      already_have_account: '[AI_TRANSLATION]Já tens uma conta no zgcombat ou Ozaria? Inicia sessão.',
    ...
    parents_landing_1: {
      ...
      codecombat_intro: '[AI_TRANSLATION]zgcombat combina o poder do jogo e instrução personalizada para oferecer aulas online de programação que o teu filho vai ansiar todas as semanas.',
      ...
      quote_1: '[AI_TRANSLATION]Embora a aula comece todos os sábados às 7h, o meu filho está tão entusiasmado que acorda antes de mim! O zgcombat cria um caminho para o meu filho melhorar as suas habilidades de programação.',
      ...
      private_instructions: '[AI_TRANSLATION]Todas as aulas têm instrução privada e individualizada. Para inscrever um grupo de alunos, contacte <a href="mailto:classes@flsong.iok.la">classes@flsong.iok.la</a> para um plano personalizado.',
      ...
      benefit_3: '[AI_TRANSLATION]Licença premium do zgcombat incluída',
      ...
      subscription_details: '[AI_TRANSLATION]Todas as subscrições são cobradas mensalmente e podem ser pausadas, canceladas ou retomadas sem taxas. A tua compra de subscrição é 100% livre de risco nos primeiros 30 dias. Se por alguma razão decidires não continuar, basta <a href="mailto:classes@flsong.iok.la">contactar-nos</a> dentro de 30 dias após a compra e nós reembolsaremos prontamente 100% do teu pagamento, sem perguntas. Todos os planos são renovados automaticamente ao mesmo nível e ciclo de faturação, a menos que sejam alterados ou cancelados.\n',
      ...
      grit_description: '[AI_TRANSLATION]zgcombat desafia os alunos a abraçar e aprender com os seus erros. Dicas integradas ajudam os alunos a identificar e corrigir bugs, levando a uma maior confiança na programação.',
      ...
      faq_a_1: '[AI_TRANSLATION]Cada um dos nossos instrutores foi escolhido a dedo para representar o zgcombat e proporcionar uma experiência de aprendizagem divertida e personalizada, adaptada a cada aluno. Acreditamos que o teu filho vai gostar de aprender com qualquer um dos nossos instrutores, mas se, por algum motivo, quiseres mudar de professor, estamos felizes em acomodar.',
      ...
      faq_a_4: '[AI_TRANSLATION]A tua compra de subscrição é 100% livre de risco nos primeiros 30 dias. Se por qualquer razão decidires não continuar, simplesmente <a href="mailto:classes@flsong.iok.la">contacta-nos</a> dentro de 30 dias após a compra e reembolsaremos rapidamente 100% da tua compra, sem perguntas. Podes também congelar a tua subscrição a qualquer momento e reativá-la quando te for conveniente.',
      faq_q_5: '[AI_TRANSLATION]E se eu precisar de remarcar uma aula?',
      faq_a_5: '[AI_TRANSLATION]Assim que marcares uma aula semanal connosco, reservamos um horário na nossa agenda exclusivamente para ti, por isso exigimos um aviso prévio de 48 horas para remarcar as aulas. Podes remarcar a tua aula enviando um e-mail para <a href="mailto:classes@flsong.iok.la">classes@flsong.iok.la</a>. Aulas perdidas ou canceladas com menos de 48 horas de antecedência não serão remarcadas ou reembolsadas.',
      ...
      other_questions: '[AI_TRANSLATION]Se tiveres alguma questão sobre as nossas aulas online, por favor <a href="mailto:classes@flsong.iok.la">contacta-nos.</a>',
    },
    ...
    parents_landing_2: {
      ...
      live_classes_offered: '[AI_TRANSLATION]O zgcombat agora oferece aulas ao vivo de ciências da computação online para alunos que aprendem em casa. Ótimo para estudantes que se dão melhor em ambientes 1:1 ou em pequenos grupos onde os resultados de aprendizagem são adaptados às suas necessidades.',
      ...
      premium_need_help: '[AI_TRANSLATION]Precisas de ajuda ou preferes Paypal? Envia email para <a href="mailto:support@flsong.iok.la">support@flsong.iok.la</a>',
      not_sure_kid: '[AI_TRANSLATION]Não tens a certeza se o zgcombat é adequado para o teu filho? Pergunta-lhe!',
      ...
      why_kids_love: '[AI_TRANSLATION]Porque as Crianças Adoram o zgcombat',
      ...
      why_parents_love: '[AI_TRANSLATION]Porque os Pais Adoram o zgcombat',
      ...
      critical_skills_detail: '[AI_TRANSLATION]O teu filho vai aprender a navegar e tornar-se um cidadão no mundo digital. zgcombat é uma solução que melhora o pensamento crítico, a criatividade e a resiliência do teu filho, dando-lhe as competências necessárias para qualquer indústria.',
      parent_support: '[AI_TRANSLATION]Suportando Vários Caminhos de CS Numa Turma',
      parent_support_detail: '[AI_TRANSLATION]No zgcombat, somos pais. Somos programadores. Somos educadores. Mas, acima de tudo, somos pessoas que acreditam em dar às nossas crianças a melhor oportunidade de sucesso, seja lá o que decidirem fazer.',
      ...
      quotes_title: '[AI_TRANSLATION]O que os pais e crianças dizem sobre o zgcombat',
      ...
      quote_3: '[AI_TRANSLATION]"O Python do Oliver está a avançar. Ele está a usar o zgcombat para fazer os seus próprios videojogos. Desafia-me a jogar os seus jogos, e depois ri-se quando eu perco."',
      quote_4: '[AI_TRANSLATION]"Esta é uma das minhas coisas favoritas para fazer. Todas as manhãs acordo e jogo zgcombat. Se tivesse de dar uma classificação ao zgcombat de 1 a 10, dar-lhe-ia um 10!"',
      //    parent: "Parent",
      //    student: "Student",
      grade: '[AI_TRANSLATION]Grau',
      subscribe_error_user_type: '[AI_TRANSLATION]Parece que já te registaste para uma conta. Se estiveres interessado no zgcombat Premium, por favor contacta-nos em team@flsong.iok.la.',
      ...
      live_classes_title: '[AI_TRANSLATION]Aulas de programação ao vivo com zgcombat!',
    ...
    modal_timetap_confirmation: {
      ...
      paragraph_5: '[AI_TRANSLATION]Obrigado por escolheres o zgcombat e boa sorte na tua jornada pela ciência da computação!',
      back_to_coco: '[AI_TRANSLATION]De Volta ao zgcombat',
    },
    ...
    hoc_2018_interstitial: {
      welcome: '[AI_TRANSLATION]Bem-vindo à Hora de Código do zgcombat!',
    ...
    school_administrator: {
      ...
      add_additional_teacher: '[AI_TRANSLATION]Precisas de adicionar um professor extra? Contacta o teu gestor de conta zgcombat ou envia um email para support@flsong.iok.la.',
      ...
      active_students_stat_description: '[AI_TRANSLATION]Estudantes ativos conta o número de estudantes que fizeram login no zgcombat nos últimos 60 dias.',
      ...
      no_teachers: '[AI_TRANSLATION]Ainda não tens escolas associadas à tua conta. Por favor contacta o teu <strong>Gestor de Sucesso Distrital</strong> ou <a href="mailto:schools@flsong.iok.la">schools@flsong.iok.la</a> para configurar o teu painel de controlo.',
    ...
    browser_recommendation: {
      title: '[AI_TRANSLATION]zgcombat funciona melhor no Chrome!',
      pitch_body: '[AI_TRANSLATION]Para a melhor experiência no zgcombat, recomendamos usar a versão mais recente do Chrome. Faz o download da última versão do Chrome ao clicar no botão abaixo!',
    ...
    events: {
      title: '[AI_TRANSLATION]Eventos do zgcombat',
      main_title: '[AI_TRANSLATION]Eventos do zgcombat',
      main_description: '[AI_TRANSLATION]Os eventos importantes do zgcombat na China',
      ...
      sync_to_google_desc: '[AI_TRANSLATION]Sincronizar este evento no TEU calendário do google, em vez do calendário do proprietário. E só pode funcionar com o gmail do zgcombat.',
    ...
    teacher_dashboard: {
      ...
      want_to_save_tooltip_coco: '[AI_TRANSLATION]<h3>Queres guardar o teu progresso?</h3><p>Por favor cria uma conta de aluno, ou vai a <i>Minha Conta / Testar como Aluno</i> e joga zgcombat como aluno se quiseres guardar o teu progresso.</p>',
      ...
      ozaria_hs_modal_title: '[AI_TRANSLATION]Acede ao Hackstack da IA Exclusivamente no zgcombat  ',
      ozaria_hs_modal_blurb: '[AI_TRANSLATION]Os educadores podem agora aceder ao AI Hackstack diretamente no **[https://flsong.iok.la/teachers/classes]zgcombat** usando as mesmas credenciais do Ozaria. Para maior comodidade, podes importar as tuas turmas do Ozaria para o zgcombat facilmente.  ',
    ...
    outcomes: {
      ...
      using_codecombat: '[AI_TRANSLATION]Usando o motor de aprendizagem personalizado do zgcombat...',
      //    wrote: "wrote...",
      ...
      coverage_p1_coco: '[AI_TRANSLATION]O currículo completo do zgcombat cobre os principais padrões de programação em vários frameworks amplamente adotados, incluindo os da Sociedade Internacional de Tecnologia em Educação (ISTE), da Associação de Professores de Ciência da Computação (CSTA) e do Framework de Ciência da Computação K-12.',
    ...
    efficacy: {
      ...
      commitment_title: '[AI_TRANSLATION]Compromisso do zgcombat com a Eficácia',
      ...
      //    teachers_love_codecombat: "Teachers Love zgcombat",
      teachers_love_description: '[AI_TRANSLATION]Explora o impacto do nosso produto irmão, zgcombat, no ensino e aprendizagem de Ciências da Computação!',
      //    teachers_love_box1: "Report that their students enjoy using zgcombat to learn how to code",
      //    teachers_love_box2: "Would recommend zgcombat to other computer science teachers",
      //    teachers_love_box3: "Say that zgcombat helps them support students’ problem solving abilities",
    ...
    league: {
      ...
      summary: '[AI_TRANSLATION]A Liga de IA do zgcombat é única pois é tanto um simulador de batalhas de IA competitivo como um motor de jogo para aprender código real em Python e JavaScript.',
      join_now: '[AI_TRANSLATION]Inscreve-te Já',
      tagline: '[AI_TRANSLATION]A Liga de IA do zgcombat combina o nosso currículo baseado em projetos alinhado com os padrões, um jogo de código envolvente baseado em aventuras, e o nosso torneio global anual de codificação em IA numa competição académica organizada como nenhuma outra.',
      ...
      comprehensive_curr_subheader: '[AI_TRANSLATION]zgcombat é uma solução de CS alinhada aos padrões que ajuda educadores a ensinar programação real em JavaScript e Python, independentemente da sua experiência.',
      ...
      season1_prize_3: '[AI_TRANSLATION]Avatar Personalizado do zgcombat',
      season1_prize_4: '[AI_TRANSLATION]E mais!',
      season1_prize_hyperx: '[AI_TRANSLATION]Periféricos Premium HyperX',
      codecombat_ai_league: '[AI_TRANSLATION]Liga de IA do zgcombat',
      register: '[AI_TRANSLATION]Registar',
      ...
      coco_reserves: '[AI_TRANSLATION]zgcombat reserva-se',
      ...
      contact_sales_custom: '[AI_TRANSLATION]O teu torneio personalizado aguarda-te. Escolhe a arena que queres usar para o teu torneio personalizado e contacta o teu representante de vendas do zgcombat para confirmar os detalhes da configuração e agendamento.',
      ...
      codecombat_ai_league_description: '[AI_TRANSLATION]A Liga de IA do zgcombat combina o nosso currículo baseado em projetos alinhado com os padrões, um jogo de código envolvente baseado em aventuras, e o nosso torneio global anual de codificação em IA numa competição académica única.',
    ...
    payments: {
      ...
      most_popular: '[AI_TRANSLATION]Mais Popular',
      best_value: '[AI_TRANSLATION]Melhor Valor',
      purchase_licenses: '[AI_TRANSLATION]Compra Licenças facilmente para obter acesso total ao zgcombat e Ozaria',
      ...
      implementation_info: '[AI_TRANSLATION]60 min de Treino de Introdução sobre como usar o zgcombat e Ozaria para apoiar objetivos institucionais e instrucionais específicos.',
      ...
      full_access_coco: '[AI_TRANSLATION]Acesso Completo a ambos zgcombat',
      ...
      bd_subheading: '[AI_TRANSLATION]Para Parceiros de Negócio com pelo menos 10 alunos, obtenha acesso premium aos jogos de ciência da computação e codificação do zgcombat:',
      bd_info_list_heading: '[AI_TRANSLATION]O zgcombat é o parceiro preferido por dezenas de empresas de educação em programação porque:',
      ...
      bd_info_list_2: '[AI_TRANSLATION]qualquer pessoa pode ensinar programação com zgcombat; o jogo é o professor principal e nós fornecemos recursos de suporte extensivos',
      //    bd_info_list_3: "you will receive over 200 hours of curriculum, providing years of educational content for your business",
      bd_includes_1: '[AI_TRANSLATION]Acesso completo ao zgcombat e Ozaria com mais de 200 horas de conteúdo premium baseado em jogo',
    ...
    partners: {
      ...
      below_headline_blurb: '[AI_TRANSLATION]Na zgcombat, desenvolvemos ferramentas abrangentes que tornam aprender a programar divertido e ensinar programação fácil. As nossas soluções turnkey podem ser aproveitadas em muitas execuções.',
      ...
      esports_blurb: '[AI_TRANSLATION]Estamos a reinventar o que um e-sport pode ser ao envolver milhares de estudantes a aprender a programar. O pilar dos e-sports endémicos __hyperx__ apoiou a zgcombat AI League desde a sua temporada inaugural, criando programas promocionais atraentes em torno deste e-sport único.',
    ...
    podcast: {
      ...
      learn_more_coco: '[AI_TRANSLATION]Queres aprender mais sobre as experiências de codificação do zgcombat?',
      //    subscribe: "Subscribe",
      explore_coco: '[AI_TRANSLATION]Explora o zgcombat',
    ...
    library: {
      ...
      access_coco: '[AI_TRANSLATION]Acessar zgcombat',
      ...
      network_detected: '[AI_TRANSLATION]Rede da biblioteca detetada, redirecionando-te para jogar zgcombat',
      ...
      library_signup_promotion: '[AI_TRANSLATION]Regista-te para guardar o progresso e continuar de onde paraste no zgcombat!!',
    ...
    related_accounts: {
      subtitle: '[AI_TRANSLATION]Adiciona conexões entre diferentes contas do zgcombat para poderes alternar rapidamente entre elas. Por exemplo, como pai/mãe, poderias trocar para ver o zgcombat a partir das contas dos teus filhos. Ou, como professor, poderias adicionar uma conta de estudante de teste para ti próprio(a) para veres o que os teus alunos veem.',
    ...
    modal_free_class: {
      paragraph_1: '[AI_TRANSLATION]Obrigado por escolheres o zgcombat.',
    ...
    roblox_landing: {
      meta_title: '[AI_TRANSLATION]Mundos do zgcombat no Roblox: Joga, Programa e Cria',
      ...
      box_play_blurb_player: '[AI_TRANSLATION]Explora a experiência 3D imersiva dos Mundos do zgcombat. Programa os teus animais de estimação e aventura-te num universo de criatividade e experiências partilhadas com amigos.',
      ...
      bottom_blurb_parent: '[AI_TRANSLATION]Não precisas esperar - __sign-up__ para as nossas aulas online ao vivo e começa a ensinar o teu filho a programar hoje! Começa com zgcombat web para seres o primeiro a ter acesso à experiência zgcombat Worlds Roblox.',
      bottom_blurb_sign_up: '[AI_TRANSLATION]Regista-te',
      bottom_blurb_partner: '[AI_TRANSLATION]Queres usar a nova experiência zgcombat Worlds no Roblox para o teu negócio educacional, iniciativa de impacto social ou oportunidade de distribuição internacional? __reach-out__ para discutir a parceria hoje.',
      ...
      connect_button_blurb: '[AI_TRANSLATION]Liga as tuas contas de zgcombat e Roblox para uma experiência contínua!',
      ...
      faq_bottom: '[AI_TRANSLATION]Ver mais <a href="https://codecombat.zendesk.com/hc/en-us/categories/18084251471383-zgcombat-Worlds-Roblox-" target="_blank">perguntas frequentes no nosso centro de ajuda</a>. <br />Se tiveres outras perguntas, <a href="mailto:support@flsong.iok.la">Contacta-nos</a>.',
      modal_title: '[AI_TRANSLATION]Mundos do zgcombat<br> Agora ao Vivo no Roblox!',
    ...
    ai: {
      ...
      hackstack_promotion_blurb: '[AI_TRANSLATION]Novato na IA? Explora <b>zgcombat AI HackStack</b> – a rota mais simples para a literacia em IA. Desbloqueia o potencial do ChatGPT-4, Claude, Stable Diffusion, e DALL-E. Esta ferramenta inovadora oferece treino prático em IA, tornando a criação fácil.',
    ...
    home_v3: {
      ...
      testimonals_2_title: '[AI_TRANSLATION]"Nomeia um programa online, já o experimentei. Nenhum deles se compara ao zgcombat & Ozaria. Qualquer professor que queira que os seus alunos aprendam a programar... comece aqui!"',
      ...
      testimonals_4_title: '[AI_TRANSLATION]"O que eu mais adoro no zgcombat é que não simplifica a programação. Os alunos estão a aprender a escrever código real, mas de uma forma que se estão a divertir."',
      ...
      engaging_boxes_2_title: '[AI_TRANSLATION]zgcombat Sala de Aula',
      engaging_boxes_2_text: '[AI_TRANSLATION]Um currículo completo de CS que se baseia em conceitos fundamentais até ao desenvolvimento web, desenvolvimento de jogos e **[https://flsong.iok.la/apcsp]AP CSP**.',
      engaging_boxes_3_title: '[AI_TRANSLATION]Mundos do zgcombat no Roblox',
      ...
      engaging_boxes_4_title: '[AI_TRANSLATION]zgcombat Liga de Esports IA',
      ...
      engaging_boxes_6_title: '[AI_TRANSLATION]Página Inicial do zgcombat',
      ...
      young_learners_1_title: '[AI_TRANSLATION]zgcombat Júnior',
    ...
    schools_page: {
      meta_title: '[AI_TRANSLATION]zgcombat: a solução de ciência da computação mais eficaz para escolas',
      ...
      flexible_standards_aligned_curriculum_text: '[AI_TRANSLATION]A nossa abordagem escalonada cobre desde os fundamentos de ciência da computação até cursos avançados e apresenta **[https://flsong.iok.la/apcsp]AP CSP endossado pelo College Board**, desenvolvimento web e de jogos. Construímos caminhos personalizados para proporcionar uma experiência de aprendizagem personalizada que atende aos **[https://flsong.iok.la/standards]padrões CSTA, ISTE e Common Core State Standards**. O currículo flexível permite ensinar Python, JavaScript, C++, Luau e mais.',
      ...
      elementary_school: '[AI_TRANSLATION]Escola Elementar',
      codecombat_jr: '[AI_TRANSLATION]zgcombat Júnior',
      ai_hacksstack_jr: '[AI_TRANSLATION]AI Junior',
      codecombat_worlds: '[AI_TRANSLATION]Mundos do zgcombat',
      k: '[AI_TRANSLATION]Ok',
      ...
      core_curriculum_2_title: '[AI_TRANSLATION]zgcombat Sala de Aula',
      core_curriculum_2_text: '[AI_TRANSLATION]Um currículo completo de CS que se baseia em conceitos fundamentais até ao desenvolvimento web, desenvolvimento de jogos e **[http://flsong.iok.la/apcsp]AP CSP**.',
      core_curriculum_2_link_text: '[AI_TRANSLATION]Experimenta agora',
      practice_enrichment_1_title: '[AI_TRANSLATION]zgcombat Liga de Esports IA',
      ...
      practice_enrichment_2_title: '[AI_TRANSLATION]Mundos do zgcombat no Roblox',
    ...
    standards_page: {
      ...
      curriculum_description: '[AI_TRANSLATION]zgcombat oferece caminhos robustos de curso alinhados com várias estruturas de padrões nacionais e estaduais através das séries K-12, incluindo cursos de programação de nível AP em muitas linguagens. Nosso currículo engaja os alunos a explorar e aprender ciência da computação através de lições alinhadas aos padrões.',
      most_effective_computer_science_solution: '[AI_TRANSLATION]A solução mais eficaz de ciência da computação para **[https://flsong.iok.la/schools]schools**.',
    ...
    codequest_page: {
      ...
      core_curriculum_text_23: '[AI_TRANSLATION]O Nick é o fundador e CEO do zgcombat. Um líder comprovado na indústria edtech, o Nick mistura a sua paixão pela educação com a sua perícia tecnológica para tornar a aprendizagem de programação mais acessível e envolvente para estudantes em todo o mundo. Antes do zgcombat, ele co-fundou a Skritter, uma plataforma para aprender caracteres chineses e japoneses. Com um forte compromisso em revolucionar o setor educativo, o Nick contribui ativamente para fazer da programação uma habilidade fundamental para a geração futura. A sua dedicação e visão continuam a inspirar e a impactar o mundo da edtech.',
    ...
    hackstack: {
      ...
      'HowItWorksPage_codecombat-ai-hackstack-is-an-all-in-one': '[AI_TRANSLATION]zgcombat IA HackStack é uma ferramenta tudo-em-um para criar jogos, arte, músicas, apps e muito mais apenas conversando. Ele executa tudo para ti, hospeda os teus projetos e ajuda com a programação. O modo CORE é gratuito e ensina-te através de prompts de múltipla escolha. O modo PRO+ custa $9.99/mês para prompts de forma livre. Os projetos são seguros e não alimentam dados das grandes tecnologias. Foi feito pela equipa zgcombat para tornar a IA acessível a todos. Agora, vamos começar a criar.',
      ...
      'HowItWorksPage_learn-anything-create-something-do-every': '[AI_TRANSLATION]Aprende QUALQUER COISA, cria ALGUMA COISA, faz TUDO com a zgcombat AI HackStack. Empoderamento de IA para todos!',
      ...
      'HowItWorksPage_the-codecombat-team-they-got-really-good': '[AI_TRANSLATION]A equipa do zgcombat. Eles ficaram mesmo bons a tornar fácil aprender coisas difíceis ao ensinar 20 milhões de iniciantes a programar com aprendizado baseado em jogos, então quando a tecnologia ficou suficientemente boa, quiseram fazer o mesmo para a IA. Se a IA é o futuro da criação, então precisamos tornar fácil para qualquer um usar!',
      ...
      'NewProjectPage_prompt-the-ai-to-create-websites-games-w': '[AI_TRANSLATION]Prompt para a IA criar websites, jogos, apps web, histórias, arte e muito mais com o zgcombat AI HackStack.',
    ...
    parents_v2: {
      ...
      grid_ai_hints_allowance: '[AI_TRANSLATION]Permissão de Dicas na AI do zgcombat (Diária)***  ',
      grid_prompts_allowance: '[AI_TRANSLATION]Permissão de Sugestões na AI do zgcombat (Mensal)***  ',
      ...
      prefix_or: '[AI_TRANSLATION]Ou, **[https://flsong.iok.la/payments/initial-online-classes-71]Inscreve-te agora**',
      ...
      teach_child: '[AI_TRANSLATION]Se planeares ensinar o teu filho, podemos fornecer uma solução pronta que te capacita a entregar o nosso currículo em tua casa. Providenciamos todos os recursos de ensino necessários para que tu e o teu filho tenham sucesso, incluindo guias de solução de cursos. Contacta a nossa equipa para saber mais - envia um email para **[mailto:classes@flsong.iok.la]classes@flsong.iok.la** para te conectares com um conselheiro de aprendizagem.  ',
      ...
      //    carousel_items_1_text: "For students with little to no coding experience, most class sessions will be in Ozaria to build foundational skills and then in zgcombat to deepen programming knowledge. AI HackStack will be used to help accelerate your child’s coding abilities and showcase real-world applications of their new-found skills. zgcombat Worlds and AI League will offer occasional practice and creative play opportunities.",
      carousel_items_2_title: '[AI_TRANSLATION]Desenvolvimento do Jogo  ',
      carousel_items_2_title_prefix: '[AI_TRANSLATION]**Concentra-te:**  ',
      //    carousel_items_2_text: "If your child loves games and wants to make them, then our game development focused curriculum will feature zgcombat at the core for the initial game development activities and projects. In no time your child will be working in zgcombat Worlds building and publishing real games to the Roblox platform. Competing in our AI League provides additional insight into successful game dynamics and development, while AI HackStack will be a powerful tool for iterative game development.",
      ...
      //    carousel_items_3_text: "Developing for the web is ever evolving and it’s important to stay ahead of the curve. In this curriculum focus the initial web development activities will be conducted in zgcombat, while Ozaria will be used for those new to coding. AI HackStack will be heavily implemented as the platform to build an publish to the web, with limited use of zgcombat Worlds and AI League to help reinforce key coding concepts.",
      ...
      carousel_items_4_text: '[AI_TRANSLATION]Os entusiastas de esports vão adorar o espírito competitivo deste currículo focado. Com uma base construída a partir do zgcombat, o teu filho estará a competir nos nossos torneios de esports globais da AI League durante todo o ano, com bolsas de estudo e prémios em jogo. Com ênfase no código criativo e iteração, o teu filho vai aprender a usar a nossa ferramenta AI HackStack para turbinar as suas habilidades em competição.',
      carousel_items_5_title: '[AI_TRANSLATION]IA[NEWLINE]Aplicações  ',
      carousel_items_5_title_prefix: '[AI_TRANSLATION]**Concentra-te:**  ',
      //    carousel_items_5_text: "AI is everywhere and those that can harness its power will be able to maximise their potential. This curriculum focus builds from zgcombat but it’s AI HackStack that will help teach the art of drafting the strongest AI prompts and how to use all the latest generative AI tools in a safe and secure environment. The generative AI feature built into zgcombat Worlds will offer yet another real world opportunity to see what your child can do with AI.",
      ...
      faq_5_answer: '[AI_TRANSLATION]A tua subscrição é 100% sem risco nos primeiros 30 dias. Se por qualquer razão decidires não continuar, basta contactares-nos para **[mailto:classes@flsong.iok.la]classes@flsong.iok.la** dentro de 30 dias após a compra e reembolsamos 100% do valor, sem perguntas.  ',
      //    faq_6_question: "What if I need to reschedule a class?",
      faq_6_answer: '[AI_TRANSLATION]Uma vez que tenhas reservado uma aula semanal connosco, temos tempo reservado exclusivamente para ti, por isso, exigimos um aviso prévio de 48 horas para reprogramar aulas. Podes reprogramar a tua aula enviando um e-mail para **[mailto:classes@flsong.iok.la]classes@flsong.iok.la**. Aulas perdidas ou canceladas com menos de 48 horas de antecedência não serão reorganizadas ou reembolsadas.',
    ...
    roblox: {
      ...
      link_reward_desc: '[AI_TRANSLATION]Liga as tuas contas do zgcombat e do Roblox para desbloquear funcionalidades e recompensas  ',
      ...
      faq_3_answer: '[AI_TRANSLATION]Sim. Os jogadores podem partilhar as suas experiências dentro dos Mundos do zgcombat e importar as suas experiências para o Studio para publicação através de um plugin, mantendo a compatibilidade com o Studio.  ',
      faq_4_question: '[AI_TRANSLATION]Preciso de uma conta Roblox?\n',
      faq_4_answer: '[AI_TRANSLATION]Sim. Todos os jogadores podem inscrever-se gratuitamente em roblox.com. Não te esqueças de ligar a tua conta zgcombat e a tua conta Roblox para aceder a todas as funcionalidades e recompensas.  ',
      faq_5_question: '[AI_TRANSLATION]Vai funcionar no meu Chromebook ou dispositivo móvel?',
      faq_5_answer: '[AI_TRANSLATION]Sim. zgcombat Worlds permite-te jogar, digitar código real e criar jogos em PC, Mac, Chromebooks, tablets, telemóveis e consolas.  ',
    ...
    pd_page: {
      ...
      implementation_training_blurb: '[AI_TRANSLATION]Os educadores recebem uma formação de iniciação ao vivo e online de 60 minutos e orientação sobre como usar zgcombat ou Ozaria para apoiar objetivos institucionais e instrucionais específicos. A implementação foca-se numa visão geral do painel de professor abrangente que inclui:  ',
      ...
      ap_csp_professional_development_title: '[AI_TRANSLATION]Desenvolvimento Profissional AP CSP[NEWLINE](Com zgcombat)  ',
      ap_csp_professional_development_blurb: '[AI_TRANSLATION]Este curso online de mais de 40 horas, em grande parte autodirigido, é ideal para qualquer educador que queira preparar os seus alunos para terem sucesso no exame AP Computer Science Principles usando o zgcombat.  ',
      list_7: '[AI_TRANSLATION]Tanto este curso como o currículo AP CSP do zgcombat são endossados pelo College Board. As horas concluídas neste curso podem ser usadas para qualificar-se para crédito em educação profissional valiosa.  ',
      ...
      list_9: '[AI_TRANSLATION]Através da parceria da zgcombat com a Southern New Hampshire University (SNHU), podes ganhar até 3 créditos a nível de pós-graduação enquanto aprendes a preparar melhor os teus alunos para o exame AP CSP.\n',
