module.exports = {
  ...
  translation: {
    ...
    legal: {
      ...
      art_paragraph_2: '[AI_TRANSLATION]Se o conteúdo a ser usado não for criado pelo zgcombat, mas sim por um utilizador do codecombat.com, atribui-lhes o crédito e segue as instruções de atribuição fornecidas na descrição desse recurso, se houver.',
    ...
    parents_landing_2: {
      ...
      subscribe_error_user_type: '[AI_TRANSLATION]Parece que já te registaste para uma conta. Se estiveres interessado no zgcombat Premium, por favor contacta-nos em team@codecombat.com.',
    ...
    school_administrator: {
      ...
      add_additional_teacher: '[AI_TRANSLATION]Precisas de adicionar um professor extra? Contacta o teu gestor de conta zgcombat ou envia um email para support@codecombat.com.',
    ...
    teacher_dashboard: {
      ...
      ozaria_hs_modal_blurb: '[AI_TRANSLATION]Os educadores podem agora aceder ao AI Hackstack diretamente no **[https://codecombat.com/teachers/classes]zgcombat** usando as mesmas credenciais do Ozaria. Para maior comodidade, podes importar as tuas turmas do Ozaria para o zgcombat facilmente.  ',
    ...
    roblox_landing: {
      ...
      faq_bottom: '[AI_TRANSLATION]Ver mais <a href="https://codecombat.zendesk.com/hc/en-us/categories/18084251471383-zgcombat-Worlds-Roblox-" target="_blank">perguntas frequentes no nosso centro de ajuda</a>. <br />Se tiveres outras perguntas, <a href="mailto:support@codecombat.com">Contacta-nos</a>.',
