module.exports = {
  ...
  translation: {
    ...
    ozaria_home: {
      ...
      faq_row1_header: 'Como o Ozaria se relaciona com o zgcombat?',
      faq_row1_p: 'Ozaria é a evolução centrada na sala de aula do zgcombat, um dos jogos de programação mais populares da história. Construímos o Ozaria com base nos insights obtidos ao ensinar mais de 20 milhões de estudantes Python e JavaScript. Ozaria incorpora novos modelos pedagógicos, uma narrativa envolvente e foi projetado para ser implementado em salas de aula, tanto presenciais quanto remotas.',
    ...
    new_home: {
      title_coco: 'zgcombat - Codificando jogos para aprender Python e JavaScript',
      title_ozar: 'Ozaria - Ciência da computação que cativa',
      //    title_cn_home: "zgcombat|Python, Javascript",
      meta_keywords_coco: 'zgcombat, python, javascript, Jogos de Codificação',
      meta_keywords_ozar: 'zgcombat, python, javascript, Jogos de Codificação, Programa de Ciência da Computação, Aventura, História Épica',
      ...
      become_investor: 'Como se tornar um investidor em zgcombat',
      built_for_teachers_title: 'Um jogo de codificação construído com professores em mente',
      built_for_teachers_blurb: 'Ensinar as crianças a codificar muitas vezes pode parecer esmagadora. O zgcombat ajuda todos os educadores a ensinar os alunos a codificar em JavaScript ou Python, duas das linguagens de programação mais populares. Com um currículo abrangente que inclui seis unidades de ciência da computação e reforça o aprendizado através do desenvolvimento de jogos baseados em projetos e unidades de desenvolvimento web, as crianças progridem em uma jornada da sintaxe básica à recursão!',
      ...
      century_skills_subblurb1: 'Com quebra-cabeças de código que são naturalmente reforçados em níveis cada vez mais desafiadores, o jogo de programação da zgcombat garante que as crianças estejam sempre praticando o pensamento crítico.',
      ...
      century_skills_subblurb2: 'O zgcombat incentiva os alunos a mostrar sua criatividade construindo e compartilhando seus próprios jogos e páginas da Web.',
      ...
      creativity_rigor_blurb2: 'Cada nível do zgcombat é baseado em milhões de pontos de dados e otimizado para se adaptar a cada aluno. Os níveis de prática e dicas ajudam os alunos quando eles ficam presos e os níveis de desafio avaliam o aprendizado dos alunos durante o jogo.',
      creativity_rigor_subtitle3: 'Criado para todos os professores, independentemente da experiência',
      creativity_rigor_blurb3: 'O currículo individualizado e alinhado aos padrões da zgcombat torna o ensino da ciência da computação possível para todos. O zgcombat equipa os professores com treinamento, recursos instrucionais e suporte dedicado para se sentir confiante e bem-sucedido em sala de aula.',
      ...
      for_leaders_subblurb3: 'Se você quer construir uma classe eletiva de codificação da Escola Secundária, uma via de CTE, ou uma classe de Princípios da Ciência da Computação AP, o zgcombat é adaptado para atender às suas necessidades.',
      ...
      game_based_blurb: 'O zgcombat é um programa de ciência da computação baseado em jogos onde os alunos digitam o código real e vêem seus personagens reagirem em tempo real.',
      get_started: 'Comece',
      ...
      quotes_quote1: 'Nome qualquer programa on-line, eu tentei. Nenhum deles corresponde ao zgcombat. Qualquer professor que queira que seus alunos aprendam como programar ... comece aqui!',
      quotes_quote2: ' Fiquei surpreso com o quão fácil e intuitivo o zgcombat torna o aprendizado da ciência da computação. As pontuações no exame AP foram muito maiores do que eu esperava e acredito que o zgcombat é a razão pela qual este foi o caso.',
      quotes_quote3: 'O zgcombat tem sido o mais benéfico para ensinar aos alunos a capacidade de codificação da vida real. Meu marido é engenheiro de software e testou todos os meus programas. Ele colocou isso como sua melhor escolha.',
      quotes_quote4: 'O feedback ... foi tão positivo que estamos estruturando uma aula de ciência da computação em torno do zgcombat. O programa realmente envolve os alunos com uma plataforma de estilo de jogo que é divertida e instrutiva ao mesmo tempo. Mantenha o bom trabalho, zgcombat!',
      ...
      teachers_love_codecombat_title: 'Professores amam zgcombat',
      teachers_love_codecombat_blurb1: 'Relatam que seus alunos gostam de usar o zgcombat para aprender a codificar',
      teachers_love_codecombat_blurb2: 'Recomendariam zgcombat para outros professores de ciência da computação',
      teachers_love_codecombat_blurb3: 'Dizem que o zgcombat os ajude a apoiar as habilidades de resolução de problemas dos alunos',
      ...
      codecombat_is: 'zgcombat é uma plataforma <strong>para estudantes</strong> aprenderem ciência da computação através de um jogo real.',
      ...
      watch_how: 'Assista agora como zgcombat está transformando as vidas das pessoas de como elas aprendem ciências da computação.',
      ...
      builds_concepts_up: 'Eu gosto de como o zgcombat constrói os conceitos. É muito fácil de entender e divertido descobrir.',
      ...
      agency: 'zgcombat é um jogo que fornece aos jogadores essa ação e confiança com nosso robusto mecanisno de digitação de código, que ajuda alunos iniciantes e avançados tanto na escrita quanto na validação do código.',
      ...
      want_coco: 'Quer o zgcombat na sua escola?',
      educator: 'Educador',
      student: 'Estudante',
      ...
      //    ozaria_china_blurb: "",
      try_codecombat: 'Experimente zgcombat',
    ...
    diplomat_suggestion: {
      title: 'Ajude a traduzir o zgcombat!',
      sub_heading: 'Nós precisamos de suas habilidades linguísticas.',
      pitch_body: 'Desenvolvemos o zgcombat em Inglês, mas já temos jogadores de todo o mundo. Muitos deles querem jogar em Português Brasileiro por não falar Inglês, por isso, se você conhece os dois idiomas, por favor, considere inscrever-se no programa para Diplomata e ajude a traduzir tanto o site do zgcombat quanto todos os níveis para o Português Brasileiro.',
    ...
    play: {
      ...
      anon_signup_title_1: 'zgcombat têm',
      ...
      get_more_codecombat: 'Saiba mais sobre zgcombat',
    ...
    share_progress_modal: {
      blurb: 'Você está fazendo bastante progresso! Compartilhe com alguém o quanto você já aprendeu com o zgcombat!',
    ...
    signup: {
      ...
      email_announcements: 'Receba notícias por email sobre novos níveis e características do zgcombat.',
      ...
      teacher_type_1: 'Ensine programação usando o zgcombat!',
      ...
      want_codecombat_in_school: 'Quer jogar zgcombat todo o tempo?',
      eu_confirmation: 'Eu estou de acordo em permitir que o zgcombat armazene os meus dados em servidores dos Estados Unidos.',
    ...
    play_level: {
      ...
      tip_open_source: 'zgcombat é 100% código aberto!',
      tip_tell_friends: 'Está gostando do zgcombat? Mostre para os seus amigos!',
      tip_beta_launch: 'zgcombat lançou sua versão beta em outubro de 2013.',
      ...
      tip_open_source_contribute: 'Você pode ajudar o zgcombat a melhorar!',
    ...
    play_game_dev_level: {
      ...
      play: 'Jogar Nível',
      play_more_codecombat: 'Jogue mais zgcombat',
    ...
    subscribe: {
      ...
      thank_you: 'Obrigado por apoiar o zgcombat.',
    ...
    premium_features: {
      get_premium: 'Assine<br>zgcombat<br>Premium',
      ...
      everything_in_premium: 'Tudo o que você tem direito com o zgcombat Premium:',
    ...
    about: {
      ...
      main_description: 'No zgcombat, nosso trabalho é assegurar que você está fazendo isso com um sorriso no rosto.',
      mission_link: 'Missão',
      team_link: 'Time',
      story_link: 'História',
      press_link: 'Contato',
      mission_title: 'Nossa missão: fazer programação acessível para todos os estudantes.',
      mission_description_1: '<strong>Programação é mágica</strong>. É a habilidade de criar coisas apartir da pura imaginação. Criamos o zgcombat para dar aos alunos a sensação de poder de um mago na ponta de seus dedos enquanto <strong>digita códigos</strong>.',
      ...
      team_title: 'Conheça o time do zgcombat',
      ...
      story_subtitle: 'Desde 2013, o zgcombat cresceu de um mero conjunto de esboços para um jogo vivo e próspero.',
      story_statistic_1a: '20,000,000+',
      story_statistic_1b: 'jogadores no total',
      story_statistic_1c: 'Começaram sua jornada de programação através do zgcombat',
      ...
      jobs_title: 'Venha trabalhar conosco e ajudar a escrever a história do zgcombat!',
      ...
      jobs_custom_description: 'Você é apaixonado pelo zgcombat, mas não vê um emprego listado que corresponda às suas qualificações? Escreva-nos e mostre como você acha que pode contribuir com a nossa equipe. Gostaríamos de ouvir de você!',
    ...
    teachers_quote: {
      ...
      state: 'Estado',
      country: 'País',
      num_students_help: 'Quantos alunos usarão o zgcombat?',
      ...
      thanks_sub_header_coco: 'Obrigado por manifestar interesse no zgcombat para sua escola.',
      thanks_sub_header_ozar: 'Obrigado por manifestar interesse no zgcombat para sua escola.',
      ...
      learn_more_modal: 'As contas de professores no zgcombat têm a capacidade de monitorar o progresso do aluno, atribuir licenças e gerenciar salas de aula. As contas de professor não podem fazer parte de uma sala de aula - se você estiver matriculado em uma turma usando essa conta, não poderá mais acessá-la depois de atualizar para uma conta do professor.',
      create_account: 'Crie uma conta de professor',
      create_account_subtitle: 'Tenha acesso a ferramentas exclusivas de professores para usar o zgcombat na sala de aula.  <strong>Configure uma turma</strong>, adicione seus alunos, e <strong>monitore seu progresso.</strong>!',
    ...
    contact: {
      ...
      subscribe: 'compre uma assinatura de zgcombat',
      subscribe_suffix: 'e teremos prazer em te ajudar com seu código.',
      subscriber_support: 'Desde que você seja um assinante zgcombat, seu e-mail será nossa prioridade de resposta.',
    ...
    account_settings: {
      ...
      email_announcements_description: 'Receba emails com as últimas notícias e desenvolvimentos do zgcombat.',
      email_notifications: 'Notificações',
      email_notifications_summary: 'Controles para notificações por email, automáticas e personalizadas, relacionadas a sua atividade no zgcombat.',
    ...
    community: {
      main_title: 'Comunidade zgcombat',
      ...
      level_editor_prefix: 'Use o zgcombat',
      ...
      article_editor_suffix: 'e ajude os jogadores do zgcombat a aproveitar o máximo de seu jogo.',
      ...
      social_blog: 'Leia o blog do zgcombat no Sett',
      social_discource: 'Entre na discussão no nosso Fórum',
      social_facebook: 'Curta o zgcombat no Facebook',
      social_twitter: 'Siga o zgcombat no Twitter',
      social_slack: 'Converse conosco usando o canal público Slack do zgcombat',
    ...
    courses: {
      ...
      ask_teacher_for_code_coco: 'Pergunte ao seu professor se você tem o código de uma turma do zgcombat! Se sim, insira - o abaixo:',
      ask_teacher_for_code_ozar: 'Pergunte ao seu professor se você tem o código de uma turma do zgcombat! Se sim, insira - o abaixo:',
      ...
      update_account_confirm_update_student2: 'Você não poderá gerenciar nenhuma turma que tenha criado anteriormente ou criar novas turmas. Suas turmas criadas anteriormente serão removidas do zgcombat e não poderão ser restauradas.',
      instructor: 'Instrutor: ',
      youve_been_invited_1: 'Você foi convidado para se juntar ',
      youve_been_invited_2: ', onde você aprenderá ',
      youve_been_invited_3: ' com seus colegas no zgcombat.',
      ...
      license_required_to_play_coco: 'Peça ao seu professor para atribuir uma licença a você para que você possa continuar a jogar zgcombat!',
      license_required_to_play_ozar: 'Peça ao seu professor para atribuir uma licença a você para que você possa continuar a jogar zgcombat!',
    ...
    teacher: {
      ...
      teacher_account_explanation: 'Uma conta do zgcombat de Professor permite criar turmas, monitorar os alunos, gerenciar os cursos, gerenciar as licenças e acessar recursos para a construção de suas aulas.',
      ...
      pacing_guides_desc: 'Aprenda como incorporar todos os recursos da zgcombat para planejar seu ano letivo!',
      ...
      educator_faq_desc: 'Perguntas frequentes sobre o uso do zgcombat em sua sala de aula ou escola.',
      teacher_getting_started: 'Guia de Iniciação do Professor',
      teacher_getting_started_desc: 'Novo no zgcombat? Faça o download deste Guia de primeiros passos do professor para configurar sua conta, criar sua primeira turma e convidar os alunos para o primeiro curso.',
      student_getting_started: 'Guia Rápido do Aluno',
      student_getting_started_desc: 'Você pode distribuir este guia para seus alunos antes de iniciar o zgcombat para que eles possam se familiarizar com o editor de código. Este guia pode ser usado para aulas de Python e JavaScript.',
      ...
      hoc_intro: 'Existem três maneiras de sua classe participar da Hora do Código com o zgcombat',
      hoc_self_led: 'Jogo autônomo',
      hoc_self_led_desc: 'Os alunos podem jogar através de dois tutoriais Hour of Code zgcombat por conta própria',
      ...
      hoc_additional_desc1: 'Para recursos e atividades adicionais da zgcombat, consulte nosso',
      ...
      teacher_quest_teach_methods_step2: 'Imprima o [Student Quick Start Guide](https://files.flsong.iok.la/docs/resources/StudentQuickStartGuide.pdf) em Recursos do Professor.',
      ...
      teacher_quest_kithgard_gates_100_step2: 'Oriente os alunos a pensarem sobre problemas difíceis usando [Engineering Cycle Worksheet](https://files.flsong.iok.la/docs/resources/EngineeringCycleWorksheet.pdf).',
      ...
      teacher_quest_done: 'Quer que seus alunos aprendam ainda mais sobre programação? Entre em contato com nosso [school specialists](mailto:schools@flsong.iok.la) hoje!',
    ...
    classes: {
      ...
      archmage_summary: 'Se você é um desenvolvedor interessado em programar jogos educacionais, seja um arquimago e ajude-nos a construir zgcombat!',
      ...
      diplomat_summary: 'zgcombat está disponível em mais de 45 idiomas graças aos nossos Diplomatas. Nos ajude você também, contribuindo com as traduções.',
      ambassador_title: 'Embaixador',
      ambassador_title_description: '(Suporte)',
      ambassador_summary: 'Acalme nossos usuários do fórum e forneça uma direção para suas dúvidas. Nossos embaixadores representam zgcombat no mundo todo.',
    ...
    contribute: {
      ...
      scribe_introduction_pref: 'O zgcombat não será apenas um monte de níveis. Ele também irá incluir uma fonte de conhecimento, um wiki de conceitos de programação que os níveis podem se basear. Dessa forma, em vez de cada Artesão ter que descrever em detalhes o que é um operador de comparação, eles podem simplesmente criar um link para o artigo que o descreve. Algo na linha do que a ',
      ...
      diplomat_introduction_suf: 'é que há um interesse considerável no zgcombat em outros países, especialmente no Brasil! Estamos construindo um corpo de tradutores ansiosos para transformar um conjunto de palavras em outro conjunto de palavras para tornar o zgcombat tão acessível em todo o mundo quanto for possível. Se você gosta de obter cenas inéditas do próximo conteúdo e obter esses níveis para os seus compatriotas o mais rápido possível, então esta classe pode ser para você.',
      ...
      ambassador_introduction: 'Esta é uma comunidade que estamos construindo, e vocês são as conexões. Temos chats Olark, emails e redes sociais com muitas pessoas para conversar e ajudar a se familiarizar com o jogo e aprender. Se você quer ajudar as pessoas a se envolver e se divertir, e ter uma boa noção da pulsação do zgcombat e para onde estamos indo em seguida, esta classe pode ser para você.',
    ...
    user: {
      user_title: '__name__ - Aprenda a programar com zgcombat',
      stats: 'Estatísticas',
    ...
    account: {
      ...
      status_unsubscribed: 'Ganhe acesso a novos níveis, heróis, itens, e gemas bônus com uma assinatura zgcombat!',
      ...
      unsubscribe_from_marketing: 'Cancelar a inscrição de e-mails de marketing do zgcombat para __email__ ?',
    ...
    account_prepaid: {
      ...
      purchase_code1: 'Os códigos de assinatura podem ser resgatados para adicionar tempo de assinatura premium a uma ou mais contas para a Home Version do zgcombat.',
      purchase_code2: 'Cada conta do zgcombat só pode resgatar um código de assinatura específico.',
      purchase_code3: 'Os meses do Código de Assinatura serão adicionados ao final de qualquer assinatura existente na conta.',
      purchase_code4: 'Códigos de Assinatura são para contas que jogam a versão Home do zgcombat, eles não podem ser usados no lugar de Licenças de Estudante para a versão do Sala de Aula.',
    ...
    anonymous_teacher: {
      ...
      teacher_notified: 'Nós notificamos o seu professor que você quer jogar mais zgcombat na sua sala de aula!',
    },
    ...
    legal: {
      page_title: 'Jurídico',
      opensource_introduction: 'O zgcombat faz parte da comunidade de código aberto.',
      opensource_description_prefix: 'Confira ',
      github_url: 'nosso GitHub',
      opensource_description_center: 'e ajude-nos se você gostar! zgcombat é construído a partir de dúzias de projetos de código aberto, e nós amamos eles. Veja ',
      ...
      client_code_description_prefix: 'Todo o código do lado do cliente para flsong.iok.la no repositório público GitHub e no banco de dados flsong.iok.la, é licenciado sob o',
      mit_license_url: 'Licença do MIT',
      code_description_suffix: 'Isso inclui todo o código nos sistemas e componentes que são disponibilizados pelo zgcombat para o propósito de criar níveis.',
      art_title: 'Arte/Música - Creative Commons ',
      art_description_prefix: 'Todo o conteúdo comum está disponível sob a',
      cc_license_url: 'Creative Commons Attribution 4.0 International License',
      art_description_suffix: 'Conteúdo comum é qualquer coisa disponível pelo zgcombat com o propósito de criar níveis. Isto inclui:',
      art_music: 'Música',
      art_sound: 'Som',
      ...
      art_paragraph_1: 'Para atribuição, por favor, nomeie e referencie o flsong.iok.la perto de onde a fonte é utilizada, ou onde for apropriado para o meio. Por exemplo:',
      use_list_1: 'Se usado em um filme ou outro jogo, inclua flsong.iok.la nos créditos.',
      use_list_2: 'Se usado em um site, incluir um link perto do local de uso, por exemplo, em baixo de uma imagem, ou em uma página de atribuições gerais onde você pode também mencionar outros trabalhos em Creative Commons e softwares de código aberto que estão sendo usados no site.Algo que já está referenciando claramente o zgcombat, como um post no blog mencionando o zgcombat, não precisa de atribuição separada.',
      art_paragraph_2: 'Se o conteúdo que está sendo usado não é criado pelo zgcombat mas por algum usuário do flsong.iok.la, você deve referenciá-los seguindo as normas contidas neste documento caso haja alguma.',
      ...
      third_party_description: 'zgcombat usa os seguintes serviços de terceiros(entre outros):',
    ...
    ladder_prizes: {
      ...
      in_cash: 'Em dinheiro',
      custom_wizard: 'Assistente Personalizado do zgcombat',
      custom_avatar: 'Avatar Personalizado do zgcombat',
    ...
    apcsp: {
      ...
      syllabus_description: 'Use este recurso para planejar o currículo do zgcombat para a aula de Princípios de Ciência da Computaçã.',
