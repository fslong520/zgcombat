module.exports = {
  ...
  translation: {
    ...
    diplomat_suggestion: {
      ...
      pitch_body: "We develop zgcombat in English, but we already have players all over the world. Many of them want to play in Uzbek but don't speak English, so if you can speak both, please consider signing up to be a Diplomat and help translate both the zgcombat website and all the levels into Uzbek.",
