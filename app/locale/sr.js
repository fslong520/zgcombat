module.exports = {
  ...
  translation: {
    ...
    legal: {
      ...
      art_paragraph_2: 'ако садржај који се користи није направљен од стране zgcombat-а већ од корисника codecombat.com-а, наведи их уместо тога и следи смер атрибуције у опису ресурса ако постоји.',
