module.exports = {
  ...
  translation: {
    ...
    new_home: {
      ...
      codecombat_is: 'zgcombat је платформа <strong>за ученике</strong> да науче компјутерске науке док играју праву игру.',
      ...
      watch_how: 'Гледај како zgcombat мења начин на који људи уче компјутерске науке.',
      ...
      builds_concepts_up: 'Свиђа ми се како се уз помоћ zgcombat-а изграђују концепти. Заиста је једноставно и забавно да се нови концепти укапирају.',
      ...
      agency: 'zgcombat је игра која даје играчима прилику да непосредно делају и стекну самопоуздање, захваљујући нашим робустним системом за проверу типова, који помаже подједнако и почетном и напредном ученику да пише правилан, валидан код.',
      ...
      want_coco: 'Желиш zgcombat у својој школи?',
      //    educator: "Educator",
      //    student: "Student",
    ...
    diplomat_suggestion: {
      title: 'Помози нам у превођењу zgcombat-а!',
      sub_heading: 'Потребне су нам твоје језичке способности.',
      pitch_body: 'Развијамо zgcombat на енглеском језику, али већ имамо играче из целог света. Многи од њих желе да играју на српском језику јер не говоре енглески, па ако говориш оба, молимо те да размислиш о томе да нам помогнеш да преведемо zgcombat сајт, као и све нивое на српски.',
    ...
    play: {
      ...
      get_more_codecombat: 'Добиј још zgcombat-а',
    ...
    share_progress_modal: {
      blurb: 'Правиш одличан напредак! Реци свом родитељу колико си научио са zgcombat-ом.',
    ...
    signup: {
      ...
      teacher_type_1: 'Учите ђаке програмирању користећи zgcombat!',
      ...
      want_codecombat_in_school: 'Желиш ли да играш zgcombat све време?',
      eu_confirmation: 'Пристајем да допустим zgcombat-у да чува моје податке на америчким серверима.',
    ...
    play_level: {
      ...
      explore_codecombat: 'Истражи zgcombat',
      ...
      tip_open_source: 'zgcombat је 100% отворен код!',
      tip_tell_friends: 'Уживаш у zgcombat-у? Реци својим пријатељима о нама!',
      tip_beta_launch: 'zgcombat је покренуо своју бета верзију у октобру, 2013. године.',
      ...
      tip_open_source_contribute: 'Можеш да помогнеш да се zgcombat побољша!',
    ...
    play_game_dev_level: {
      ...
      play: 'Играј ниво',
      play_more_codecombat: 'Играј више zgcombat',
    ...
    subscribe: {
      ...
      confirmation: 'Честитамо! Сада имаш zgcombat премијум претплату!',
      premium_already_subscribed: 'Већ си претплачен на премијум!',
      subscribe_modal_title: 'zgcombat премијум',
      comparison_blurb: 'Унапреди своје вештине са zgcombat претплатом!',
      ...
      thank_you: 'Хвала што подржаваш zgcombat.',
    ...
    premium_features: {
      get_premium: 'Прими<br>zgcombat<br>премијум',
      ...
      everything_in_premium: 'Све што добијаш у zgcombat премијуму:',
    ...
    about: {
      ...
      main_description: 'У zgcombat-у, наш посао је да будемо сигурни да то радиш с осмехом на лицу.',
      mission_link: 'Мисија',
      team_link: 'Тим',
      story_link: 'Прича',
      press_link: 'Штампа',
      mission_title: 'Наша мисија: да учинимо програмирање доступним сваком ученику на планети.',
      mission_description_1: '<strong>Програмирање је магично</strong>. То је могућност да створиш ствари из чисте маште. Ми смо покренули zgcombat да бисмо дали ученицима осећај чаробњачке моћи на дохват руке користећи <strong>куцани код</strong>.',
      ...
      team_title: 'Упознај zgcombat тим',
      ...
      community_subtitle: 'Преко 450 сарадника је помогло да се изгради zgcombat и још њих се придружује сваке недеље!',
      community_description_3: 'zgcombat је',
      community_description_link_2: 'пројекат заједнице',
      community_description_1: 'zgcombat је пројекат заједнице, са стотинама играча који волонтирају да праве нивое, доприносе нашем коду да додају функције, исправљају грешке, тестирају игру и чак и преводе игру на (до сад) 50 језика. Запослени, сарадници и сајт добијају путем дељења идеја и удруживањем напора, као и заједница отвореног кода у глобалу. Сајт је изграђен на бројним пројектима отвореног кода и ми смо отвореног кода како бисмо вратили заједници и пружили радозналим-за-код играчима познати пројекат за истраживање и експериментисање. Свако може да се прикључи zgcombat заједници! Погледај нашу',
      ...
      story_subtitle: 'Од 2013. године, zgcombat је израстао из обичних скупова скица у праву успешну игру.',
      story_statistic_1a: 'Више од 20.000.000',
      story_statistic_1b: 'играча укупно',
      story_statistic_1c: 'је започело своје програмерско путовање кроз zgcombat',
      ...
      jobs_title: 'Дођи да радиш са нама и помози нам да напишемо zgcombat историју!',
      ...
      jobs_custom_description: 'Да ли си заинтересован за zgcombat али не видиш од наведених послова ниједан који одговара твојим квалификацијама? Пиши нам и покажи нам како мислиш да можеш да допринесеш нашем тиму. Волели бисмо да нам се јавиш!',
    ...
    teachers_quote: {
      ...
      country: 'Држава',
      num_students_help: 'Колико ученика очекујеш да се упишу на zgcombat?',
      ...
      thanks_sub_header_coco: 'Хвала на интересовању за zgcombat за твоју школу.',
      thanks_sub_header_ozar: 'Хвала на интересовању за zgcombat за твоју школу.',
      ...
      learn_more_modal: 'Наставнички налози на zgcombat-у имају могућност посматрања напретка ученика, додељивања уписа и управљања разредима. Наставнички налози не могу бити део разреда - ако си тренутно уписан у разред преко овог налога, нећеш више моћи да му приступиш кад ажурираш у Наставнички налог.',
      create_account: 'Направи наставнички налог',
      create_account_subtitle: 'Добиј приступ алатима само за наставнике за коришћење zgcombat-а у учионици.  <strong>Подеси разред</strong>, додај своје ученике и <strong>посматрај њихов напредак</strong>!',
    ...
    contact: {
      contact_us: 'Контактирај zgcombat',
      ...
      subscribe: 'купиш zgcombat претплату',
      subscribe_suffix: 'и радо ћемо ти помоћи у твом коду.',
      subscriber_support: 'Пошто си zgcombat претплатник, твој и-мејл ће имати приоритет у нашој подршци.',
    ...
    account_settings: {
      ...
      email_announcements_description: 'Прими и-мејл за најновије вести и достигнућа на zgcombat-у',
      email_notifications: 'Обавештења',
      email_notifications_summary: 'Контроле за персонализована, аутоматска и-мејл обавештења вазана за твоју zgcombat активност.',
    ...
    community: {
      ...
      level_editor_prefix: 'Користи zgcombat',
      ...
      thang_editor_suffix: 'да модификујеш zgcombat изворне илустрације. Дозволи јединицама да бацају пројектиле, измени дирекцију анимације, промени хит поене јединице или отпреми сопствене векторске спрајтове.',
      ...
      article_editor_suffix: 'и помози zgcombat играчима да добију највише од свог играња.',
      ...
      social_blog: 'Читај zgcombat блог на Sett-у',
      social_discource: 'Придружи се дискусији на нашем Discourse форуму',
      social_facebook: 'Лајкуј zgcombat на Фејсбуку',
      social_twitter: 'Запрати zgcombat на Твитеру',
      social_slack: 'Ћаскај са нама на јавном zgcombat Slack каналу',
    ...
    courses: {
      ...
      ask_teacher_for_code_coco: 'Питај свог наставника да ли имаш zgcombat код за разред! Ако имаш, унеси га испод:',
      ask_teacher_for_code_ozar: 'Питај свог наставника да ли имаш zgcombat код за разред! Ако имаш, унеси га испод:',
      ...
      update_account_confirm_update_student2: 'Нећеш моћи да управљаш часовима које си претходно направио или да направиш нове часове. Твоји претходно направљени часови ће бити уклољени са zgcombat-а и неће моћи да се поврате.',
      instructor: 'Инструктор:',
      youve_been_invited_1: 'Позван си да се учланиш',
      youve_been_invited_2: ', где ћеш учити',
      youve_been_invited_3: 'са својим пријатељима из разреда zgcombat.',
      ...
      license_required_to_play_coco: 'Тражи од наставнка да ти додели лиценцу како би наставио да играш zgcombat!',
      license_required_to_play_ozar: 'Тражи од наставнка да ти додели лиценцу како би наставио да играш zgcombat!',
    ...
    teacher: {
      ...
      teacher_account_explanation: 'zgcombat наставнички налог ти допушта да подесиш учионице, надгледаш напредак ученика док похађају курсеве, управљаш лиценцама и приступаш ресурсима за помоћ при стварању твог наставног плана. ',
      ...
      pacing_guides_desc: 'Научи како да уврстиш све zgcombat ресурсе за планирање школске године!',
      ...
      educator_faq_desc: 'Често постављена питања о коришћењу zgcombat-а у твојој учионици или школи.',
      teacher_getting_started: 'Водич за започињање за наставника',
      teacher_getting_started_desc: 'Нов си на zgcombat-у? Преузми овај водич за започињање за наставника да направиш свог налог, свој први час и да позовеш ученике на први курс.',
      student_getting_started: 'Водич за брзо започињање за ученика',
      student_getting_started_desc: 'Можеш да поделиш овај водич ученицима пре него што отпочнеш zgcombat да би могли да се упознају са уређивачем кода. Овај водич може да се користи и за Python и за JavaScript учионице.',
      ...
      hoc_intro: 'Постоји три начина да твој разред учествује у Сату кода уз zgcombat',
      hoc_self_led: 'Самоиницијативна игра',
      hoc_self_led_desc: 'Ученици могу да играју два Сата кода zgcombat туторијала сами',
      ...
      hoc_additional_desc1: 'За додатне zgcombat ресурсе и активности, погледај наш',
      ...
      teacher_quest_teach_methods_step2: 'Одштампај [Водич за брзи почетак за ученика](https://files.flsong.iok.la/docs/resources/StudentQuickStartGuide.pdf) из ресурса.',
      ...
      teacher_quest_kithgard_gates_100_step2: 'Упути ученике како да размишљају о тешким проблемима користећи [Вежбанка за циклус инжењерства](https://files.flsong.iok.la/docs/resources/EngineeringCycleWorksheet.pdf).',
      ...
      teacher_quest_done: 'Желиш ли да твоји ученици науче још кодова? Контактирај наш [школски специјалисти](mailto:schools@flsong.iok.la) today!',
    ...
    classes: {
      ...
      archmage_summary: 'Ако си програмер који је заинтересован за едукативне игре кодирања, постани врховни мађионичар да би нам помогао да направимо zgcombat!',
      ...
      diplomat_summary: 'zgcombat је локализован у 45+ језика од стране наших дипломата. Помози нам и пошаљи преводе.',
      ambassador_title: 'Амбасадор',
      ambassador_title_description: '(Подршка)',
      ambassador_summary: 'Укроти наше кориснике форума и понуди смер за оне са питањима. Наши амбасадори представљају zgcombat свету.',
      teacher_title: 'Наставник',
    },

    editor: {
      main_title: 'zgcombat уредници',
    ...
    contribute: {
      ...
      scribe_introduction_pref: 'zgcombat неће бити само гомила нивоа. Такође ће укључивати ресурсе за знање, wiki концепте за програмирање које нивои могу да пређу. На такав начин сваки уметник уместо да опише детаљно шта је оператер за упоређивање, може да повеже свој ниво са чланком који га описује а који је већ написан зарад образовање играча. Нешто слично',
      ...
      diplomat_introduction_suf: 'то је да постоји знатно интересовање за zgcombat у другим земљама! Градимо скуп преводилаца који једва чекају да преокрену један пакет речи у други како би zgcombat био доступан широм света. Ако желиш да примиш кратке увиде у предстојећи садржај и да твоји сународници добију ове нивое што је пре могуће, онда је овај час можда за тебе.',
      ...
      ambassador_introduction: 'Ово је заједница коју градимо и ти си веза. Имамо форуме, и-мејлове и друштвене мреже са пуно људи са којима разговарамо и који нам помажу са игром. Ако желиш да помогнеш да се људи укључе и забаве и да осетиш импулс zgcombat-а и шта нам је циљ, онда је овај час можда за тебе.',
    ...
    account: {
      ...
      status_unsubscribed: 'Приступи новим нивоима, херојима, стварима и додатним драгуљима са zgcombat претплатом!',
      ...
      unsubscribe_from_marketing: 'Поништи претплату __email__ са свих zgcombat маркетиншких и-мејлова?',
    ...
    account_prepaid: {
      ...
      purchase_code1: 'Претплатни кодови могу да се искористе за додавање премијум претплате на један или више налога за zgcombat верзију за кућу.',
      purchase_code2: 'Сваки zgcombat налог може да искористи одређени код за претплату једном. ',
      purchase_code3: 'Месечни претплатни кодови ће се додати на крају постојеће претплате на налог. ',
      purchase_code4: 'Претплатни кодови су за налоге који играју zgcombat код куће, не могу да се користе уместо ученичких лиценци за верзију учионице.',
    ...
    anonymous_teacher: {
      ...
      teacher_notified: 'Обавестили смо твог наставника да желиш да играш више zgcombat-а у учионици!',
    },
    ...
    legal: {
      ...
      opensource_description_center: 'и помози ако желиш! zgcombat је саграђен на десетинама пројеката отвореног извора и ми их волимо. Погледај ',
      ...
      code_description_suffix: 'Ово укључује све кодове у системима и компонентама који су доступни од стране zgcombat-а зарад прављења нивоа.',
      ...
      art_description_suffix: 'Заједнички садржај је било шта што је опште доступно од стране zgcombat-а зарад прављења нивоа. Ово укључује:',
      art_music: 'музику',
      art_sound: 'звук',
      ...
      art_paragraph_1: 'За атрибуцију, молимо да именујеш и повежеш се на flsong.iok.la у близини извора где се користи или где одговара за медијум. На пример:',
      use_list_1: 'ако се користи на филму или у другој игри, укључи flsong.iok.la у шпицу.',
      use_list_2: 'ако се користи на вебсајту, укључи линк близу коришћења, на пример испод слике, или на општој страни атрибута где можеш да поменеш друге Creative Commons радове и софтвер отвореног извора који се користи на сајту. Нешто што већ јасно указује на zgcombat, као што је блог објава која помиње zgcombat, не захтева одвојену атрибуцију.',
      art_paragraph_2: 'ако садржај који се користи није направљен од стране zgcombat-а већ од корисника flsong.iok.la-а, наведи их уместо тога и следи смер атрибуције у опису ресурса ако постоји.',
      ...
      nutshell_description: 'Било који ресурси које понудимо у нивоу уређивача су бесплатни за коришћење за креирање нивоа. Али задржавамо право да ограничимо дистрибуцију самих нивоа (који су направљени на flsong.iok.la-у) тако да могу да се наплате.',
      ...
      third_party_description: 'zgcombat користи следеће услуге других лица (између осталих):',
      cookies_message: 'zgcombat користи неколико основних и не-основних колачића.',
    ...
    ladder_prizes: {
      ...
      in_cash: 'у готовини',
      custom_wizard: 'Прилагођен zgcombat мађионичар',
      custom_avatar: 'Прилагођен zgcombat аватар',
    ...
    apcsp: {
      ...
      syllabus_description: 'Користи овај ресурс за планирање zgcombat наставног плана за твој час AP принципа компјутерске науке.',
