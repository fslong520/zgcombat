module.exports = {
  ...
  translation: {
    ...
    new_home: {
      ...
      agency: 'zgcombat is een game die de mogelijkheid en het zelfvertrouwen geeft om met echte code te werken, wat zowel beginners als gevorderde helpt bij het schrijven van goede, valide code.',
    ...
    signup: {
      ...
      account_exists: 'Dit e-mailadres bestaat al:',
      sign_in: 'Log in',
    ...
    teacher: {
      ...
      teacher_dashboard: 'Docenten Dashboard',
      my_classes: 'Mijn Klassen',
      ...
      teacher_account_explanation: 'Een zgcombat Docentenaccount geeft je de mogelijkheid om klassen aan te maken, voortgang van leerlingen te bekijken terwijl ze de cursussen volgen, inschrijvingen te beheren en hulpmiddelen te gebruiken voor het opzetten van een leerplan',
      ...
      teacher_quest_teach_methods_step2: 'Print de [Snelle Startgids voor Studenten](https://files.flsong.iok.la/docs/resources/StudentQuickStartGuide.pdf) in de Resource Hub.',
      ...
      teacher_quest_kithgard_gates_100_step2: 'Begeleid studenten om door moeilijke problemen heen te denken door de [Engineering Cycle Worksheet](https://files.flsong.iok.la/docs/resources/EngineeringCycleWorksheet.pdf)te gebruiken.',
    ...
    account: {
      ...
      status_unsubscribed: 'Krijg toegang tot nieuwe levels, helden, items, en bonus edelstenen met een abonnement op zgcombat!',
    ...
    apcsp: {
      ...
      syllabus_description: 'Gebruik dit hulpmiddel om het zgcombat-curriculum (leerplan) te plannen voor uw informaticales. Begrippen worden niet vertaald naar het Nederlands.',
