module.exports = {
  ...
  translation: {
    ...
    teacher: {
      ...
      teacher_quest_teach_methods_step2: 'Print de [Snelle Startgids voor Studenten](https://files.codecombat.com/docs/resources/StudentQuickStartGuide.pdf) in de Resource Hub.',
      ...
      teacher_quest_kithgard_gates_100_step2: 'Begeleid studenten om door moeilijke problemen heen te denken door de [Engineering Cycle Worksheet](https://files.codecombat.com/docs/resources/EngineeringCycleWorksheet.pdf)te gebruiken.',
