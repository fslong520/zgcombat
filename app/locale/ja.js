module.exports = {
  ...
  translation: {
    ...
    teacher_dashboard: {
      ...
      ozaria_hs_modal_blurb: '教師はOzariaと同じ資格情報を使用して、**[https://codecombat.com/teachers/ai-league]zgcombat**からAI Hackstackに直接アクセスできます。Ozariaからクラスを簡単にインポートできます。',
      ozaria_ai_league_modal_title: 'zgcombatからAI Leagueにアクセス',
      ozaria_ai_league_modal_blurb: '教師はOzariaと同じ資格情報を使用して、**[https://codecombat.com/teachers/ai-league]zgcombat**からAI Leagueに直接アクセスできます。Ozariaからクラスを簡単にインポートできます。',
