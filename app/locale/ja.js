module.exports = {
  ...
  translation: {
    ...
    ozaria_home: {
      ...
      faq_header: 'よくある質問',
      faq_row1_header: 'Ozariaはzgcombatとどのように関係していますか？',
      faq_row1_p: 'Ozariaは、歴史上最も人気のあるコーディングゲームの1つであるzgcombatの教室中心の進化形です。PythonとJavaScriptを学ぶ2000万人以上の学習者に教えた知見をもとにOzariaを構築しました。Ozariaは、新しい教育モデルと没入型のストーリー主導のナラティブを取り入れ、教室で実施されることを想定して、対面授業と遠隔学習の両方の設定で使用できるように設計されました。',
    ...
    new_home: {
      title_coco: 'zgcombat - PythonとJavaScriptを学ぶコーディングゲーム',
      title_ozar: 'zgcombat - PythonとJavaScriptを学ぶコーディングゲーム',
      title_cn_home: 'zgcombat|Python, Javascript',
      meta_keywords_coco: 'zgcombat, Python, Javascript, コーディングゲーム',
      meta_keywords_ozar: 'zgcombat, Python, Javascript, コーディングゲーム, コンピューターサイエンスプログラム, アドベンチャー, エピックストーリー',
      ...
      become_investor: 'zgcombatの投資家になる',
      built_for_teachers_title: '教師のために作られたコーディングゲーム',
      built_for_teachers_blurb: '子供たちにコーディングを教えることは、しばしば圧倒的に感じることがあります。zgcombatは、すべての教育者がJavaScriptやPythonといった最も人気のあるプログラミング言語で生徒にコードを教える手助けをします。6つのコンピューターサイエンスユニットを含む包括的なカリキュラムと、プロジェクトベースのゲーム開発やウェブ開発ユニットを通じて学習を強化することで、子供たちは基本的な構文から再帰までの道のりを進んでいきます。',
      ...
      century_skills_subblurb1: '自然に段階的により難しいレベルにスカフォールドされたコーディングパズルがあるため、zgcombatのプログラミングゲームでは子供たちは常に批判的思考を練習しています。',
      century_skills_quote2: 'みんなが迷路を作っていたので、「フラッグを取る」と思い、それをやりました。',
      century_skills_subtitle2: '創造力',
      century_skills_subblurb2: 'zgcombatは、生徒が自分たちのゲームやウェブページを作成して共有することで、創造力を発揮するように促します。',
      ...
      creativity_rigor_blurb2: 'zgcombatの各レベルは、何百万ものデータポイントに基づいて段階的に構築され、各学習者に適応するように最適化されています。練習レベルとヒントが、生徒が詰まったときに助けとなり、チャレンジレベルでゲームを通じて生徒の学習を評価します。',
      creativity_rigor_subtitle3: '経験の有無に関わらず、すべての教師向けに作られています',
      creativity_rigor_blurb3: 'zgcombatの自己学習型、基準に沿ったカリキュラムは、誰でもコンピューターサイエンスを教えることができるようになります。zgcombatは、教師に研修、教材、専用のサポートを提供し、教室で自信を持って成功を収めることができるようになります。',
      ...
      for_leaders_subblurb3: '中学校のコーディング選択科目、職業訓練教育（CTE）の進路、またはAPコンピューターサイエンスの原則クラスを構築したい場合、zgcombatはあなたのニーズに合わせて調整されています。',
      ...
      game_based_blurb: 'zgcombatは、生徒が実際のコードを入力し、キャラクターがリアルタイムで反応するゲームベースのコンピューターサイエンスプログラムです。',
      get_started: 'はじめに',
      ...
      quotes_quote1: 'オンラインのあらゆるプログラムを挙げてください。私は試しています。それらのどれもzgcombatとOzariaには敵いません。生徒にコーディングを学ばせたい先生はここから始めてください！',
      quotes_quote2: 'zgcombatがどれだけ簡単で直感的にコンピューターサイエンスを学ぶことができるのかに驚きました。AP試験のスコアは私が予想したよりもはるかに高く、その理由はzgcombatだと信じています。',
      quotes_quote3: 'zgcombatは、私の生徒たちに現実のコーディング能力を教える上で最も有益でした。私の夫はソフトウェアエンジニアで、私のプログラムをすべて試してきました。彼はこれをトップの選択肢としています。',
      quotes_quote4: 'フィードバックは非常に肯定的であり、zgcombatを中心にコンピューターサイエンスのクラスを構築しています。このプログラムは、エンターテイメントと指導が同時に行われるゲームスタイルのプラットフォームで、生徒たちを魅了します。zgcombatの良い仕事を続けてください！',
      quotes_quote5: 'クラスは毎週土曜日の朝7時に始まりますが、息子はとても興奮して私よりも早く目を覚まします！zgcombatは、息子がコーディングスキルを向上させるための道筋を作ります。',
      ...
      teachers_love_codecombat_title: '先生方はzgcombatが大好き',
      teachers_love_codecombat_blurb1: '生徒たちがzgcombatを使ってコーディングを学ぶのを楽しんでいると報告しています',
      teachers_love_codecombat_blurb2: '他のコンピューターサイエンスの先生にzgcombatをお勧めするでしょう',
      teachers_love_codecombat_blurb3: 'zgcombatは、生徒たちの問題解決能力をサポートするのに役立っていると言います',
      ...
      top_banner_blurb_roblox: '新！zgcombatがRobloxに登場！',
      top_banner_blurb_roblox_teachers: '新！zgcombatはRoblox Educationと提携しました！',
      ...
      top_banner_blurb_demo_day_10_20: '10月20日（木）午後4時（CDT）にzgcombat＆Ozariaのお化け屋敷デモにご参加ください。',
      ...
      codecombat_is: 'zgcombatは<strong>生徒のための</strong>実際にゲームを遊びながらコンピュータサイエンスを学べるプラットフォームです',
      our_courses: 'これまでのプログラミング経験がほとんどまたはまったくない教師の場合でも、我々のコースは<strong>教室で優秀になる</strong>ために特別にテストされています。',
      watch_how: 'zgcombatが、人々がコンピュータサイエンスを学ぶ方法をどのように変えているかをご覧ください。',
      ...
      builds_concepts_up: 'zgcombatが概念を積み上げていくやり方が好きです。本当に分かりやすくて、問題を解くのが楽しいです。',
    ...
    diplomat_suggestion: {
      title: 'zgcombatの翻訳にご協力ください！',
      sub_heading: 'あなたの言語力が必要です。',
      pitch_body: 'zgcombatは英語で開発されています。日本語でプレイしたい方がたくさんいますが、ゲームの多くはまだ英語のままです。なのでもし両方話せるなら、外交官（翻訳者）として登録し、zgcombatのwebサイト等を日本語に翻訳するのを手伝ってください！',
    ...
    new_home_faq: {
      ...
      main_curriculum: 'zgcombatまたはOzariaを主なカリキュラムとして使用できますか？',
      main_curriculum_blurb: 'もちろんです！zgcombatやOzariaを主なコンピュータサイエンスのカリキュラムとして使用できるよう、教育専門家と協力して授業用カリキュラムや教材を作成しました。多くの学校でzgcombatやOzariaをメインのカリキュラムとして導入しています。',
      clever_instant_login: 'zgcombatやOzariaはClever Instant Loginをサポートしていますか？',
    ...
    play: {
      title: 'zgcombatであそぶ - Python、JavaScript、HTMLを学ぼう',
      ...
      anon_signup_title_1: 'zgcombatには',
    ...
    share_progress_modal: {
      blurb: 'あなたは大きな進歩を遂げています！ zgcombatでどれだけ学んだか親に伝えよう。',
    ...
    login: {
      ...
      already_have_account1: '既にzgcombatの教師用、または生徒用アカウントをお持ちですか？',
      already_have_account2: 'そのアカウントを使って、Ozaria.comにサインインできます。',
      sign_into_ozaria: 'Ozaria.comにサインイン',
      individual_users_not_supported: 'Ozariaは教室専用です！引き続きプレイするにはzgcombatをご利用ください！',
    ...
    signup: {
      ...
      email_announcements: '新しいzgcombatのレベルと機能についてのお知らせをメールで受け取る',
      ...
      teacher_type_1: 'zgcombatを使ってプログラミングを教えよう！',
    ...
    play_level: {
      ...
      explore_codecombat: 'zgcombatを探検',
      ...
      tip_open_source: 'zgcombatは、100％オープンソースです！',
      tip_tell_friends: 'zgcombatを楽しんでますか？友達にもおすすめしよう！',
      tip_beta_launch: 'zgcombatは、2013年10月にベータ版を開始しました。',
      ...
      tip_open_source_contribute: 'あなたは zgcombat をより良くすることができます！',
    ...
    play_game_dev_level: {
      ...
      restart: 'レベルをリセット',
      play: 'プレイレベル',
      play_more_codecombat: 'もっとzgcombatで遊ぶ',
    ...
    subscribe: {
      ...
      subscribe_modal_title: 'zgcombatプレミアム',
      comparison_blurb: 'zgcombatへ課金してスキルを磨きましょう！',
      ...
      thank_you: 'zgcombatをサポートして下さりありがとうございます。',
    ...
    about: {
      ...
      main_description: 'zgcombatでの私たちの仕事はあなたが笑顔でプレイするのを確かめることです。',
      mission_link: 'ミッション',
      team_link: 'チーム',
      story_link: 'ストーリー',
      press_link: '記事',
    ...
    contact: {
      ...
      subscribe: 'zgcombatのサブスクリプション',
      subscribe_suffix: 'を購入頂けると喜んであなたのコードを手伝います。',
      subscriber_support: 'あなたはzgcombatにすでに加入しているので、メールは優先サポートされます。',
    ...
    account_settings: {
      ...
      email_announcements_description: 'zgcombatの最新のニュースや進展をメールで受け取る',
      email_notifications: '通知',
      email_notifications_summary: 'zgcombatアクティビティに関する自動電子メール通知の管理。',
    ...
    community: {
      ...
      thang_editor_suffix: 'を使って zgcombat のアートワークを加工しましょう。ユニットが投射物を投げることを許可したり、アニメーションの方向を変えたり、ユニットのヒットポイントを変えたり、あなたのベクタースプライトをアップロードすることもできます。',
      article_editor_prefix: '私たちのドキュメントにミスを見つけましたか？自分の作品のチュートリアルを作りたいですか？',
      article_editor_suffix: 'を使って zgcombat のプレイヤーを助けて彼らのプレイタイムを最大限に活用できるようにしましょう。',
      find_us: '各サイトで私たちを見る',
      social_github: 'GitHubで私達のコードをチェックする',
      //    social_reddit: "Join the zgcombat community on Reddit",
      social_blog: 'Sett の zgcombat ブログを読む',
      social_discource: 'Discourse のフォーラムで議論しよう',
      social_facebook: 'Facebook で zgcombat にいいね！する',
      social_twitter: 'Twitter の zgcombat をフォローする',
      social_slack: '公開zgcombat Slackチャンネルで私たちと話す',
    ...
    teacher_ozaria_encouragement_modal: {
      ...
      sub_title: 'zgcombatからの新しいアドベンチャーゲームにご招待します。',
      cancel: 'zgcombatに戻る',
      ...
      you_can_return: 'あなたはいつでも、zgcombatに戻ることができます。',
    },
    ...
    classes: {
      ...
      archmage_summary: 'もしあなたが教育的なゲームに興味のあるデベロッパーであれば、zgcombatを作るアーキメイジになれます！',
      artisan_title: 'アーチザン',
      ...
      diplomat_summary: 'zgcombat は私たちの外交官により45ヶ国語以上の言語にローカライズされています。翻訳に貢献し、私たちを手伝ってください。',
      ambassador_title: '大使',
      ambassador_title_description: '(サポート)',
      ambassador_summary: 'フォーラムのユーザが投稿する質問に答えます。私たちの大使が zgcombat を世界に表現します。',
      teacher_title: '先生',
    },

    editor: {
      main_title: 'zgcombatエディター',
    ...
    contribute: {
      page_title: 'コントリビュート',
      intro_blurb: 'zgcombat は100%オープンソースです！何百もの熱心なプレイヤーが私たちがゲームを作るのを手伝っています。私たちと一緒に zgcombat の次のチャプターを作って世界中のプレイヤーにプログラミングを教えましょう！',
      alert_account_message_intro: 'やあ、こんにちは！',
      alert_account_message: 'クラスのメールを購読するには,まずログインが必要です。',
      archmage_introduction: 'ゲームを作る上で一番重要なのは、たくさんの要素を合成することです。グラフィック、サウンド、リアルタイムネットワーキング、ソーシャルネットワーキング、一般的なプログラミング、ローレベルのデータベースマネジメント、管理画面のデザインやインターフェイスなど多岐に渡ります。やらなくてはいけないことはたくさんあります。もしあなたが経験豊富なプログラマであればアーキメイジになって zgcombat のコアにコミットしましょう。ぜひとも私たちの最高のプログラミングゲームを手伝ってください。',
      ...
      how_to_join: '参加の方法',
      join_desc_1: '誰でも',
      join_desc_2: 'からはじめることができます。また、下のチェックボックをオンにするとアークメイジと zgcombat の最新情報がメールで届きます。さらに深く一翼を担いたいですか？',
    ...
    hoc_2018: {
      ...
      about: 'zgcombatについて:',
      about_copy: 'zgcombatはゲームのようにCSを教えてくれるプログラムです。PythonとJavaScriptに対応しています。zgcombatは、正しくプログラミングを学びながらみんなが楽しめるようにできています。1.2千万人以上がzgcombatを使っています。',
      point1: '✓ ベースが分かりやすい',
      point2: '✓ 生徒に合うように調整する',
      point3: '✓ コンセプトのテストもある',
    ...
    teacher_dashboard: {
      ...
      want_to_save_tooltip_coco: '<h3>進捗を保存しますか？</h3><p>進捗を保存したい場合は、学生アカウントを作成するか、<i>アカウント / 学生としてテスト</i>に移動してzgcombatを学生としてプレイしてください。</p>',
      ...
      ozaria_hs_modal_title: 'zgcombatからAI Hackstackにアクセス',
      ozaria_hs_modal_blurb: '教師はOzariaと同じ資格情報を使用して、**[https://flsong.iok.la/teachers/ai-league]zgcombat**からAI Hackstackに直接アクセスできます。Ozariaからクラスを簡単にインポートできます。',
      ozaria_ai_league_modal_title: 'zgcombatからAI Leagueにアクセス',
      ozaria_ai_league_modal_blurb: '教師はOzariaと同じ資格情報を使用して、**[https://flsong.iok.la/teachers/ai-league]zgcombat**からAI Leagueに直接アクセスできます。Ozariaからクラスを簡単にインポートできます。',
    ...
    home_v3: {
      ...
      innovative_play_experiences: 'zgcombatは、コンピュータサイエンスを楽しく身近にする革新的な体験の場を提供しています。',
      ...
      testimonals_2_title: '「オンラインプログラムならどれでも試しました。でもzgcombatとOzariaには敵いません。生徒にコーディングを教えたい教師は、ここから始めてください！」',
      ...
      testimonals_4_title: '「zgcombatで私が一番好きなのは、コーディングを簡略化しないことです。生徒たちは実際のコードを書くことを学びながらも、楽しく取り組んでいます。」',
      ...
      engaging_boxes_2_title: 'zgcombat クラスルーム',
      engaging_boxes_2_text: 'コアコンセプトからWeb開発、ゲーム開発、**[https://flsong.iok.la/apcsp]AP CSP**まで構築された完全なCSカリキュラム。',
      ...
      engaging_boxes_4_title: 'zgcombat AIリーグeスポーツ',
      ...
      engaging_boxes_6_title: 'zgcombat ホーム',
      ...
      solutions_8_text: '完全に自己ペースで自己指向型のデジタルリソースとして、zgcombatは図書館に最適な統合を提供します。初心者から大学レベルのコーディング概念を習得したい人々まで、すべての学習者が高レベルのコーディング教育を体験するために必要なものを備えています。',
