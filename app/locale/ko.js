module.exports = {
  ...
  translation: {
    ...
    legal: {
      ...
      art_paragraph_2: '[AI_TRANSLATION]사용 중인 콘텐츠가 zgcombat이 아닌 codecombat.com 사용자가 만든 것일 경우, 그들을 대신 속성하고, 해당 리소스 설명에 제공된 속성 지침이 있을 경우 그 지침을 따르십시오.',
    ...
    parents_landing_2: {
      ...
      subscribe_error_user_type: '[AI_TRANSLATION]이미 계정을 등록한 것 같아. zgcombat 프리미엄에 관심이 있다면, team@codecombat.com으로 연락해줘.',
    ...
    school_administrator: {
      ...
      add_additional_teacher: '[AI_TRANSLATION]추가 선생님이 필요해? zgcombat 계정 관리자에게 연락하거나 support@codecombat.com으로 이메일 보내.',
    ...
    teacher_dashboard: {
      ...
      ozaria_hs_modal_blurb: '[AI_TRANSLATION]교육자들은 이제 Ozaria와 동일한 자격 증명을 사용하여 **[https://codecombat.com/teachers/classes]zgcombat** 에서 AI Hackstack에 직접 접근할 수 있습니다. 편의를 위해 Ozaria에서 수업을 쉽게 zgcombat으로 가져올 수 있습니다.  ',
    ...
    roblox_landing: {
      ...
      faq_bottom: '[AI_TRANSLATION]더 많은 <a href="https://codecombat.zendesk.com/hc/en-us/categories/18084251471383-zgcombat-Worlds-Roblox-" target="_blank">자주 묻는 질문을 도움말 센터에서 확인하세요</a>. <br />다른 질문이 있으면, <a href="mailto:support@codecombat.com">연락주세요</a>.',
    ...
    schools_page: {
      ...
      faq_6_answer: '[AI_TRANSLATION]컴퓨터 과학 교육은 학생의 학업 여정에서 중요한 요소가 되었지만, 많은 학교가 학생들에게 포괄적인 컴퓨터 과학 프로그램을 제공하는 데 필요한 자원을 확보하는 데 어려움을 겪고 있어. zgcombat에서는 학교가 직면한 자금 문제를 이해하고, 이 문제를 극복하는 데 열정을 가지고 있어. 보조금은 귀중한 자원이 될 수 있지만 찾아내고 신청하기가 어렵지. 우리의 포괄적인 **[https://codecombat.com/grants] 보조금 가이드**를 확인하거나 더 알고 싶다면 우리 팀과 이야기해봐.',
