module.exports = {
  ...
  translation: {
    ...
    ozaria_home: {
      ...
      faq_row1_header: '[AI_TRANSLATION]Ozaria는 zgcombat과 어떤 관계야?',
      faq_row1_p: '[AI_TRANSLATION]Ozaria는 역대 가장 인기 있는 코딩 게임 중 하나인 zgcombat의 교실 중심 진화 버전이야. 우리는 Python과 JavaScript를 2천만 명 이상의 학습자에게 가르치면서 얻은 통찰력을 바탕으로 Ozaria를 만들었어. Ozaria는 새로운 교육 모델과 몰입형 이야기 중심 서사를 통합했으며, 대면 학습과 원격 학습 설정 모두를 위해 교실에서 구현할 수 있도록 설계되었어.',
    ...
    new_home: {
      title_coco: 'zgcombat - Python과 JavaScript를 배울 수 있는 코딩 게임',
      title_ozar: 'zgcombat - Python과 JavaScript를 배울 수 있는 코딩 게임',
      title_cn_home: '[AI_TRANSLATION]zgcombat|Python, Javascript',
      meta_keywords_coco: '[AI_TRANSLATION]zgcombat, 파이썬, 자바스크립트, 코딩 게임들',
      ...
      become_investor: '[AI_TRANSLATION]zgcombat의 투자자가 되기',
      built_for_teachers_title: '선생님들의 마음을 생각한 코딩 게임',
      built_for_teachers_blurb: '아이들에게 코드를 가르치는 것은 종종 어렵게 느껴질 수 있습니다. zgcombat은 모든 교육자가 학생들에게 가장 인기 있는 프로그래밍 언어 중 하나인 JavaScript 또는 Python으로 코드를 짤 수 있는 방법을 가르칠 수 있도록 도와줍니다. 6개의 컴퓨터 사이언스 유닛과 프로젝트 기반 게임 개발 및 웹 개발 유닛들을 통해 학습을 증진시키는 종합적인 교육과정을 통하여, 아이들은 기본 구문을 시작으로 재구성으로의 여정을 진행할 것입니다!',
      ...
      century_skills_subblurb1: '코딩 퍼즐은 자연스럽게 점점 더 도전적인 수준으로 되기 때문에, zgcombat의 프로그래밍 게임은 아이들이 항상 비판적 사고를 연습하도록 보장합니다.',
      century_skills_quote2: "다른 사람들은 모두 미로를 만들고 있었기 때문에 저는 '깃발 잡기'를 생각했고, 그걸 만들었죠!",
      century_skills_subtitle2: '창의성',
      century_skills_subblurb2: 'zgcombat은 학생들이 자신만의 게임과 웹 페이지를 만들고 공유함으로써 그들의 창의성을 보여주도록 장려합니다.',
      ...
      creativity_rigor_blurb2: '모든 zgcombat 레벨은 수백만 개의 데이터를 기반으로 하며 각 학생에게 맞게 최적화됩니다. 연습 수준과 힌트는 학생들이 막혔을 때 도움을 주고, 도전 수준은 게임 내내 학생들의 학습을 평가합니다.',
      creativity_rigor_subtitle3: '경험과 상관없이 모든 선생님들을 위해 만들어졌습니다.',
      creativity_rigor_blurb3: 'zgcombat의 자율적이고 표준화된 커리큘럼은 모든 사람에게 컴퓨터 공학을 가르치는 것을 가능하게 합니다. zgcombat은 교실에서 자신감과 성취감을 느끼기 위해 교사들에게 트레이닝, 교육 리소스 및 헌신적인 지원을 제공합니다.',
      ...
      for_leaders_subblurb3: 'zgcombat은 여러분의 필요에 맞게 조정됩니다. 중학교 코딩 선택 과목을 만들든, CTE Pathway나 AP Computer Science Principle 클래스를 만들든 말이죠.',
      ...
      game_based_blurb: 'zgcombat은 학생들이 실제 코드를 입력하고 실시간으로 반응을 보는 게임 기반의 컴퓨터 공학 프로그램입니다.',
      get_started: '시작하기',
      ...
      quotes_quote1: '인터넷 상에는 많은 교육 프로그램들이 있죠. 다 시도해 봤지만, zgcombat만한 것은 없습니다. 학생들이 코드를 배우길 원하는 선생님이라면... 여기서 시작하세요!',
      quotes_quote2: '저는 zgcombat이 컴퓨터 공학을 배우는 것을 얼마나 쉽고 직관적으로 만드는지에 대해 놀랐습니다. AP 시험의 점수는 내가 예상했던 것보다 훨씬 높았고 나는 zgcombat이 그 이유라고 믿습니다.',
      quotes_quote3: 'zgcombat은 학생들에게 실제 코딩 능력을 가르치는데 가장 도움이 되었습니다. 제 남편은 소프트웨어 엔지니어이고 제 모든 프로그램을 시험해 봤어요. 그는 zgcombat을 자신의 최고 선택으로 삼았습니다',
      quotes_quote4: '피드백은 매우 긍정적이어서 우리는 zgcombat을 중심으로 컴퓨터 공학 수업을 구상하고 있습니다. 이 프로그램은 재미있고 동시에 교육적인 게임 스타일의 플랫폼으로 학생들을 참여시킵니다. 계속 수고해주세요, zgcombat!',
      quotes_quote5: '코딩 수업이 토요일 아침 7시에 시작하는데도, 제 아들은 수업 듣기를 너무 좋아해서 저보다도 먼저 일어나곤 해요! zgcombat은 아이가 코딩 스킬을 더 발전시키기 위한 방법들을 제공해 줍니다.',
      ...
      teachers_love_codecombat_title: '선생님들이 좋아하는 zgcombat',
      teachers_love_codecombat_blurb1: '학생들이 코딩 방법을 배우기 위해 zgcombat을 즐겨 사용한다고 말합니다.',
      teachers_love_codecombat_blurb2: 'zgcombat을 다른 컴퓨터 공학 선생님들에게 추천합니다.',
      teachers_love_codecombat_blurb3: 'zgcombat이 학생들의 문제 해결 능력을 지원하는 데 도움이 된다고 말합니다.',
      ...
      top_banner_blurb_roblox: '[AI_TRANSLATION]새로운 소식! zgcombat이 Roblox에 온다!',
      top_banner_blurb_roblox_teachers: '[AI_TRANSLATION]새 소식! zgcombat이 로블록스 교육과 파트너 관계를 맺었어!',
      ...
      top_banner_blurb_demo_day_10_20: '[AI_TRANSLATION]10월 20일 목요일 오후 4시 CDT에 zgcombat & Ozaria의 스푸캣큘러 데모에 합류하세요.',
      ...
      im_an_educator_description: '[AI_TRANSLATION]zgcombat로 컴퓨터 과학 가르치기',
      im_a_teacher: '선생님입니다',
      im_a_student: '학생입니다',
      ...
      codecombat_is: 'zgcombat은 <strong>학생들이</strong> 게임을 하면서 컴퓨터 공학을 배울 수 있는 플랫폼입니다',
      our_courses: '저희 강좌는 프로그래밍 경험이 거의 없거나 아예 없는 선생님들까지도 <strong>교실에서 좋은 성적</strong>을 내기 위해 테스트 플레이를 해 왔습니다.',
      watch_how: 'zgcombat이 사람들이 컴퓨터 공학을 배우는 방식을 어떻게 변화시키고 있는지 보세요.',
      ...
      builds_concepts_up: 'zgcombat이 컨셉을 구축하는 방식이 마음에 듭니다. 정말 이해하기 쉽고, 알아내는 것도 재미있어요.',
      ...
      agency: 'zgcombat은 초급생과 상급생 모두가 적절하고 유효한 코드를 작성할 수 있도록 도와주는 우리의 강력한 타이핑 코드 엔진으로 플레이어들에게 자신감을 주는 게임입니다.',
      ...
      codecombat_live_online_classes: '[AI_TRANSLATION]zgcombat 라이브 온라인 수업',
      ...
      codecombat_home: '[AI_TRANSLATION]zgcombat 홈',
      ...
      for_partners_blurb: '[AI_TRANSLATION]zgcombat과 함께 소중한 파트너가 되어 코딩을 모든 사람에게 접근 가능하고 흥미롭게 만드는 우리의 미션에 동참하세요. 파트너 구조에는 교육 사업, e스포츠 스폰서, 국제 유통업체, 그리고 사회적 영향 파트너가 포함됩니다. 파트너는 사용하기 쉬운 프로그램, 구현 리소스, 그리고 성공적이고 즐거운 경험을 위한 교육 옵션에 접근할 수 있습니다.',
      ...
      meta_keywords_podcast: '[AI_TRANSLATION]zgcombat, python, javascript, 코딩 게임, 팟캐스트, 에드테크',
      coco_worlds_header: '[AI_TRANSLATION]zgcombat 세상',
      coco_worlds_description: '[AI_TRANSLATION]Roblox에서 3D 코딩 모험을 시작해, 여기서 너는 애완동물을 프로그램하고, 친구들과 놀고, 게임을 개발할 수 있어. zgcombat 커뮤니티에 가입하고 메타버스에서 창의력을 발휘해!',
      coco_worlds_button: '[AI_TRANSLATION]zgcombat 세계 탐험하기  ',
    ...
    nav: {
      ...
      return_coco: '[AI_TRANSLATION]zgcombat으로 돌아가기',
      ...
      codecombat_classroom: '[AI_TRANSLATION]zgcombat 교실\n',
      ...
      codecombat_dashboard: '[AI_TRANSLATION]zgcombat 대시보드',
      codecombat_teacher_dashboard: '[AI_TRANSLATION]zgcombat 교사 대시보드',
      codecombat_admin_dashboard: '[AI_TRANSLATION]zgcombat 관리자 대시보드',
      ...
      codecombat_worlds_on_roblox: '[AI_TRANSLATION]Roblox의 zgcombat 월드',
      ...
      coco_junior_beta: '[AI_TRANSLATION]zgcombat 주니어 (베타)',
    ...
    new_home_faq: {
      ...
      main_curriculum: '[AI_TRANSLATION]zgcombat이나 Ozaria를 주요 커리큘럼으로 사용할 수 있나요?',
      main_curriculum_blurb: '[AI_TRANSLATION]당연하지! 우리가 교육 전문가들과 협력하여 컴퓨터 과학 경험이 전혀 없는 교사들도 사용할 수 있도록 zgcombat이나 Ozaria를 위한 교실 커리큘럼과 자료들을 만들었어. 많은 학교들이 zgcombat과/또는 Ozaria를 주요 컴퓨터 과학 커리큘럼으로 도입하고 있어.',
      clever_instant_login: '[AI_TRANSLATION]zgcombat과 Ozaria가 Clever Instant Login을 지원하나요?',
      ...
      recommended_systems_blurb: '[AI_TRANSLATION]zgcombat과 Ozaria는 최소 4GB RAM이 있는 컴퓨터에서 최적의 성능을 발휘하며, Chrome, Safari, Firefox, 또는 Edge와 같은 최신 브라우저에서 실행돼. 2GB RAM을 가진 크롬북은 이후 수업에서 약간의 그래픽 문제가 있을 수 있어. 학생당 최소 200 Kbps의 대역폭이 필요하며, 1Mbps 이상의 속도가 권장돼.',
      ...
      ai_bot_faq_blurb: '[AI_TRANSLATION]zgcombat의 AI 챗 레벨 도움 봇은 학습자에게 코딩 챌린지에 대한 AI 기반 힌트를 제공하여 가이드와 독립적인 학습 경험을 보장해. 안전이 가장 중요하며, AI는 개인 데이터를 필터링하고 부적절한 요청을 처리할 수 있도록 교육받았어.',
    },

    play: {
      title: 'zgcombat Levels를 플레이하여 - Python, JavaScript, 그리고 HTML을 배워보세요.',
      ...
      teacher_button: '교사용',
      get_more_codecombat: 'zgcombat을 더 알아보기',
      ...
      play_codecombat: '[AI_TRANSLATION]zgcombat 플레이하기',
      play_codecombat_junior: '[AI_TRANSLATION]zgcombat Junior 플레이하기',
    ...
    login: {
      ...
      already_have_account1: '[AI_TRANSLATION]이미 zgcombat 교사 또는 학생 계정이 있나요?',
      already_have_account2: '[AI_TRANSLATION]그 계정으로 `Ozaria.com`에 로그인할 수 있습니다.',
      sign_into_ozaria: '[AI_TRANSLATION]Ozaria.com에 로그인하기',
      individual_users_not_supported: '[AI_TRANSLATION]오자리아는 교실 전용이야! 계속하려면 zgcombat을 방문해줘!',
    ...
    signup: {
      ...
      teacher_type_1: 'zgcombat을 이용하여 프로그래밍을 가르치세요!',
      ...
      want_codecombat_in_school: 'zgcombat을 언제든지 하고 싶으신가요?',
      eu_confirmation: '저는 제 정보들을 zgcombat이 미국 서버에 저장하는 것을 허용합니다.',
      ...
      already_have_account: '[AI_TRANSLATION]이미 zgcombat 또는 Ozaria 계정이 있어',
      ...
      want_to_play_codecombat: '그런 건 없지만 zgcombat을 플레이하고 싶습니다.',
    ...
    common: {
      default_title_coco: '[AI_TRANSLATION]zgcombat - Python과 JavaScript를 배우는 코딩 게임',
    ...
    play_level: {
      ...
      explore_codecombat: 'zgcombat 탐험하기',
    ...
    play_game_dev_level: {
      ...
      restart: '레벨 재시작',
      play: '레벨 시작',
      play_more_codecombat: 'zgcombat 플레이 더 하기',
    ...
    subscribe: {
      best_deal: '특가!',
      confirmation: '축하드려요! 당신은 이제 zgcombat 프리미엄 구독자입니다.!',
      premium_already_subscribed: '당신은 이미 프리미엄을 구독 중 입니다!',
      subscribe_modal_title: 'zgcombat 프리미엄',
      ...
      thank_you: 'zgcombat을 도와 주셔서 감사합니다.',
    ...
    premium_features: {
      ...
      ai_bot_description: '[AI_TRANSLATION]zgcombat의 AI 기능 힌트는 코드를 평가하고, 오류를 찾아내며, 이를 수정하는 방법을 설명할 수 있어. 가장 중요한 것은, 해결책 전체를 제공하지 않고도 필요한 모든 맥락을 제공한다는 거야. 현재의 코드 문제 해결 지원만으로도 어린 학습자들은 각 레벨의 코딩 도전을 스스로 해결해 나갈 필요가 있어. 프리미엄 구독자는 하루에 <b>10개의 AI 힌트</b>를 할당받아 항상 필요한 지원을 받을 수 있어.  ',
    ...
    about: {
      title: 'zgcombat에 대해 - 학생 참여, 교사 역량 강화, 창작에 대한 열정',
      ...
      main_description: 'zgcombat에서 우리의 임무는 당신이 미소를 짓고 있는지 확인하는 것입니다.',
      mission_link: '미션',
      team_link: '팀',
      story_link: '스토리',
      press_link: '요약',
      mission_title: '우리의 임무는 지구상의 모든 학생들이 프로그래밍을 할 수 있도록 하는 것입니다.',
      mission_description_1: '<strong>프로그래밍은 마법</strong>입니다. 그것은 순수한 상상력으로 사물을 창조하는 능력입니다. zgcombat은<strong> 타이핑된 코드</strong>를 사용하여 학습자에게 손끝에서 마법 같은 힘을 느낄 수 있도록 합니다.',
      ...
      team_title: 'zgcombat team을 만나보세요!',
      ...
      zhiran_title: '[AI_TRANSLATION]zgcombat 중국 총괄 커리큘럼 책임자',
      ...
      story_subtitle: '2013년부터 zgcombat은 단순한 스케치에서 성장하는 게임으로 성장했습니다.',
      story_statistic_1a: '20,000,000명 이상의',
      story_statistic_1b: '총 플레이어',
      story_statistic_1c: '들은 zgcombat을 통해 그들의 프로그래밍 여정을 시작했습니다',
      ...
      jobs_title: '저희의 여정에 참여하여 zgcombat의 역사를 같이 써내려 가세요!',
      ...
      jobs_custom_description: 'zgcombat에 대해 열정이 있으면서도 자격 요건에 맞는 역할이 나열되어 있지 않습니까? 저희에게 연락을 보내서 어떻게 하면 우리 팀에 기여할 수 있다고 생각하는지 보여주세요. 저희는 당신의 소식을 듣고 싶습니다.!',
    ...
    teachers: {
      ...
      free_course_blurb_junior: '[AI_TRANSLATION]K-5학년에 아주 좋아. zgcombat Junior는 글을 못 읽는 아이들을 위해 블록 기반과 모바일 옵션도 있고, 초등 고학년을 위해 Python이나 JavaScript 코드도 지원해. 블록과 코드를 병행해서 전환을 도울 수도 있어.',
    ...
    no_licenses_page: {
      ...
      join_our_community_desc: '[AI_TRANSLATION]1,200만 명 이상이 zgcombat을 통해 파이썬과 자바스크립트를 배웠어. 이제 우리는 82,000명 이상의 교육자와 25,000개 이상의 학교와 함께하는 우리 커뮤니티에 너를 초대해. Ozaria는 새로운 세대의 학생들이 컴퓨터 과학을 배우도록 영감을 주고 싶은 교육자들을 위해 고안됐어.',
    ...
    teachers_quote: {
      subtitle_coco: '[AI_TRANSLATION]zgcombat에 대해 더 알아보세요. 제품, 가격 및 구현에 대한 인터랙티브한 안내로!',
      ...
      state: '도 / 지역',
      country: '국가',
      num_students_help: '얼마나 많은 사람들이 zgcombat를 사용할까요?',
      ...
      referrer: '저희 zgcombat을 어떻게 아시게 되었나요?',
      ...
      anything_else: '당신은 zgcombat를 통한 수업을 어떤식으로 기대하십니까?',
      //    anything_else_helper: "",
      thanks_header: '접수 완료!',
      thanks_sub_header_coco: '당신의 학교를 위해 zgcombat에 대해 관심을 가져주셔서 감사드립니다.',
      ...
      learn_more_modal: 'zgcombat에서의 선생님 계정은 학생들의 과정을 모니터링 할 수 있고 라이센스를 부여하고 교실을 관리할 수 있습니다. 선생님 계정은 수업을 들을 수는 없습니다 -만약 당신의 계정이 수업에 등록되어있다면 계정이 업데이트 된 이후로는 수업에 접근하실 수 없습니다.',
      create_account: '선생님 계정을 생성하세요',
      create_account_subtitle: '[AI_TRANSLATION]zgcombat을 교실에서 사용할 수 있는 교사 전용 도구에 접근해봐.  <strong>클래스를 설정</strong>하고, 학생들을 추가하고, <strong>진행 상황을 모니터링</strong>해!',
    ...
    contact: {
      ...
      send: '의견 보내기',
      ooo_blurb: '[AI_TRANSLATION]zgcombat 팀은 6월 5일부터 6월 9일까지 사무실을 비울 예정이고, 이 기간 동안 이메일 접근이 제한될 거야. 최대한 빠르게 질문에 답변 드리겠지만, 예상되는 대기 시간을 참고해 줘.',
    },
    ...
    account_settings: {
      ...
      roblox_not_connected: '[AI_TRANSLATION]zgcombat 계정이랑 Roblox 계정을 연결해줘.',
    ...
    community: {
      ...
      thang_editor_suffix: ' zgcombat 소스 작품을 수정하여 사용합니다.유닛들이 발사체를 던지는것을 허용하며, 애니메이션의 방향을 변경하고, 유닛의 타격지점을 변경하거나, 우리의 벡터 스프라이트를 업로드 할 수도 있습니다.',
      ...
      social_slack: '[AI_TRANSLATION]공개 zgcombat Slack 채널에서 우리와 채팅하세요.',
      contribute_to_the_project: '프로젝트에 기여하기',
    },

    clans: {
      title: '[AI_TRANSLATION]zgcombat 클랜에 가입하여 Python, JavaScript, HTML을 배워봐',
      clan_title: '[AI_TRANSLATION]__clan__ - zgcombat 클랜에 가입하고 코딩을 배우세요',
    ...
    courses: {
      ...
      welcome_to_courses_coco: '[AI_TRANSLATION]모험가님, zgcombat에 오신 걸 환영해!',
      ...
      ask_teacher_for_code_coco: '[AI_TRANSLATION]너희 선생님께 zgcombat 수업 코드가 있는지 물어봐! 만약 있다면, 아래에 입력해줘:',
      ...
      update_account_individuals_warning_ozaria: '[AI_TRANSLATION]경고: 개인 계정으로는 Ozaria를 플레이할 수 없고, zgcombat만 플레이 가능해.',
    ...
    teacher: {
      ...
      teacher_account_explanation: '[AI_TRANSLATION]zgcombat 교사 계정은 교실 설정, 학생들의 학습 진행 상황 모니터링, 라이선스 관리 및 커리큘럼 구축을 돕는 자원 접근을 허용합니다.',
      ...
      pacing_guides_desc: '[AI_TRANSLATION]zgcombat의 모든 자원을 활용하여 학사 일정을 계획하는 방법을 배워봐!',
      ...
      student_getting_started_desc: '[AI_TRANSLATION]이 가이드를 배포하여 학생들이 zgcombat을 시작하기 전에 코드 에디터에 익숙해지도록 할 수 있어. 이 가이드는 파이썬과 자바스크립트 교실 모두에게 사용할 수 있어.',
      ...
      hoc_meta_description: '[AI_TRANSLATION]너만의 게임을 만들거나 던전을 탈출해 봐! zgcombat에는 네 가지 다른 Hour of Code 활동과 60개 이상의 코드 학습, 게임, 창작 레벨이 있어.',
      hoc_intro: '[AI_TRANSLATION]네 클래스가 시간의 코드에 참여하는 세 가지 방법이 있어',
      hoc_self_led: '[AI_TRANSLATION]스스로 진행하는 게임플레이',
      hoc_self_led_desc: '[AI_TRANSLATION]학생들은 혼자서 우리 Hour of Code zgcombat 튜토리얼을 플레이할 수 있어.',
      ...
      hoc_additional_desc1: '[AI_TRANSLATION]추가적인 zgcombat 자료와 활동을 위해, 우리의  ',
      ...
      teacher_quest_teach_methods_step2: '[AI_TRANSLATION][학생 빠른 시작 가이드](https://files.flsong.iok.la/docs/resources/StudentQuickStartGuide.pdf)를 선생님 도구 키트에서 출력해.',
      ...
      teacher_quest_kithgard_gates_100_step2: '[AI_TRANSLATION][Engineering Cycle Worksheet](https://files.flsong.iok.la/docs/resources/EngineeringCycleWorksheet.pdf)을 사용해 학생들이 어려운 문제를 생각하도록 지도합니다.',
      ...
      teacher_quest_done: '[AI_TRANSLATION]학생들이 더 많은 코드를 배우길 원해? 오늘 [school specialists](mailto:schools@flsong.iok.la)에게 연락해 봐!',
    ...
    teacher_ozaria_encouragement_modal: {
      ...
      sub_title: '[AI_TRANSLATION]zgcombat의 새로운 모험 게임에 초대합니다.',
      cancel: '[AI_TRANSLATION]zgcombat으로 돌아가기',
      ...
      you_can_return: '[AI_TRANSLATION]언제든지 zgcombat으로 돌아올 수 있어',
    },
    ...
    educator_signup_ozaria_encouragement: {
      ...
      educators_continue_coco: '[AI_TRANSLATION]수업에서 zgcombat을 계속 사용하고 싶은 교육자들',
      continue_coco: '[AI_TRANSLATION]zgcombat 계속하기',
    },
    ...
    contribute: {
      ...
      scribe_introduction_pref: '[AI_TRANSLATION]zgcombat는 단순한 여러 레벨이 아니다. 또한 지식의 자원이 포함될 것이며, 레벨이 연동될 수 있는 프로그래밍 개념의 위키가 포함될 것이다. 이렇게 하면 각 장인이 비교 연산자가 무엇인지 상세히 설명할 필요 없이, 플레이어가 이해할 수 있도록 이미 작성된 기사로 레벨을 연결할 수 있다. 예를 들어',
      ...
      diplomat_introduction_suf: '[AI_TRANSLATION]다른 나라에서도 zgcombat에 많은 관심이 있습니다! 우리는 가능한 한 zgcombat을 전 세계적으로 접근할 수 있도록 단어를 다른 단어로 바꾸는 것을 열망하는 번역가 군단을 구축하고 있습니다. 다가오는 콘텐츠를 미리보고 이 단계를 동료들에게 최대한 빨리 전달하는 것을 좋아한다면 이 수업이 당신에게 맞을 수 있습니다.',
      ...
      ambassador_introduction: '[AI_TRANSLATION]우리가 만드는 이곳은 커뮤니티야, 너는 그 연결 부분이야. 포럼, 이메일, 소셜 네트워크 등에서 많은 사람들과 대화하고 게임에 익숙해지고 배울 수 있어. 사람들이 참여하고 즐겁게 플레이를 돕고, zgcombat의 흐름을 잘 느끼고 싶다면, 이 클래스가 너를 위한 것일지도 몰라.',
    ...
    user: {
      user_title: '[AI_TRANSLATION]__name__ - zgcombat으로 코딩 배우기',
    ...
    account: {
      ...
      status_unsubscribed: '[AI_TRANSLATION]zgcombat 구독으로 새로운 레벨, 영웅, 아이템, 보너스 젬을 얻어 봐!',
      ...
      unsubscribe_from_marketing: '[AI_TRANSLATION]모든 zgcombat 마케팅 이메일에서 __email__ 구독 취소할까요?',
    ...
    account_prepaid: {
      ...
      purchase_code1: '[AI_TRANSLATION]구독 코드는 zgcombat 홈 버전의 하나 이상의 계정에 프리미엄 구독 시간을 추가하기 위해 사용할 수 있습니다.',
      purchase_code2: '[AI_TRANSLATION]각 zgcombat 계정은 특정 구독 코드를 한 번만 사용할 수 있습니다.',
      purchase_code3: '[AI_TRANSLATION]구독 코드 개월수가 계정의 기존 구독 끝에 추가될 거야.',
      purchase_code4: '[AI_TRANSLATION]구독 코드는 zgcombat의 홈 버전을 플레이하는 계정용이야. 교실 버전의 학생 라이선스를 대신할 수 없어.',
    ...
    impact: {
      ...
      teacher_quote: '제가 zgcombat을 손에 넣고 제 학생들이 그것을 사용하기 시작했을 때, 전구는 켜졌습니다.',
      ...
      ozaria_impact_blurb: '[AI_TRANSLATION]zgcombat의 자매 교육과정인 오자리아가 학생들과 교육자들에게 가장 중요한 학습 결과에 긍정적인 영향을 준 것으로 입증되었습니다.',
    ...
    anonymous_teacher: {
      ...
      teacher_notified: '[AI_TRANSLATION]네가 교실에서 zgcombat을 더 하고 싶다고 선생님께 알렸어!',
    },
    ...
    legal: {
      ...
      opensource_introduction: '[AI_TRANSLATION]zgcombat은 오픈 소스 커뮤니티의 일부입니다.',
      ...
      cost_description: '[AI_TRANSLATION]zgcombat의 소개 레벨은 무료로 플레이할 수 있고, 추가 레벨과 매달 __gems__ 개의 보너스 보석에 접근하려면 한 달에 $__price__ USD의 구독이 필요해. 클릭 한 번으로 취소할 수 있고, 100% 환불 보장을 제공해.',
      ...
      client_code_description_prefix: '[AI_TRANSLATION]flsong.iok.la의 모든 클라이언트 측 코드는 공공 GitHub 저장소와 flsong.iok.la 데이터베이스에 있으며, 이는 라이선스에 따릅니다',
      ...
      art_description_suffix: '[AI_TRANSLATION]일반 콘텐츠는 zgcombat이 레벨 제작 목적으로 일반적으로 제공하는 모든 것을 포함해. 여기에는 다음이 포함됩니다:',
      art_music: '뮤직',
      art_sound: '사운드',
      art_artwork: '원화',
      art_sprites: '스프라이트',
      ...
      art_paragraph_1: '[AI_TRANSLATION]저작권 표시를 위해 출처를 사용하는 위치나 매체에 적절한 곳에 flsong.iok.la의 이름과 링크를 제공해주세요. 예시:',
      use_list_1: '[AI_TRANSLATION]영화나 다른 게임에 사용된다면 크레딧에 flsong.iok.la을 포함하세요.',
      use_list_2: '[AI_TRANSLATION]웹사이트에서 사용될 경우, 사용 근처에 링크를 포함시켜야 해, 예를 들어 이미지 아래나 사이트에서 다른 크리에이티브 커먼즈 작품과 오픈 소스 소프트웨어를 언급하는 일반 저작권 페이지에. zgcombat을 분명히 참조하는 블로그 게시물 같은 경우 따로 저작권 표시를 할 필요 없어.',
      art_paragraph_2: '[AI_TRANSLATION]사용 중인 콘텐츠가 zgcombat이 아닌 flsong.iok.la 사용자가 만든 것일 경우, 그들을 대신 속성하고, 해당 리소스 설명에 제공된 속성 지침이 있을 경우 그 지침을 따르십시오.',
      ...
      nutshell_description: '[AI_TRANSLATION]레벨 편집기에서 제공하는 모든 자원은 레벨을 만들 때 자유롭게 사용할 수 있어. 하지만 flsong.iok.la에서 만들어진 레벨 자체의 배포를 제한할 권리를 보유하고 있어서 유료로 제공될 수 있어.',
      ...
      third_party_description: '[AI_TRANSLATION]zgcombat은 다음과 같은 서드파티 서비스를 사용해 (다른 것들도 있어):',
      cookies_message: '[AI_TRANSLATION]zgcombat은 필수 및 비필수 쿠키를 몇 가지 사용해.',
    ...
    ladder_prizes: {
      ...
      custom_avatar: '[AI_TRANSLATION]사용자 정의 zgcombat 아바타',
    ...
    apcsp: {
      ...
      meta_description: '[AI_TRANSLATION]zgcombat의 포괄적인 커리큘럼과 전문 개발 프로그램은 학생들에게 College Board의 최신 컴퓨터 과학 과정을 제공하는 데 필요한 모든 것을 갖추고 있어.',
      syllabus: '[AI_TRANSLATION]AP CS 원칙 강의 계획서',
      syllabus_description: '[AI_TRANSLATION]AP 컴퓨터 과학 원칙 수업에 zgcombat 커리큘럼을 계획하기 위해 이 리소스를 사용해.',
    ...
    apcsp_marketing: {
      ...
      icons_coding_levels: '[AI_TRANSLATION]150+ zgcombat 코딩 레벨',
      ...
      course_outline_description: '[AI_TRANSLATION]다음 설명은 zgcombat AP CSP 코스에서 탐구한 내용의 개요야.',
      ...
      professional_development: '[AI_TRANSLATION]전문가 개발',
      professional_development_description: '[AI_TRANSLATION]zgcombat은 모든 수준의 AP CSP 전문성을 가진 교육자들을 위한 온라인, 자기 주도의 전문 개발 과정을 제공합니다. 참가자들은 zgcombat 커리큘럼을 탐구하고, 이를 통해 학생들이 AP CSP 시험에서 성공할 수 있도록 준비시키는 방법을 배웁니다. 동료 교사들과 비동기식 토론과 zgcombat 학습 디자이너와의 화상 회의를 통해, AP CSP에서 모든 학생들을 지원하는 데 필요한 도구와 기술을 갖추게 될 것입니다. 과정이 끝나면 교사 자격증 갱신에 사용할 수 있는 수료증을 받게 됩니다.',
      ...
      question_2: '[AI_TRANSLATION]zgcombat의 AP CSP 커리큘럼을 위한 기술 요구사항은 무엇인가요?',
      ...
      coco_requirements: '[AI_TRANSLATION]zgcombat의 시스템 요구 사항',
      coco_recognized_blurb: '[AI_TRANSLATION]zgcombat은 AP® 컴퓨터 과학 원칙 수업(AP CSP)을 위한 교육과 전문 개발을 위한 공인 제공자로서 College Board의 인정을 받았어. 이 인증은 zgcombat의 커리큘럼이 모든 AP 커리큘럼 프레임워크 표준 및 AP CSP 평가와 일치한다는 것을 확인시켜 줘. 이로 인해 학교는 College Board의 과정 감사에서 사전 승인된 AP CSP 강의 계획서 및 이 커리큘럼을 가르칠 수 있도록 준비하는 공식적으로 인정된 전문 개발 자원에 접근할 수 있어.  ',
    ...
    apcsp_curriculum: {
      ...
      professional_development_description: '[AI_TRANSLATION]zgcombat은 모든 수준의 AP CSP 전문가를 위한 온라인 자율 학습 전문 개발 과정을 제공합니다. 참여자들은 zgcombat 커리큘럼을 탐구하고, AP CSP 시험에서 학생들이 성공할 수 있도록 커리큘럼을 어떻게 활용할 수 있는지를 배웁니다. 동료 교사들과 비동기 토론 및 zgcombat 커리큘럼 개발자와의 화상 회의를 통해 AP CSP의 모든 학생들을 지원하는 데 필요한 도구 및 기술을 얻게 됩니다. 과정이 끝난 후에는 교사 자격 갱신에 사용할 수 있는 수료증을 받게 됩니다. 우리는 __edapp__에서 우리 커리큘럼을 제공합니다.',
      ...
      no_license: '[AI_TRANSLATION]우리 AP CSP 커리큘럼은 유료 라이센스가 필요해. zgcombat의 AP CSP 커리큘럼에 대해 더 알아보려면, 아래 링크된 정보 페이지를 방문해줘.',
      ...
      step_1_subtitle: '[AI_TRANSLATION]zgcombat의 AP CSP 강의 계획서를 커먼보드에 업로드해.',
    ...
    hoc_2019: {
      ...
      already_have_account: '[AI_TRANSLATION]zgcombat이나 Ozaria 계정이 이미 있나요? 로그인하세요.',
    ...
    parents_landing_1: {
      ...
      codecombat_intro: '[AI_TRANSLATION]zgcombat는 게임 플레이와 개인 맞춤형 지도를 결합하여 자녀가 매주 기대할 수 있는 온라인 코딩 수업을 제공합니다!',
      ...
      private_instructions: '[AI_TRANSLATION]모든 수업은 개별 맞춤형으로 진행됩니다. 학생 그룹 등록을 원하시면 <a href="mailto:classes@flsong.iok.la">classes@flsong.iok.la</a>로 연락주세요.',
      ...
      benefit_3: '[AI_TRANSLATION]zgcombat 프리미엄 라이선스 포함',
      ...
      subscription_details: '[AI_TRANSLATION]모든 구독은 월 단위로 청구되며, 추가 비용 없이 일시 중지, 취소, 재개할 수 있습니다. 구독 구매 후 30일 이내에 100% 위험 부담 없이 취소 가능합니다. 어떤 이유에서든 계속하지 않기로 결정한 경우, 구입 후 30일 이내에 <a href="mailto:classes@flsong.iok.la">저희에게 연락</a>해 주시면 즉시 결제 금액 전액을 환불해 드립니다. 모든 계획은 별도의 변경이나 취소가 없는 한 동일한 수준과 청구 주기로 자동 갱신됩니다.',
      ...
      grit_description: '[AI_TRANSLATION]zgcombat는 학생들이 실수를 받아들이고 이를 통해 배울 수 있도록 도전하게 합니다. 내장된 힌트는 학생들이 버그를 식별하고 수정하도록 도와줘서 더 큰 코딩 자신감을 얻게 해줍니다.',
      ...
      faq_a_1: '[AI_TRANSLATION]우리 강사들은 모두 zgcombat을 대표하고 각 학생들에게 재미있고 맞춤형 학습 경험을 제공하도록 신중하게 선발되었다구. 자녀가 우리 강사들과 함께 학습하는 것을 즐길 것이라고 믿지만, 만약 다른 강사로 변경하고 싶다면 언제든지 알려줘!',
      ...
      faq_a_4: '[AI_TRANSLATION]구독 구매는 처음 30일 이내에 100% 위험 부담이 없어. 어떤 이유에서든 계속하고 싶지 않다면, 구매 후 30일 이내에 <a href="mailto:classes@flsong.iok.la">contact us</a>로 연락 주시면 즉시 구매 금액의 100%를 환불해 드릴게. 또한 언제든지 구독을 중지하고 원할 때 다시 활성화할 수 있어.',
      ...
      other_questions: '[AI_TRANSLATION]온라인 수업에 대해 다른 질문이 있으면, <a href="mailto:classes@flsong.iok.la">저희에게 연락</a>해주세요.',
    },
    ...
    parents_landing_2: {
      ...
      live_classes_offered: '[AI_TRANSLATION]zgcombat는 이제 집에서 배우는 학생들을 위한 실시간 온라인 컴퓨터 과학 수업을 제공해. 1:1 또는 소그룹 환경에서 개별 필요에 맞춘 학습 결과를 원하는 학생들에게 딱 좋아.',
      ...
      premium_need_help: '[AI_TRANSLATION]도움이 필요하거나 페이팔을 선호해? <a href="mailto:support@flsong.iok.la">support@flsong.iok.la</a>에 이메일 해.',
      not_sure_kid: '[AI_TRANSLATION]zgcombat이 너희 아이에게 맞을지 잘 모르겠어? 물어봐!\n',
      share_trailer: '[AI_TRANSLATION]우리 게임 트레일러를 자녀에게 보여주고, 시작할 수 있도록 계정을 만들어주세요.',
      why_kids_love: '[AI_TRANSLATION]아이들이 zgcombat을 좋아하는 이유',
      ...
      why_parents_love: '[AI_TRANSLATION]부모님들이 zgcombat을 사랑하는 이유',
      ...
      critical_skills_detail: '[AI_TRANSLATION]아이가 디지털 세계를 탐험하고 시민으로 성장하는 방법을 배울 거야. zgcombat은 아이의 비판적 사고, 창의성, 그리고 회복력을 강화하는 솔루션이야. 모든 산업에서 필요한 기술을 아이에게 제공해줘.',
      parent_support: '[AI_TRANSLATION]부모님 같은 지원자들 덕분에',
      parent_support_detail: '[AI_TRANSLATION]zgcombat에서 우리는 부모야. 우리는 코더고, 교육자야. 하지만 무엇보다도, 우리는 우리 아이들이 무엇을 하든지 가장 성공할 수 있는 기회를 주는 걸 믿는 사람들이야.',
      ...
      quotes_title: '[AI_TRANSLATION]zgcombat에 대한 부모님과 아이들이 말하는 것',
      ...
      quote_3: '[AI_TRANSLATION]"올리버가 파이썬을 잘 사용하고 있어. 그는 zgcombat으로 자신만의 비디오 게임을 만들고 있어. 그는 나에게 그의 게임을 도전하게 하고, 내가 질 때마다 웃어."',
      quote_4: '[AI_TRANSLATION]"이건 내가 가장 좋아하는 일 중 하나야. 매일 아침 일어나서 zgcombat를 해. zgcombat에 점수를 매긴다면 1에서 10까지 중 10점을 줄 거야!"',
      parent: '[AI_TRANSLATION]부모',
      //    student: "Student",
      grade: '[AI_TRANSLATION]점수',
      subscribe_error_user_type: '[AI_TRANSLATION]이미 계정을 등록한 것 같아. zgcombat 프리미엄에 관심이 있다면, team@flsong.iok.la으로 연락해줘.',
      subscribe_error_already_subscribed: '[AI_TRANSLATION]이미 프리미엄 계정에 가입했어.',
      start_free_trial_today: '[AI_TRANSLATION]오늘 무료 체험 시작하기',
      live_classes_title: '[AI_TRANSLATION]zgcombat의 라이브 코딩 수업!',
    ...
    modal_timetap_confirmation: {
      ...
      paragraph_5: '[AI_TRANSLATION]zgcombat을 선택해 주셔서 감사합니다. 컴퓨터 과학 여정에 행운을 빌어요!',
      back_to_coco: '[AI_TRANSLATION]zgcombat으로 돌아가기',
    },
    ...
    hoc_2018_interstitial: {
      welcome: '[AI_TRANSLATION]zgcombat의 Hour of Code에 온 걸 환영해!',
    ...
    school_administrator: {
      ...
      add_additional_teacher: '[AI_TRANSLATION]추가 선생님이 필요해? zgcombat 계정 관리자에게 연락하거나 support@flsong.iok.la으로 이메일 보내.',
      ...
      active_students_stat_description: '[AI_TRANSLATION]활성 학생은 지난 60일 동안 zgcombat에 로그인한 학생 수를 세.',
      project_stat_description: '[AI_TRANSLATION]생성된 프로젝트는 만들어진 게임 및 웹 개발 프로젝트의 총 개수를 계산해.\n',
      no_teachers: '[AI_TRANSLATION]아직 계정에 연결된 학교가 없어요. <strong>District Success Manager</strong>에게 연락하거나 <a href="mailto:schools@flsong.iok.la">schools@flsong.iok.la</a>으로 연락해 대시보드를 설정하세요.',
    ...
    browser_recommendation: {
      title: '[AI_TRANSLATION]zgcombat는 크롬에서 가장 잘 작동해!',
      pitch_body: '[AI_TRANSLATION]최고의 zgcombat 경험을 위해 최신 Chrome 버전을 사용하는 걸 추천해! 아래 버튼을 눌러 최신 Chrome 버전을 다운로드해봐!',
    ...
    events: {
      title: '[AI_TRANSLATION]zgcombat 이벤트',
      main_title: '[AI_TRANSLATION]zgcombat 이벤트',
      ...
      sync_to_google_desc: '[AI_TRANSLATION]이 이벤트를 소유자의 캘린더 대신 당신의 구글 캘린더에 동기화하세요. zgcombat gmail에서만 작동할 수 있습니다.',
    ...
    teacher_dashboard: {
      ...
      want_to_save_tooltip_coco: '[AI_TRANSLATION]<h3>너의 진행 상황을 저장하고 싶어?</h3><p>진행 상황을 저장하고 싶다면 학생 계정을 생성하거나, <i>내 계정 / 학생으로 테스트</i>로 가서 학생으로 zgcombat을 플레이해.</p>  ',
      ...
      ozaria_hs_modal_title: '[AI_TRANSLATION]zgcombat에서 독점적으로 AI Hackstack에 접근하기  ',
      ozaria_hs_modal_blurb: '[AI_TRANSLATION]교육자들은 이제 Ozaria와 동일한 자격 증명을 사용하여 **[https://flsong.iok.la/teachers/classes]zgcombat** 에서 AI Hackstack에 직접 접근할 수 있습니다. 편의를 위해 Ozaria에서 수업을 쉽게 zgcombat으로 가져올 수 있습니다.  ',
    ...
    outcomes: {
      ...
      using_codecombat: '[AI_TRANSLATION]zgcombat의 개인 맞춤 학습 엔진을 사용하여...',
      ...
      coverage_p1_coco: '[AI_TRANSLATION]zgcombat의 전체 커리큘럼은 국제 교육 기술 협회(ISTE), 컴퓨터 과학 교사 협회(CSTA), K-12 컴퓨터 과학 프레임워크와 같은 주요 프로그래밍 표준을 다루고 있어.',
      ...
      coverage_p2_coco: '[AI_TRANSLATION]zgcombat에서는 학생들이 실질적인 컴퓨팅 직무와 컴퓨터 과학의 심화 학습에 가장 잘 준비될 수 있도록, 초보자를 위한 블록 기반 비주얼 프로그래밍 언어 대신에 실제로 타이핑하는 코드와 전체 프로그래밍 언어를 사용해서 Python과 JavaScript를 가르쳐. 이 언어들은 구글부터 뉴욕 타임스까지 많은 회사들이 오늘날 널리 사용하는 언어야.',
      coverage_p2_ozar: '[AI_TRANSLATION]Ozaria는 zgcombat이라는 게임 기반 학습 회사에서 만들어졌어. 우리는 학생들이 실제 코드를 타이핑하면서 현실의 컴퓨팅 직업과 컴퓨터 과학의 추가 학습에 가장 잘 준비될 것이라고 믿어. 그래서 블록 기반 비주얼 프로그래밍 언어 대신, 우리는 Python과 JavaScript를 가르쳐 – 오늘날 구글에서 뉴욕타임스까지 널리 사용되는 언어들이야.',
    ...
    efficacy: {
      ...
      commitment_title: '[AI_TRANSLATION]zgcombat의 효능에 대한 약속',
      ...
      teachers_love_description: '[AI_TRANSLATION]우리 자매 제품인 zgcombat이 컴퓨터 과학 교육 및 학습에 미치는 영향을 탐구해보세요!',
    ...
    league: {
      ...
      summary: '[AI_TRANSLATION]zgcombat AI 리그는 독특하게도 경쟁적인 AI 전투 시뮬레이터이자 실제 파이썬과 자바스크립트 코드를 배우기 위한 게임 엔진이야.',
      join_now: '[AI_TRANSLATION]지금 가입해',
      tagline: '[AI_TRANSLATION]zgcombat AI 리그는 우리의 프로젝트 기반 학습 기준에 맞춘 커리큘럼, 모험 기반 코딩 게임, 그리고 연례 AI 코딩 글로벌 토너먼트를 결합한 다른 어떤 것과도 비교할 수 없는 조직적인 학문적 경쟁입니다.',
      ...
      comprehensive_curr_subheader: '[AI_TRANSLATION]zgcombat은 자바스크립트와 파이썬으로 실제 코딩을 가르칠 수 있도록 교사들을 돕는 표준에 맞춘 CS 솔루션이야, 경험이 없어도 상관없어.',
      ...
      season1_prize_3: '[AI_TRANSLATION]커스텀 zgcombat 아바타',
      season1_prize_4: '[AI_TRANSLATION]그리고 더 많아!',
      season1_prize_hyperx: '[AI_TRANSLATION]HyperX 프리미엄 주변기기',
      codecombat_ai_league: '[AI_TRANSLATION]zgcombat AI 리그',
      register: '[AI_TRANSLATION]등록해',
      ...
      coco_reserves: '[AI_TRANSLATION]zgcombat 예약어',
      ...
      contact_sales_custom: '[AI_TRANSLATION]네 맞춤 토너먼트가 대기 중이야. 사용하고 싶은 경기장을 선택하고 zgcombat 영업 담당자에게 연락해서 설정 및 일정 세부 정보를 확인해.',
      ...
      codecombat_ai_league_description: '[AI_TRANSLATION]zgcombat AI 리그는 프로젝트 기반의 표준에 맞춘 커리큘럼, 모험 기반의 코딩 게임, 그리고 연간 AI 코딩 글로벌 토너먼트를 결합하여 그 어떤 것과도 다른 학술 경쟁을 제공합니다.',
    ...
    payments: {
      ...
      most_popular: '[AI_TRANSLATION]가장 인기 있는',
      best_value: '[AI_TRANSLATION]최고의 가치',
      purchase_licenses: '[AI_TRANSLATION]라이선스를 쉽게 구입해서 zgcombat와 Ozaria에 완전히 접근하세요.',
      ...
      implementation_info: '[AI_TRANSLATION]기관 및 수업 목표를 지원하기 위한 zgcombat과 Ozaria 사용법에 대한 60분 온보딩 트레이닝.\n',
      ...
      full_access_coco: '[AI_TRANSLATION]zgcombat 전체 액세스',
      ...
      bd_subheading: '[AI_TRANSLATION]학생이 10명 이상인 비즈니스 파트너는 zgcombat의 컴퓨터 과학 및 코딩 게임에 대한 프리미엄 접근 권한을 얻을 수 있어:',
      bd_info_list_heading: '[AI_TRANSLATION]zgcombat은 여러 코딩 교육 회사가 선호하는 파트너입니다. 이유는:',
      bd_info_list_1: '[AI_TRANSLATION]학생들은 판타지와 모험 기반의 게임 커리큘럼을 사랑해서 계속해서 더 많은 세션에 돌아와요.',
      bd_info_list_2: '[AI_TRANSLATION]누구나 zgcombat으로 코딩을 가르칠 수 있어; 게임이 주로 가르치고 우리는 광범위한 지원 자원을 제공해',
      bd_info_list_3: '[AI_TRANSLATION]너희는 200시간 이상의 커리큘럼을 받게 될 거야, 네 사업에 필요한 몇 년 간의 교육 콘텐츠를 제공해 줄게',
      bd_includes_1: '[AI_TRANSLATION]zgcombat과 Ozaria의 200시간 이상의 프리미엄 게임 기반 콘텐츠를 완전히 이용 가능',
    ...
    partners: {
      ...
      below_headline_blurb: '[AI_TRANSLATION]zgcombat에서는 코딩을 배우는 것을 재미있게 만들고, 프로그래밍을 가르치는 것을 쉽게 할 수 있는 종합 도구를 개발했어. 우리 솔루션은 다양한 실행에 활용할 수 있어.',
      ...
      esports_blurb: '[AI_TRANSLATION]우리가 이스포츠의 개념을 새롭게 정의하면서 동시에 수천 명의 학생들이 코딩을 배우도록 참여시키고 있어. 엔데믹 이스포츠의 대표주자인 __hyperx__는 zgcombat AI 리그의 첫 시즌부터 지원하며 이 독특한 이스포츠 주위에 매력적인 홍보 프로그램을 구축했어.',
    ...
    podcast: {
      ...
      learn_more_coco: '[AI_TRANSLATION]zgcombat 코딩 체험에 대해 더 알고 싶어?',
      //    subscribe: "Subscribe",
    ...
    library: {
      ...
      access_coco: '[AI_TRANSLATION]zgcombat에 접속하세요\n',
      already_using_library_id: '[AI_TRANSLATION]이미 라이브러리 아이디를 사용 중이야',
      play_coco: '[AI_TRANSLATION]zgcombat을 하다',
      not_library_id: '[AI_TRANSLATION]너의 라이브러리 id가 아냐',
      //    access_using_id: "to access using your id!!",
      network_detected: '[AI_TRANSLATION]라이브러리 네트워크가 감지되었습니다. zgcombat으로 리디렉션 합니다.',
      ...
      communication_limit_blurb: '[AI_TRANSLATION]회원의 안전을 위해, 우리는 게임 내 채팅이나 다른 소통 기능을 제공하지 않지만, 회원들이 안전하게 친구, 가족 및 zgcombat 커뮤니티와 코딩 프로젝트를 공유할 수 있도록 허용해. 우리는 고객에게 방해되지 않는 경험을 제공하기 위해 업셀 또는 마케팅 메시지를 제한해.',
      ...
      library_signup_promotion: '[AI_TRANSLATION]진도 저장하고 zgcombat에서 이어서 하려면 가입하세요!!',
    ...
    related_accounts: {
      subtitle: '[AI_TRANSLATION]다양한 zgcombat 계정 간의 연결을 추가하여 빠르게 전환할 수 있도록 하세요. 예를 들어, 부모라면 아이들의 zgcombat 계정으로 전환할 수 있어요. 혹은 교사라면 학생들이 보는 것을 보기 위해 테스트 학생 계정을 추가할 수 있어요.',
    ...
    modal_free_class: {
      paragraph_1: '[AI_TRANSLATION]zgcombat을 선택해줘서 고마워.',
    ...
    roblox_landing: {
      meta_title: '[AI_TRANSLATION]Roblox에서 zgcombat 월드: 플레이하고, 코딩하고, 창조해봐',
      ...
      box_play_blurb_player: '[AI_TRANSLATION]3D 몰입형 zgcombat Worlds를 탐험해보세요. 여러분의 애완동물을 프로그래밍하고 친구들과의 공유 경험을 통해 창의적 우주로 모험을 떠나세요.',
      ...
      bottom_blurb_parent: '[AI_TRANSLATION]기다릴 필요 없어 - 오늘 바로 우리 라이브 온라인 수업에 __sign-up__ 해서 아이가 코딩을 시작하게 해! 그들을 zgcombat 웹에서 시작하게 해서 zgcombat Worlds Roblox 경험을 가장 먼저 접하게 해줘.',
      bottom_blurb_sign_up: '[AI_TRANSLATION]가입하기',
      bottom_blurb_partner: '[AI_TRANSLATION]교육 비즈니스, 사회적 영향 이니셔티브 또는 국제 유통 기회에 새로운 zgcombat 월드 Roblox 경험을 사용하고 싶으신가요? __reach-out__하여 오늘 파트너십에 대해 논의하세요.',
      ...
      faq_bottom: '[AI_TRANSLATION]더 많은 <a href="https://codecombat.zendesk.com/hc/en-us/categories/18084251471383-zgcombat-Worlds-Roblox-" target="_blank">자주 묻는 질문을 도움말 센터에서 확인하세요</a>. <br />다른 질문이 있으면, <a href="mailto:support@flsong.iok.la">연락주세요</a>.',
      modal_title: '[AI_TRANSLATION]zgcombat Worlds<br> 이제 Roblox에서 라이브!',
    ...
    ai: {
      ...
      hackstack_promotion_blurb: '[AI_TRANSLATION]AI가 처음이세요? <b>zgcombat AI HackStack</b>을 탐험해보세요. AI 문해력의 가장 쉬운 경로입니다. ChatGPT-4, Claude, Stable Diffusion, DALL-E의 잠재력을 열어보세요. 이 혁신적인 도구는 손쉬운 AI 훈련을 제공하여 창조를 간단하게 만듭니다.',
    ...
    home_v3: {
      ...
      testimonals_2_title: '[AI_TRANSLATION]"온라인에서 어떤 프로그램이든 시도해봤어. zgcombat & Ozaria에 비할 만한 건 없어. 학생들이 코딩을 배우게 하고 싶은 선생님들... 여기가 시작점이야!"',
      ...
      testimonals_4_title: '[AI_TRANSLATION]"내가 zgcombat에서 가장 좋아하는 점은 코딩을 단순화하지 않는 것이야. 학생들이 실제 코드를 작성하는 법을 배우면서도, 재미를 느끼며 하고 있다는 점이 좋아."',
      ...
      engaging_boxes_2_title: '[AI_TRANSLATION]zgcombat 교실\n',
      engaging_boxes_2_text: '[AI_TRANSLATION]핵심 개념부터 웹 개발, 게임 개발 및 **[https://flsong.iok.la/apcsp]AP CSP**까지 구축하는 전체 CS 커리큘럼.',
      engaging_boxes_3_title: '[AI_TRANSLATION]Roblox의 zgcombat 월드',
      engaging_boxes_3_text: '[AI_TRANSLATION]Roblox 교육과 협력하여, 이 AI 지원 경험은 학생의 코딩 능력을 슈퍼 차지하고 멋진 게임과 경험을 창출할 수 있는 실제 세계 플랫폼을 제공해.',
      engaging_boxes_4_title: '[AI_TRANSLATION]zgcombat AI 리그 이스포츠',
      ...
      engaging_boxes_6_title: '[AI_TRANSLATION]zgcombat 홈',
      ...
      young_learners_1_title: '[AI_TRANSLATION]zgcombat 주니어',
      ...
      solutions_8_text: '[AI_TRANSLATION]zgcombat은 완전 자율 학습 디지털 리소스로, 모든 연령대의 사람들이 코딩을 배울 수 있도록 도와주는 최고의 플랫폼이야. 우리 플랫폼은 고유의 흥미진진한 게임 기반 커리큘럼을 통해 고급 코딩 교육을 경험할 수 있는 모든 것을 제공해. 초보자부터 대학 수준의 코딩 개념을 마스터하고 싶은 사람들까지 모두에게 완벽해.',
    ...
    schools_page: {
      meta_title: '[AI_TRANSLATION]zgcombat: 학교를 위한 가장 효과적인 컴퓨터 과학 솔루션',
      ...
      first_year_high_school_curriculum: '[AI_TRANSLATION]첫해 고등학교 커리큘럼은 **AP CS 원리**에 중점을 두고 있어, 여기에는 zgcombat 코스, CS1−CS4 및 **데이터 과학**과 **컴퓨팅 시스템**과 같은 시험 커리큘럼 내용이 포함돼. 더 고급 학년에서는 학생들이 **고급 CS 코스**를 더 탐구할 수 있고, 세 가지 플랫폼에서 목소리와 선택권을 제공해.',
      ...
      testimonials_3_quote: '[AI_TRANSLATION]"zgcombat은 우리가 진행했던 프로그램 중 가장 구현하기 쉬운 것 중 하나였고, 학생들의 참여도가 매우 높았어. 콘텐츠가 설계된 방식이 완벽하게 발판을 마련해주고, 학생들이 우리가 기대했던 것 이상으로 고급 프로그래밍 기술을 빠르게 익히게 해줬어."',
      ...
      faq_6_answer: '[AI_TRANSLATION]컴퓨터 과학 교육은 학생의 학업 여정에서 중요한 요소가 되었지만, 많은 학교가 학생들에게 포괄적인 컴퓨터 과학 프로그램을 제공하는 데 필요한 자원을 확보하는 데 어려움을 겪고 있어. zgcombat에서는 학교가 직면한 자금 문제를 이해하고, 이 문제를 극복하는 데 열정을 가지고 있어. 보조금은 귀중한 자원이 될 수 있지만 찾아내고 신청하기가 어렵지. 우리의 포괄적인 **[https://flsong.iok.la/grants] 보조금 가이드**를 확인하거나 더 알고 싶다면 우리 팀과 이야기해봐.',
      ...
      faq_8_answer: '[AI_TRANSLATION]우리 는 Clever와 구글 클래스룸 통합을 제공 해. 시작하는 방법에 대한 자세한 내용은 **[https://flsong.iok.la/teachers/resources/clever-faq]Clever 통합 FAQ**를 확인해봐. 구글 클래스룸을 사용하고 있다면 구글 단일 로그인 (SSO) 모달 을 사용해서 교사 계정을 등록해. 이미 구글 이메일로 계정을 갖고 있다면, 다음 번에 구글 SSO 모달을 사용해 로그인해. 수업 만들기 모달에서 구글 클래스룸 연결 옵션을 볼 수 있어. 현재는 구글 클래스룸을 통한 명부 작성만 지원해. 참고: 구글 SSO를 사용하여 최소 한 번은 등록 하거나 로그인 해야 구글 클래스룸 통합 옵션을 볼 수 있어.',
      faq_9_question: '[AI_TRANSLATION]추천 브라우저와 운영 체제',
      faq_9_answer: '[AI_TRANSLATION]zgcombat과 Ozaria는 최소 4GB RAM이 있는 컴퓨터에서 최적의 성능을 발휘하며, Chrome, Safari, Firefox, 또는 Edge와 같은 최신 브라우저에서 실행돼. 2GB RAM을 가진 크롬북은 이후 수업에서 약간의 그래픽 문제가 있을 수 있어. 학생당 최소 200 Kbps의 대역폭이 필요하며, 1Mbps 이상의 속도가 권장돼.',
      ...
      core_curriculum_2_title: '[AI_TRANSLATION]zgcombat 교실\n',
      core_curriculum_2_text: '[AI_TRANSLATION]핵심 개념부터 시작해서 웹 개발, 게임 개발까지 이어지는 완전한 CS 커리큘럼 **[http://flsong.iok.la/apcsp]AP CSP**.',
      core_curriculum_2_link_text: '[AI_TRANSLATION]이 작업에는 로봇이 확실히 필요해.',
      practice_enrichment_1_title: '[AI_TRANSLATION]zgcombat AI 리그 이스포츠',
      ...
      practice_enrichment_2_title: '[AI_TRANSLATION]Roblox의 zgcombat 월드',
    ...
    standards_page: {
      ...
      most_effective_computer_science_solution: '[AI_TRANSLATION]가장 효과적인 컴퓨터 과학 솔루션 **[https://flsong.iok.la/schools]학교들**을 위해',
      ...
      carousel_1_text: '[AI_TRANSLATION]**[https://csteachers.org/k12standards/]컴퓨터 과학 교사 협회 K-12 컴퓨터 과학 표준**은 K-12 전체 컴퓨터 과학 커리큘럼과 그 구현을 위한 핵심 학습 목표를 제시합니다.[NEWLINE]zgcombat는 CSTA에서 공식 인정한 커리큘럼 및 전문성 개발 제공자로 인정받았습니다. 우리 자가 학습, CSTA 인증 **[https://www.ozaria.com/professional-development]Professional Development** 과정을 통해 컴퓨터 과학을 효과적으로 가르치는 기술을 배워보세요. 언제 어디서든 최대 40학점 취득이 가능합니다.[NEWLINE]아래에서 자세한 CSTA 표준 정렬에 대해 알아보세요:',
      ...
      carousel_2_text: '[AI_TRANSLATION]zgcombat은 AP® 컴퓨터 과학 원칙 (AP CSP)에 대한 교과 과정 및 전문 개발의 공인 제공자로 대학 위원회의 인정을 받았어. 이 인정은 zgcombat의 교과 과정이 모든 AP 교과 과정 프레임워크 표준 및 AP CSP 평가와 일치한다는 것을 확인해 줘. 이를 통해 학교는 대학 위원회의 과정 감사에서 사전 승인된 AP CSP 강의 계획서와 공식적으로 인정된 전문 개발에 접근할 수 있어, 이는 교사가 이 커리큘럼을 가르칠 준비를 할 수 있게 도와줘.[NEWLINE]아래에서 우리 zgcombat AP CSP 커리큘럼에 대해 더 알아봐:',
      carousel_2_button_1_text: '[AI_TRANSLATION]zgcombat AP CSP',
      carousel_3_title: '[AI_TRANSLATION]국제 교육 기술 협회 (ISTE)',
      carousel_3_text: '[AI_TRANSLATION]도구가 아닌 교육학에 중점을 둔 **[https://iste.org/standards]ISTE 표준**은 모든 학생들에게 고효율, 지속 가능, 확장 가능한 학습 경험을 제공하기 위해 기술을 사용하는 교육자들을 안내하는 틀이야.[NEWLINE]zgcombat의 커리큘럼은 모든 ISTE 표준을 충족하도록 설계되었어, 학생과 교사 모두를 위해.[NEWLINE]아래에서 자세한 ISTE 표준 정렬에 대해 알아봐:',
      ...
      carousel_4_text: '[AI_TRANSLATION]**[https://corestandards.org/]Common Core State Standards**는 K-12 수학 및 영어 언어 예술에 대한 일관된 학업 표준 세트야.[NEWLINE]zgcombat은 우리의 커리큘럼 전반에 걸쳐 핵심 과목 영역에 다양한 교차 커리큘럼 연결을 통합하고 있어. [NEWLINE]아래에서 자세한 Common Core Standards 조정에 대해 알아봐:',
      ...
      carousel_5_text: '[AI_TRANSLATION]**[https://www.nextgenscience.org/]차세대 과학 교육 표준 (NGSS)**은 K-12 과학 교육 내용 기준으로, 학생들이 알아야 할 것과 할 수 있어야 할 것에 대한 기대치를 설정합니다. 이 표준은 모든 학생의 과학 교육을 향상시키기 위해 각 주에서 개발되었습니다.[NEWLINE]zgcombat은 NGSS에서 중요한 과학과 공학 개념을 도입하기에 완벽한 교육 커리큘럼 파트너입니다.[NEWLINE]아래에서 자세한 NGSS 표준 정렬에 대해 알아보세요:',
    ...
    codequest_page: {
      ...
      core_curriculum_text_23: '[AI_TRANSLATION]닉은 zgcombat의 창립자이자 CEO야. 교육 기술 분야에서 인정받은 리더인 닉은 교육에 대한 열정을 기술 전문성과 결합하여 전 세계 학생들이 프로그래밍을 더 쉽게 배우고 재미있게 만들고 있어. zgcombat 이전에는 중국어와 일본어 문자를 배우는 플랫폼인 Skritter를 공동 창립했어. 교육 분야에 혁신을 가져오는 데 강한 의지를 가진 닉은 코딩을 미래 세대에게 중요한 기술로 만드는 데 적극적으로 기여하고 있어. 그의 헌신과 비전은 에드테크 분야에 영감을 주고 지속적인 영향을 미치고 있어.  ',
    ...
    hackstack: {
      ...
      'HowItWorksPage_codecombat-ai-hackstack-is-an-all-in-one': '[AI_TRANSLATION]zgcombat AI HackStack은 게임, 예술, 음악, 앱 등을 채팅만으로 만들 수 있는 올인원 AI 도구야. 모든 걸 실행해주고, 프로젝트를 호스팅하며, 코딩을 도와줘. CORE 모드는 무료로, 선택형 프롬프트를 통해 배울 수 있어. PRO+ 모드는 월 $9.99로 자유 형식의 프롬프트를 제공해. 프로젝트는 안전하게 보호되고 빅 테크 데이터에 사용되지 않아. zgcombat 팀이 모두에게 AI를 접근할 수 있게 만들었어. 이제, 창작을 시작해보자.',
      ...
      'HowItWorksPage_learn-anything-create-something-do-every': '[AI_TRANSLATION]아무거나 배워봐, 뭔가를 만들어봐, zgcombat AI HackStack으로 뭐든 해봐. 모두를 위한 AI 파워업!',
      ...
      'HowItWorksPage_the-codecombat-team-they-got-really-good': '[AI_TRANSLATION]zgcombat 팀. 그들은 2천만 명의 초보자들에게 게임 기반 학습으로 코딩을 가르치는 것을 정말 잘하게 되었어. 기술이 충분히 좋아졌을 때, 그들은 AI도 동일하게 만들고 싶어했지. AI가 창조의 미래라면, 누구나 쉽게 사용할 수 있도록 만들어야 해!',
      ...
      'NewProjectPage_prompt-the-ai-to-create-websites-games-w': '[AI_TRANSLATION]zgcombat AI HackStack으로 웹사이트, 게임, 웹 앱, 이야기, 예술 등을 만드는 AI를 유도해봐.',
    ...
    parents_v2: {
      ...
      grid_codecombat_worlds: '[AI_TRANSLATION]zgcombat 세상',
      ...
      grid_ai_hints_allowance: '[AI_TRANSLATION]zgcombat 인공지능 힌트 할당량 (일일)***',
      grid_prompts_allowance: '[AI_TRANSLATION]zgcombat AI HackStack 프로토콜 허가 (월별)***',
      ...
      enroll_now: '[AI_TRANSLATION]또는, **[https://flsong.iok.la/payments/initial-online-classes-71]지금 등록하기**',
      ...
      teach_child: '[AI_TRANSLATION]아이를 가르칠 계획이라면, 우리 커리큘럼을 집에서 쉽게 전달할 수 있게 도와줄 수 있어. 성공을 위한 모든 교재와 가이드가 제공돼. 자세한 내용을 알아보려면 우리 팀에 연락해줘 - **[mailto:classes@flsong.iok.la]classes@flsong.iok.la**로 학습 어드바이저와 연결해봐.',
      ...
      codecombat_worlds_title: '[AI_TRANSLATION]zgcombat 세상',
      ...
      carousel_items_2_text: '[AI_TRANSLATION]너희 아이가 게임을 좋아하고 만들기를 원한다면, 우리 게임 개발 중심 커리큘럼은 초기 게임 개발 활동 및 프로젝트에서 zgcombat을 핵심으로 다룰 거야. 금방 아이는 zgcombat 세계에서 게임을 만들고 Roblox 플랫폼에 게시할 수 있을 거야. AI 리그에 참가하면 성공적인 게임 역학과 개발에 대한 추가 통찰을 제공하며, AI HackStack은 반복적인 게임 개발을 위한 강력한 도구가 될 거야.',
      carousel_items_3_title: '[AI_TRANSLATION]웹[NEWLINE]개발',
      carousel_items_3_title_prefix: '[AI_TRANSLATION]**초점:**',
      carousel_items_3_text: '[AI_TRANSLATION]웹 개발은 계속 진화하고 있어, 그래서 앞서 나가는 게 중요해. 이 커리큘럼에서는 초기 웹 개발 활동을 zgcombat에서 진행하고, 코딩 초보자들을 위해 Ozaria를 사용할 거야. AI HackStack을 웹에 게시하는 플랫폼으로 많이 활용할 거야, zgcombat Worlds와 AI League는 주요 코딩 개념을 강화하는 데 제한적으로 사용할 거고.',
      carousel_items_4_title: '[AI_TRANSLATION]경쟁적인[NEWLINE]코딩 e스포츠  ',
      carousel_items_4_title_prefix: '[AI_TRANSLATION]**초점:**',
      carousel_items_4_text: '[AI_TRANSLATION]e스포츠 팬들은 이 커리큘럼의 경쟁 정신을 사랑할 거야. zgcombat 기반의 기초로, 당신의 아이는 장학금과 상금이 걸린 우리의 AI 리그 글로벌 e스포츠 대회에 연중 내내 출전할 거야. 창의적인 코딩과 반복을 강조하면서 당신의 아이는 경쟁에서 능력을 극대화할 수 있는 우리 AI HackStack 도구를 사용하는 방법을 배울 거야.',
      carousel_items_5_title: '[AI_TRANSLATION]AI[NEWLINE]응용 프로그램',
      carousel_items_5_title_prefix: '[AI_TRANSLATION]**초점:**',
      carousel_items_5_text: '[AI_TRANSLATION]AI는 어디에나 있고, 그 힘을 최대한 활용하는 사람들은 잠재력을 극대화할 수 있어. 이 커리큘럼은 zgcombat에서 시작하여, AI HackStack을 통해 강력한 AI 프롬프트 작성과 최신 생성형 AI 도구들을 안전하고 보안적인 환경에서 사용하는 방법을 가르쳐 줄 거야. zgcombat Worlds에 내장된 생성형 AI 기능은 자녀가 AI로 무엇을 할 수 있는지 또 다른 실제 기회를 제공할 거야.',
      ...
      faq_5_answer: '[AI_TRANSLATION]구독 구매는 첫 30일 동안 100% 무위험이야. 만약 어떤 이유로든 계속하지 않기로 했다면, 구매 후 30일 이내에 **[mailto:classes@flsong.iok.la]classes@flsong.iok.la**으로 연락해 주면 묻지도 따지지도 않고 100% 환불해 줄게.',
      faq_6_question: '[AI_TRANSLATION]수업 재조정이 필요한 경우 어떻게 하나요?',
      faq_6_answer: '[AI_TRANSLATION]일단 주간 수업을 예약하시면, 저희 스케줄에 당신만을 위해 시간을 비워두기 때문에 수업을 재조정하려면 최소 48시간 전에 알려주셔야 합니다. **[mailto:classes@flsong.iok.la]classes@flsong.iok.la**로 이메일을 보내 수업 일정을 변경할 수 있습니다. 48시간 미만의 통보로 놓친 수업이나 취소된 수업은 다시 조정되거나 환불되지 않습니다.',
      ...
      faq_9_answer: '[AI_TRANSLATION]형제자매나 그룹 수업 할인해줘. 우리가 그룹 수업을 따로 구성하진 않지만, 같이 공부하려는 그룹이 있으면 우리가 도와줄게. 가격 관련 질문은 **[mailto:classes@flsong.iok.la]classes@flsong.iok.la**에 문의해줘.',
      ...
      faq_12_answer: '[AI_TRANSLATION]영어와 스페인어 모두에서 전체 수업 경험을 제공합니다. 그러나 재능 있는 강사 그룹은 다양한 언어를 구사합니다. 특정 언어를 선호하는 경우, **[mailto:classes@flsong.iok.la]classes@flsong.iok.la** 으로 연락하셔서 자녀의 선호 언어를 수용할 수 있는지 확인해 주세요.',
    ...
    roblox: {
      ...
      link_reward_desc: '[AI_TRANSLATION]zgcombat 계정이랑 Roblox 계정을 연결하면 기능하고 보상을 잠금 해제할 수 있어',
      ...
      faq_3_answer: '[AI_TRANSLATION]그래. 플레이어들은 zgcombat Worlds 안에서 경험을 공유하고, 스튜디오에 플러그인을 통해 발행할 수 있도록 경험을 가져올 수 있어. 스튜디오 호환성도 유지돼.',
      faq_4_question: '[AI_TRANSLATION]로블록스 계정이 필요한가요?  ',
      faq_4_answer: '[AI_TRANSLATION]그래. 모든 플레이어는 roblox.com에서 무료로 회원가입할 수 있어. 모든 기능과 보상을 받으려면 zgcombat 계정과 Roblox 계정을 연결하는 걸 잊지 마.',
      faq_5_question: '[AI_TRANSLATION]내 Chromebook이나 모바일 기기에서 작동할까?  ',
      faq_5_answer: '[AI_TRANSLATION]그래. zgcombat Worlds에서는 PC, Mac, 크롬북, 태블릿, 핸드폰, 콘솔에서 실제 코딩을 하고 게임을 만들 수 있어.',
    ...
    pd_page: {
      ...
      implementation_training_blurb: '[AI_TRANSLATION]교육자들은 zgcombat이나 Ozaria를 사용하여 특정한 기관 및 교육 목표를 지원하는 방법에 대한 60분의 라이브 온라인 온보딩 교육과 가이드를 받습니다. 이 구현은 포괄적인 교사 대시보드 지침에 중점을 두어 다음 내용들을 포함합니다:  ',
      ...
      ap_csp_professional_development_title: '[AI_TRANSLATION]AP CSP 전문가 개발[NEWLINE](With zgcombat)  ',
      ap_csp_professional_development_blurb: '[AI_TRANSLATION]40시간이 넘는 이 온라인, 주로 자기 주도형 코스는 AP 컴퓨터 과학 원칙 시험을 위해 zgcombat을 사용하는 모든 교육자에게 이상적이야.  ',
      list_7: '[AI_TRANSLATION]이 코스와 zgcombat AP CSP 커리큘럼은 모두 College Board의 승인을 받았어. 이 코스를 완료한 시간은 가치 있는 전문 교육 크레딧으로 사용할 수 있어.',
      list_8: '[AI_TRANSLATION]이 과정은 전 세계 AP CSP 교사들과 동기식, 소규모 그룹 대화를 통해 CS 지식을 깊이 있게 하고 교실 활동을 풍요롭게 해줄 거야.',
      list_9: '[AI_TRANSLATION]zgcombat이 남부 뉴햄프셔 대학교(SNHU)와의 파트너십을 통해 AP CSP 시험 준비를 최적화하는 방법을 배우면서 최대 3학점의 대학원 학점을 얻을 수 있어.',
