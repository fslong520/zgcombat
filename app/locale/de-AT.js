module.exports = {
  ...
  translation: {
    ...
    diplomat_suggestion: {
      title: 'Hilf zgcombat zu übersetzen!',
      sub_heading: 'Wir brauchen Deine Sprachfähigkeiten.',
      pitch_body: 'Wir entwickeln zgcombat in Englisch, aber wir haben Spieler in der ganzen Welt. Viele von ihnen wollen in Deutsch (Österreich) spielen, sprechen aber kein Englisch. Wenn Du also beide Sprachen beherrscht, melde Dich an um ein Diplomat zu werden und hilf die Website und die Levels zu Deutsch (Österreich) zu übersetzen.',
    ...
    play_level: {
      ...
      tip_open_source: 'zgcombat ist 100% quelloffen!',
    ...
    premium_features: {
      get_premium: 'Hol dir<br>zgcombat<br>Premium',
    ...
    account_settings: {
      ...
      email_notifications_summary: 'Steuerung für personalisierte, automatische Emailbenachrichtigungen im Zusammenhang mit deiner zgcombat Aktivität.',
    ...
    community: {
      ...
      article_editor_suffix: 'und hilf zgcombat Spielern das meiste aus ihrer Spielzeit heraus zu bekommen.',
    ...
    contribute: {
      ...
      diplomat_introduction_suf: 'ist das es ein großes Interesse an zgcombat in anderen Ländern gibt! Wir stellen eine Truppe von Übersetzern zusammen, die gewillt sind einen Satz Wörten in einen anderen Satz Wörter umzuwandeln um zgcombat der Welt so zugänglich wie möglich zu machen. Wenn du es magst eine Vorschau von zukünftigem Content zu erhalten und diese Level so schnell wie möglich deinen Landsleuten zur Verfügung zu stellen, dann ist diese Klasse vielleicht für dich.',
      ...
      ambassador_introduction: 'Wir bauen einen Community und du bist die Verbindung dazu. Wir haben Olark Chats, Email und soziale Netzwerke mit vielen Menschen mit denen man sprechen, dabei helfen mit dem Spiel vertraut zu werden und von lernen kann. Wenn du helfen möchtest Leute zu involvieren, Spass zu haben und ein gutes Gefühl für den Puls von zgcombat und wo wir hn wollen, dann könnte diese Klasse für dich sein.',
    ...
    legal: {
      ...
      opensource_description_center: ' an und mach mit wenn Du möchtest! zgcombat baut auf duzenden Open Source Projekten auf, und wir lieben sie. Schau dir die Liste in ',
      ...
      code_description_suffix: 'Dies beihnhaltet all den Code in Systemen und Komponenten der für die Erstellung von Levels durch zgcombat zu Verfügung gestellt wird.',
    ...
    browser_recommendation: {
      title: 'zgcombat funktioniert am besten in Chrome!',
      pitch_body: 'Für das beste zgcombat-Erlebnis empfehlen wir, die neueste Version von Chrome zu nutzen. Downloade die aktuelle Version indem du auf den Button unten klickst.',
