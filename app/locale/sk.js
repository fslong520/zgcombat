module.exports = {
  ...
  translation: {
    ...
    new_home: {
      ...
      codecombat_is: 'zgcombat je platforma  <strong>pre študentov</strong>, kde sa naučia programovať hrou. ',
      ...
      watch_how: 'Pozri si ako zgcombat mení spôsob učenia informatiky.',
      ...
      agency: 'zgcombat je hra, ktorá umožňuje vďaka robustnému kódovaciemu enginu písať začiatočníkom aj pokročilým čistý a validný kód.',
      ...
      want_coco: 'Chceš zgcombat na svojej škole?',
      //    educator: "Educator",
      //    student: "Student",
    ...
    diplomat_suggestion: {
      title: 'Pomôžte preložiť zgcombat!',
      sub_heading: 'Potrebujeme tvoje jazykové zručnosti.',
      pitch_body: 'zgcombat je vyvíjaný v angličitne, ale hrajú ho hráči z celého sveta. Máme aj hráčov, ktorí potrebujú preklad do slovenčiny. Ak vieš teda po anglicky aj po slovensky, prihlás sa ako diplomat a pomôž s prekladom stránky a úrovní do slovenčiny.',
    ...
    share_progress_modal: {
      blurb: 'Postupuješ míľovými krokmi ! Povedz kamarátom, čo si sa už naučil pomocou zgcombatu.',
    ...
    signup: {
      ...
      teacher_type_1: 'Uč programovať pomocou hry zgcombat!',
    ...
    play_level: {
      ...
      explore_codecombat: 'preskúmaj zgcombat',
      ...
      tip_tell_friends: 'Užívaš si zgcombat? Povedz to svojím priateľom!',
      tip_beta_launch: 'zgcombat spustil svoju beta verziu v októbri roku 2013.',
      ...
      tip_open_source_contribute: 'Aj ty môžeš zlepšiť zgcombat !',
    ...
    play_game_dev_level: {
      ...
      restart: 'Začni znovu',
      play: 'Hraj level',
      play_more_codecombat: 'Hraj ďalej zgcombat',
    ...
    subscribe: {
      ...
      thank_you: 'Ďakujeme za podporu zgcombatu.',
      ...
      unlock_help_videos: 'Predplať si zgcombat a získaj prístup ku videonávodom.',
    ...
    premium_features: {
      get_premium: 'Staň sa preplatiteľom hry <br>zgcombat<br>',
      ...
      subscribe_now: 'Predplať si zgcombat',
    ...
    about: {
      ...
      main_description: 'Úlohou zgcombatu je programovanie s úsmevom.',
      mission_link: 'Cieľ',
      team_link: 'Tím',
      story_link: 'Príbeh',
      press_link: 'Pre tlač',
      mission_title: 'Náš cieľ: Sprístupnenie programovania pre všetkých.',
      mission_description_1: '<strong>Programovanie je mágia</strong>.Je to možnosť, ako využiť svoju predstavivosť. Začali sme s zgcombatom, aby naši študenti pocítili magické schopnosti pri <strong>písaní kódu</strong>.',
      ...
      team_title: 'Zoznám sa s tímom zgcombat',
      ...
      story_subtitle: 'Všetko sa začalo v roku 2013, keď sa začal  zgcombat meniť z pár náčrtov na živú, vzrušujúcu hru',
      story_statistic_1a: '20,000,000+',
      story_statistic_1b: 'hráčov',
      story_statistic_1c: 'svoju programátorskú dráhu vďaka zgcombatu.',
      ...
      jobs_title: 'Pridaj sa ku nám a začni aj ty písať históriu zgcombatu!',
      jobs_subtitle: 'Máš schopnosti, ktoré by si chcel využiť pri rozvoji zgcombatu? Pozri si  "Vytvor si svoju pozíciu" .',
      ...
      jobs_custom_description: 'Zaujíma ťa  zgcombat, ale nevidíš pozíciu, ktorá by zodpovedala tvojej kvalifikácii? Napíš nám, ako by si mohol prispieť ku nášmu dielu. Radi si to prečítame',
    ...
    contact: {
      ...
      subscribe: 'kúp si predplatné pre zgcombat',
    ...
    account_settings: {
      ...
      email_announcements_description: 'Chcem dostávať emaily o novinkách a vývoji programu zgcombat.',
      email_notifications: 'Oznámenia',
      email_notifications_summary: 'Ovládanie osobných, automatických emailových oznámení o tvojej aktivite v programe zgcombat.',
    ...
    community: {
      ...
      article_editor_suffix: 'a pomôž hráčom, aby získali, čo najviac z hrania na zgcombat.',
      ...
      social_facebook: 'Daj Like zgcombatu na Facebooku',
      social_twitter: 'Sleduj zgcombat na Twitteri',
    ...
    classes: {
      ...
      archmage_summary: 'Ak si vývojár so záujmom o kódovanie vzdelávacíh hier, staň sa Arcimágom a pomôž nám s vývojom  zgcombatu !',
      ...
      diplomat_summary: 'zgcombat je preložený vďaka naším diplomatom do  45+ jazykov. Pomôž nám s prekladom.',
      ambassador_title: 'Ambasador',
      ambassador_title_description: '(Poradca)',
      ambassador_summary: 'Kroť použivateľov nášho fóra a nasmeruj na správnu cestu tých, čo sa pýtajú. Naši ambasádori reprezentujú  zgcombat na celom svete.',
      teacher_title: 'učiteľ',
    },

    editor: {
      main_title: 'Editory pre zgcombat',
    ...
    contribute: {
      ...
      intro_blurb: 'zgcombat je  100% open source! Stovky nadšených hráčov nám pomohli dostať hru na dnešnú úroveň. Pripoj sa k nám a napíš ďalšiu kapitolu zgcombatu, ktorý učí svet kódovať!',
    ...
    legal: {
      ...
      opensource_description_center: 'a pomôž nám, ak máš chuť! zgcombat je založený na tucte projektov open source, ktoré milujeme. Pozri sa ',
