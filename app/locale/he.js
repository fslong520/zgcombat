module.exports = {
  ...
  translation: {
    ...
    new_home: {
      ...
      codecombat_is: 'zgcombat היא פלטפורמה <strong>לתלמידים</strong>, ללימוד מדעי המחשב, תוך כדי חויית משחק מחשב אמיתי.',
      ...
      agency: 'zgcombat הוא משחק שמעצים תלמידים ומעניק להם ביטחון באמצעות המנוע המקיף שלנו לקידוד בהקלדה, אשר עוזר לתלמידים מתחילים ומתקדמים כאחד, עם קוד נכון ותקין.',
      ...
      want_coco: 'רוצים את zgcombat אצלכם בבית הספר?',
      //    educator: "Educator",
      //    student: "Student",
    ...
    diplomat_suggestion: {
      title: 'עזרו לתרגם את zgcombat!',
      sub_heading: 'אנו זקוקים לכישורי השפה שלכם',
      pitch_body: 'אנו מפתחים את zgcombat בשפה האנגלית, אך כבר יש לנו שחקנים בכל העולם. רבים מהם רוצים לשחק בשפה English אך אינם דוברים אנגלית. לכן, אם אתם דוברים את שתי השפות, אנא שקלו להירשם בתור דיפלומט ולעזור לתרגם את אתר האינטרנט ואת כל השלבים של zgcombat לשפה English.',
    ...
    share_progress_modal: {
      blurb: 'אתם מתקדמים נהדר! ספרו להורה שלכם כמה למדתם עם zgcombat.',
    ...
    signup: {
      ...
      email_announcements: 'קבלו הודעות על שלבים ותכונות חדשים ב-zgcombat!',
      ...
      teacher_type_1: 'למדו תלמידים תכנות באמצעות zgcombat!',
    ...
    play_level: {
      ...
      explore_codecombat: 'לחקור את zgcombat',
      ...
      tip_open_source: 'zgcombat בנוי מ-100% קוד פתוח!',
      tip_tell_friends: 'נהנים מ-zgcombat? ספרו עלינו לחברים שלכם!',
      tip_beta_launch: 'zgcombat הושק בגרסת ביתא באוקטובר 2013.',
      ...
      tip_open_source_contribute: 'אתם יכולים לעזור ל-zgcombat להשתפר!',
    ...
    play_game_dev_level: {
      ...
      play: 'שחקו בשלב',
      play_more_codecombat: 'שחקו עוד zgcombat',
    ...
    subscribe: {
      ...
      subscribe_modal_title: 'zgcombat פרימיום',
      ...
      thank_you: 'אנו מודים לכם על התמיכה ב-zgcombat.',
    ...
    premium_features: {
      get_premium: 'מנוי<br>zgcombat<br>פרימיום',
      ...
      everything_in_premium: 'כל מה שתקבלו ב-zgcombat פרימיום:',
    ...
    about: {
      ...
      main_description: 'המשימה שלנו ב-zgcombat היא לוודא שאתם עושים זאת עם חיוך על הפנים.',
      mission_link: 'המשימה',
      team_link: 'הצוות',
      story_link: 'הסיפור',
      press_link: 'עיתונות',
      mission_title: 'המשימה שלנו: להפוך את התכנות נגיש לכל תלמיד בעולם.',
      mission_description_1: '<strong>תכנות זה קסם</strong>. הוא היכולת ליצור דברים מתוך הדמיון עצמו. הקמנו את zgcombat כדי להעניק ללומדים תחושה של כוחות קסם בקצות אצבעותיהם, דרך השימוש ב<strong>קוד מוקלד</strong>.',
      ...
      team_title: 'הכירו את הצוות של zgcombat',
      ...
      community_subtitle: 'למעלה מ-500 תורמים כבר עוזרים לבנות את zgcombat, ותורמים נוספים מצטרפים מדי שבוע!',
      community_description_3: 'zgcombat הוא',
      community_description_link_2: 'פרויקט קהילתי',
      community_description_1: 'עם מאות שחקנים שמתנדבים ליצור שלבים, תורמים לקוד שלנו כדי להוסיף תכונות, מתקנים באגים, בודקים את המשחק ואפילו מתרגמים את המשחק ל-50 שפות עד כה. העובדים, התורמים והאתר מרוויחים משיתוף רעיונות וממאמצים משותפים, וכך גם קהילת הקוד הפתוח באופן כללי. האתר בנוי על אינספור פרויקטים של קוד פתוח, ואנו פועלים במתכונת של קוד פתוח כדי לתרום בחזרה לקהילה ולספק לשחקנים חובבי קוד פרויקט מוכר שאפשר לחקור ולערוך בו ניסויים. כל אחד יכול להצטרף לקהילה של zgcombat! בואו לראות את',
      ...
      story_subtitle: 'מאז שנת 2013, zgcombat צמח מאוסף של סקיצות למשחק חי ומשגשג.',
      story_statistic_1a: 'יותר מ-20,000,000',
      story_statistic_1b: 'שחקנים בסך הכול',
      story_statistic_1c: 'התחילו את המסע שלהם בעולם התכנות דרך zgcombat',
      ...
      jobs_title: 'בואו לעבוד אתנו ולעזור לכתוב את ההיסטוריה של zgcombat!',
      ...
      jobs_custom_description: 'מתלהבים מ-zgcombat, אבל לא מוצאים כאן משרה שמתאימה לכישורים שלכם? כתבו וספרו לנו כיצד לדעתכם תוכלו לתרום לצוות שלנו. נשמח לשמוע מכם!',
      ...
      about_codecombat: 'אודות zgcombat',
      logo: 'לוגו',
    ...
    teachers_quote: {
      ...
      country: 'ארץ',
      num_students_help: 'עם כמה תלמידים, לדעתכם, אתם צפויים להשתמש ב-zgcombat?',
      ...
      thanks_sub_header_coco: 'אנו מודים לכם על גילוי העניין ב-zgcombat עבור מוסד הלימודים שלכם.',
      thanks_sub_header_ozar: 'אנו מודים לכם על גילוי העניין ב-zgcombat עבור מוסד הלימודים שלכם.',
      ...
      learn_more_modal: 'חשבונות מורה ב-zgcombat מסוגלים לעקוב אחר התקדמות התלמידים, להקצות רישיונות ולנהל כיתות. חשבונות מורה לא יכולים להיות חלק מהכיתה - אם אתם רשומים כעת בכיתה כלשהי באמצעות חשבון זה, לא תוכלו יותר לגשת אליה לאחר שתעודכנו לחשבון מורה.',
      create_account: 'יצירת חשבון מורה',
      create_account_subtitle: 'קבלו גישה לכלים המיועדים למורים בלבד, לצורך השימוש ב-zgcombat בכיתה.  <strong>הקימו כיתה</strong>, הוסיפו תלמידים, <strong>ועקבו אחר ההתקדמות שלהם</strong>!',
    ...
    contact: {
      contact_us: 'צרו קשר עם zgcombat',
      ...
      subscribe: 'לקנות מנוי zgcombat',
      subscribe_suffix: 'ואנו נשמח לעזור עם הקוד שלכם.',
      subscriber_support: 'משום שאתם מנויים ל-zgcombat, ההודעה שנקבל מכם בדואר אלקטרוני תקבל עדיפות בתמיכה.',
    ...
    account_settings: {
      ...
      email_announcements_description: 'קבלו בדואר אלקטרוני הודעות על החדשות והפיתוחים האחרונים ב-zgcombat.',
      email_notifications: 'הודעות',
      email_notifications_summary: 'להגדרה של הודעות אוטומטיות ומותאמות אישית בדואר אלקטרוני לגבי פעילותכם ב-zgcombat.',
    ...
    community: {
      ...
      thang_editor_suffix: 'תוכלו לשנות את אמנות המקור של zgcombat. אפשרו ליחידות להטיל קליעים, לשנות את כיוון ההנפשה, לשנות את מספר נקודות הפגיעה של יחידות או להעלות ספרייט וקטור משלכם.',
      article_editor_prefix: 'מצאתם שגיאה במסמכים שלנו? רוצים ליצור הוראות עבור יצירות משלכם? בואו לראות את',
      article_editor_suffix: 'ולעזור לשחקני zgcombat להפיק את המרב מחוויית המשחק שלהם.',
      ...
      social_blog: 'קראו את הבלוג של zgcombat ב-Sett',
      social_discource: 'הצטרפו לדיון בפורום ה-Discourse שלנו',
      social_facebook: 'תנו ל-zgcombat "לייק" ב-Facebook',
      social_twitter: 'עקבו אחרי zgcombat ב-Twitter',
      social_slack: "שוחחו עמנו בצ'אט בערוץ ה-Slack הציבורי של zgcombat",
    ...
    courses: {
      ...
      ask_teacher_for_code_coco: 'שאלו את המורה אם יש לכם קוד כיתה של zgcombat! אם כן, הזינו אותו למטה:',
      ask_teacher_for_code_ozar: 'שאלו את המורה אם יש לכם קוד כיתה של zgcombat! אם כן, הזינו אותו למטה:',
      ...
      update_account_confirm_update_student2: 'לא תוכלו לנהל שום כיתה שיצרתם בעבר או ליצור כיתות חדשות. הכיתות שיצרתם בעבר יוסרו מ-zgcombat, ולא תהיה אפשרות לשחזר אותן.',
      instructor: 'מדריך: ',
      youve_been_invited_1: 'הוזמנתם להצטרף אל ',
      youve_been_invited_2: ', ושם תלמדו ',
      youve_been_invited_3: ' עם חבריכם לכיתה ב-zgcombat.',
      ...
      license_required_to_play_coco: 'בקשו מהמורה להקצות לכם רישיון, כדי שתוכלו להמשיך ולשחק ב-zgcombat!',
      license_required_to_play_ozar: 'בקשו מהמורה להקצות לכם רישיון, כדי שתוכלו להמשיך ולשחק ב-zgcombat!',
    ...
    teacher: {
      ...
      teacher_account_explanation: 'חשבון מורה ב-zgcombat מאפשר לכם להקים כיתות, לעקוב אחר התקדמות התלמידים בקורסים, לנהל רישיונות ולגשת אל משאבים שיעזרו לכם בבניית תכנית הלימודים.',
      ...
      pacing_guides_desc: 'למדו כיצד לשלב את כל המשאבים של zgcombat בתכנון שנת הלימודים שלכם!',
      ...
      educator_faq_desc: 'שאלות נפוצות על השימוש ב-zgcombat בכיתה או במוסד הלימודים שלכם.',
      teacher_getting_started: 'מדריך ההתחלה המהירה למורה',
      teacher_getting_started_desc: 'חדשים ב-zgcombat? הורידו את מדריך ההתחלה המהירה למורה כדי להקים חשבון, ליצור את הכיתה הראשונה ולהזמין תלמידים לקורס הראשון.',
      student_getting_started: 'מדריך התחלה מהירה לתלמיד',
      student_getting_started_desc: 'תוכלו לחלק מדריך זה לתלמידים שלכם לפני שתתחילו עם zgcombat, כדי לתת להם הזדמנות להכיר את עורך הקוד. ניתן להשתמש במדריך זה בכיתות ללימוד Python ו-JavaScript .',
      ...
      hoc_intro: 'לרשות הכיתה שלכם זמינות שלוש דרכים להשתתפות ב"שעת הקוד" עם zgcombat',
      hoc_self_led: 'משחק בהנחיה עצמית',
      hoc_self_led_desc: 'לרשות הכיתה שלכם זמינות שלוש דרכים להשתתפות ב"שעת הקוד" עם zgcombat',
      ...
      hoc_additional_desc1: 'למשאבים ולפעילויות נוספים של zgcombat, עיינו',
      ...
      teacher_quest_teach_methods_step2: 'הדפיסו את [Student Quick Start Guide]‏(https://files.flsong.iok.la/docs/resources/StudentQuickStartGuide.pdf) במרכז המשאבים.',
      ...
      teacher_quest_kithgard_gates_100_step2: 'הנחו את התלמידים כיצד לחשוב על בעיות קשות באמצעות [Engineering Cycle Worksheet]‏(https://files.flsong.iok.la/docs/resources/EngineeringCycleWorksheet.pdf).',
      ...
      teacher_quest_done: 'רוצים שהתלמידים שלכם ילמדו אפילו יותר קוד? צרו קשר עם [school specialists]‏(mailto:schools@flsong.iok.la) עוד היום!',
    ...
    classes: {
      ...
      archmage_summary: 'אם אתם מפתחים שמתעניינים בקידוד של משחקים לימודיים, בואו להפוך לקוסמי-על ולעזור לנו לבנות את zgcombat!',
      ...
      diplomat_summary: 'zgcombat זכה ללוקליזציה ביותר מ-45 שפות על-ידי הדיפלומטים שלנו. עזרו לנו, ותרמו תרגומים.',
      ambassador_title: 'שגריר',
      ambassador_title_description: '(תמיכה)',
      ambassador_summary: 'רסנו את משתמשי הפורום שלנו, וספקו הכוונה עבור אלה שיש להם שאלות. השגרירים שלנו מייצגים את zgcombat מול העולם.',
      teacher_title: 'מורה',
    },

    editor: {
      main_title: 'עורכי zgcombat',
    ...
    contribute: {
      page_title: 'תרומה',
      intro_blurb: 'zgcombat בנוי מ-100% קוד פתוח! מאות שחקנים מסורים כבר עזרו לנו להביא את המשחק לרמתו הנוכחית. הצטרפו אלינו, כדי לכתוב את הפרק הבא במסע של zgcombat ללמד את העולם איך לקודד!',
      ...
      scribe_introduction_pref: 'zgcombat הוא יותר מאשר אוסף שלבים. הוא יכלול גם משאב לידע, אתר ויקי לעקרונות תכנות אשר אליו ניתן להתחבר מתוך השלבים. כך, במקום שבעלי המלאכה יצטרכו לתאר בפירוט מהו אופרטור השוואה, הם יוכלו פשוט לקשר את השלב שלהם אל מאמר תיאור, שכבר נכתב כדי לספק מידע לשחקן. משהו שדומה למה ש-',
      ...
      diplomat_introduction_suf: 'זה שקיים עניין ניכר ב-zgcombat במדינות אחרות! אנו בונים נבחרת של מתרגמים שמשתוקקים להפוך אוסף של מילים לאוסף אחר של מילים, כדי להנגיש את zgcombat לכמה שיותר אנשים ברחבי העולם. אם תרצו לקבל מבט מהיר בתוכן הצפוי בקרוב, ולהביא את השלבים האלה כמה שיותר מהר על אלה שגרים במדינה שלכם, אולי זה המקצוע שמתאים לכם.',
      ...
      ambassador_introduction: 'אנו בונים כאן קהילה, ואתם נקודות החיבור. יש לנו פורומים, דואר אלקטרוני ורשתות חברתיות עם הרבה אנשים לשוחח עמם, להכיר להם את המשחק וללמוד מהם. אם ברצונכם לעזור לאנשים לקחת חלק וליהנות, כמו גם להבין את הרוח של zgcombat ואת מה שצפוי לו, אולי זה המקצוע שמתאים לכם.',
    ...
    account: {
      ...
      status_unsubscribed: 'קבלו גישה אל בונוס אבני חן ואל שלבים, גיבורים ופריטים חדשים עם מנוי על zgcombat!',
    ...
    account_prepaid: {
      ...
      purchase_code1: 'ניתן לממש קודי מנוי כדי להוסיף זמן מנוי פרימיום לחשבון אחד או יותר עבור הגרסה הביתית של zgcombat.',
      purchase_code2: 'כל חשבון zgcombat יכול לממש קוד מנוי מסוים פעם אחת בלבד.',
      purchase_code3: 'חודשים של קוד מנוי יתווספו בסופו של כל מנוי קיים באותו החשבון.',
      purchase_code4: 'קודי מנוי מיועדים לחשבונות המשחקים בגרסה הביתית של zgcombat, ולא ניתן להשתמש בהם במקום רישיונות תלמיד עבור הגרסה הכיתתית.',
    ...
    legal: {
      ...
      opensource_description_center: 'ולעזור לנו, אם תרצו! zgcombat בנוי על עשרות פרויקטים של קוד פתוח, ואנו ממש אוהבים אותם. עיינו ',
      ...
      code_description_suffix: 'בכלל זה כל הקוד במערכות וברכיבים, אשר מונגש על-ידי zgcombat לצורך יצירת שלבים.',
      art_title: 'אמנות/מוזיקה - Creative Commons ',
      art_description_prefix: 'כל התוכן המשותף זמין במסגרת',
      cc_license_url: 'Creative Commons Attribution 4.0 International License',
      art_description_suffix: 'התוכן המשותף הוא כל מה שמונגש על-ידי zgcombat לצורך יצירת שלבים. בכלל זה:',
      art_music: 'מוזיקה',
      art_sound: 'צלילים',
      art_artwork: 'אמנות',
      ...
      art_paragraph_1: 'כדי לייחס, נא לתת שם וקישור אל flsong.iok.la ליד המיקום שבו המקור נמצא בשימוש או במידת הצורך בהתאם למדיום. לדוגמה:',
      use_list_1: 'במקרה של שימוש בסרט או במשחק אחר, יש לכלול את flsong.iok.la בקרדיטים.',
      use_list_2: 'במקרה של שימוש באתר אינטרנט, יש לכלול קישור בסמוך למקום השימוש, לדוגמה מתחת לתמונה או בדף ייחוס כללי, שבו תזכירו אולי גם יצירות אחרות מ-Creative Commons ותוכנות קוד פתוח שבהן נעשה שימוש באתר. דבר מה שכבר מאזכר בבירור אל zgcombat, כגון פוסט בלוג שמציין את zgcombat, לא צריך ייחוס נפרד כלשהו.',
      art_paragraph_2: 'אם התוכן שבו נעשה שימוש לא נוצר על-ידי zgcombat, אלא במקום זאת על-ידי משתמש של flsong.iok.la, יש לייחס את החומר למשתמש זה במקום זאת, ולפעול לפי הנחיות הייחוס המסופקות בתיאור המשאב, אם ישנן.',
      ...
      nutshell_description: 'בכל משאב אשר אנו מספקים בעורך השלבים, אתם חופשיים להשתמש כרצונכם לצורך יצירת שלבים. עם זאת, אנו שומרים את הזכות להגביל את ההפצה של השלבים עצמם (אשר נוצרו ב-flsong.iok.la) כך שאולי הם יהיו כרוכים בחיוב.',
      ...
      third_party_description: 'zgcombat משתמש בשירותי הצד השלישי שלהלן (בין השאר):',
    ...
    ladder_prizes: {
      ...
      in_cash: 'כולל',
      custom_wizard: 'קוסם מותאם אישית של zgcombat',
      custom_avatar: 'אוואטאר מותאם אישית של zgcombat',
