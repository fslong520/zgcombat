module.exports = {
  ...
  translation: {
    ...
    legal: {
      ...
      art_paragraph_2: 'אם התוכן שבו נעשה שימוש לא נוצר על-ידי zgcombat, אלא במקום זאת על-ידי משתמש של codecombat.com, יש לייחס את החומר למשתמש זה במקום זאת, ולפעול לפי הנחיות הייחוס המסופקות בתיאור המשאב, אם ישנן.',
