module.exports = {
  ...
  translation: {
    ...
    new_home: {
      title_coco: 'zgcombat - Codeerspellen om Python en JavaScript te leren',
      title_ozar: 'zgcombat - Codeerspellen om Python en JavaScript te leren',
      ...
      century_skills_subblurb1: 'Met codeerpuzzels die op een natuurlijke manier in steeds uitdagendere levels worden gezet, zorgt het programmeerspel van zgcombat ervoor dat kinderen altijd kritisch blijven nadenken.',
      ...
      century_skills_subblurb2: 'zgcombat moedigt studenten aan om hun creativiteit te laten zien door het bouwen en delen van hun eigen games en webpagina’s. ',
      ...
      for_leaders_subblurb3: 'Of u nu een keuzevak voor de middelbare school, een CTE-pad of een AP Computer Science Principles-klas wilt maken, zgcombat is afgestemd op uw behoeften.',
      ...
      game_based_blurb: 'zgcombat is een spelgebaseerd computerwetenschappelijk programma waarbij studenten echte code typen en hun personages in realtime zien reageren.',
      get_started: 'Begin',
      ...
      quotes_quote1: 'Noem elk programma online, ik heb het geprobeerd. Geen van hen komt overeen met zgcombat. Elke leraar die wil dat zijn studenten leren programmeren raad ik aan... begin hier!',
      quotes_quote2: 'Ik was verrast hoe gemakkelijk en intuïtief zgcombat het leren van informatica maakt. De scores op het AP-examen waren veel hoger dan ik had verwacht en ik geloof dat zgcombat de reden is.',
      quotes_quote3: "zgcombat is ontzettend nuttig geweest om mijn studenten echte programmeervaardigheden bij te brengen. Mijn man is een software-ingenieur en hij heeft al mijn programma's getest. Hij beschouwde dit als zijn topkeuze. ",
      quotes_quote4: 'De feedback… is zo positief geweest dat we een Computerwetenschapsklas gaan maken rond zgcombat. Het programma betrekt de studenten er echt bij met een gaming-style platform dat tegelijikertijd vermakelijk en  leerzaam is. Ga zo door, zgcombat!',
      quotes_quote5: "[AI_TRANSLATION]Ondanks dat de les elke zaterdag om 7 uur 's ochtends begint, is mijn zoon zo enthousiast dat hij eerder wakker is dan ik! zgcombat creëert een pad voor mijn zoon om zijn programmeervaardigheden te verbeteren.",
      ...
      teachers_love_codecombat_title: 'Leraren houden van zgcombat',
      teachers_love_codecombat_blurb1: 'Melden dat hun studenten zgcombat graag gebruiken om te leren hoe ze moeten coderen',
      teachers_love_codecombat_blurb2: 'Zouden zgcombat aanraden aan andere informatica-docenten',
      teachers_love_codecombat_blurb3: 'Zeggen dat zgcombat hen helpt om de probleemoplossende vaardigheden van studenten te ondersteunen',
      ...
      top_banner_blurb_roblox: '[AI_TRANSLATION]NIEUW! zgcombat komt naar Roblox!',
      top_banner_blurb_roblox_teachers: '[AI_TRANSLATION]NIEUW! zgcombat heeft een samenwerking met Roblox Education!',
      ...
      top_banner_blurb_demo_day_10_20: '[AI_TRANSLATION]Doe mee met een spooktaculaire demo van zgcombat & Ozaria op donderdag 20 oktober om 16:00 uur CDT.',
      ...
      im_an_educator_description: '[AI_TRANSLATION]Leer Informatica met zgcombat',
      ...
      codecombat_is: 'zgcombat is een platform waarmee leerlingen spelenderwijs leren programmeren.',
      ...
      builds_concepts_up: 'Ik vind het leuk hoe zgcombat de concepten opbouwt. Het is heel gemakkelijk te begrijpen en leuk om erachter te komen.',
      ...
      agency: 'zgcombat is een game die de mogelijkheid en het zelfvertrouwen geeft om met echte code te werken, wat zowel beginners als gevorderden helpt bij het schrijven van goede, valide code.',
      ...
      want_coco: 'Wil je zgcombat op jouw school?',
      ...
      //    ozaria_china_blurb: "",
      try_codecombat: 'Probeer zgcombat',
      try_ozaria: 'Probeer Ozaria',
      explore_codecombat: '[AI_TRANSLATION]Verken zgcombat',
      ...
      codecombat_live_online_classes: '[AI_TRANSLATION]zgcombat Live Online Cursussen',
      ...
      coco_worlds_header: '[AI_TRANSLATION]zgcombat Werelden',
      coco_worlds_description: '[AI_TRANSLATION]Ga op een 3D-codeeravontuur in Roblox, waar je huisdieren kunt programmeren, spelen met vrienden, en games ontwikkelen terwijl je er een speelt. Doe mee met de zgcombat-gemeenschap en ontketen je creativiteit in de metaverse!',
      coco_worlds_button: '[AI_TRANSLATION]Verken zgcombat-Werelden',
    ...
    nav: {
      ...
      return_coco: '[AI_TRANSLATION]Keer terug naar zgcombat',
      //    classes: "Classes",
      ...
      codecombat_teacher_dashboard: '[AI_TRANSLATION]zgcombat Lerer Dashboard',
      ...
      codecombat_worlds_on_roblox: '[AI_TRANSLATION]zgcombat Werelden op Roblox',
      //    pricing: "Pricing",
    ...
    diplomat_suggestion: {
      title: 'Help zgcombat vertalen!',
      sub_heading: 'We hebben je taalvaardigheden nodig.',
      pitch_body: 'We ontwikkelen zgcombat in het Engels, maar we hebben al spelers van over de hele wereld. Veel van hen willen in het Nederlands spelen, maar kunnen geen Engels. Dus als je beiden talen spreekt, overweeg a.u.b. om je aan te melden als Diplomaat en help zowel de zgcombat website als alle levels te vertalen naar het Nederlands.',
    ...
    new_home_faq: {
      ...
      main_curriculum: '[AI_TRANSLATION]Kan ik zgcombat of Ozaria als mijn hoofdleerplan gebruiken?',
      main_curriculum_blurb: '[AI_TRANSLATION]Absoluut! We hebben tijd besteed aan het raadplegen van onderwijsspecialisten om lesmateriaal en curriculum specifiek voor leerkrachten te ontwikkelen die zgcombat of Ozaria gebruiken zonder zelf enige ervaring met computerwetenschappen te hebben. Veel scholen implementeren zgcombat en/of Ozaria als het hoofdvak computerwetenschappen.',
      clever_instant_login: '[AI_TRANSLATION]Ondersteunen zgcombat en Ozaria Clever Instant Login?',
      ...
      recommended_systems_blurb: '[AI_TRANSLATION]zgcombat en Ozaria werken het best op computers met minstens 4GB RAM, in een moderne browser zoals Chrome, Safari, Firefox of Edge. Chromebooks met 2GB RAM kunnen kleine grafische problemen hebben in latere cursussen. Een minimum van 200 Kbps bandbreedte per student is vereist, hoewel 1+ Mbps wordt aanbevolen.',
      ...
      ai_bot_faq_blurb: '[AI_TRANSLATION]De AI Chat Level Help Bot in zgcombat helpt leerlingen met AI-gestuurde hints voor codeeruitdagingen, en zorgt voor een begeleide maar toch onafhankelijke leerervaring. Veiligheid staat voorop, aangezien de AI persoonlijke gegevens filtert en is getraind om ongepaste verzoeken af te handelen.',
    },

    play: {
      title: 'Speel zgcombat Levels - Leer Python, JavaScript, en HTML',
      ...
      anon_signup_title_1: 'zgcombat heeft een',
      ...
      get_more_codecombat: 'Ga door met zgcombat',
      ...
      play_codecombat: '[AI_TRANSLATION]Speel zgcombat',
      play_codecombat_junior: '[AI_TRANSLATION]Speel zgcombat Junior',
    ...
    share_progress_modal: {
      blurb: 'Je gaat snel vooruit! Vertel je ouders hoeveel je geleerd hebt van zgcombat.',
    ...
    login: {
      ...
      already_have_account1: '[AI_TRANSLATION]Heb je al een zgcombat Docent- of Studentenaccount?',
      ...
      individual_users_not_supported: '[AI_TRANSLATION]Ozaria is alleen voor klaslokalen!  Bezoek zgcombat om verder te spelen!',
    ...
    signup: {
      ...
      teacher_type_1: 'Leer ze programmeren met gebruik van zgcombat!',
      ...
      want_codecombat_in_school: 'Wil je altijd zgcombat kunnen spelen?',
      eu_confirmation: 'Ik ga ermee akkoord dat zgcombat mijn data op US servers bewaart.',
      ...
      already_have_account: '[AI_TRANSLATION]Heb je al een zgcombat of Ozaria account',
      ...
      with: 'met',
      want_to_play_codecombat: 'Nee, die heb ik niet maar ik wil zgcombat spelen!',
    ...
    common: {
      default_title_coco: 'zgcombat - Programmeerspellen om Python en JavaScript te leren',
      default_title_ozar: 'zgcombat - Programmeerspellen om Python en JavaScript te leren',
      //    ozaria: "Ozaria",
    ...
    play_level: {
      ...
      explore_codecombat: 'Verken zgcombat',
      ...
      tip_open_source: 'zgcombat is 100% open source!',
      tip_tell_friends: 'Vind je zgcombat leuk? Vertel je vrienden over ons!',
      tip_beta_launch: 'zgcombat lanceerde zijn beta versie in Oktober, 2013.',
      ...
      tip_open_source_contribute: 'Je kunt helpen zgcombat te verbeteren!',
    ...
    play_game_dev_level: {
      ...
      play: 'Speel Level',
      play_more_codecombat: 'Speel Meer zgcombat',
    ...
    subscribe: {
      ...
      confirmation: 'Gefeliciteerd! Je hebt nu een zgcombat Premium Inschrijving!',
      premium_already_subscribed: 'Je bent al ingeschreven bij Premium!',
      subscribe_modal_title: 'zgcombat Premium',
      comparison_blurb: 'Verbeter je vaardigheden met een abonnement op zgcombat!',
      ...
      thank_you: 'Bedankt dat je zgcombat steunt.',
    ...
    premium_features: {
      get_premium: 'Neem<br>zgcombat<br>Premium',
      ...
      everything_in_premium: 'Wat je allemaal krijgt in zgcombat Premium:',
    ...
    about: {
      title: 'Over zgcombat - Studenten erbij Betrekken, Leraren Zelfvertrouwen geven, Creaties Inspireren',
      ...
      main_description: 'Bij zgcombat, is het ons doel om te zorgen dat je dat doet met een glimlach op je gezicht.',
      mission_link: 'Missie',
      team_link: 'Team',
      story_link: 'Verhaal',
      press_link: 'Pers',
      mission_title: 'Onze missie: maak programmeren toegankelijk voor elke leerling op aarde.',
      mission_description_1: '<strong>Programmeren is magie</strong>. Het is het vermogen om dingen te maken vanuit pure fantasie. We zijn zgcombat begonnen om leerlingen het gevoel the geven van een toverachtige kracht aan hun vingertoppen door het gebruik van <strong>getypte code</strong>.',
      ...
      team_title: 'Ontmoet het zgcombat team',
      ...
      run_title: '[AI_TRANSLATION]Hoofd van Operaties, zgcombat Groot-China',
      lance_title: '[AI_TRANSLATION]Hoofd van Technologie, zgcombat Groot-China',
      zhiran_title: '[AI_TRANSLATION]Hoofd Curriculum, zgcombat Groot-China',
      yuqiang_title: '[AI_TRANSLATION]Hoofd Innovatie, zgcombat Groot-China ',
      ...
      bill_title: '[AI_TRANSLATION]Algemeen Directeur, zgcombat Groot-China',
      ...
      community_subtitle: 'Meer dan 450 bijdragers hebben geholpen bij het bouwen van zgcombat, met meer die zich er bij voegen elke week!',
      community_description_3: 'zgcombat is een',
      community_description_link_2: 'gemeenschapsproject',
      community_description_1: 'zgcombat is een gemeenschapsproject, met honderden spelers die vrijwillig levels maken, bijdrage aan onze code om dingen toe te voegen, bugs te maken, speeltesten, en zelfs helpen het spel te vertalen in 50 talen zover. Werknemers, bijdragers en de site krijgen meer door het delen van ideeën en pooling inspanning, zoals de open source gemeenschap in het algemeen doet. De site is gemaakt met meerdere open source projecten, en we zijn open source zodat we wat terug kunnen geven aan de gemeenschap en leveren programmeer geïnteresseerde spelers een vertouwd project om te verkennen en mee te experimenteren. Iedereen kan zich bij de zgcombat gemeenschap voegen! Bekijk onze',
      ...
      story_subtitle: 'Sinds 2013, is zgcombat gegroeid van een paar schetsen naar een levend, bloeiend spel.',
      story_statistic_1a: '20,000,000+',
      story_statistic_1b: 'totale spelers',
      story_statistic_1c: 'zijn hun programmeerreis begonnen door zgcombat',
      ...
      jobs_title: 'Kom bij ons werken en help om zgcombat geschiedenis te laten schrijven!',
      ...
      jobs_custom_description: 'Ben je enthousiast over zgcombat maar zie je geen baan die aansluit bij je kwalificaties? Schrijf ons jouw suggesties hoe je kunt meehelpen met ons team, we horen graag van je!',
      ...
      about_codecombat: 'Over zgcombat',
      logo: 'Logo',
    ...
    teachers: {
      ...
      free_course_blurb_junior: '[AI_TRANSLATION]Geweldig voor groep K-5, zgcombat Junior kan variëren van blokgebaseerde en mobiele opties voor beginnende lezers, tot Python of JavaScript tekstcode voor hogere basisschoolleerlingen, of naar parallelle blokken-en-code om met de overgang te helpen.',
      'free_course_blurb_introduction-to-computer-science': "[AI_TRANSLATION]Geweldig voor groep 6-12, zgcombat's kern CS-cursussen beginnen met de beginnersvriendelijke Introductie tot Informatica, via AP Computer Science Principes, en verder naar gevorderde CS-cursussen. Begin hier voor middelbare schoolleerlingen.",
      ...
      import_codecombat_classroom: '[AI_TRANSLATION]Importeer zgcombat Klaslokaal',
    ...
    teachers_quote: {
      subtitle_coco: 'Gebruik zgcombat voor jouw klas of programmeerclub!',
      subtitle_ozar: 'Gebruik zgcombat voor jouw klas of programmeerclub!',
      ...
      state: 'Provincie',
      country: 'Land',
      num_students_help: 'Voor hoeveel leerlingen zou je zgcombat willen gebruiken?',
      ...
      thanks_sub_header_coco: 'Bedankt voor je interesse in zgcombat.',
      thanks_sub_header_ozar: 'Bedankt voor je interesse in zgcombat.',
      ...
      create_account_subtitle: 'Krijg toegang tot exclusieve hulpmiddelen voor docenten door zgcombat in de klas te gebruiken. <strong>Maak een klas aan</strong>, voeg leerlingen toe, en <strong>bekijk hun vooruitgang</strong>!',
    ...
    contact: {
      contact_us: 'Contact opnemen met zgcombat',
      ...
      subscribe: 'abonnee te worden van zgcombat',
      subscribe_suffix: ', dan helpen we je graag om je code te verbeteren.',
      subscriber_support: 'Omdat je geabonneerd bent op zgcombat, krijgt je e-mail prioriteit bij het beantwoorden.',
      screenshot_included: 'Screenshot inbegrepen.',
      where_reply: 'Waar moeten we reageren?',
      send: 'Feedback Verzenden',
      ooo_blurb: '[AI_TRANSLATION]Het zgcombat-team zal van 5 juni tot 9 juni niet op kantoor zijn en zal gedurende deze tijd beperkte toegang hebben tot e-mails. We zullen zo snel mogelijk op je vraag reageren, maar wees je bewust van de verwachte wachttijd.',
    },
    ...
    account_settings: {
      ...
      roblox_not_connected: '[AI_TRANSLATION]Verbind je zgcombat- en Roblox-accounts.',
      ...
      email_announcements_description: 'Ontvang e-mails over het laatste nieuws en de ontwikkelingen bij zgcombat.',
      email_notifications: 'Notificaties',
      email_notifications_summary: 'Instellingen voor gepersonaliseerde, automatische meldingen via e-mail omtrent je activiteit op zgcombat.',
    ...
    community: {
      ...
      thang_editor_suffix: "Om de zgcombat bron illustraties aan te passen. Om units projectielen te laten gooien, de richting van een animatie aan te passen, een unit's levenspunten aan te passen, of je eigen vector sprites te uploaden.",
      ...
      article_editor_suffix: 'en help zgcombat spelers meer uit hun speeltijd te halen.',
      ...
      social_facebook: 'Like zgcombat op Facebook',
      social_twitter: 'Volg zgcombat op Twitter',
      social_slack: 'Chat met ons in het openbare zgcombat Slack kanaal',
      contribute_to_the_project: 'Help mee met het project',
    },

    clans: {
      title: 'Meld je aan bij zgcombat Clans - Leer programmeren in Python, JavaScript, en HTML',
      clan_title: '__clan__ - Meld je aan bij zgcombat Clans en leer Programmeren',
    ...
    courses: {
      ...
      ask_teacher_for_code_coco: 'Vraag je juf/meester of je een zgcombat klassencode hebt! Als dat zo is, vul die dan hieronder in:',
      ask_teacher_for_code_ozar: 'Vraag je juf/meester of je een zgcombat klassencode hebt! Als dat zo is, vul die dan hieronder in:',
      ...
      update_account_individuals_warning_ozaria: '[AI_TRANSLATION]Waarschuwing: individuele accounts kunnen Ozaria niet spelen, alleen zgcombat.',
      ...
      youve_been_invited_3: ' met je klasgenoten in zgcombat.',
      ...
      license_required_to_play_coco: 'Vraag een leraar om je een licentie te geven zodat je verder kunt gaan met zgcombat!',
      license_required_to_play_ozar: 'Vraag een leraar om je een licentie te geven zodat je verder kunt gaan met zgcombat!',
    ...
    teacher: {
      ...
      teacher_account_explanation: 'Een zgcombat Lerarenaccount geeft je de mogelijkheid om klassen aan te maken, voortgang van leerlingen te bekijken terwijl ze de cursussen volgen, inschrijvingen te beheren en hulpmiddelen te gebruiken voor het opzetten van een leerplan',
      ...
      class_code_blurb: 'Nieuwe leerlingen kunnen deze klassencode invoeren op hun dashboard of via flsong.iok.la/courses om zich bij de klas aan te sluiten.',
      ...
      pacing_guides_desc: 'Leer hoe je alle middelen van zgcombat kunt gebruiken om je schooljaar te plannen!',
      ...
      educator_faq_desc: 'Veel gestelde vragen over het gebruik van zgcombat in je klas of school.',
      teacher_getting_started: 'Leraar Startgids',
      teacher_getting_started_desc: 'Nieuw bij zgcombat? Download de Leraar Startgids om een account op te zetten, een klas te creëren en leerlingen uit te nodigen voor hun eerste cursus.',
      student_getting_started: 'Leerlingen Startgids',
      student_getting_started_desc: 'Leerlingen kunnen deze gids bekijken voordat ze met zgcombat beginnen zodat ze alvast vertrouwd raken met de code editor. Deze gids kan gebruikt worden in Python en JavaScript klassen.',
      ...
      hoc_meta_description: 'Maak je eigen game of codeer je een weg uit de kelder! zgcombat heeft 4 verschillende Hour of Code activiteiten en meer dan 60 levels om te leren coderen, te spelen, en te creëren.',
      hoc_intro: 'Er zijn drie manieren waarop uw klas kan meedoen aan het Code Uur met zgcombat',
      hoc_self_led: 'Zelfstandig Gamen',
      hoc_self_led_desc: 'Leerlingen kunnen zelfstandig 2 uur zgcombat tutorials spelen',
      ...
      hoc_additional_desc1: 'Voor meer zgcombat informatie en activiteiten, ga naar',
      ...
      teacher_quest_teach_methods_step2: 'Print de [Snelle Startgids voor Leerlingen](https://files.flsong.iok.la/docs/resources/StudentQuickStartGuide.pdf) in de Resource Hub.',
      ...
      teacher_quest_kithgard_gates_100_step2: 'Begeleid leerlingen om door moeilijke problemen heen te denken door de [Engineering Cycle Worksheet](https://files.flsong.iok.la/docs/resources/EngineeringCycleWorksheet.pdf)te gebruiken.',
    ...
    teacher_ozaria_encouragement_modal: {
      ...
      sub_title: 'Je bent uitgenodigd om het nieuwe avonturenspel van zgcombat uit te proberen',
      cancel: 'Terug naar zgcombat',
      ...
      you_can_return: 'Je kunt altijd teruggaan naar zgcombat',
    },
    ...
    educator_signup_ozaria_encouragement: {
      ...
      educators_continue_coco: '[AI_TRANSLATION]Leerkrachten die zgcombat willen blijven gebruiken in hun klas',
      continue_coco: '[AI_TRANSLATION]Verder met zgcombat',
    },
    ...
    classes: {
      ...
      archmage_summary: 'Als je een programmeur bent met interesse in het maken van educatieve spellen, word dan Tovernaar en help ons zgcombat te ontwikkelen!',
      ...
      diplomat_summary: 'zgcombat ondersteunt meer dan 45 talen. Word Diplomaat en help met vertalen.',
      ambassador_title: 'Ambassadeur',
      ambassador_title_description: '(Ondersteuning)',
      ambassador_summary: 'Bewaar de vrede op onze forums en help mensen met vragen. Onze ambassadeurs helpen zgcombat te presenteren aan de buitenwereld.',
    ...
    contribute: {
      ...
      diplomat_introduction_suf: 'dan is het wel dat er een enorme belangstelling is voor zgcombat in andere landen, vooral Brazilië! We zijn een groep van vertalers aan het creëren dat ijverig de ene set woorden in de andere omzet om zgcombat zo toegankelijk mogelijk te maken in de hele wereld. Als jij het leuk vindt glimpen op te vangen van aankomende content en deze levels zo snel mogelijk naar je landgenoten te krijgen, dan is dit de klasse voor jou.',
    ...
    user: {
      user_title: '__name__ - Leer coderen met zgcombat',
      stats: 'Statistieken',
    ...
    account: {
      ...
      status_unsubscribed: 'Krijg toegang tot nieuwe levels, helden, items, en extra edelstenen met een abonnement op zgcombat!',
      ...
      unsubscribe_from_marketing: 'Schrijf __email__ uit van alle zgcombat marketing e-mails?',
    ...
    account_prepaid: {
      ...
      purchase_code1: 'Codes kunnen worden ingewisseld om toegang te krijgen tot de premium content, dit kan ook op meerdere zgcombat accounts.',
      purchase_code2: 'Op iedere zgcombat account kan een bepaalde Code maar één keer worden ingewisseld.',
      purchase_code3: 'Als je een gewoon abonnement op zgcombat hebt, worden de Codes toegevoegd aan het einde van je huidige abonnement aan je account toegevoegd.',
      purchase_code4: 'Abonnement codes zijn voor de Thuisversie van zgcombat, ze kunnen niet gebruikt worden als Leerlinglicenties in Klassen.',
    ...
    impact: {
      ...
      teacher_quote: 'Toen ik zgcombat in handen kreeg [en] door mijn studenten liet gebruiken, ging er een lichtje branden. Het was gewoon het verschil tussen dag en nacht met elk ander programma dat we hadden gebruikt. Ze komen niet eens in de buurt. ',
      ...
      ozaria_impact_blurb: "[AI_TRANSLATION]zgcombat's zuster curriculum, Ozaria, heeft bewezen een positieve impact te hebben op de leerresultaten van studenten die het belangrijkst zijn voor zowel studenten als docenten.",
    ...
    legal: {
      page_title: 'Rechten',
      opensource_introduction: 'zgcombat is deel van de open source-gemeenschap',
      opensource_description_prefix: 'Bekijk ',
      github_url: 'onze GitHub',
      opensource_description_center: 'en help ons als je wilt! zgcombat is gebouwd met de hulp van tientallen open source projecten, en wij zijn er gek op. Bekijk ook ',
      ...
      cost_title: 'Kosten',
      cost_description: '[AI_TRANSLATION]zgcombat is gratis te spelen voor de introductieniveaus, met een abonnement van $__price__ USD/maand voor toegang tot extra niveaus en __gems__ bonus edelstenen per maand. Je kunt met één klik annuleren, en we bieden een 100% niet-goed-geld-terug garantie.',
      ...
      code_title: 'Code - MIT',
      client_code_description_prefix: 'Alle client-side code voor flsong.iok.la in de openbare GitHub-repository en in de flsong.iok.la database, is gelicentieerd onder',
      ...
      art_description_suffix: 'Gemeenschappelijke inhoud is alles dat algemeen verkrijgbaar is bij zgcombat met als doel levels te maken. Dit omvat:',
      art_music: 'Muziek',
      art_sound: 'Geluid',
      ...
      art_paragraph_1: 'Voor toekenning, gelieve de naam en link naar flsong.iok.la te plaatsen waar dit passend is voor de vorm waarin het voorkomt. Bijvoorbeeld:',
      use_list_1: 'Wanneer gebruikt in een film of een ander spel, voeg flsong.iok.la toe in de credits.',
      use_list_2: 'Wanneer toegepast op een website, inclusief een link naar het gebruik, bijvoorbeeld onderaan een afbeelding. Of in een algemene webpagina waar je eventueel ook andere Creative Commons werken en open source software vernoemd die je gebruikt op de website. Iets dat al duidelijk gerelateerd is met zgcombat, zoals een blog artikel dat zgcombat vernoemd, heeft geen aparte vermelding nodig.',
      art_paragraph_2: 'Wanneer de gebruikte inhoud is gemaakt door een gebruiker van flsong.iok.la, vernoem hem/haar in plaats van ons en volg toekenningsaanwijzingen als deze in de beschrijving van de bron staan.',
      ...
      nutshell_description: 'Alle middelen die wij aanbieden in de Level Editor zijn gratis te gebruiken om levels aan te maken. Wij behouden ons echter het recht voor om levels die gemaakt zijn op flsong.iok.la te beperken, en hier in de toekomst geld voor te vragen, moest dat ooit gebeuren.',
      ...
      third_party_description: 'zgcombat gebruikt onder andere de volgende diensten van derden:',
      cookies_message: 'zgcombat gebruikt een aantal essentiële en niet-essentiële cookies',
    ...
    ladder_prizes: {
      ...
      in_cash: 'contant',
      custom_wizard: 'Aangepaste zgcombat Wizard',
      custom_avatar: 'Aangepaste zgcombat avatar',
    ...
    apcsp: {
      ...
      meta_description: 'Het uitgebreide curriculum en het professionele ontwikkelingsprogramma van zgcombat zijn alles wat u nodig hebt om de nieuwste cursus informatica van College Board aan uw studenten aan te bieden.',
      syllabus: '[AI_TRANSLATION]AP CS Principes Syllabus',
      syllabus_description: 'Gebruik dit hulpmiddel om het zgcombat-curriculum (leerplan) te plannen voor uw AP Computer Science Principles-klas. Termen worden niet vertaald naar het Nederlands.',
    ...
    apcsp_marketing: {
      ...
      icons_coding_levels: '[AI_TRANSLATION]150+ zgcombat Codeer Levels',
      ...
      course_outline_description: '[AI_TRANSLATION]De volgende beschrijvingen zijn een overzicht van de inhoud die wordt behandeld in de zgcombat AP CSP-cursus.',
      ...
      professional_development: '[AI_TRANSLATION]Professionele Ontwikkeling',
      professional_development_description: '[AI_TRANSLATION]zgcombat biedt een online, zelfgestuurde professionele ontwikkelingscursus voor docenten van elk niveau van AP CSP expertise. Deelnemers zullen het zgcombat-curriculum verkennen en leren hoe het kan worden gebruikt om studenten voor te bereiden op succes bij het AP CSP-examen. Via asynchrone discussies met collega-docenten en videoconferenties met zgcombat leerontwerpers, krijg je de tools en technieken die je nodig hebt om al je studenten te ondersteunen in AP CSP. Aan het einde van de cursus ontvang je een Certificaat van Voltooiing dat kan worden gebruikt voor de verlenging van je onderwijslicentie.',
      ...
      question_2: '[AI_TRANSLATION]Wat zijn de technologische vereisten voor het AP CSP-curriculum van zgcombat?',
      ...
      coco_requirements: '[AI_TRANSLATION]zgcombats systeemvereisten',
      coco_recognized_blurb: '[AI_TRANSLATION]zgcombat wordt erkend door College Board als een goedgekeurde aanbieder van curriculum en professionele ontwikkeling voor AP® Computer Science Principles (AP CSP). Deze goedkeuring bevestigt dat het curriculum van zgcombat in lijn is met alle AP Curriculum Framework standaarden en de AP CSP beoordeling. Dit geeft scholen toegang tot middelen, inclusief een AP CSP syllabus die vooraf is goedgekeurd door de Course Audit van College Board, en officieel erkende professionele ontwikkeling die leraren voorbereidt om dit curriculum te onderwijzen.  ',
    ...
    apcsp_curriculum: {
      ...
      professional_development_description: '[AI_TRANSLATION]zgcombat biedt een online, zelf-paced professionele ontwikkelingscursus aan voor docenten van alle niveaus van AP CSP expertise. Deelnemers zullen het zgcombat-curriculum verkennen en leren hoe het kan worden gebruikt om studenten voor te bereiden op succes bij het AP CSP-examen. Door middel van asynchrone discussies met collega-leraren en videoconferenties met zgcombat-curriculumontwikkelaars, krijg je de tools en technieken die je nodig hebt om al je studenten te ondersteunen in AP CSP. Aan het einde van de cursus ontvang je een Certificaat van Voltooiing dat kan worden gebruikt voor de verlenging van je onderwijsbevoegdheid. We bieden ons Curriculum aan op __edapp__.',
      ...
      no_license: "[AI_TRANSLATION]Ons AP CSP-curriculum vereist een betaalde licentie om te bekijken. Leer meer over zgcombat's AP CSP-curriculum door onze Over-pagina te bezoeken, die hieronder is gelinkt.",
      ...
      step_1_subtitle: '[AI_TRANSLATION]Upload zgcombat’s AP CSP-leerplan naar College Board’s Course Audit.',
    ...
    hoc_2019: {
      ...
      already_have_account: '[AI_TRANSLATION]Heb je al een zgcombat of Ozaria account? Login.',
    ...
    parents_landing_1: {
      ...
      codecombat_intro: '[AI_TRANSLATION]zgcombat combineert de kracht van gameplay en gepersonaliseerde instructie om online programmeerlessen te leveren waar je kind elke week naar uit zal kijken!',
      ...
      quote_1: "[AI_TRANSLATION]Ondanks dat de les elke zaterdag om 7 uur 's ochtends begint, is mijn zoon zo enthousiast dat hij eerder wakker is dan ik! zgcombat creëert een pad voor mijn zoon om zijn programmeervaardigheden te verbeteren.",
      ...
      private_instructions: '[AI_TRANSLATION]Alle klassen bieden privé, op maat gemaakte instructies. Om een groep studenten in te schrijven, neem contact op met <a href="mailto:classes@flsong.iok.la">classes@flsong.iok.la</a> voor een aangepast plan.',
      ...
      benefit_3: '[AI_TRANSLATION]zgcombat premium abonnement inbegrepen',
      ...
      grit_description: '[AI_TRANSLATION]zgcombat daagt leerlingen uit om van hun fouten te leren. Ingebouwde hints helpen leerlingen bugs te vinden en op te lossen, waardoor ze meer zelfvertrouwen krijgen in het coderen.',
      ...
      faq_a_1: '[AI_TRANSLATION]Elk van onze instructeurs is zorgvuldig uitgekozen om zgcombat te vertegenwoordigen en een leuke en persoonlijke leerervaring te bieden die is afgestemd op elke student. We geloven dat je kind plezier zal hebben met leren bij een van onze instructeurs, maar als je om welke reden dan ook van leraar wilt wisselen, staan we daar altijd voor open.',
      ...
      faq_a_4: '[AI_TRANSLATION]Je abonnementsaankoop is 100% risicoloos binnen de eerste 30 dagen. Als je om welke reden dan ook besluit niet door te gaan, neem dan gewoon binnen 30 dagen na aankoop <a href="mailto:classes@flsong.iok.la">contact met ons op</a> en we zullen je aankoop onmiddellijk 100% terugbetalen, zonder vragen. Je kunt je abonnement ook op elk moment bevriezen en opnieuw activeren wanneer het voor jou uitkomt.',
      faq_q_5: '[AI_TRANSLATION]Wat als ik een les moet verzetten?',
      faq_a_5: '[AI_TRANSLATION]Als je een wekelijkse les bij ons hebt geboekt, hebben we tijd in ons schema exclusief voor jou gereserveerd, dus we vragen 48 uur van tevoren voor het verzetten van lessen. Je kunt je les verzetten door een e-mail te sturen naar <a href="mailto:classes@flsong.iok.la">classes@flsong.iok.la</a>. Gemiste of geannuleerde lessen met minder dan 48 uur voorafgaande kennisgeving zullen niet worden verzet of terugbetaald.',
    ...
    parents_landing_2: {
      ...
      live_classes_offered: '[AI_TRANSLATION]zgcombat biedt nu live online computerwetenschapslessen aan voor studenten die thuis leren. Geweldig voor studenten die het beste werken in 1:1 of kleine groepen waar de leerresultaten zijn afgestemd op hun behoeften.',
      ...
      premium_need_help: '[AI_TRANSLATION]Hulp nodig of liever Paypal? Mail naar <a href="mailto:support@flsong.iok.la">support@flsong.iok.la</a>',
      not_sure_kid: '[AI_TRANSLATION]Niet zeker of zgcombat geschikt is voor je kind? Vraag het hen!',
      share_trailer: '[AI_TRANSLATION]Deel onze gametrailer met je kind en laat hen een account aanmaken om te beginnen.',
      why_kids_love: '[AI_TRANSLATION]Waarom Kinderen Dol Zijn Op zgcombat',
      ...
      why_parents_love: '[AI_TRANSLATION]Waarom Ouders zgcombat Leuk Vinden',
      ...
      critical_skills_detail: '[AI_TRANSLATION]Je kind leert navigeren en burger worden in de digitale wereld. zgcombat is een oplossing die het kritische denken, de creativiteit en het doorzettingsvermogen van je kind verbetert, en hen de vaardigheden geeft die ze nodig hebben voor elke industrie.',
      parent_support: '[AI_TRANSLATION]Gesteund door ouders zoals jij',
      parent_support_detail: '[AI_TRANSLATION]Bij zgcombat zijn we ouders. We zijn programmeurs. We zijn docenten. Maar vooral zijn we mensen die geloven in het geven van de beste kans op succes aan onze kinderen, in wat ze ook besluiten te doen.',
      ...
      quotes_title: '[AI_TRANSLATION]Wat ouders en kinderen zeggen over zgcombat',
      ...
      quote_3: "[AI_TRANSLATION]\"Oliver's Python gaat goed. Hij gebruikt zgcombat om zijn eigen videogames te maken. Hij daagt me uit zijn spellen te spelen en lacht als ik verlies.\"  ",
      quote_4: '[AI_TRANSLATION]"Dit is een van mijn favoriete dingen om te doen. Elke ochtend word ik wakker en speel ik zgcombat. Als ik zgcombat een cijfer moest geven van 1 tot 10, zou ik een 10 geven!"',
      //    parent: "Parent",
      //    student: "Student",
      grade: '[AI_TRANSLATION]Cijfer',
      subscribe_error_user_type: '[AI_TRANSLATION]Het lijkt erop dat je al een account hebt aangemaakt. Als je interesse hebt in zgcombat Premium, neem dan contact met ons op via team@flsong.iok.la.',
      ...
      live_classes_title: '[AI_TRANSLATION]Live coding lessen van zgcombat!',
    ...
    modal_timetap_confirmation: {
      ...
      paragraph_5: '[AI_TRANSLATION]Bedankt dat je voor zgcombat hebt gekozen en veel succes met je computerwetenschappenreis!',
    ...
    hoc_2018: {
      ...
      about: 'Over zgcombat:',
      about_copy: "zgcombat is een spel-gebaseerd computerwetenschappelijk programma voor het lesgeven in Python en JavaScript. zgcombat's op standaarden gebaseerde leerplan / curriculum is opgebouwd rond een spel waar studenten gek op zijn. Meer dan 12 miljoen studenten hebben leren programmeren met zgcombat!",
    ...
    hoc_2018_interstitial: {
      welcome: "Welkom bij zgcombat's Hour of Code!",
    ...
    school_administrator: {
      ...
      add_additional_teacher: 'Wilt u een extra docent toevoegen? Neem contact op met uw zgcombat-accountmanager of e-mail product@codecombat.eu. ',
      ...
      active_students_stat_description: 'Actieve studenten telt het aantal studenten dat zich de afgelopen 60 dagen heeft aangemeld bij zgcombat. ',
    ...
    browser_recommendation: {
      title: 'zgcombat werkt het best onder Chrome!',
      pitch_body: 'Voor de beste zgcombat-ervaring, raden we aan om de nieuwste versie van Chrome te gebruiken. Download de nieuwste versie van Chrome door op de onderstaande knop te klikken!',
    ...
    events: {
      title: '[AI_TRANSLATION]zgcombat Evenementen',
      main_title: '[AI_TRANSLATION]zgcombat Evenementen',
      ...
      sync_to_google_desc: '[AI_TRANSLATION]Synchroniseer dit evenement naar JOUW Google-agenda, in plaats van die van de eigenaar. En kan alleen werken op zgcombat Gmail  ',
    ...
    teacher_dashboard: {
      ...
      want_to_save_tooltip_coco: '[AI_TRANSLATION]<h3>Wil je je voortgang opslaan?</h3><p>Maak een studentenaccount aan, of ga naar <i>Mijn Account / Test als Student</i> en speel zgcombat als student als je je voortgang wilt opslaan.</p>',
      ...
      ozaria_hs_modal_title: '[AI_TRANSLATION]Toegang tot AI Hackstack Exclusief op zgcombat',
      ozaria_hs_modal_blurb: '[AI_TRANSLATION]Docenten kunnen nu direct toegang krijgen tot AI Hackstack op **[https://flsong.iok.la/teachers/classes]zgcombat** met dezelfde inloggegevens als Ozaria. Voor extra gemak kun je je klassen eenvoudig importeren van Ozaria naar zgcombat.',
    ...
    outcomes: {
      ...
      using_codecombat: "[AI_TRANSLATION]Gebruikmakend van zgcombat's gepersonaliseerde leerengine...",
      ...
      coverage_p2_coco: '[AI_TRANSLATION]Bij zgcombat geloven we dat studenten het beste voorbereid zullen zijn op echte computertaken en verdere studie van informatica door het gebruik van echte, getypte code in volledige programmeertalen. In plaats van blok-gebaseerde visuele programmeertalen voor beginners, leren we Python en JavaScript – dezelfde talen die tegenwoordig veel worden gebruikt door bedrijven variërend van Google tot de New York Times.',
      coverage_p2_ozar: '[AI_TRANSLATION]Ozaria is gemaakt door zgcombat, het game-based learning bedrijf. Wij geloven dat studenten het beste voorbereid zullen zijn voor zowel echte computertaken als verdere studie van informatica door echte, getypte code te gebruiken in volledige programmeertalen, dus in plaats van block-gebaseerde visuele programmeertalen voor beginners, leren wij Python en JavaScript – dezelfde talen die tegenwoordig veel worden gebruikt door bedrijven variërend van Google tot de New York Times.',
    ...
    efficacy: {
      ...
      commitment_title: '[AI_TRANSLATION]zgcombat’s Commitment to Efficacy',
      ...
      teachers_love_description: '[AI_TRANSLATION]Verken de impact van ons zusterproduct, zgcombat, op het onderwijs & leren van informatica!',
    ...
    league: {
      ...
      summary: '[AI_TRANSLATION]De zgcombat AI League is uniek omdat het zowel een competitieve AI-gevechtssimulator als een game-engine is om echte Python- en JavaScript-code te leren.  ',
      join_now: '[AI_TRANSLATION]Meld je nu aan',
      tagline: '[AI_TRANSLATION]De zgcombat AI League combineert ons projectgebaseerde, op standaarden afgestemde curriculum, een boeiend op avontuur gebaseerd coderingsspel, en ons jaarlijkse wereldwijde AI coderings toernooi tot een georganiseerde academische competitie die zijn weerga niet kent.',
      ...
      comprehensive_curr_subheader: '[AI_TRANSLATION]zgcombat is een CS-oplossing die aan de standaarden voldoet en docenten helpt om echte codering in JavaScript en Python te onderwijzen, ongeacht hun ervaring.',
      ...
      season1_prize_3: '[AI_TRANSLATION]Aangepaste zgcombat Avatar',
      ...
      coco_reserves: '[AI_TRANSLATION]zgcombat reserves',
      ...
      contact_sales_custom: '[AI_TRANSLATION]Jouw aangepaste toernooi wacht. Kies de arena die je wilt gebruiken voor je aangepaste toernooi en neem contact op met je zgcombat-vertegenwoordiger om de details van de opzet en planning te bevestigen.',
      ...
      codecombat_ai_league_description: '[AI_TRANSLATION]De zgcombat AI League combineert onze projectgebaseerde, standaarden-uitgelijnde curriculum, boeiend avonturengebaseerd codeerspel en onze jaarlijkse AI-codeerwereldtoernooi in een academische competitie die nergens anders mee te vergelijken is.',
    ...
    payments: {
      ...
      most_popular: '[AI_TRANSLATION]Meest Populair',
      best_value: '[AI_TRANSLATION]Beste Waarde',
      purchase_licenses: '[AI_TRANSLATION]Koop eenvoudig licenties om volledige toegang tot zgcombat en Ozaria te krijgen',
      ...
      implementation_info: '[AI_TRANSLATION]60 min Onboarding Training over hoe je zgcombat en Ozaria kunt gebruiken om specifieke institutionele en educatieve doelen te ondersteunen.',
      ...
      full_access_coco: '[AI_TRANSLATION]Volledige toegang tot zowel zgcombat',
      ...
      bd_subheading: "[AI_TRANSLATION]Voor zakelijke partners met minstens 10 studenten, krijg premium toegang tot zgcombat's computerwetenschap en codingspellen:",
      bd_info_list_heading: '[AI_TRANSLATION]zgcombat is de voorkeurs partner voor tientallen coding educatie bedrijven omdat:',
      ...
      bd_info_list_2: '[AI_TRANSLATION]iedereen kan leren coderen met zgcombat; de game is de hoofddocent en wij bieden uitgebreide ondersteuningsbronnen',
      ...
      bd_includes_1: '[AI_TRANSLATION]Volledige toegang tot zgcombat en Ozaria met meer dan 200 uur aan premium game-gebaseerde inhoud',
    ...
    partners: {
      ...
      below_headline_blurb: '[AI_TRANSLATION]Bij zgcombat hebben we uitgebreide tools ontwikkeld die leren coderen leuk maken en programmeren gemakkelijk onderwijzen. Onze kant-en-klare oplossingen kunnen op vele manieren worden gebruikt.',
      ...
      esports_blurb: "[AI_TRANSLATION]We herontwerpen wat een esport kan zijn terwijl we duizenden studenten betrekken om te leren coderen. Endemische esports-hoofdrolspeler __hyperx__ ondersteunde de zgcombat AI League vanaf het eerste seizoen, waarbij boeiende promotieprogramma's rond deze unieke esport werden ontwikkeld.",
    ...
    podcast: {
      ...
      learn_more_coco: '[AI_TRANSLATION]Wil je meer leren over zgcombat coding ervaringen?',
      //    subscribe: "Subscribe",
      explore_coco: '[AI_TRANSLATION]Verken zgcombat',
    ...
    library: {
      ...
      access_coco: '[AI_TRANSLATION]Toegang tot zgcombat',
      already_using_library_id: '[AI_TRANSLATION]Bibliotheek-id al in gebruik',
      play_coco: '[AI_TRANSLATION]om zgcombat te spelen',
      not_library_id: '[AI_TRANSLATION]Niet jouw bibliotheek-ID',
      access_using_id: '[AI_TRANSLATION]om toegang te krijgen met je id!!',
      network_detected: '[AI_TRANSLATION]Bibliotheeknetwerk gedetecteerd, je wordt doorgestuurd naar zgcombat',
      ...
      communication_limit_blurb: '[AI_TRANSLATION]Om de veiligheid van je leden te garanderen, bieden we geen in-game chat of andere communicatieopties tussen spelers aan, maar we laten leden wel veilig hun codingprojecten delen met vrienden, familie en de zgcombat-gemeenschap. We beperken elke vorm van upsell of marketingberichten om een ononderbroken ervaring voor je leden te bieden.',
      ...
      library_signup_promotion: '[AI_TRANSLATION]Meld je aan om voortgang op te slaan en verder te gaan waar je was gebleven op zgcombat!!',
    ...
    related_accounts: {
      subtitle: '[AI_TRANSLATION]Voeg verbindingen toe tussen verschillende zgcombat-accounts om snel tussen hen te kunnen schakelen. Bijvoorbeeld, als ouder zou je kunnen schakelen naar het bekijken van zgcombat vanuit de accounts van je kinderen. Of, als leraar zou je een teststudentaccount voor jezelf kunnen toevoegen om te zien wat je studenten zien.',
    ...
    modal_free_class: {
      paragraph_1: '[AI_TRANSLATION]Bedankt dat je voor zgcombat hebt gekozen.',
    ...
    roblox_landing: {
      meta_title: '[AI_TRANSLATION]zgcombat Werelden op Roblox: Speel, Codeer en Creëer',
      ...
      box_play_blurb_player: '[AI_TRANSLATION]Verken de 3D-immersieve ervaring van zgcombat Werelden. Programmeer je huisdieren en avonturier in een universum van creativiteit en gedeelde ervaringen met vrienden.',
      ...
      bottom_blurb_parent: '[AI_TRANSLATION]Geen nood om te wachten - __schrijf je in__ voor onze live online lessen om je kind vandaag nog te laten coderen! Laat ze aan de slag gaan met zgcombat web om als eerste toegang te krijgen tot de zgcombat Worlds Roblox ervaring.',
      bottom_blurb_sign_up: '[AI_TRANSLATION]Inschrijven',
      bottom_blurb_partner: '[AI_TRANSLATION]Wil je de nieuwe zgcombat Worlds Roblox-ervaring gebruiken voor je onderwijsbedrijf, maatschappelijke impact-ininitiatief of internationale distributiekans? __reach-out__ om vandaag nog te bespreken hoe we kunnen samenwerken.',
      ...
      connect_button_blurb: '[AI_TRANSLATION]Koppel je zgcombat- en Roblox-accounts voor een naadloze ervaring!',
      ...
      faq_bottom: '[AI_TRANSLATION]Zie meer <a href="https://codecombat.zendesk.com/hc/en-us/categories/18084251471383-zgcombat-Worlds-Roblox-" target="_blank">veelgestelde vragen in ons helpcentrum</a>. <br />Als je andere vragen hebt, <a href="mailto:support@flsong.iok.la">Neem contact op</a>.',
      modal_title: '[AI_TRANSLATION]zgcombat Werelden<br> Nu live op Roblox!',
    ...
    ai: {
      ...
      hackstack_promotion_blurb: '[AI_TRANSLATION]Nieuw in AI? Ontdek <b>zgcombat AI HackStack</b> – de makkelijkste weg naar AI-geletterdheid. Ontgrendel het potentieel van ChatGPT-4, Claude, Stable Diffusion en DALL-E. Dit innovatieve hulpmiddel biedt hands-on AI-training, waardoor creatie moeiteloos wordt.',
    ...
    home_v3: {
      ...
      testimonals_2_title: '[AI_TRANSLATION]"Noem een willekeurig programma online en ik heb het geprobeerd. Geen van hen komt in de buurt van zgcombat & Ozaria. Elke leraar die wil dat zijn leerlingen leren programmeren... begin hier!"',
      ...
      testimonals_4_title: '[AI_TRANSLATION]"Wat ik het leukst vind aan zgcombat is dat het coderen niet vereenvoudigt. De studenten leren echte code schrijven, maar doen dat op een manier die leuk is.”',
      ...
      engaging_boxes_2_text: '[AI_TRANSLATION]Een volledige CS-curriculum die bouwt vanaf kernconcepten tot en met webontwikkeling, gameontwikkeling en **[https://flsong.iok.la/apcsp]AP CSP**.',
      engaging_boxes_3_title: '[AI_TRANSLATION]zgcombat Werelden op Roblox',
    ...
    schools_page: {
      meta_title: '[AI_TRANSLATION]zgcombat: de meest effectieve informaticaoplossing voor scholen',
      ...
      codecombat_worlds: '[AI_TRANSLATION]zgcombat Werelden',
      k: '[AI_TRANSLATION]K',
      ...
      first_year_high_school_curriculum: '[AI_TRANSLATION]Het eerste jaar van ons middelbare schoolcurriculum richt zich op **AP CS Principles**, inclusief onze zgcombat-cursussen, CS1−CS4 en examencurriculum zoals **Data Science** en **Computing Systems**. Het meer gevorderde jaar stelt studenten in staat om meer van onze **gevorderde CS-cursussen** te verkennen en biedt keuze en stem op onze drie platforms.',
      ...
      faq_6_answer: '[AI_TRANSLATION]Informatica-onderwijs is een essentieel onderdeel geworden van de academische reis van een student, maar veel scholen hebben moeite om de nodige middelen te verkrijgen om hun studenten een uitgebreid informatica-programma te bieden. Bij zgcombat begrijpen we de financieringshobbels die scholen ondervinden en we zijn gepassioneerd om hen te helpen deze obstakels te overwinnen. Subsidies kunnen een waardevolle bron zijn, maar ze zijn moeilijk te ontdekken en aan te vragen. Bekijk onze uitgebreide **[https://flsong.iok.la/grants] gids voor subsidie-financiering** of spreek met ons team om meer te leren.  ',
      ...
      core_curriculum_2_text: '[AI_TRANSLATION]Een volledig CS-curriculum dat opbouwt van kernconcepten tot aan webontwikkeling, game-ontwikkeling en **[http://flsong.iok.la/apcsp]AP CSP**.',
      ...
      practice_enrichment_2_title: '[AI_TRANSLATION]zgcombat Werelden op Roblox',
    ...
    standards_page: {
      ...
      curriculum_description: '[AI_TRANSLATION]zgcombat biedt robuuste cursuspaden die zijn afgestemd op verschillende nationale en staatsstandaardkaders in groepen K-12, inclusief AP-niveau programmeerlessen in vele talen. Onze leerplannen betrekken studenten bij het verkennen en leren van computerwetenschappen via lesinhoud die voldoet aan de standaarden.',
      most_effective_computer_science_solution: '[AI_TRANSLATION]De meest effectieve oplossing voor informatica voor **[https://flsong.iok.la/schools]scholen**',
      ...
      carousel_2_text: '[AI_TRANSLATION]zgcombat wordt erkend door College Board als een goedgekeurde leverancier van curriculum en professionele ontwikkeling voor AP® Computer Science Principles (AP CSP). Deze goedkeuring bevestigt dat het curriculum van zgcombat is afgestemd op alle AP Curriculum Framework-normen en de AP CSP-beoordeling. Dit geeft scholen toegang tot middelen, inclusief een AP CSP-syllabus die vooraf is goedgekeurd door de College Board’s Course Audit, en officieel erkende professionele ontwikkeling die leraren voorbereidt om dit curriculum te geven.[NEWLINE]Leer meer over ons zgcombat AP CSP-curriculum hieronder:',
      ...
      carousel_4_text: '[AI_TRANSLATION]De **[https://corestandards.org/]Common Core State Standards** zijn een set uniforme academische standaarden voor K–12 Wiskunde en Engels Taalvaardigheid.[NEWLINE]zgcombat integreert een verscheidenheid aan vakoverschrijdende verbindingen met kernvakgebieden door ons curriculum heen. [NEWLINE]Leer hieronder meer over de gedetailleerde Common Core Standards Uitlijning:',
    ...
    hackstack: {
      ...
      'HowItWorksPage_learn-anything-create-something-do-every': '[AI_TRANSLATION]Leer ALLES, creëer IETS, doe ALLES met zgcombat AI HackStack. AI-kracht voor iedereen!',
      ...
      'NewProjectPage_prompt-the-ai-to-create-websites-games-w': '[AI_TRANSLATION]Vraag de AI om websites, games, web-apps, verhalen, kunst en meer te maken met de zgcombat AI HackStack.',
    ...
    parents_v2: {
      ...
      testimonials_3_quote: "[AI_TRANSLATION]Ondanks dat de les elke zaterdag om 7 uur 's ochtends begint, is mijn zoon zo enthousiast dat hij eerder wakker is dan ik! zgcombat creëert een pad voor mijn zoon om zijn programmeervaardigheden te verbeteren.",
      ...
      grid_codecombat_worlds: '[AI_TRANSLATION]zgcombat Werelden',
      ...
      grid_ai_hints_allowance: '[AI_TRANSLATION]zgcombat AI Tips Toelating (Dagelijks)***',
      grid_prompts_allowance: '[AI_TRANSLATION]zgcombat AI HackStack Prompts Toelage (Maandelijks)***',
      ...
      enroll_now: '[AI_TRANSLATION]Of, **[https://flsong.iok.la/payments/initial-online-classes-71]Schrijf je nu in**',
      ...
      codecombat_worlds_title: '[AI_TRANSLATION]zgcombat Werelden',
      ...
      carousel_items_1_text: '[AI_TRANSLATION]Voor studenten met weinig tot geen codeerervaring zullen de meeste klassensessies in Ozaria zijn om fundamentele vaardigheden op te bouwen en daarna in zgcombat om programmeerkennis te verdiepen. AI HackStack wordt gebruikt om de codeervaardigheden van je kind te versnellen en real-world toepassingen van hun nieuwe vaardigheden te laten zien. zgcombat Worlds en AI League zullen af en toe oefen- en creatieve speelmogelijkheden bieden.',
      carousel_items_2_title: '[AI_TRANSLATION]Game[NIEUWEREGEL]Ontwikkeling',
      carousel_items_2_title_prefix: '[AI_TRANSLATION]**Focus:**',
      carousel_items_2_text: '[AI_TRANSLATION]Als je kind van games houdt en ze wil maken, dan zal ons curriculum gericht op game-ontwikkeling zgcombat bevatten als kern voor de eerste game-ontwikkelingsactiviteiten en projecten. Binnen de kortste keren zal je kind in zgcombat Werelden werken en echte games publiceren naar het Roblox-platform. Deelnemen aan onze AI League biedt extra inzicht in succesvolle game-dynamiek en -ontwikkeling, terwijl AI HackStack een krachtig hulpmiddel zal zijn voor iteratieve game-ontwikkeling.',
      carousel_items_3_title: '[AI_TRANSLATION]Web[NEWLINE]Ontwikkeling',
      carousel_items_3_title_prefix: '[AI_TRANSLATION]**Focus:**',
      carousel_items_3_text: '[AI_TRANSLATION]Ontwikkelen voor het web evolueert voortdurend en het is belangrijk om voorop te blijven lopen. In deze curriculumfocus worden de eerste webontwikkelingsactiviteiten uitgevoerd in zgcombat, terwijl Ozaria zal worden gebruikt voor diegenen die nieuw zijn in coderen. AI HackStack zal zwaar worden geïmplementeerd als het platform om te bouwen en te publiceren naar het web, met beperkt gebruik van zgcombat Worlds en AI League om belangrijke codeerconcepten te versterken.',
      ...
      faq_5_answer: '[AI_TRANSLATION]Je abonnementaankoop is 100% risicovrij binnen de eerste 30 dagen. Als je om welke reden dan ook besluit niet door te gaan, neem dan binnen 30 dagen na aankoop contact met ons op via **[mailto:classes@flsong.iok.la]classes@flsong.iok.la** en we zullen direct 100% van je aankoop terugbetalen, zonder vragen.',
      faq_6_question: '[AI_TRANSLATION]Wat als ik een les moet verzetten?',
      faq_6_answer: '[AI_TRANSLATION]Zodra je een wekelijkse les bij ons hebt geboekt, hebben we tijd in ons schema gereserveerd exclusief voor jou, dus we vragen om 48 uur van tevoren bericht voor het verzetten van lessen. Je kunt je les verzetten door een e-mail te sturen naar **[mailto:classes@flsong.iok.la]classes@flsong.iok.la**. Lessen die worden gemist of geannuleerd met minder dan 48 uur van tevoren, worden niet opnieuw ingepland of terugbetaald.',
    ...
    roblox: {
      ...
      link_reward_desc: '[AI_TRANSLATION]Koppel je zgcombat- en Roblox-accounts om functies en beloningen te ontgrendelen\n',
      ...
      faq_3_answer: '[AI_TRANSLATION]Ja. Spelers kunnen hun ervaringen delen binnen zgcombat Worlds en hun ervaringen importeren naar Studio voor publicatie via een plugin, waarbij Studio-compatibiliteit behouden blijft.',
      faq_4_question: '[AI_TRANSLATION]Heb ik een Roblox-account nodig?  ',
      faq_4_answer: '[AI_TRANSLATION]Ja. Alle spelers kunnen zich gratis aanmelden op roblox.com. Vergeet niet je zgcombat-account en Roblox-account te koppelen om toegang te krijgen tot alle functies en beloningen.  ',
      faq_5_question: '[AI_TRANSLATION]Werkt het op mijn Chromebook of mobiele apparaat?  ',
      faq_5_answer: '[AI_TRANSLATION]Ja. zgcombat Worlds laat je spelen, echte code typen en games maken op pc, Mac, Chromebooks, tablets, telefoons en consoles.  ',
    ...
    pd_page: {
      ...
      ap_csp_professional_development_title: '[AI_TRANSLATION]AP CSP Professionele Ontwikkeling[NEWLINE](Met zgcombat)',
      ap_csp_professional_development_blurb: '[AI_TRANSLATION]Deze online cursus van 40+ uur, grotendeels zelfgestuurd, is ideaal voor elke docent die zijn studenten klaar wil stomen voor het AP Computer Science Principles-examen met behulp van zgcombat.',
      list_7: '[AI_TRANSLATION]Zowel deze cursus als het zgcombat AP CSP-curriculum worden onderschreven door het College Board. De uren die in deze cursus worden voltooid, kunnen worden gebruikt om in aanmerking te komen voor waardevolle professionele onderwijskredieten.  ',
      ...
      list_9: '[AI_TRANSLATION]Door zgcombat’s samenwerking met Southern New Hampshire University (SNHU) kun je tot 3 studiepunten op graduate-niveau verdienen terwijl je leert hoe je je studenten het beste kunt voorbereiden op het AP CSP-examen.  ',
