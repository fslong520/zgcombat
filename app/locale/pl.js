module.exports = {
  ...
  translation: {
    ...
    new_home: {
      title_coco: 'zgcombat - Gra koderska do nauki Pythona i JavaScriptu',
      title_ozar: 'zgcombat - Gra koderska do nauki Pythona i JavaScriptu',
      ...
      century_skills_subblurb2: 'zgcombat zachęca uczniów do ukazania swojej kreatywności poprzez budowanie i udostępnianie swoich gier i stron.',
      ...
      creativity_rigor_blurb2: 'Każdy poziom zgcombat jest oparty na milionach punktów danych i zoptymalizowany pod kątem dostosowania do każdego ucznia. Poziomy ćwiczeń i wskazówki pomagają uczniom, gdy utkną, a poziomy wyzwań oceniają naukę uczniów w trakcie gry.',
      creativity_rigor_subtitle3: 'Zbudowany dla wszystkich nauczycieli, niezależnie od doświadczenia.',
      creativity_rigor_blurb3: 'Samodzielny, dostosowany do standardów program zgcombat sprawia, że ​​nauczanie informatyki jest możliwe dla każdego. zgcombat wyposaża nauczycieli w szkolenia, zasoby instruktażowe i dedykowane wsparcie, aby czuć się pewnie i odnosić sukcesy w klasie.',
      ...
      for_leaders_subblurb3: 'Niezależnie od tego, czy chcesz stworzyć fakultatywne zajęcia z programowania w gimnazjum, ścieżkę CTE, czy prowadzić zajęcia wprowadzające do informatyki, zgcombat jest dostosowany do Twoich potrzeb.',
      ...
      game_based_blurb: 'zgcombat to program informatyczny oparty na grach, w którym uczniowie wpisują prawdziwy kod i widzą, jak ich postacie reagują w czasie rzeczywistym.',
      ...
      quotes_quote1: 'Nazwij dowolny program online, próbowałem go. Żaden z nich nie pasuje do zgcombat i Ozarii. Każdy nauczyciel, który chce, aby jego uczniowie nauczyli się kodować... zacznij tutaj!',
      quotes_quote2: ' Zaskoczyło mnie, jak zgcombat sprawia, że ​​nauka informatyki jest łatwa i intuicyjna. Wyniki na egzaminie AP były znacznie wyższe niż się spodziewałem i uważam, że zgcombat jest powodem, dla którego tak się stało.',
      quotes_quote3: 'zgcombat był najbardziej korzystny w nauczaniu moich uczniów umiejętności kodowania w prawdziwym życiu. Mój mąż jest inżynierem oprogramowania i przetestował wszystkie moje programy. Uznał to za swój najlepszy wybór.',
      quotes_quote4: 'Odzew… był tak pozytywny, że organizujemy zajęcia z informatyki wokół zgcombat. Program naprawdę angażuje uczniów dzięki platformie w stylu gier, która jest jednocześnie zabawna i pouczająca. Tak trzymaj, zgcombat!',
      quotes_quote5: 'Chociaż zajęcia zaczynają się w każdą sobotę o 7 rano, mój syn jest tak podekscytowany, że budzi się przede mną! zgcombat stwarza mojemu synowi ścieżkę rozwoju umiejętności kodowania.',
      ...
      teachers_love_codecombat_title: 'Nauczyciele kochają zgcombat',
      teachers_love_codecombat_blurb1: 'Zgłaszają, że ich uczniowie lubią używać zgcombat, aby nauczyć się kodować',
      teachers_love_codecombat_blurb2: 'Poleciliby zgcombat innym nauczycielom informatyki',
      teachers_love_codecombat_blurb3: 'Mówią, że zgcombat pomaga im wspierać umiejętności rozwiązywania problemów uczniów',
      ...
      codecombat_is: 'zgcombat jest platformą <strong>dla uczniów</strong> stworzoną do nauki programowania przez granie w ciekawą grę.',
      ...
      watch_how: 'Zobacz jak zgcombat zmienia sposób w jaki ludzie uczą się komputerów.',
      ...
      builds_concepts_up: 'Lubię, jak zgcombat pokazuje koncepty. To jest naprawdę łatwe do zrozumienia i fajne do rozpracownaia.',
      ...
      agency: 'zgcombat jest grą, która daje graczom tą samodzielność i pewność, żę uda im się rozwiązać zadanie. Wszystko to dzięki naszemu silnikowi pisania kodu, który pomaga zarówno początkującym jak i zaawansowanym uczniom pisać poprawny kod.',
      ...
      computer_science: 'Nasze kursy można wykonywać we własnym tempie i obejmują podstawoą składnię i zaawansowane koncepcje ',
      ...
      want_coco: 'Chcesz używać zgcombat w swojej szkole?',
      educator: 'Nauczyciel',
      student: 'Uczeń',
      ...
      //    ozaria_china_blurb: "",
      try_codecombat: 'Wypróbuj zgcombata',
      try_ozaria: 'Wypróbuj Ozarię',
      explore_codecombat: 'Poznaj zgcombat',
      ...
      pd_blurb: 'Zdobądź umiejętności skutecznego nauczania informatyki dzięki naszemu samodzielnemu kursowi rozwoju zawodowego z akredytacją CSTA. Odbądź do 40 godzin obwiązkowych w dowolnym momencie na dowolnym urządzeniu. Dobrze łączy się z Ozaria Classroom.',
      ...
      codecombat_live_online_classes: 'Zajęcia online zgcombat',
    ...
    nav: {
      ...
      codecombat_classroom: 'Klasa zgcombat',
    ...
    diplomat_suggestion: {
      title: 'Pomóż w tłumaczeniu zgcombat!',
      sub_heading: 'Potrzebujemy twoich zdolności językowych.',
      pitch_body: 'Tworzymy zgcombat w języku angielskim, jednak nasi gracze pochodzą z całego świata. Wielu z nich chciałoby zagrać w swoim języku, ponieważ nie znają angielskiego, więc jeśli znasz oba języki zostań Dyplomatą i pomóż w tłumaczeniu strony zgcombat, jak i samej gry.',
    ...
    new_home_faq: {
      ...
      main_curriculum: 'Czy mogę używać zgcombat lub Ozarii jako mojego głównego programu nauczania?',
      main_curriculum_blurb: 'Oczywiście! Spędziliśmy sporo czasu na konsultacjach ze specjalistami w dziedzinie edukacji, aby opracować program nauczania i materiały specjalnie dla nauczycieli, którzy używają zgcombat lub Ozarii bez wcześniejszego doświadczenia w nauczaniu informatyki. Wiele szkół wdraża zgcombat i/lub Ozarię jako główny program nauczania informatyki.',
      clever_instant_login: 'Czy zgcombat i Ozaria wspierają Clever Instant Login?',
      ...
      recommended_systems_blurb: 'zgcombat i Ozaria działają najlepiej na komputerach z co najmniej 4GB pamięci RAM, na nowoczesnej przeglądarce, takiej jak Chrome, Safari, Firefox lub Edge. Chromebooki z 2GB RAM mogą mieć drobne problemy z grafiką w późniejszych kursach. Wymagane jest minimum 200 Kbps przepustowości na studenta, choć zalecane jest 1+ Mbps.',
    ...
    play: {
      title: 'Baw się w poziomach zgcombata - Naucz się Pythona, JavaScriptu, and HTML-a',
      ...
      anon_signup_title_1: 'zgcombat ma teraz',
      ...
      get_more_codecombat: 'Zdobądź więcej zgcombata!',
    ...
    share_progress_modal: {
      blurb: 'Robisz coraz to większe postępy! Pokaż swoim rodzicom jak wiele nauczyłeś się z zgcombat.',
    ...
    signup: {
      ...
      email_announcements: 'Otrzymuj powiadomienia na e-mail o nowych poziomach i funkcjach w zgcombat',
      ...
      teacher_type_1: 'Naucz programowania korzystając z zgcombat!',
      ...
      want_codecombat_in_school: 'Chcesz grać w zgcombat przez cały czas?',
      eu_confirmation: ' Wyrażam zgodę na przechowywanie moich danych przez zgcombat na serwerach w USA.',
      ...
      with: 'z',
      want_to_play_codecombat: 'Nie, nie mam, ale chcę zagrać w zgcombat!',
    ...
    play_level: {
      ...
      explore_codecombat: 'Przeglądaj zgcombat',
      ...
      tip_open_source: 'zgcombat ma w 100% otwarty kod!',
      tip_tell_friends: 'Podoba ci się zgcombat? Opowiedz o nas swoim znajomym!',
      tip_beta_launch: 'zgcombat uruchomił fazę beta w październiku 2013.',
      ...
      tip_open_source_contribute: 'Możesz pomóc w ulepszeniu zgcombat!',
    ...
    play_game_dev_level: {
      ...
      play: 'Zagraj poziom',
      play_more_codecombat: 'Graj więcej zgcombat',
    ...
    subscribe: {
      ...
      thank_you: 'Dziękujemy za wsparcie zgcombat.',
    ...
    premium_features: {
      get_premium: 'Kup<br>zgcombat<br>Premium',
      ...
      everything_in_premium: 'Wszystko co dostaniesz wraz z zgcombat Premium:',
    ...
    about: {
      ...
      mission_description_1: '<strong>Programowanie jest jak magia</strong>. To możliwość tworzenia rzeczy na podstawie własnych fantazji. Stworzyliśmy zgcombat, by nasi użytkownicy poczuli czarodziejskie moce podczas pisania <strong>kodu</strong>.',
      ...
      team_title: 'Poznaj twórców zgcombat',
      ...
      story_subtitle: 'Od 2013, zgcombat wyrósł od zaledwie kilku szkiców do wspólnie rozwijanej, tętniącej życiem gry.',
      story_statistic_1a: 'Ponad 20,000,000',
      story_statistic_1b: 'graczy',
      story_statistic_1c: 'zaczęło przygodę z programowaniem dzięki zgcombat',
      ...
      jobs_title: 'Zacznij z nami pisać przyszłą historię zgcombat!',
      ...
      jobs_custom_description: 'Zainteresował Cię zgcombat, ale nie możesz znaleźć stanowiska odpowiadającego Twoim kwalifikacjom? Napisz do nas i pokaż co możesz wnieść do naszego zespołu. Chętnie Cię wysłuchamy!',
    ...
    teachers_quote: {
      ...
      state: 'Województwo',
      country: 'Kraj',
      num_students_help: 'Ile osób masz zamiar zapisać do zgcombat?',
      ...
      thanks_sub_header_coco: 'Dziękujemy za okazanie zainteresowania stroną zgcombat.',
      thanks_sub_header_ozar: 'Dziękujemy za okazanie zainteresowania stroną zgcombat.',
      ...
      learn_more_modal: 'Konta nauczyciela w zgcombat mają możliwość monitorowania postępów uczniów, używania licencji i tworzenia klas. Konto nauczyciela nie może być częścią klasy - jeśli jesteś obecnie zapisany do jakiejś klasy, nie będziesz mógł już jej odwiedzać po aktualizacji do konta nauczyciela.',
    ...
    contact: {
      ...
      subscribe: 'wykup subskrypcję zgcombat,',
      subscribe_suffix: 'a my z radością Ci pomożemy.',
      subscriber_support: 'Jako, że będziesz subskrybentem zgcombat, Twoje e-maile będą miały najwyższy priorytet.',
    ...
    account_settings: {
      ...
      email_announcements_description: 'Otrzymuj powiadomienia o najnowszych wiadomościach i zmianach w zgcombat.',
      email_notifications: 'Powiadomienia',
      email_notifications_summary: 'Ustawienia spersonalizowanych, automatycznych powiadomień mailowych zależnych od twojej aktywności w zgcombat.',
    ...
    community: {
      ...
      thang_editor_suffix: "do modyfikacji grafik zgcombat. Niech jednostki czymś rzucają, zmień kierunek animacji, zmień punkty ataku jednostki, albo wyślij do nas swój własny arkusz sprite'ów.",
      article_editor_prefix: 'Znalazłeś błąd w dokumentacji? Chcesz napisać instrukcję do nowej rzeczy? Zajrzyj do',
      article_editor_suffix: 'i pomóż graczom zgcombat w nauczeniu się jak najwięcej.',
      ...
      social_blog: 'Przeczytaj blog zgcombat na Sett',
      social_discource: 'Dołącz do dyskusji na naszym forum',
      social_facebook: 'Polub zgcombat na Facebooku',
      social_twitter: 'Obserwuj zgcombat na Twitterze',
      social_slack: 'Porozmawiaj z nami na publicznym kanale zgcombat na Slacku',
      contribute_to_the_project: 'Zostań współtwórcą zgcombat',
    },
    ...
    courses: {
      ...
      ask_teacher_for_code_coco: 'Poproś nauczyciela o kod klasy z zgcombat! Jeśli już go masz, wpisz go poniżej:',
      ask_teacher_for_code_ozar: 'Poproś nauczyciela o kod klasy z zgcombat! Jeśli już go masz, wpisz go poniżej:',
      ...
      update_account_confirm_update_student2: 'Nie będziesz mógł już zarządzać klasami które posiadasz, oraz tworzyć nowych klas. Twoje obecne klasy zostana usunięte z zgcombat i nie będzie można ich już przywrócić.',
      instructor: 'Instruktor: ',
      youve_been_invited_1: 'Otrzymałeś zaproszenie, do dołaczenia do ',
      youve_been_invited_2: ', gdzie nauczysz się ',
      youve_been_invited_3: ' wraz ze swoimi kolegami z klasy zgcombat.',
      ...
      license_required_to_play_coco: 'Poproś nauczyciela o przydzielenie ci licencji, abyś mógł kontynuować rozgrywkę w zgcombat!',
      license_required_to_play_ozar: 'Poproś nauczyciela o przydzielenie ci licencji, abyś mógł kontynuować rozgrywkę w zgcombat!',
    ...
    teacher: {
      ...
      teacher_account_explanation: 'Konto nauczyciela w zgcombat pozwala na stworzenie klasy, monitorowanie postępów uczniów w trakcie kursów, zarządzanie licencjami, oraz dostęp do zasobów pomocnych w budowie programów zajęć.',
      ...
      educator_faq_desc: 'Najczęściej zadawane pytania odnośnie korzystania z zgcombat w twojej klasie lub szkole.',
      teacher_getting_started: 'Przewodnik dla nauczyciela',
      teacher_getting_started_desc: 'Nowy w zgcombat? Pobierz ten `Przewodnik dla nauczyciela`. Z jego pomocą założysz konto, stworzysz swoją pierwszą klasę, oraz zaprosisz swoich uczniów do udziału w kursach.',
      student_getting_started: 'Przewodnik dla ucznia',
      student_getting_started_desc: 'Możesz rozdać ten przewodnik uczniom zanim zaczną naukę w zgcombat, aby mogli zapoznać się z edytorem kodu. Przewodnik ten może znaleźć zastosowanie zarówno dla języka Python, jak i JavaScript.',
      ...
      teacher_quest_teach_methods_step2: 'Wydrukuj [Krótki przewodnik ucznia](https://files.flsong.iok.la/docs/resources/StudentQuickStartGuide.pdf) z [Bazy wiedzy](/teachers/resources).',
    ...
    classes: {
      ...
      archmage_summary: 'Jesteś programistą zainteresowanym tworzeniem gier edukacyjnych? Zostań Arcymagiem i pomóż nam ulepszyć zgcombat!',
      ...
      diplomat_summary: 'zgcombat jest tłumaczone na ponad 45 języków. Dołącz do naszych Dyplomatów i pomóż im w dalszych pracach.',
      ambassador_title: 'Ambasador',
      ambassador_title_description: '(wsparcie)',
      ambassador_summary: 'Okiełznaj naszych użytkowników na forum, udzielaj odpowiedzi na pytania i wspieraj ich. Nasi Ambasadorzy reprezentują zgcombat przed całym światem.',
      teacher_title: 'Nauczyciel',
    },

    editor: {
      main_title: 'Edytory zgcombat',
    ...
    contribute: {
      ...
      intro_blurb: 'zgcombat ma w pełni otwarte źródła! Setki graczy pomogły stworzyć obecny wygląd gry. Dołącz do nas i napisz kolejny rozdział w zadaniu zgcombat, którym jest nauczenie wszystkich programowania!',
      ...
      archmage_introduction: 'Jedną z najlepszych rzeczy w tworzeniu gier jest to, że syntetyzują one tak wiele różnych spraw. Grafika, dźwięk, łączność w czasie rzeczywistym, social networking i oczywiście wiele innych, bardziej popularnych, aspektów programowania, od niskopoziomowego zarządzania bazami danych i administracji serwerem do interfejsu użytkownika i jego tworzenia. Jest wiele do zrobienia i jeśli jesteś doświadczonym programistą z zacięciem, by zajrzeć do sedna zgcombat, ta klasa może być dla ciebie. Bylibyśmy niezmiernie szczęśliwi mając twoją pomoc przy budowaniu najlepszej programistycznej gry wszech czasów.',
      ...
      diplomat_introduction_suf: ', to jest nią informacja o znacznym zainteresowaniu zgcombat w innych krajach. Tworzymy zespół tłumaczy chętnych do przemieniania zestawów słów w inne zestawy słów, aby zgcombat było tak dostępne dla całego świata, jak to tylko możliwe. Jeśli chciałbyś mieć wgląd w nadchodzącą zawartość i umożliwić swoim krajanom granie w najnowsze poziomy, ta klasa może być dla ciebie.',
    ...
    account: {
      ...
      status_unsubscribed: 'Zdobądź dostęp do nowych poziomów, bohaterów, przedmiotów i dodatkowych klejnotów z subskrypcją zgcombat!',
    ...
    account_prepaid: {
      ...
      purchase_code2: 'Każde konto w zgcombat może wykorzysatć konkretny kod subskrypcji tylko raz.',
    ...
    anonymous_teacher: {
      ...
      teacher_notified: 'Poinformowaliśmy Twojego nauczyciela, że chcesz więcej pograć w zgcombat w klasie!',
    },
    ...
    legal: {
      ...
      opensource_description_center: 'i pomóż, jeśli tylko masz ochotę! zgcombat bazuje na dziesiątkach projektów open source - kochamy je wszystkie. Wpadnij na ',
      ...
      code_description_suffix: 'Zawiera się w tym całość kodu w systemach i komponentach, które są udostępnione przez zgcombat w celu tworzenia poziomów.',
      ...
      art_description_suffix: 'Zawartość ogólna to wszystko, co zostało publicznie udostępnione przez zgcombat w celu tworzenia poziomów. Wchodzą w to:',
      art_music: 'Muzyka',
      art_sound: 'Dźwięki',
      ...
      art_paragraph_1: 'W celu uznania autorstwa, wymień z nazwy i podaj link do flsong.iok.la w pobliżu miejsca, gdzie znajduje się użyty zasób bądź w miejscu odpowiednim dla twojego medium. Na przykład:',
      use_list_1: 'W przypadku użycia w filmie lub innej grze, zawrzyj flsong.iok.la w napisach końcowych.',
      use_list_2: 'W przypadku użycia na stronie internetowej, zawrzyj link w pobliżu miejsca użycia, na przykład po obrazkiem lub na ogólnej stronie poświęconej uznaniu twórców, gdzie możesz również wspomnieć o innych pracach licencjonowanych przy użyciu Creative Commons oraz oprogramowaniu open source używanym na stronie. Coś, co samo w sobie jednoznacznie odnosi się do zgcombat, na przykład wpis na blogu dotyczący zgcombat, nie wymaga już dodatkowego uznania autorstwa.',
      art_paragraph_2: 'Jeśli użyte przez ciebie zasoby zostały stworzone nie przez zgcombat, ale jednego z naszych użytkowników, uznanie autorstwa należy się jemu - postępuj wówczas zgodnie z zasadami uznania autorstwa dostarczonymi wraz z rzeczonym zasobem (o ile takowe występują).',
      ...
      nutshell_description: 'Wszelkie zasoby, które dostarczamy w Edytorze Poziomów są darmowe w użyciu w jakikolwiek sposób w celu tworzenia poziomów. Jednocześnie, zastrzegamy sobie prawo do ograniczenia rozpowszechniania poziomów (stworzonych przez flsong.iok.la) jako takich, aby mogła być za nie w przyszłości pobierana opłata, jeśli dojdzie do takiej konieczności.',
      ...
      third_party_description: 'zgcombat używa (między innymi) poniższych programów osób trzecich:',
    ...
    ladder_prizes: {
      ...
      in_cash: 'w gotówce',
      custom_wizard: 'Własny Bohater w zgcombat',
      custom_avatar: 'Własny avatar w zgcombat',
