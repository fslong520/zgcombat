module.exports = {
  ...
  translation: {
    ...
    subscribe: {
      ...
      comparison_blurb: '',
      must_be_logged: '',
      subscribe_title: '', // Actually used in subscribe buttons, too
      unsubscribe: '',
      confirm_unsubscribe: '',
      never_mind: '',
      ...
      unlock_help_videos: '',
      personal_sub: '', // Accounts Subscription View below
      loading_info: '',
      managed_by: '',
      will_be_cancelled: '',
      currently_free: '',
    ...
    premium_features: {
      get_premium: '', // Fit into the banner on the /features page
      master_coder: '',
      paypal_redirect: '',
      subscribe_now: '',
      hero_blurb_1: '',
    ...
    payments: {
      ...
      email_not_verified: '',
      stripe_no_data: '',
      manage_payment_and_subscription: '',
      discover_more_title: '',
      discover_more_desc: '',
      billing_portal_desc: '',
      billing_portal_btn: '',
      payment_history: '',
      payment_history_btn_all: '',
      payment_history_btn_less: '',
    },
    ...
    new_premium: {
      ...
      junior_title: '',
      junior_text: '',
      codecombat_worlds_text: '',
      junior_text_short: '',
      codecombat_text_short: '',
      ai_league_text_short: '',
      codecombat_worlds_text_short: '',
      ai_hackstack_text_short: '',
      subscription_includes_title: '',
      subscription_includes_1: '',
      subscription_includes_2: '',
      subscription_includes_3: '',
      subscription_includes_4: '',
      subscription_includes_5: '',
      testimonials_2_name: '',
      features_1: '',
      features_2: '',
      features_3: '',
      features_4: '',
      features_5: '',
      every_learner_different_learning_style: '',
      adapt_interests: '',
      carousel_items_1_title: '',
      carousel_items_1_text: '',
      carousel_items_2_text: '',
      carousel_items_3_text: '',
      carousel_items_4_text: '',
      carousel_items_5_title: '',
      carousel_items_5_text: '',
      cs_benefits: '',
      our_solutions: '',
      learning_code_challenging: '',
      new_to_ai: '',
      premium_page_title: '',
    },
    parents_v2: {
