module.exports = {
  ...
  englishDescription: 'Filipino (Philippines)',
  translation: {
    ...
    new_home: {
      ...
      //    title_cn_home: "zgcombat|Python, Javascript",
      //    meta_keywords_coco: "zgcombat, python, javascript, Coding Games",
      //    meta_keywords_ozar: "zgcombat, python, javascript, Coding Games, Computer Science Program, Adventure, Epic Story",
      ...
      //    become_investor: "to become an investor in zgcombat",
      //    built_for_teachers_title: "A Coding Game Built with Teachers in Mind",
      //    built_for_teachers_blurb: "Teaching kids to code can often feel overwhelming. zgcombat helps all educators teach students how to code in either JavaScript or Python, two of the most popular programming languages. With a comprehensive curriculum that includes six computer science units and reinforces learning through project-based game development and web development units, kids will progress on a journey from basic syntax to recursion!",
      ...
      //    century_skills_subblurb2: "zgcombat encourages students to showcase their creativity by building and sharing their own games and webpages.",
      ...
      //    creativity_rigor_blurb2: "Every zgcombat level is scaffolded based on millions of data points and optimized to adapt to each learner. Practice levels and hints help students when they get stuck, and challenge levels assess students' learning throughout the game.",
      //    creativity_rigor_subtitle3: "Built for all teachers, regardless of experience",
      //    creativity_rigor_blurb3: "zgcombat’s self-paced, standards-aligned curriculum makes teaching computer science possible for everyone. zgcombat equips teachers with the training, instructional resources, and dedicated support to feel confident and successful in the classroom.",
      ...
      //    for_leaders_subblurb3: "Whether you want to build a Middle School coding elective, a CTE pathway, or an AP Computer Science Principles class, zgcombat is tailored to suit your needs.",
      ...
      //    game_based_blurb: "zgcombat is a game-based computer science program where students type real code and see their characters react in real time.",
      ...
      //    quotes_quote1: "Name any program online, I’ve tried it. None of them match up to zgcombat & Ozaria. Any teacher who wants their students to learn how to code... start here!",
      //    quotes_quote2: " I was surprised about how easy and intuitive zgcombat makes learning computer science. The scores on the AP exam were much higher than I expected and I believe zgcombat is the reason why this was the case.",
      //    quotes_quote3: "zgcombat has been the most beneficial for teaching my students real-life coding capabilities. My husband is a software engineer and he has tested out all of my programs. He put this as his top choice.",
      //    quotes_quote4: "The feedback … has been so positive that we are structuring a computer science class around zgcombat. The program really engages the students with a gaming style platform that is entertaining and instructional at the same time. Keep up the good work, zgcombat!",
      //    quotes_quote5: "Even though the class starts every Saturday at 7am, my son is so excited that he wakes up before me! zgcombat creates a pathway for my son to advance his coding skills.",
      ...
      //    teachers_love_codecombat_title: "Teachers Love zgcombat",
      //    teachers_love_codecombat_blurb1: "Report that their students enjoy using zgcombat to learn how to code",
      //    teachers_love_codecombat_blurb2: "Would recommend zgcombat to other computer science teachers",
      //    teachers_love_codecombat_blurb3: "Say that zgcombat helps them support students’ problem solving abilities",
      ...
      //    top_banner_blurb_roblox: "NEW! zgcombat is coming to Roblox!",
      //    top_banner_blurb_roblox_teachers: "NEW! zgcombat has partnered with Roblox Education!",
      ...
      //    top_banner_blurb_demo_day_10_20: "Join us for a spooktacular demo of zgcombat & Ozaria on Thursday, October 20 at 4:00 pm CDT.",
      ...
      //    im_an_educator: "I'm an Educator",
      //    im_an_educator_description: "Teach Computer Science with zgcombat",
      ...
      learn_more: 'Alamin Lalo',
      //    check_it_out: "Check it out!",
      classroom_in_a_box: 'Isang Silid-Aralan-In-A-Box para sa pagtuturo ng Computer Science.',
      codecombat_is: 'Ang zgcombat ay isang platforma para matuto ang <strong>mga estudyante</strong> ng computer science habang naglalaro ng tunay na laro',
      our_courses: 'Ang aming mga kurso ay subok na subok na  <strong>para sa mga Silid-Aralan</strong>, kayang sundan kahit ng mga guro na kaunti hanggang wala pang karasanan sa programming.',
      //    watch_how: "Watch how zgcombat is transforming the way people learn computer science.",
      top_screenshots_hint: 'Ang mga Estudyante ay nagcocode at nakikita ang resulta agad agad',
      designed_with: 'Ginawa para tumulong sa mga guro',
      real_code: 'Totoong, Gumaganang Code',
      from_the_first_level: 'mula sa unang baitang',
      getting_students: 'Ang pagkapamilyar ng mga Estudyante sa totoong code ng agaran ay kritikal sa pag aral ng programming syntax at istraktura ng code.',
      educator_resources: 'Gabay sa mga guro',
      course_guides: 'at panuntunan sa mga kurso',
      teaching_computer_science: "Ang pagtuturo ng computer science ay hindi nangangailangan ng mamahaling antas na natapos, dahil nagbibigay kami ng sapat na mga kagamitang pang-aralin para masuportahan ang mga Guro na iba't iba ang karanasang pang-edukasyon.",
      ...
      //    builds_concepts_up: "I like how zgcombat builds the concepts up. It's really easy to understand and fun to figure it out.",
      ...
      excel: 'Ang mga laro ay nangunguna sa pag-gantimpala',
      struggle: 'Produktibong Pagsisikap',
      kind_of_struggle: 'klase ng paghihirap na nakakaengganyo mag-aral',
      motivating: 'nakakagana',
      not_tedious: 'hindi nakakapagod.',
      gaming_is_good: 'May mga pagsusuri na nagsasabing mabuti ang mga laro para sa utak ng mga bata. (Totoo!).',
      game_based: 'Kapag ang mga larong pang-aralin ay',
      compared: 'kinukumpara',
      conventional: 'laban sa mga nakagawiang paraan ng pag-aaral, malinaw ang resulta: mas nakakatulong ang mga laro maalala ng mga bata ang kanilang mga naaral, tumutok sa aralin at',
      perform_at_higher_level: 'gumawa sa mas mataas na antas para magtagumpay',
      feedback: 'Ang mga laro ay nagbibigay ng agarang resulta na nagbibigay ng pagkakataon sa mga estudyante na ayusin ang kanilang mga sagot at maintindihan ang mga konsepto ng buo, sa halip na mababaw na "tama" at "mali"ng gawain.',
      real_game: 'Totoong laro, nilalaro gamit ng totoong code.',
      great_game: 'Ang isang magandang laro ay hindi lang mga pang-sagisag at mga nakamit - ito ay dapat tungkol sa paglalakbay ng manlalaro, mainam na palaisipan, at abilidad na salubungin ang mga hamon ng may gawa at tiwala.',
      agency: "Ang zgcombat ay laro na nagbibigay sa mga manlalaro ng tamang-gawa at tiwala gamit ang aming pulidong 'typed code engine', na tumutulong sa mga baguhan at bihasang estudyante magsulat ng tama at maayos na code.",
      request_demo_title: 'Pagsimulain ang mga Estudyante ngayon!',
      request_demo_subtitle: 'Humingi ng pansubok at pwede nyo nang pagsimulain ang mga estudyante sa loob ng isang oras!',
      get_started_title: 'Simulan ang klase ngayon',
      get_started_subtitle: 'Gumawa ng klase, idagdag ang mga mag-aaral, at patnubayan ang kanilang progreso habang sila ay natututo ng computer science.',
      request_demo: 'Humingi ng Subok',
      //    request_quote: "Request a Quote",
      setup_a_class: 'Magtaguyod ng Klase',
      have_an_account: 'Meron nang account?',
      logged_in_as: 'Ikaw ay kinikilalang si',
      computer_science: 'Mga kursong "Computer Science" para sa lahat ng edad',
      ffa: 'Libre sa lahat ng estudyante',
      coming_soon: 'Marami pang darating!',
      courses_available_in: 'Mga kurso ay meron sa JavaScript at Python. Mga kursong pang-Web Development  ay gumagamit ng HTML, CSS, jQuery, at Bootstrap.',
      boast: 'Pinagmamalaking mga palaisipan na mahirap sa puntong nakakahanga sa mga manlalaro at mga coder.',
      winning: 'Ang panalong pagsasama ng RPG na laro habang gumagawa ng aralin para sa programming ay gumagana sa pag-gawa ng edukasyong pambata na lehitimong nakakatuwa.',
      run_class: 'Lahat ng kailangan para mag-turo ng Computer Science sa inyong paaralan ngayon, hindi kailangan ng karanasan sa Computer Science',
      goto_classes: 'Mga Klase',
      view_profile: 'Aking Profile',
      view_progress: 'Aking Progreso',
      go_to_courses: 'Aking mga Kurso',
      want_coco: 'Gusto nyo ng zgcombat sa inyong paaralan?',
      //    educator: "Educator",
      //    student: "Student",
      //    go_to_my_dashboard: "Go to My Dashboard",
      //    our_coding_programs: "Our Coding Programs",
      //    codecombat: "zgcombat Classroom",
      ...
      //    codecombat_live_online_classes: "zgcombat Live Online Classes",
      ...
      //    meta_keywords_podcast: "zgcombat, python, javascript, Coding Games, podcast, edtech",
      //    coco_worlds_header: "zgcombat Worlds",
      //    coco_worlds_description: "Embark on a 3D coding adventure in Roblox, where you can program pets, play with friends, and develop games all while playing one. Join the zgcombat community and unleash your creativity in the metaverse!",
      //    coco_worlds_button: "Explore zgcombat Worlds",
    ...
    //    parent: "Parents",
    //    faq: "FAQ",
    //    return_coco: "Return to zgcombat",
    //    classes: "Classes",
    ...
    //    codecombat_classroom: "zgcombat Classroom",
    ...
    //    codecombat_dashboard: "zgcombat Dashboard",
    //    codecombat_teacher_dashboard: "zgcombat Teacher Dashboard",
    //    codecombat_admin_dashboard: "zgcombat Admin Dashboard",
    ...
    //    codecombat_home: "zgcombat",
    //    libraries: "Libraries",
    //    codecombat_worlds_on_roblox: "zgcombat Worlds on Roblox",
    //    pricing: "Pricing",
    ...
    //    coco_junior_beta: "zgcombat Junior (Beta)",
    ...
    //  diplomat_suggestion: {
    //    title: "Help translate zgcombat!",
    //    sub_heading: "We need your language skills.",
    //    pitch_body: "We develop zgcombat in English, but we already have players all over the world. Many of them want to play in {English} but don't speak English, so if you can speak both and are a native speaker of {English}, please consider signing up to be a Diplomat and help translate both the zgcombat website and all the levels into {English}.",
    ...
    //    main_curriculum: "Can I use zgcombat or Ozaria as my main curriculum?",
    ...
    //    clever_instant_login: "Does zgcombat and Ozaria support Clever Instant Login?",
    ...
    //    recommended_systems_blurb: "zgcombat and Ozaria run best on computers with at least 4GB of RAM, on a modern browser such as Chrome, Safari, Firefox, or Edge. Chromebooks with 2GB of RAM may have minor graphics issues in later courses. A minimum of 200 Kbps bandwidth per student is required, although 1+ Mbps is recommended.",
    ...
    //    ai_bot_faq_blurb: "The AI Chat Level Help Bot in zgcombat empowers learners with AI-driven hints for coding challenges, ensuring a guided yet independent learning experience. Safety is paramount, as the AI filters out personal data and is trained to handle improper requests.",
    //  },

    //  play: {
    //    title: "Play zgcombat Levels - Learn Python, JavaScript, and HTML",
    ...
    //    level_title: "__level__ - zgcombat",
    ...
    //    anon_signup_title_1: "zgcombat has a",
    ...
    //    get_more_codecombat: "Get More zgcombat",
    ...
    //    play_codecombat: "Play zgcombat",
    //    play_codecombat_junior: "Play zgcombat Junior",
    ...
    //    blurb: "You’re making great progress! Tell your parent how much you've learned with zgcombat.",
    ...
    //    already_have_account1: "Already have a zgcombat Teacher or Student account?",
    //    already_have_account2: "You can sign into Ozaria.com using that account.",
    //    sign_into_ozaria: "Sign Into Ozaria.com",
    //    individual_users_not_supported: "Ozaria is for classrooms only!  Please visit zgcombat to continue playing!",
    ...
    //    email_announcements: "Receive announcements about new zgcombat levels and features!",
    ...
    //    teacher_type_1: "Teach programming using zgcombat!",
    ...
    //    want_codecombat_in_school: "Want to play zgcombat all the time?",
    //    eu_confirmation: "I agree to allow zgcombat to store my data on US servers.",
    ...
    //    already_have_account: "Already have a zgcombat or Ozaria account",
    ...
    //    with: "with",
    //    want_to_play_codecombat: "No, I don't have one but want to play zgcombat!",
    ...
    common: {
      //    default_title_coco: "zgcombat - Coding games to learn Python and JavaScript",
    ...
    //    tip_open_source: "zgcombat is part of the open source community!",
    //    tip_tell_friends: "Enjoying zgcombat? Tell your friends about us!",
    //    tip_beta_launch: "zgcombat launched its beta in October, 2013.",
    ...
    //    tip_open_source_contribute: "You can help zgcombat improve!",
    ...
    //    play: "Play Level",
    //    play_more_codecombat: "Play More zgcombat",
    ...
    //  subscribe: {
    //    best_deal: "Best Deal!",
    //    confirmation: "Congratulations! You now have a zgcombat Premium Subscription!",
    ...
    //    thank_you: "Thank you for supporting zgcombat.",
    ...
    //  premium_features: {
    //    get_premium: "Get<br>zgcombat<br>Premium",
    ...
    //    everything_in_premium: "Everything you get in zgcombat Premium:",
    ...
    //    mission_description_1: "<strong>Programming is magic</strong>. It's the ability to create things from pure imagination. We started zgcombat to give learners the feeling of wizardly power at their fingertips by using <strong>typed code</strong>.",
    //    mission_description_2: "As it turns out, that enables them to learn faster too. WAY faster. It's like having a conversation instead of reading a manual. We want to bring that conversation to every school and to <strong>every student</strong>, because everyone should have the chance to learn the magic of programming.",
    //    team_title: "Meet the zgcombat team",
    ...
    //    run_title: "Head of Operations, zgcombat Greater China",
    //    lance_title: "Head of Technology, zgcombat Greater China",
    //    zhiran_title: "Head of Curriculum, zgcombat Greater China",
    //    yuqiang_title: "Head of Innovation, zgcombat Greater China",
    ...
    //    bill_title: "General Manager, zgcombat Greater China",
    ...
    //    community_subtitle: "Over 600 contributors have helped build zgcombat, with more joining every week!",
    //    community_description_3: "zgcombat is a",
    ...
    //    story_subtitle: "Since 2013, zgcombat has grown from a mere set of sketches to a living, thriving game.",
    //    story_statistic_1a: "20,000,000+",
    //    story_statistic_1b: "total players",
    //    story_statistic_1c: "have started their programming journey through zgcombat and Ozaria",
    ...
    //    jobs_custom_description: "Are you passionate about zgcombat but don't see a job listed that matches your qualifications? Write us and show how you think you can contribute to our team. We'd love to hear from you!",
    ...
    //    about_codecombat: "About zgcombat",
    //    logo: "Logo",
    ...
    //  teachers_quote: {
    //    subtitle_coco: "Learn more about zgcombat with an interactive walk through of the product, pricing, and implementation!",
    ...
    //    thanks_sub_header_coco: "Thanks for expressing interest in zgcombat for your school.",
    ...
    //    learn_more_modal: "Teacher accounts on zgcombat have the ability to monitor student progress, assign licenses and manage classrooms. Teacher accounts cannot be a part of a classroom - if you are currently enrolled in a class using this account, you will no longer be able to access it once you update to a Teacher Account.",
    //    create_account: "Create a Teacher Account",
    //    create_account_subtitle: "Get access to teacher-only tools for using zgcombat in the classroom.  <strong>Set up a class</strong>, add your students, and <strong>monitor their progress</strong>!",
    ...
    //    subscribe: "buy a zgcombat subscription",
    //    subscribe_suffix: "and we'll be happy to help you with your code.",
    //    subscriber_support: "Since you're a zgcombat subscriber, your email will get our priority support.",
    ...
    //    roblox_not_connected: "Connect your zgcombat and Roblox accounts.",
    ...
    //    email_announcements_description: "Get emails on the latest news and developments at zgcombat.",
    //    email_notifications: "Notifications",
    //    email_notifications_summary: "Controls for personalized, automatic email notifications related to your zgcombat activity.",
    ...
    //    level_editor_prefix: "Use the zgcombat",
    //    level_editor_suffix: "to create and edit levels. Users have created levels for their classes, friends, hackathons, students, and siblings. If create a new level sounds intimidating you can start by forking one of ours!",
    //    thang_editor_prefix: "We call units within the game 'thangs'. Use the",
    //    thang_editor_suffix: "to modify the zgcombat source artwork. Allow units to throw projectiles, alter the direction of an animation, change a unit's hit points, or upload your own vector sprites.",
    //    article_editor_prefix: "See a mistake in some of our docs? Want to make some instructions for your own creations? Check out the",
    //    article_editor_suffix: "and help zgcombat players get the most out of their playtime.",
    //    find_us: "Find us on these sites",
    //    social_github: "Check out all our code on GitHub",
    //    social_reddit: "Join the zgcombat community on Reddit",
    //    social_blog: "Read the zgcombat blog",
    //    social_discource: "Join the discussion on our Discourse forum",
    //    social_facebook: "Like zgcombat on Facebook",
    //    social_twitter: "Follow zgcombat on Twitter",
    //    social_slack: "Chat with us in the public zgcombat Slack channel",
    //    contribute_to_the_project: "Contribute to the project",
    //  },

    //  clans: {
    //    title: "Join zgcombat Clans - Learn to Code in Python, JavaScript, and HTML",
    //    clan_title: "__clan__ - Join zgcombat Clans and Learn to Code",
    ...
    //    java: "Java (beta)",
    //    welcome_to_courses_coco: "Adventurer, welcome to zgcombat!",
    ...
    //    ask_teacher_for_code_coco: "Ask your teacher if you have a zgcombat class code! If so, enter it below:",
    ...
    //    update_account_individuals_warning_ozaria: "Warning: individual accounts cannot play Ozaria, only zgcombat.",
    ...
    //    update_account_confirm_update_student2: "You will not be able to manage any classes that you have previously created or create new classes. Your previously created classes will be removed from zgcombat and cannot be restored.",
    //    instructor: "Instructor: ",
    //    youve_been_invited_1: "You've been invited to join ",
    //    youve_been_invited_2: ", where you'll learn ",
    //    youve_been_invited_3: " with your classmates in zgcombat.",
    ...
    //    license_required_to_play_coco: "Ask your teacher to assign a license to you so you can continue to play zgcombat!",
    ...
    //    teacher_account_explanation: "A zgcombat Teacher account allows you to set up classrooms, monitor students’ progress as they work through courses, manage licenses and access resources to aid in your curriculum-building.",
    ...
    //    pacing_guides_desc: "Learn how to incorporate all of zgcombat's resources to plan your school year!",
    ...
    //    student_getting_started_desc: "You can distribute this guide to your students before starting zgcombat so that they can familiarize themselves with the code editor. This guide can be used for both Python and JavaScript classrooms.",
    ...
    //    hoc_meta_description: "Make your own game or code your way out of a dungeon! zgcombat has four different Hour of Code activities and over 60 levels to learn code, play, and create.",
    //    hoc_intro: "There are three ways for your class to participate in Hour of Code with zgcombat",
    //    hoc_self_led: "Self-Led Gameplay",
    //    hoc_self_led_desc: "Students can play through our Hour of Code zgcombat tutorials on their own",
    ...
    //    hoc_additional_desc1: "For additional zgcombat resources and activities, see our",
    ...
    //    teacher_quest_teach_methods_step2: "Print out the [Student Quick Start Guide](https://files.flsong.iok.la/docs/resources/StudentQuickStartGuide.pdf) in the Teacher Toolkit.",
    ...
    //    teacher_quest_kithgard_gates_100_step2: "Guide students to think through hard problems using the [Engineering Cycle Worksheet](https://files.flsong.iok.la/docs/resources/EngineeringCycleWorksheet.pdf).",
    ...
    //    teacher_quest_done: "Want your students to learn even more code? Get in touch with our [school specialists](mailto:schools@flsong.iok.la) today!",
    ...
    //    sub_title: "You are invited to try the new adventure game from zgcombat",
    //    cancel: "Back to zgcombat",
    ...
    //    you_can_return: "You can always return to zgcombat",
    //  },
    ...
    //    educators_continue_coco: "Educators who want to continue using zgcombat in their class",
    //    continue_coco: "Continue with zgcombat",
    //  },
    ...
    //    archmage_summary: "If you are a developer interested in coding educational games, become an archmage to help us build zgcombat!",
    ...
    //    diplomat_summary: "zgcombat is localized in 45+ languages by our Diplomats. Help us out and contribute translations.",
    //    ambassador_title: "Ambassador",
    //    ambassador_title_description: "(Support)",
    //    ambassador_summary: "Tame our forum users and provide direction for those with questions. Our ambassadors represent zgcombat to the world.",
    //    teacher_title: "Teacher",
    //  },

    //  editor: {
    //    main_title: "zgcombat Editors",
    ...
    //    intro_blurb: "zgcombat is part of the open source community! Hundreds of dedicated players have helped us build the game into what it is today. Join us and write the next chapter in zgcombat's quest to teach the world to code!",
    //    alert_account_message_intro: "Hey there!",
    //    alert_account_message: "To subscribe for class emails, you'll need to be logged in first.",
    //    archmage_introduction: "One of the best parts about building games is they synthesize so many different things. Graphics, sound, real-time networking, social networking, and of course many of the more common aspects of programming, from low-level database management, and server administration to user facing design and interface building. There's a lot to do, and if you're an experienced programmer with a hankering to really dive into the nitty-gritty of zgcombat, this class might be for you. We would love to have your help building the best programming game ever.",
    ...
    //    scribe_introduction_pref: "zgcombat isn't just going to be a bunch of levels. It will also include a resource for knowledge, a wiki of programming concepts that levels can hook into. That way rather than each Artisan having to describe in detail what a comparison operator is, they can simply link their level to the Article describing them that is already written for the player's edification. Something along the lines of what the ",
    ...
    //    diplomat_introduction_suf: "it's that there is sizeable interest in zgcombat in other countries! We're building a corps of translators eager to turn one set of words into another set of words to get zgcombat as accessible across the world as possible. If you like getting sneak peeks at upcoming content and getting these levels to your fellow nationals ASAP, then this class might be for you.",
    ...
    //    ambassador_introduction: "This is a community we're building, and you are the connections. We've got forums, emails, and social networks with lots of people to talk with and help get acquainted with the game and learn from. If you want to help people get involved and have fun, and get a good feel of the pulse of zgcombat and where we're going, then this class might be for you.",
    ...
    //  user: {
    //    user_title: "__name__ - Learn to Code with zgcombat",
    //    stats: "Stats",
    ...
    //    status_unsubscribed: "Get access to new levels, heroes, items, and bonus gems with a zgcombat subscription!",
    ...
    //    unsubscribe_from_marketing: "Unsubscribe __email__ from all zgcombat marketing emails?",
    ...
    //    purchase_code1: "Subscription Codes can be redeemed to add premium subscription time to one or more accounts for the Home version of zgcombat.",
    //    purchase_code2: "Each zgcombat account can only redeem a particular Subscription Code once.",
    //    purchase_code3: "Subscription Code months will be added to the end of any existing subscription on the account.",
    //    purchase_code4: "Subscription Codes are for accounts playing the Home version of zgcombat, they cannot be used in place of Student Licenses for the Classroom version.",
    ...
    //    teacher_quote: "When I got my hands on zgcombat [and] started having my students use it, the light bulb went on. It was just night and day from every other program that we had used. They’re not even close.",
    ...
    //    ozaria_impact_blurb: "zgcombat's sister curriculum, Ozaria, has proven to have a positive impact on the student learning outcomes that matter most to both students and educators.",
    ...
    //    teacher_notified: "We've notified your teacher that you want to play more zgcombat in your classroom!",
    //  },
    ...
    legal: {
      page_title: 'Legal',
      //    opensource_introduction: "zgcombat is part of the open source community.",
      opensource_description_prefix: 'Tignan ang ',
      github_url: 'aming GitHub',
      opensource_description_center: "at tumulong kung gusto nyo! Ang zgcombat ay gawa sa samutsaring proyekto na 'open source' at mahal namin ang mga ito. Tignan ang ",
      archmage_wiki_url: 'Archmage wiki',
      opensource_description_suffix: 'para sa listahan ng mga proyekto na dahilan para maging posible ang laro na ito.',
      practices_title: "Nirerespetong 'Best Practices'",
      practices_description: 'Ito ang mga pangako namin sa inyo, mga manlalaro, sa bagyang mababang mga legalese.',
      privacy_title: 'Pagkapribado',
      privacy_description: 'Hindi namin ibebenta ang alinman sa inyong impormasyong pang-personal.',
      security_title: 'Seguridad',
      security_description: "Nagsusumikap kami na maging ligtas ang inyong personal na impormasyon. Bilang isang 'open source' na proyekto, ang aming site ay bukas sa mga kanino mang gustong suriin at paigtingin ang aming seguridad.",
      email_title: 'Email',
      email_description_prefix: 'Hindi namin kayo papadalhan ng spam. Sa pamamagitan ng',
      ...
      cla_url: 'CLA',
      contributor_description_suffix: 'na inyong sinang-ayunan bago mag-ambag.',
      code_title: 'Code - MIT',
      //    client_code_description_prefix: "All client-side code for flsong.iok.la in the public GitHub repository and in the flsong.iok.la database, is licensed under the",
      mit_license_url: 'MIT license',
      code_description_suffix: "Kabilang dito ang lahat ng code sa 'Systems' at 'Components' na ibinabahagi ng zgcombat na ang layunin ay pag-gawa ng mga Level sa laro.",
      art_title: 'Art/Music - Creative Commons ',
      art_description_prefix: "Lahat ng 'common content' ay pwedeng gamitin sa ilalim ng",
      cc_license_url: 'Creative Commons Attribution 4.0 International License',
      art_description_suffix: "Ang 'Common content' ay kahit anong ginawang pwedeng kunin mula sa zgcombat para pang-gawa ng mga Level. Kabilang dito ay:",
      art_music: 'Tugtog - Music',
      art_sound: 'Tunog - Sound',
      art_artwork: 'Likhang Sining - Artwork',
      art_sprites: 'Sprites',
      art_other: 'Kahit anong hindi code na malayang binibigay para pang-gawa ng mga Level.',
      art_access: "Sa kasalukuyan walang universal, at madaling paraan para makuha ang mga 'assets'. Karaniwan, kunin  mula sa mga URL na ginagamit site, humingi ng tulong sa amin, o tulungan kami sa pagdagdag sa site upang mapadali ang paghanap sa mga assets.",
      art_paragraph_1: 'Para sa pagbanngit ng ngalan, pangalanan at i-link sa flsong.iok.la malapit sa kung saan ginamit ang asset ay ginamit. Halimbawa:',
      use_list_1: 'Kung ginamit sa pelikula o ibang laro, pakilagay ang flsong.iok.la sa credits.',
      use_list_2: "Kung ginamit sa website, maglagay ng link malapit sa pinag-gamitan, halimbawa sa ilalim ng imahe, o isama sa isang 'attributions page' kung saan magpapasalamat sa iba pang 'Creative Commons' at 'Open Source Software' na ginamit sa site. Anumang bagay na malinaw na pinapatukuyan ang zgcombat, gawa ng mga blog post na binabanggit ang zgcombat, ay hindi na kelangan gumawa ng hiwalay na pag-ngalan.",
      art_paragraph_2: 'Kung ang content na ginagamit ay gawa hindi ng zgcombat ngunit ng isang miyembro ng flsong.iok.la, pangalanan sila at sundin ang anumang panunturin sa pag ngalan, kung meron man.',
      rights_title: 'Mga Karapatan',
      rights_desc: 'Lahat ng karapatan ay nakalaan sa lahat ng Level mismo. Kabilang dito',
      rights_scripts: 'Skripto - Scripts',
      rights_unit: 'Unit configuration',
      rights_writings: 'Lathala - Writings',
      rights_media: "Media (sounds, music) at kahit anong asset na ginawa para sa Level at hindi kabilang sa mga 'free assets'",
      rights_clarification: "Para maliwanan, kahit ano na meron sa 'Level Editor' na ang layunin ay pag-gawa ng mga antas as sumasailalim sa Creative Commons(CC), ngunit anong bagay na ginawa gamit ang 'Level Editor' o inupload sa kurso ng pag-gawa ng mga Level ay hindi.",
      nutshell_title: 'TL;DR',
      nutshell_description: "Kahit ano na mayroon sa 'Level Editor' na aming binigay ay libre gamitin para sa lahat ng  'Levels'. Ngunit nasa aming karapatan na ipagbawal ang pagkalat ng mag Levels mismo (na ginawa sa flsong.iok.la) na kinakailangan pabayaran.",
      //    nutshell_see_also: "See also:",
      canonical: 'Ang Ingles na bersyon ng dokumento na ito ang nararapat, at naaayon na bersyon. Kung mayroon mang pagkakaiba sa pagkakasalin ng dokumento na ito at ng Ingles na bersyon, ang Ingles na dokumento ang mas nararapat.',
      third_party_title: 'Third Party Services',
      third_party_description: 'zgcombat ay gumagamit ng mga sumusunod na third party services (Bukod sa iba pa):',
      //    cookies_message: "zgcombat uses a few essential and non-essential cookies.",
    ...
    //    in_cash: "in cash",
    //    custom_wizard: "Custom zgcombat Wizard",
    //    custom_avatar: "Custom zgcombat avatar",
    ...
    //    meta_description: "zgcombat’s comprehensive curriculum and professional development program are all you need to offer College Board’s newest computer science course to your students.",
    //    syllabus: "AP CS Principles Syllabus",
    //    syllabus_description: "Use this resource to plan zgcombat curriculum for your AP Computer Science Principles class.",
    ...
    //    icons_coding_levels: "150+ zgcombat Coding Levels",
    ...
    //    course_outline_description: "The following descriptions are an overview of the content explored in the zgcombat AP CSP course.",
    ...
    //    professional_development: "Professional Development",
    //    professional_development_description: "zgcombat offers an online, self-paced professional development course for educators of all levels of AP CSP expertise. Participants will explore the zgcombat curriculum and learn how it can be used to prepare students to succeed on the AP CSP exam. Through asynchronous discussions with fellow teachers and video conferences with zgcombat learning designers, you will be equipped with the tools and techniques you need to support all of your students in AP CSP. At the end of the course, you will earn a Certificate of Completion that can be used for the renewal of your teaching credential.",
    ...
    //    question_2: "What are the technology requirements for zgcombat’s AP CSP curriculum?",
    ...
    //    course_overview: "Course Overview",
    //    outcomes: "outcomes",
    //    coco_requirements: "zgcombat’s system requirements",
    //    coco_recognized_blurb: "zgcombat is recognized by College Board as an endorsed provider of curriculum and professional development for AP® Computer Science Principles (AP CSP). This endorsement affirms that zgcombat’s curriculum is aligned to all the AP Curriculum Framework standards and the AP CSP assessment. This affords schools access to resources including an AP CSP syllabus pre-approved by the College Board’s Course Audit, and officially recognized professional development that prepares teachers to teach this curriculum.",
    ...
    //    professional_development_description: "zgcombat offers an online, self-paced professional development course for educators of all levels of AP CSP expertise. Participants will explore the zgcombat curriculum and learn how it can be used to prepare students to succeed on the AP CSP exam. Through asynchronous discussions with fellow teachers and video conferences with zgcombat curriculum developers, you will be equipped with the tools and techniques you need to support all of your students in AP CSP. At the end of the course, you will earn a Certificate of Completion that can be used for the renewal of your teaching credential. We offer our Curriculum on __edapp__.",
    //    contact: "Contact __apcsp_email__ to get access.",
    //    role: "Role",
    //    location: "Location",
    //    state_and_country: "state and country",
    //    no_license: "Our AP CSP curriculum requires a paid license to view. Learn more about zgcombat's AP CSP curriculum by visiting our About page, linked below.",
    ...
    //    step_1_subtitle: "Upload zgcombat’s AP CSP syllabus to College Board’s Course Audit.",
    ...
    //    sign_up: "2. SIGN UP",
    //    already_have_account: "Already have a zgcombat or Ozaria account? Login.",
    ...
    //    codecombat_intro: "zgcombat combines the power of gameplay and personalized instruction to deliver online coding classes that your child will look forward to every week!",
    ...
    //    quote_1: "Even though the class starts every Saturday at 7am, my son is so excited that he wakes up before me! zgcombat creates a pathway for my son to advance his coding skills.",
    ...
    //    private_instructions: "All classes feature private, individualized instruction. To enroll a group of students, contact <a href=\"mailto:classes@flsong.iok.la\">classes@flsong.iok.la</a> for a custom plan.",
    ...
    //    benefit_3: "zgcombat premium license included",
    ...
    //    grit_header: "Grit",
    //    grit_description: "zgcombat challenges students to embrace and learn from their mistakes. Built-in hints help students identify and fix bugs, leading to greater coding confidence.",
    ...
    //    faq_a_4: "Your subscription purchase is 100% risk-free within the first 30 days. If for any reason you decide not to continue, simply <a href=\"mailto:classes@flsong.iok.la\">contact us</a> within 30 days of purchase and we will promptly refund 100% of your purchase, no questions asked. You can also freeze your subscription at any time and re-activate when it works for you.",
    ...
    //    live_classes_offered: "zgcombat now offers live online computer science classes for students learning at home. Great for students who work best in 1:1 or small-group settings where learning outcomes are tailored to their needs.",
    ...
    //    premium_need_help: "Need help or prefer Paypal? Email <a href=\"mailto:support@flsong.iok.la\">support@flsong.iok.la</a>",
    //    not_sure_kid: "Not sure if zgcombat is right for your kid?  Ask them!",
    //    share_trailer: "Share our game trailer with your kid and have them create an account to get started.",
    //    why_kids_love: "Why Kids Love zgcombat",
    ...
    //    why_parents_love: "Why Parents Love zgcombat",
    ...
    //    critical_skills_detail: "Your child will learn how to navigate and become citizens in the digital world. zgcombat is a solution that enhances your child’s critical thinking, creativity, and resilience, empowering them with the skills they need for any industry.",
    //    parent_support: "Supported by parents like you",
    //    parent_support_detail: "At zgcombat, we’re parents. We’re coders. We’re educators. But most of all, we’re people who believe in giving our kids the best opportunity for success in whatever it is they decide to do.",
    ...
    //    quote_3: "\"Oliver’s Python is coming along. He’s using zgcombat to make his own video games. He challenges me to play his games, then laughs when I lose.\"",
    ...
    //    student: "Student",
    //    grade: "Grade",
    //    subscribe_error_user_type: "Looks like you've already signed up for an account. If you're interested in zgcombat Premium, please contact us at team@flsong.iok.la.",
    ...
    //    live_classes_title: "Live coding classes from zgcombat!",
    ...
    //    paragraph_5: "Thank you for choosing zgcombat and good luck on your computer science journey!",
    //    back_to_coco: "Back to zgcombat",
    //  },
    ...
    //    featured_title_1: "zgcombat: Goblins 'n' Glory",
    ...
    //    welcome: "Welcome to zgcombat's Hour of Code!",
    ...
    //    add_additional_teacher: "Need to add an additional teacher? Contact your zgcombat Account Manager or email support@flsong.iok.la. ",
    ...
    //    active_students_stat_description: "Active students counts the number of students that have logged into zgcombat in the last 60 days.",
    //    project_stat_description: "Projects created counts the total number of Game and Web development projects that have been created.",
    //    no_teachers: "You don’t have any schools tied to your account yet. Please contact your <strong>District Success Manager</strong> or <a href=\"mailto:schools@flsong.iok.la\">schools@flsong.iok.la</a> to get your dashboard set up.",
    ...
    //    title: "zgcombat works best on Chrome!",
    //    pitch_body: "For the best zgcombat experience we recommend using the latest version of Chrome. Download the latest version of chrome by clicking the button below!",
    ...
    //  events: {
    //    title: "zgcombat Events",
    //    main_title: "zgcombat Events",
    ...
    //    sync_to_google_desc: "Sync this event to YOUR google calendar, instead of the owner's calendar. And can only work on zgcombat gmail",
    ...
    //    want_to_save_tooltip_coco: "<h3>Want to save your progress?</h3><p>Please create a student account, or go to <i>My Account / Test as Student</i> and play zgcombat as a student if you would like to save your progress.</p>",
    ...
    //    using_codecombat: "Using zgcombat's personalized learning engine...",
    //    wrote: "wrote...",
    ...
    //    coverage_p1_coco: "The full zgcombat curriculum covers major programming standards in several widely-adopted frameworks, including those of the International Society for Technology in Education (ISTE), the Computer Science Teacher Association (CSTA), and the K-12 Computer Science Framework.",
    ...
    //    commitment_title: "zgcombat’s Commitment to Efficacy",
    ...
    //    summary: "The zgcombat AI League is uniquely both a competitive AI battle simulator and game engine for learning real Python and JavaScript code.",
    //    join_now: "Join Now",
    //    tagline: "The zgcombat AI League combines our project-based standards-aligned curriculum, engaging adventure-based coding game, and our annual AI coding global tournament into an organized academic competition unlike any other.",
    ...
    //    comprehensive_curr_subheader: "zgcombat is a standards-aligned CS solution that helps educators teach real coding in JavaScript and Python, no matter their experience.",
    ...
    //    season1_prize_3: "Custom zgcombat Avatar",
    ...
    //    coco_reserves: "zgcombat reserves",
    ...
    //    contact_sales_custom: "Your custom tournament awaits. Choose the arena that you’d like to use for your custom tournament and contact your zgcombat sales representative to confirm set up and scheduling details.",
    ...
    //    codecombat_ai_league_description: "The zgcombat AI League combines our project-based standards-aligned curriculum, engaging adventure-based coding game, and our annual AI coding global tournament into an academic competition unlike any other.",
    ...
    //    most_popular: "Most Popular",
    //    best_value: "Best Value",
    //    purchase_licenses: "Purchase Licenses easily to get full access to zgcombat and Ozaria",
    ...
    //    implementation_info: "60 min Onboarding Training on how to use zgcombat and Ozaria to support specific institutional and instructional goals.",
    ...
    //    full_access_coco: "Full Access to both zgcombat",
    //    and_oz: "And Ozaria",
    ...
    //    bd_subheading: "For Business Partners with at least 10 students, get premium access to zgcombat’s computer science and coding games:",
    //    bd_info_list_heading: "zgcombat is the preferred partner for dozens of coding education businesses because:",
    ...
    //    bd_includes_1: "Full access to zgcombat and Ozaria with over 200 hours of premium game-based content",
    ...
    //    below_headline_blurb: "At zgcombat we’ve developed comprehensive tools that make learning to code fun and teaching programming easy. Our turnkey solutions can be leveraged in many executions.",
    ...
    //    esports_blurb: "We are reinventing what an esport can be while engaging thousands of students to learn to code. Endemic esports mainstay __hyperx__ supported the zgcombat AI League from its inaugural season, building compelling promotional programs around this unique esport.",
    //    hyperx: "HyperX",
    //    respawn: "RESPAWN",
    ...
    //    learn_more_coco: "Want to learn more about zgcombat coding experiences?",
    //    subscribe: "Subscribe",
    //    explore_coco: "Explore zgcombat",
    ...
    //    network_detected: "Library network detected, redirecting you to play zgcombat",
    ...
    //    library_signup_promotion: "Sign Up to save progress and continue from where you left off on zgcombat!!",
    ...
    //  related_accounts: {
    //    subtitle: "Add connections between different zgcombat accounts to be able to quickly switch between them. For example, as a parent, you could switch to viewing zgcombat from your kids’ accounts. Or, as a teacher, you could add a test student account for yourself to see what your students see.",
    ...
    //  modal_free_class: {
    //    paragraph_1: "Thank you for choosing zgcombat.",
    ...
    //  roblox_landing: {
    //    meta_title: "zgcombat Worlds on Roblox: Play, Code and Create",
    ...
    //    box_play_blurb_player: "Explore the 3D immersive experience of zgcombat Worlds. Program your pets and adventure into a universe of creativity and shared experiences with friends.",
    ...
    //    bottom_blurb_parent: "No need to wait - __sign-up__ for our live online classes to get your child coding today! Get them started with zgcombat web to be the first to get access to the zgcombat Worlds Roblox experience.",
    //    bottom_blurb_sign_up: "Sign up",
    //    bottom_blurb_partner: "Want to use the new zgcombat Worlds Roblox experience for your education business, social impact initiative or international distribution opportunity? __reach-out__ to discuss partnering today.",
    ...
    //    connect_button_blurb: "Link your zgcombat and Roblox accounts for a seamless experience!",
    ...
    //    modal_title: "zgcombat Worlds<br> Now Live on Roblox!",
    ...
    //    testimonals_2_title: "\"Name any program online, I’ve tried it. None of them match up to zgcombat & Ozaria. Any teacher who wants their students to learn how to code... start here!\"",
    ...
    //    testimonals_4_title: "\"What I love the most about zgcombat is that it does not simplify coding. The students are learning to write actual code, yet doing it in such a way that they are having fun.”",
    ...
    //    engaging_boxes_2_text: "A full CS curriculum that builds from core concepts all the way through web development, game development and **[https://flsong.iok.la/apcsp]AP CSP**.",
    //    engaging_boxes_3_title: "zgcombat Worlds on Roblox",
    ...
    //    engaging_boxes_4_title: "zgcombat AI League Esports",
    ...
    //    engaging_boxes_5_title: "zgcombat AI HackStack",
    ...
    //    engaging_boxes_6_title: "zgcombat Home",
    ...
    //    young_learners_1_title: "zgcombat Junior",
    ...
    //    solutions_8_text: "As an entirely self-paced and self-directed digital resource, zgcombat is the best integration for libraries that want to empower their members of all ages to learn how to code. Our platform offers everything learners need to experience a high-level coding education through a uniquely exciting, game-based curriculum. Perfect for beginners all the way up to those who want to master college-level coding concepts.",
    ...
    //  schools_page: {
    //    meta_title: "zgcombat: the most effective computer science solution for schools",
    ...
    //    faq_9_answer: "zgcombat and Ozaria run best on computers with at least 4GB of RAM, on a modern browser such as Chrome, Safari, Firefox, or Edge. Chromebooks with 2GB of RAM may have minor graphics issues in later courses. A minimum of 200 Kbps bandwidth per student is required, although 1+ Mbps is recommended.",
    ...
    //    core_curriculum_2_text: "A full CS curriculum that builds from core concepts all the way through web development, game development and **[http://flsong.iok.la/apcsp]AP CSP**.",
    //    core_curriculum_2_link_text: "Try it now",
    //    practice_enrichment_1_title: "zgcombat AI League Esports",
    ...
    //    practice_enrichment_2_title: "zgcombat Worlds on Roblox",
    ...
    //    student_acceleration_1_title: "zgcombat AI HackStack",
    ...
    //    curriculum_description: "zgcombat offers robust course pathways aligned with several national and state standard frameworks across grades K-12 including AP level programming courses in many languages. Our curriculum engages students to explore and learn computer science through standards-aligned lessons.",
    //    most_effective_computer_science_solution: "The most effective computer science solution for **[https://flsong.iok.la/schools]schools**",
    ...
    //    carousel_2_text: "zgcombat is recognized by College Board as an endorsed provider of curriculum and professional development for AP® Computer Science Principles (AP CSP). This endorsement affirms that zgcombat’s curriculum is aligned to all of the AP Curriculum Framework standards and the AP CSP assessment. This affords schools access to resources including an AP CSP syllabus pre-approved by the College Board’s Course Audit, and officially recognized professional development that prepares teachers to teach this curriculum.[NEWLINE]Learn more about our zgcombat AP CSP curriculum below:",
    //    carousel_2_button_1_text: "zgcombat AP CSP",
    //    carousel_3_title: "International Society for Technology in Education (ISTE)",
    //    carousel_3_text: "Focused on pedagogy, not tools, the **[https://iste.org/standards]ISTE Standards** are a framework that guides educators in using technology to create high-impact, sustainable, and scalable learning experiences for all students.[NEWLINE]zgcombat’s curriculum is designed to meet the needs of all ISTE standards, for both students and teachers.[NEWLINE]Learn about the detailed ISTE Standards Alignment below:",
    ...
    //    core_curriculum_title_23: "Nick Winter, CEO, zgcombat",
    ...
    //    "HowItWorksPage_learn-anything-create-something-do-every": "Learn ANYTHING, create SOMETHING, do EVERYTHING with zgcombat AI HackStack. AI empowerment for all!",
    ...
    //    "HowItWorksPage_the-codecombat-team-they-got-really-good": "The zgcombat team. They got really good at making it easy to learn hard stuff by teaching 20 million beginners how to code with game-based learning, so when the tech got good enough, they wanted to do the same thing for AI. If AI is the future of creation, then we need to make it easy for anyone to use!",
    ...
    //    NewProjectPage_: "▲",
    //    "NewProjectPage_codecombat-ai": "zgcombat AI",
    //    NewProjectPage_filters: "Filters ▼",
    //    "NewProjectPage_learn-more": "Learn more",
    //    "NewProjectPage_new-ai-project": "New AI Project",
    //    "NewProjectPage_prompt-the-ai-to-create-websites-games-w": "Prompt the AI to create websites, games, web apps, stories, art, and more with the zgcombat AI HackStack.",
    //    "NewScenarioPage_a-webpage": "a webpage",
    //    "NewScenarioPage_codecombat-ai": "zgcombat AI",
    ...
    //    grid_ai_hints_allowance: "zgcombat AI Hints Allowance (Daily)***",
    //    grid_prompts_allowance: "zgcombat AI HackStack Prompts Allowance (Monthly)***",
    ...
    //    enroll_now: "Or, **[https://flsong.iok.la/payments/initial-online-classes-71]enroll now**",
    ...
    //    faq_5_answer: "Your subscription purchase is 100% risk-free within the first 30 days. If for any reason you decide not to continue, simply contact us at **[mailto:classes@flsong.iok.la]classes@flsong.iok.la** within 30 days of purchase and we will promptly refund 100% of your purchase, no questions asked.",
