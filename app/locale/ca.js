module.exports = {
  ...
  translation: {
    ...
    new_home: {
      ...
      codecombat_is: "zgcombat és una plataforma <strong> per als estudiants </ strong> per aprendre ciències de la computació mentre es juga a través d'un veritable joc.",
      ...
      watch_how: 'Observeu com zgcombat està transformant la manera com la gent aprèn la informàtica.',
      ...
      builds_concepts_up: "M'agrada com zgcombat construeix els conceptes. Realment és fàcil d'entendre i divertit de comprovar.",
      ...
      agency: 'zgcombat és un joc que dóna als jugadors aquesta decisió i confiança amb el nostre robust motor de codi mecanografiat, que ajuda tant als estudiants principiants com a estudiants avançats a escriure el codi correcte i vàlid.',
      ...
      want_coco: 'Vols zgcombat al teu centre?',
      //    educator: "Educator",
      //    student: "Student",
    ...
    diplomat_suggestion: {
      title: 'Ajuda a traduir zgcombat!',
      sub_heading: 'Neccesitem les teves habilitats lingüístiques.',
      pitch_body: "Hem desenvolupat zgcombat en anglès, però tenim jugadors per tot el món. Molts d'ells volen jugar en Català, però no parlen anglès, per tant si pots parlar ambdues llengües, siusplau considereu iniciar sessió per a ser Diplomàtic i ajudar a traduir la web de zgcombat i tots els seus nivells en Català.",
    ...
    play: {
      ...
      get_more_codecombat: 'Obté més zgcombat',
    ...
    share_progress_modal: {
      blurb: "Estàs progressant molt! Digues als teus pares quant n'has après amb zgcombat.",
    ...
    signup: {
      ...
      email_announcements: 'Rebre anuncis sobre nous nivells zgcombat i les seves característiques',
      ...
      teacher_type_1: 'Ensenyeu la programació amb zgcombat!',
      ...
      want_codecombat_in_school: 'Vols jugar zgcombat tot el temps?',
      eu_confirmation: "Estic d'acord en permetre que zgcombat desi les meves dades als servidors dels EE.UU.",
    ...
    play_level: {
      ...
      tip_open_source: 'zgcombat és 100% codi lliure!',
      tip_tell_friends: "Gaudint de zgcombat? Explica'ls-ho als teus amics!",
      tip_beta_launch: "zgcombat va llançar la seva beta l'octubre de 2013.",
      ...
      tip_open_source_contribute: 'Pots ajudar a millorar zgcombat!',
    ...
    play_game_dev_level: {
      ...
      play: 'Juga el nivell',
      play_more_codecombat: 'Juga més zgcombat',
    ...
    subscribe: {
      ...
      confirmation: 'Felicitats! Ja tens una subscripció a zgcombat Prèmium!',
      premium_already_subscribed: 'Ja estàs subscrit a Prèmium!',
      subscribe_modal_title: 'zgcombat Prèmium',
      comparison_blurb: 'Millora les teves habilitats amb una subscripció a zgcombat!',
      ...
      thank_you: 'Gràcies per donar suport a zgcombat.',
      ...
      personal_sub: 'Subscripció Personal',
    ...
    announcement: {
      ...
      cuddly_companions: 'Companys tendres!',
    ...
    premium_features: {
      get_premium: 'Aconsegueix<br>zgcombat<br>Prèmium',
      ...
      everything_in_premium: 'Tot el que obtens en zgcombat Prèmium:',
    ...
    choose_hero: {
      ...
      range: 'Abast',
      blocks: 'Bloqueja',
      backstab: "Punyalada per l'esquena",
      skills: 'Habilitats',
      attack_1: 'Danys',
      ...
      available_for_purchase: 'Disponible per a la compra',
    ...
    about: {
      ...
      main_description: 'A zgcombat, el nostre treball és assegurar-vos que ho feu amb un somriure a la cara.',
      mission_link: 'Missió',
      team_link: 'Equip',
      story_link: 'Història',
      press_link: 'Prensa',
      mission_title: 'La nostra missió: fer que la programació sigui accessible per a tots els estudiants de la Terra.',
      mission_description_1: "<strong>Programar és màgic</strong>. És la capacitat de crear coses des d'una imaginació pura. Vam començar zgcombat per donar a l'alumnat la sensació d'un poder màgic al seu abast usant <strong>codi escrit</strong>.",
      ...
      team_title: "Coneix l'equip de zgcombat",
      ...
      story_subtitle: "Des de 2013, zgcombat ha passat de ser un mer conjunt d'esbossos a un joc viu i pròsper.",
      story_statistic_1a: 'Més de 20,000,000',
      story_statistic_1b: 'de jugadors en total',
      story_statistic_1c: 'han iniciat el seu viatge vers la programació mitjançant zgcombat',
      ...
      jobs_title: "Vine a treballar amb nosaltres i ajuda'ns a escriure la història de zgcombat!",
      ...
      jobs_custom_description: "Estàs apassionat amb zgcombat, però no veus una feina que coincideixi amb les teves qualitats? Escriu-nos i mostra'ns com creus que pots contribuir al nostre equip. Ens encantaria saber de tu!",
      ...
      about_codecombat: 'Sobre zgcombat',
      logo: 'Logo',
    ...
    teachers_quote: {
      ...
      state: 'Província',
      country: 'País',
      num_students_help: 'Quants alumnes usaran zgcombat?',
      ...
      anything_else: 'Amb quin tipus de classe preveus usar zgcombat?',
      //    anything_else_helper: "",
      thanks_header: 'Sol·licitud rebuda!',
      thanks_sub_header_coco: "Gràcies per expressar l'interès en zgcombat per al vostre centre.",
      thanks_sub_header_ozar: "Gràcies per expressar l'interès en zgcombat per al vostre centre.",
      ...
      learn_more_modal: "Els comptes de professors de zgcombat tenen la capacitat de supervisar el progrés dels estudiants, assignar llicències i gestionar les aules. Els comptes de professors no poden formar part d'una aula: si actualment esteu inscrit en una classe amb aquest compte, ja no podreu accedir-hi una vegada que l'actualitzeu a un compte del professor.",
      create_account: 'Crear un compte de professor',
      create_account_subtitle: "Obteniu accés a les eines exclusives de professors per utilitzar zgcombat a l'aula. <strong>Configura una classe</strong>, afegeix els teus alumnes, i <strong>supervisa el seu progrés</strong>!",
    ...
    contact: {
      ...
      subscribe: 'compra una subscripció de zgcombat',
      subscribe_suffix: "i estarem encantats d'ajudar-te amb el teu codi.",
      subscriber_support: 'Com que seràs subscriptor de zgcombat, el teu e-mail tindrà el nostre suport prioritari.',
    ...
    account_settings: {
      ...
      email_announcements_description: 'Rebre les últimes notícies i desenvolupaments de zgcombat.',
      email_notifications: 'Notificacions',
      email_notifications_summary: "Controls per personalitzar les teves notificacions d'email automàtiques relacionades amb la teva activitat a zgcombat.",
    ...
    community: {
      ...
      article_editor_suffix: 'i ajuda als jugadors de zgcombat a treure el màxim profit del seu temps de joc.',
      ...
      social_blog: 'Llegiu el bloc de zgcombat al setembre',
      social_discource: 'Uneix-te a les discussions al nostre fòrum de comentaris',
      social_facebook: 'Fes Like a zgcombat en Facebook',
      social_twitter: 'Segueix zgcombat al Twitter',
      social_slack: 'Xateja amb nosaltres al canal públic zgcombat Slack',
    ...
    courses: {
      ...
      ask_teacher_for_code_coco: "Demana al teu professorat si té un codi de classe zgcombat! Si el té, posa'l a continuació:",
      ask_teacher_for_code_ozar: "Demana al teu professorat si té un codi de classe zgcombat! Si el té, posa'l a continuació:",
      ...
      subtitle: 'Reviseu els detalls i nivells del curs',
      ...
      language_select: 'Tria un idioma',
      ...
      update_account_confirm_update_student2: "No podràs manegar cap classe que hagis creat anteriorment ni crear classes noves. Les teves classes creades anteriorment s'esborraran de zgcombat i no es podran recuperar.",
      instructor: 'Instructor: ',
      youve_been_invited_1: 'Has estat invitat a unir-te ',
      youve_been_invited_2: ', on aprendràs ',
      youve_been_invited_3: ' amb els teus companys amb zgcombat.',
      ...
      license_required_to_play_coco: "Demana al teu professorat que t'assigni una llicència per continuar jugant a zgcombat!",
      license_required_to_play_ozar: "Demana al teu professorat que t'assigni una llicència per continuar jugant a zgcombat!",
    ...
    teacher: {
      ...
      teacher_account_explanation: "Un compte de professorat zgcombat et permet configurar aules, veure el progrés de l'alumnat mentre van fent els cursos, administrar llicències i accedir a recursos per ajudar-te en la creació de currículums.",
      ...
      create_new_class: 'Crear una Classe Nova',
      class_overview: 'Descripció de la classe',
      ...
      show_students_from: 'Mostrar alumnat de',
      ...
      pacing_guides_desc: 'Aprendre com incorporar tots els recursos de zgcombat per planificar el teu curs escolar!',
      ...
      educator_faq_desc: "Preguntes habituals sobre l'ús de zgcombat a la teva aula o al teu centre.",
      teacher_getting_started: "Guia d'introducció per a docents",
      teacher_getting_started_desc: "Ets nou a zgcombat? Descarrega aquesta Guia d'introducció per a docents per configurar el teu compte, crear la teva primera classe, i invitar alumnat al primer curs.",
      student_getting_started: "Guia d'introducció per l'alumnat",
      student_getting_started_desc: "Pots distribuir aquesta guia al teu alumnat abans de començar amb zgcombat per a que es puguin anar familiaritzant amb l'editor de codi. Aquesta guis serveix tant per classes de Python com de JavaScript.",
      ...
      hoc_intro: 'Hi ha tres maneres per a que la vostra classe participi en Hora del Codi amb zgcombat',
      hoc_self_led: "Joc d'autoaprenentatge",
      hoc_self_led_desc: 'Els alumnes poden accedir a dues hores de tutorials de zgcombat per compte propi',
      ...
      hoc_additional_desc1: 'Per a recursos i activitats addicionals de zgcombat, minar les nostres',
      ...
      teacher_quest_teach_methods_step2: "Imprimir la [Guia d'introducció per l'alumnat](https://files.flsong.iok.la/docs/resources/StudentQuickStartGuide.pdf) del Centre de Recursos.",
      ...
      teacher_quest_kithgard_gates_100_step2: "Guiar l'alumnat per pensar en problemes difícils usant el [Full de cicle d'enginyeria](https://files.flsong.iok.la/docs/resources/EngineeringCycleWorksheet.pdf).",
      ...
      teacher_quest_done: "Encara volen aprendre més codi els teus alumnes? Posa't en contacte avui mateix amb els nostres [especialistes escolars](mailto:schools@flsong.iok.la)!",
    ...
    classes: {
      ...
      archmage_summary: "Si ets un programador interessat en els jocs educatius sigues un arximag i ajuda'ns a construir zgcombat!",
      ...
      diplomat_summary: "zgcombat s'està traduint a més de 45 idiomes pels nostres Displomàtics. Ajuda'ns a traduir!",
      ambassador_title: 'Ambaixador',
      ambassador_title_description: '(Suport)',
      ambassador_summary: 'Posar ordre als fòrums i respondre a les preguntes que sorgeixin. Els nostres Ambaixadors representen a zgcombat envers el món.',
      teacher_title: 'Mestre',
    },

    editor: {
      main_title: 'Editors de zgcombat',
    ...
    contribute: {
      ...
      intro_blurb: "zgcombat és 100% codi obert! Una gran quantitat de jugadors ens han ajudat a construir el joc tal com és avui. Uneix-te a l'aventura d'ensenyar a programar!",
      alert_account_message_intro: 'Hola!',
      alert_account_message: "Per subscriure't a alguna classe, necessites estar identificat.",
      archmage_introduction: "Una de les millors parts de construir jocs és que aglutinen coses molt diverses. Gràfics, sons, treball en temps real, xarxes socials, i per suposat la programació, des del baix nivell d'ús de bases de dades i administració del servidor fins a dissenyar i crear interfícies. Hi ha molt a fer, i si ets un programador amb experiència i amb l'anhel de submergir-te dins zgcombat aquesta classe és per tu. Ens encantarà tenir la teva ajuda en el millor joc de programació que hi ha.",
      ...
      diplomat_introduction_suf: "és que hi ha un gran interès en zgcombat a altres països! Estem construint un cos de traductors per aconseguir que zgcombat sigui tan accessible arreu del món com sigui possible. Si t'agrada aconseguir els nivells tan aviat com surten i poder-los oferir als teus compatriotes llavors aquesta classe és per tu.",
      ...
      ambassador_introduction: 'Aquesta és una comunitat que estem construint, i tu ets les connexions. Tenim fòrums, correus electrònics i xarxes socials amb molta gent per parlar i ajudar-vos a conèixer el joc i aprendre-ne. Si voleu ajudar a la gent a participar-hi i divertir-se i tenir una bona idea del pols de zgcombat i on anem, aquesta classe pot ser per a vosaltres.',
    ...
    account: {
      ...
      status_unsubscribed: 'Accediu a nous nivells, herois, ítems i gemmes de bonificació amb una subscripció a zgcombat!',
      ...
      unsubscribe_from_marketing: 'Abandonar la subscripció a __email__ de tots els e-mails de màrqueting de zgcombat?',
    ...
    account_prepaid: {
      ...
      purchase_code1: 'Es poden bescanviar els codis de subscripció per afegir el temps de subscripció premium a un o més comptes de la versió Home de zgcombat.',
      purchase_code2: 'Cada compte de zgcombat només pot bescanviar un codi de subscripció en particular una vegada.',
      purchase_code3: "Els mesos del codi de subscripció s'afegiran al final de qualsevol subscripció existent al compte.",
      purchase_code4: "Els codis de subscripció són per als comptes que reprodueixen la versió inicial de zgcombat, no es poden utilitzar en lloc de les llicències d'estudiants per a la versió de Classroom.",
    ...
    anonymous_teacher: {
      ...
      teacher_notified: 'Hem notificat al vostre professor que voleu jugar més a zgcombat en classe.',
    },
    ...
    legal: {
      ...
      opensource_description_center: "i ajuda'ns si vols! zgcombat està construit amb dotzenes de projectes de codi obert, i ens encanta. Mira ",
      ...
      code_description_suffix: "Això inclou tot el codi a Sistemes i Components que s'han fet possibles per zgcombat amb el proposit de crear nivells.",
      ...
      art_description_suffix: 'El contingut comú és generalment disponible per zgcombat amb la finalitat de crear nivells. Inclou:',
      art_music: 'Musica',
      art_sound: 'So',
      art_artwork: 'Art',
      art_sprites: 'Capes',
      ...
      art_paragraph_1: "Per a l'atribució, si us plau, cita i vincle a flsong.iok.la a prop d'on s'utilitza la font o, si escau, per al mitjà. Per exemple:",
      use_list_1: "Si s'utilitza en una pel·lícula o en un altre joc, incloeu flsong.iok.la en els crèdits.",
      use_list_2: "Si s'utilitza en un lloc web, incloeu un enllaç prop de l'ús, per exemple, sota una imatge o en una pàgina d'atribucions generals on també podeu esmentar altres obres de Creative Commons i programari de codi obert que s'utilitza al lloc. Alguna cosa que ja fa referència clarament a zgcombat, com ara una publicació de bloc que menciona zgcombat, no necessita cap atribució per separat.",
      art_paragraph_2: "Si el contingut que s'utilitza no és creat per zgcombat sinó per un usuari de flsong.iok.la, atribueix-lo a ell, i seguiu les indicacions d'atribució proporcionades en la descripció del recurs si hi ha alguna.",
      ...
      nutshell_description: "Els recursos que oferim a l'Editor de Nivells es poden utilitzar de la manera que vulgueu per crear nivells. Però ens reservem el dret de restringir la distribució dels mateixos Nivells (que es creen a flsong.iok.la) perquè es puguin cobrar.",
      ...
      third_party_description: "zgcombat usa els següents serveis de tercers (entre d'altres):",
      cookies_message: 'zgcombat utilitza unes quantes galetes essencials i no essencials.',
    ...
    ladder_prizes: {
      ...
      in_cash: 'en diners',
      custom_wizard: 'Personalitza el teu bruixot de zgcombat',
      custom_avatar: 'Personalitza el teu avatar de zgcombat',
    ...
    esper: {
      ...
      unable_to_get_property: "Impossible adquirir la propietat '$1' d'una referència indefinida o nula",
      ...
      there_is_no_enemy: 'No hi ha cap `$1`. Usa `$2` primer.',
    ...
    apcsp: {
      ...
      syllabus_description: "Utilitza aquest recurs per planificar el currículum de zgcombat pel teu Pla d'Estudis de Fonaments de Programació de la teva classe.",
    ...
    hoc_2018: {
      ...
      about: 'Sobre zgcombat:',
      about_copy: "zgcombat és un programa informàtic basat en jocs per ensenyar Python i JavaScript reals. El currículum d'acord amb els estàndards de zgcombat es basa en un joc que els estudiants estimen. Més de 12 milions d'estudiants han après a codificar amb zgcombat!",
