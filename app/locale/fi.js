module.exports = {
  ...
  translation: {
    ...
    new_home: {
      ...
      century_skills_subblurb2: 'zgcombat rohkaisee oppijoita näyttämään luovuuttaan omien pelien sekä nettisivujen luomisessa ja jakamisessa.',
      ...
      codecombat_is: 'zgcombat on alusta <strong>oppilaille</strong> oppia ohjelmointia pelaamisen kautta.',
      ...
      watch_how: 'Katso kuinka zgcombat muuttaa miten tietojenkäsittelyä voi oppia.',
      ...
      want_coco: 'Haluatko zgcombat:in kouluusi?',
      //    educator: "Educator",
      //    student: "Student",
    ...
    diplomat_suggestion: {
      title: 'Auta zgcombatin kääntämisessä!',
      sub_heading: 'Tarvitsemme apuasi käännöksessä.',
      pitch_body: 'zgcombat:ia kehitetään englanniksi mutta pelaajia on jo ympäri maailmaa. Monet haluavat pelata peliä omalla kielellään, joten jos haluat osallistua kääntämiseen, ilmoittaudu Diplomaatiksi ja anna panoksesi.',
    ...
    play: {
      ...
      get_more_codecombat: 'Hanki Jatkoa zgcombat:lle',
    ...
    share_progress_modal: {
      blurb: 'Edistyt loistavasti! Kerro ystävillesi mitä olet oppinut zgcombat:n avulla.',
    ...
    signup: {
      ...
      teacher_type_1: 'Opeta ohjelmoimista zgcombat:in avulla!',
    ...
    play_level: {
      ...
      explore_codecombat: 'Tutki zgcombat:a',
      ...
      tip_open_source: 'zgcombat on 100% avointa lähdekoodia!',
      tip_tell_friends: 'Pidätkö zgcombatista? Kerro meistä myös ystävillesi!',
      tip_beta_launch: 'zgcombat avattiin betatestaukseen lokakuussa 2013.',
    ...
    subscribe: {
      ...
      comparison_blurb: 'Teroita kykyjäsi zgcombat kuukausitilauksella!',
      ...
      thank_you: 'zgcombat kiittää tuestasi.',
      ...
      buy_now: 'Osta nyt',
      subscription_required_to_play: 'Tarvitset zgcombat kuukausitilauksen pellataksesi tätä tasoa.',
    ...
    contact: {
      contact_us: 'Ota yhteyttä zgcombat',
      ...
      subscribe: 'zgcombat kuukausitilaus',
      subscribe_suffix: 'ja autamme mielellämme teitä ohjelmakoodinne kanssa.',
      subscriber_support: 'Kun olette zgcombat kuukausitilaaja, sähköpostisi käsitellään etusijalla.',
    ...
    account_settings: {
      ...
      email_notifications_summary: 'Valinnat automaattisia sähköposti-ilmoituksia varten toimistasi zgcombat sivustolla.',
    ...
    courses: {
      ...
      update_account_confirm_update_student2: 'Et voi hallita luokkia jotka olet luonut etkä voi luoda uusia luokkia. Kaikki luokkasi poistetaan zgcombat:ista eikä niitä voi palauttaa.',
      instructor: 'Ohjaaja: ',
    ...
    account: {
      ...
      status_unsubscribed: 'Hanki käyttöösi uusia tasoja, sankareita, esineitä ja lisää jalokiviä zgcombat kuukausitilauskella!',
