module.exports = {
  ...
  translation: {
    ...
    new_home: {
      title_coco: 'zgcombat - Programare de jocuri pentru a învăța Python și JavaScript',
      title_ozar: 'zgcombat - Programare de jocuri pentru a învăța Python și JavaScript',
      //    title_cn_home: "zgcombat|Python, Javascript",
      meta_keywords_coco: 'zgcombat, python, javascript, programare de jocuri',
      meta_keywords_ozar: 'zgcombat, python, javascript, programare de jocuri',
      ...
      century_skills_subblurb1: 'Prin scrierea de cod  pentru puzzle-urile încorporate în nivele din ce în ce mai incitante, programarea jocurilor de la zgcombat se asigură că gândirea critică este mereu exerseată de copii.',
      ...
      century_skills_subblurb2: 'zgcombat încurajează cursanții să își arate creativitatea construind și partajând propriile jocuri și pagini web.',
      ...
      creativity_rigor_blurb2: 'Fiecare nivel zgcombat este cinstruit pe baza a milioane de date și optimizat să se poată adapta fiecărui cursant. Nivelele de practică și indiciile îi ajută pe elevi atunci când aceștia se blochează, iar nivele de provocare evaluează ceea ce au învățat elevii prin joc.',
      creativity_rigor_subtitle3: 'Construit pentru profesori, indiferent de experiența lor',
      creativity_rigor_blurb3: 'zgcombat poate fi urmat într-un ritm propriu, curicula aliniată la standarde permite învățarea informaticii de către toată lumea. zgcombat echipează profesorii cu resursele de învățare necesare și cu un suport dedicat care să îi ajute să fie confidenți și să aibă succes în clasă.',
      ...
      for_leaders_subblurb3: 'Indiferent dacă vrei să construiești nucleu de programare la școala generală, o curriculă de pregătire a carierei tehnice sau vrei să predai elemente de introducere în informatică la clasă, zgcombat este pregătit să se adapteze nevoilor tale.',
      ...
      game_based_blurb: 'zgcombat este un program de informatică bazat pe jocuri  în care elevii scriu cod real și își pot urmării personajele în timp real.',
      ...
      quotes_quote1: 'Numește orice program online, eu deja l-am încercat. Nici unul dintre ele nu se compară cu zgcombat & Ozaria. Orice profesor care vrea să își învețe elevii cum să scrie cod ... să înceapă aici!',
      ...
      teachers_love_codecombat_title: 'Profesorii iubesc zgcombat',
      ...
      //    codecombat_is: "zgcombat is a platform <strong>for students</strong> to learn computer science while playing through a real game.",
      ...
      want_coco: 'Vrei zgcombat în școala ta?',
      educator: 'Formator',
      student: 'Elev',
      ...
      //    ozaria_china_blurb: "",
      try_codecombat: 'Încearcă zgcombat',
      try_ozaria: 'Încearcă Ozaria',
      explore_codecombat: 'Explorează zgcombat',
    ...
    nav: {
      ...
      codecombat_classroom: 'Clasa zgcombat',
      ...
      codecombat_dashboard: 'Panou de lucru zgcombat',
    ...
    diplomat_suggestion: {
      title: 'Ajută la traducrea zgcombat!',
      sub_heading: 'Avem nevoie de abilitățile tale lingvistice.',
      pitch_body: 'zgcombat este dezvoltat în limba engleza , dar deja avem jucători din toate colțurile lumii. Mulți dintre ei vor să joace în română și nu vorbesc engleză. Dacă poți vorbi ambele limbi te rugăm să te gândești dacă ai dori să devi un Diplomat și să ne ajuți sa traducem atât jocul cât și site-ul.',
    ...
    new_home_faq: {
      ...
      main_curriculum: 'Pot utliza zgcombat sau Ozaria ca și curiculă de bază?',
      main_curriculum_blurb: 'Absolut! Am alocat timp consultațiilor cu specialiștii în educație pentru a dezvola curicule pentru clasă și materiale special concepute pentru profesorii care utilizează zgcombat sau Ozaria fără ca aceștia să aibă cunoștințe prealabile de informatică. Multe școli implementează zgcombat și/sau Ozaria ca și curiculă de bază pentru informatică.',
      clever_instant_login: 'zgcombat și Ozaria au suport pentru Clever Instant Login?',
    ...
    play: {
      title: 'Joacă nivelele zgcombat - Învață Python, JavaScript și HTML',
      ...
      anon_signup_title_1: 'zgcombat are un/o',
      ...
      skills_granted: 'Abilități acordate',
      heroes: 'Eroi',
      //    pets: "Pets",
      ...
      get_more_codecombat: 'Mai mult zgcombat',
    ...
    share_progress_modal: {
      blurb: 'Faci progrese mari! Spune-le părinților cât de mult ai învățat cu zgcombat.',
    ...
    signup: {
      ...
      email_announcements: 'Primește anunțuri despre niveluri și îmbunătățiri ale zgcombat!',
      ...
      teacher_type_1: 'Predă programare utilizând zgcombat!',
      ...
      want_codecombat_in_school: 'Vrei să joci zgcombat tot timpul?',
      eu_confirmation: 'Sunt de acord să permit zgcombat să stocheze datele mele pe un server din SUA.',
      ...
      with: 'cu',
      want_to_play_codecombat: 'Nu, Nu am una dar vreau să joc zgcombat!',
    ...
    common: {
      default_title_coco: 'zgcombat - Jocuri de scris cod pentru a învăța Python și JavaScript',
      default_title_ozar: 'zgcombat - Jocuri de scris cod pentru a învăța Python și JavaScript',
      //    ozaria: "Ozaria",
    ...
    play_level: {
      ...
      tip_open_source: 'zgcombat este parte a comunității open source!',
      tip_tell_friends: 'Îți place zgcombat? Spune-le prietenilor tăi despre noi!',
      tip_beta_launch: 'zgcombat a fost lansat în format beta în Octombrie 2013.',
      ...
      tip_open_source_contribute: 'Poți ajuta la îmbunătățirea jocului zgcombat!',
    ...
    play_game_dev_level: {
      ...
      play: 'Joacă nivel',
      play_more_codecombat: 'Joacă mai multe zgcombat',
    ...
    subscribe: {
      ...
      confirmation: 'Felicitări! Acum ai abonament zgcombat Premium!',
      ...
      thank_you: 'Mulțumim pentru susținerea zgcombat!',
      ...
      feature_level_access: 'Accesează peste 600+ de nivele disponibile',
    ...
    announcement: {
      ...
      subscriber: 'abonat',
      cuddly_companions: 'Companioni drăguți!',
    ...
    premium_features: {
      get_premium: 'Cumpără<br>zgcombat<br>Premium',
      ...
      everything_in_premium: 'Tot ceea ce vei obține în zgcombat Premium:',
    ...
    contact: {
      ...
      subscribe: 'cumperi un abonament zgcombat',
      subscribe_suffix: 'si vom fi bucuroși să te ajutăm cu codul.',
      subscriber_support: 'Din moment ce ești un abonat zgcombat, adresa ta de email va primi sprijinul nostru prioritar.',
    ...
    account_settings: {
      ...
      email_announcements_description: 'Primește email-uri cu ultimele știri despre zgcombat.',
      email_notifications: 'Notificări',
      email_notifications_summary: 'Control pentru notificări email personalizate, legate de activitatea zgcombat.',
    ...
    community: {
      main_title: 'Comunitatea zgcombat',
      ...
      level_editor_prefix: 'Folosește zgcombat',
      ...
      thang_editor_suffix: 'pentru a modifica ilustrațile sursă zgcombat. Permitele unitătilor sa arunce proiectile, schimbă direcția unei animații, schimbă viața unei unități, sau uploadează propiile sprite-uri vectoriale.',
      ...
      article_editor_suffix: 'si ajută jucători zgcombat să obțină căt mai multe din playtime-ul lor.',
      find_us: 'Ne găsești pe aceste site-uri',
      //    social_github: "Check out all our code on GitHub",
      //    social_reddit: "Join the zgcombat community on Reddit",
      social_blog: 'Citește blogul zgcombat pe Sett',
      social_discource: 'Alăturăte discuțiilor pe forumul Discourse',
      social_facebook: 'Lasă un Like pentru zgcombat pe facebook',
      social_twitter: 'Urmărește zgcombat pe Twitter',
    ...
    classes: {
      ...
      archmage_summary: 'Dacă ești un dezvoltator interesat să programezi jocuri educaționale, devino Archmage si ajută-ne să construim zgcombat!',
      ...
      diplomat_summary: 'zgcombat e localizat în 45+ de limbi de Diplomații noștri. Ajută-ne și contribuie la traducere.',
      ambassador_title: 'Ambasador',
      ambassador_title_description: '(Suport)',
      ambassador_summary: 'Îmblânzește useri de pe forumul nostru si oferă direcți pentru cei cu întrebări. Ambasadori noștri reprezintă zgcombat în fața lumii.',
      //    teacher_title: "Teacher",
    },

    editor: {
      main_title: 'Editori zgcombat',
    ...
    contribute: {
      ...
      scribe_introduction_pref: 'zgcombat nu o să fie doar o colecție de nivele. Vor fi incluse resurse de cunoaștere, un wiki despre concepte de programare legate de fiecare nivel. În felul acesta fiecare Arisan nu trebuie să mai descrie în detaliu ce este un operator de comparație, ei pot să pună un link la un Articol mai bine documentat. Ceva asemănător cu ce ',
      ...
      diplomat_introduction_suf: 'acesta ar fi că: există un interes mare pentru zgcombat și în alte țări! Încercăm sa adunăm cât mai mulți translatori care sunt pregătiți să transforme un set de cuvinte intr-un alt set de cuvinte ca să facă zgcombat cât mai accesibil în toată lumea. Dacă vrei să tragi cu ochiul la conțintul ce va apărea și să aduci nivele cât mai repede pentru conaționali tăi, această clasă ți se potriveste.',
    ...
    account: {
      ...
      status_unsubscribed: 'Primește access la nivele noi, eroi, iteme, și Pietre Prețioase bonus cu un abonament zgcombat!',
    ...
    legal: {
      ...
      opensource_description_center: 'și ajută-ne dacă îți place! zgcombat este construit peste o mulțime de proiecte open source, care noi le iubim. Vizitați',
      ...
      code_description_suffix: 'Asta include tot codul din Systems și Components care este oferit de către zgcombat cu scopul de a crea nivele.',
      art_title: 'Artă/Muzică - Conținut Comun ',
      art_description_prefix: 'Tot conținutul creativ/artistic este valabil sub',
      cc_license_url: 'Creative Commons Attribution 4.0 International License',
      art_description_suffix: 'Conținut comun este orice făcut general valabil de către zgcombat cu scopul de a crea nivele. Asta include:',
      art_music: 'Muzică',
      art_sound: 'Sunet',
      art_artwork: 'Artwork',
      art_sprites: 'Sprites',
      ...
      art_paragraph_1: 'Pentru atribuire, vă rugăm numiți și lăsați referire link la flsong.iok.la unde este folosită sursa sau unde este adecvat pentru mediu. De exemplu:',
      use_list_1: 'Dacă este folosit într-un film sau alt joc, includeți flsong.iok.la la credite.',
      use_list_2: 'Dacă este folosit pe un site, includeți un link in apropiere, de exemplu sub o imagine, sau in pagina generală de atribuiri unde menționați și alte Bunuri Creative și software open source folosit pe site. Ceva care face referință explicit la zgcombat, precum o postare pe un blog care menționează zgcombat, nu trebuie să se facă o atribuire separată.',
      art_paragraph_2: 'Dacă conținutul folosit nu este creat de către zgcombat ci de către un utilizator al flsong.iok.la,atunci faceți referință către ei, și urmăriți indicațiile de atribuire prevăzute în descrierea resursei dacă există.',
      ...
      nutshell_description: 'Orice resurse vă punem la dispoziție în Editorul de Nivele puteți folosi liber cum vreți pentru a crea nivele. Dar ne rezervăm dreptul de a rezerva distribuția de nivele în sine (care sunt create pe flsong.iok.la) astfel încât să se poată percepe o taxă pentru ele pe vitor, dacă se va ajunge la așa ceva.',
    ...
    ladder_prizes: {
      ...
      in_cash: 'în cash',
      custom_wizard: 'Wizard zgcombat personalizat',
      custom_avatar: 'Avatar zgcombat personalizat',
    ...
    league: {
      ...
      summary: 'Liga AI zgcombat este atât un simulator unic copetitiv de lupte AI dar și un mototr de jocuri pentru a învăța Python și JavaScript.',
      join_now: 'Alătură-te acum',
      tagline: 'Liga AI zgcombat combină curicula aliniată la standarde bazată pe proiecte, programarea de jocuri captivante bazate pe aventură și campionatul anual de programare AI organizat întro competiție academică anuală cum nu există alta.',
      ...
      competing: 'Concurenți:',
      count_student: 'elev',
      count_students: 'elevi',
      top_student: 'Top:',
      top_percent: 'top',
      top_of: 'of',
    ...
    payments: {
      ...
      purchase_licenses: 'Cumpără licențe ușor pentru a avea acces la zgcombat și Ozaria',
