module.exports = {
  ...
  translation: {
    ...
    legal: {
      ...
      art_paragraph_2: "Si le contenu utilisé n'est pas créé par zgcombat mais par un autre utilisateur de codecombat.com, attribuez-le à cet utilisateur, et suivez les recommandations fournies dans la ressource de la description s'il y en a.",
    ...
    parents_landing_2: {
      ...
      subscribe_error_user_type: '[AI_TRANSLATION]Il semble que tu as déjà créé un compte. Si tu es intéressé par zgcombat Premium, contacte-nous à team@codecombat.com.',
    ...
    school_administrator: {
      ...
      add_additional_teacher: "[AI_TRANSLATION]Besoin d'ajouter un enseignant supplémentaire ? Contacte ton gestionnaire de compte zgcombat ou envoie un email à support@codecombat.com.",
    ...
    teacher_dashboard: {
      ...
      ozaria_hs_modal_blurb: "[AI_TRANSLATION]Les éducateurs peuvent désormais accéder directement à AI Hackstack sur **[https://codecombat.com/teachers/classes]zgcombat** en utilisant les mêmes identifiants qu'Ozaria. Pour plus de commodité, vous pouvez facilement importer vos classes d'Ozaria dans zgcombat.  ",
      //    ozaria_ai_league_modal_title: "Access AI League Exclusively on zgcombat",
      //    ozaria_ai_league_modal_blurb: "Educators can now access AI League directly on **[https://codecombat.com/teachers/ai-league]zgcombat** using the same credentials as Ozaria. For added convenience, you can easily import your classes from Ozaria into zgcombat.",
    ...
    roblox_landing: {
      ...
      faq_bottom: "[AI_TRANSLATION]Voir plus de <a href=\"https://codecombat.zendesk.com/hc/en-us/categories/18084251471383-zgcombat-Worlds-Roblox-\" target=\"_blank\">questions fréquemment posées dans notre centre d'aide</a>. <br />Si tu as d'autres questions, <a href=\"mailto:support@codecombat.com\">Contacte-nous</a>.  ",
    ...
    schools_page: {
      ...
      faq_1_answer: "[AI_TRANSLATION]Les programmes d'éducation technique et professionnelle (CTE) aux États-Unis visent à équiper les élèves avec des compétences valorisées par l'industrie et peuvent mener à une école de métiers ou une éducation universitaire. Exigés par les lois étatiques et fédérales, les programmes CTE doivent offrir aux étudiants des crédits post-diplôme, des certifications industrielles ou des heures de stage. Alors que certains domaines, comme la cybersécurité, offrent des examens de certification valorisés, d'autres comme l'ingénierie logicielle prioritisent les diplômes de quatre ans par rapport à ces examens. Cependant, réussir l'examen AP Computer Science Principles sert de voie reconnue pour obtenir des crédits post-secondaires, permettant aux étudiants de contourner les exigences coûteuses et chronophages du collège. Pour aider à préparer les étudiants, zgcombat propose un **[https://codecombat.com/apcsp]cours AP CSP**, approuvé par le College Board.  ",
