module.exports = {
  ...
  translation: {
    ...
    ozaria_home: {
      ...
      faq_row1_header: '[AI_TRANSLATION]Quelle est la relation entre Ozaria et zgcombat ?',
      faq_row1_p: "[AI_TRANSLATION]Ozaria est l'évolution de zgcombat centrée sur la salle de classe, l'un des jeux de codage les plus populaires de l'histoire. Nous avons créé Ozaria en nous basant sur les connaissances acquises en enseignant Python et JavaScript à plus de 20 millions d'élèves. Ozaria intègre de nouveaux modèles pédagogiques, un récit immersif axé sur l'histoire, et a été conçu pour être implémenté dans les salles de classe, pour l'apprentissage en présentiel et à distance.",
    ...
    new_home: {
      title_coco: 'zgcombat - Jeux de codage pour apprendre Python et JavaScript',
      title_ozar: 'zgcombat - Jeux de codage pour apprendre Python et JavaScript',
      title_cn_home: '[AI_TRANSLATION]zgcombat|Python, Javascript\n',
      meta_keywords_coco: 'zgcombat, python, javascript, Jeux de codage',
      meta_keywords_ozar: 'zgcombat, python, javascript, Jeux de codage',
      ...
      meta_og_url: 'https://flsong.iok.la',
      become_investor: 'Devenez investisseur dans zgcombat',
      built_for_teachers_title: 'Un jeu de codage pensé pour les professeurs',
      built_for_teachers_blurb: "Apprendre à coder aux enfants peut être épuisant. zgcombat aide tous les éducateurs à enseigner aux étudiants comment coder soit en JavaScript ou en Python, deux des langages de programmtion les plus populaires. Avec un programme d'études complet qui inclut six unités de sciences informatiques et qui renforce l'apprentissage au travers d'unités bases sur des projets de développement de jeux vidéos et de sites web, les enfants progresseront dans un voyage allant de la syntaxe de base à la récursivité !",
      ...
      century_skills_subblurb1: "With coding puzzles that are naturally scaffolded into increasingly challenging levels, zgcombat's programming game ensures kids are always practicing critical thinking.",
      ...
      century_skills_subblurb2: 'zgcombat encourage les étudiants à montrer leur créativité en construisant et partageant leurs propres jeux et pages web.',
      ...
      for_leaders_subblurb3: "Que vous souhaitiez mettre en place un cours optionnel au collège, un apprentissage technique, ou que vous enseigniez une classe d'introduction à l'informatique, zgcombat est taillé pour répondre à vos besoins.",
      ...
      game_based_blurb: "[AI_TRANSLATION]zgcombat est un programme d'informatique basé sur le jeu où les élèves tapent du vrai code et voient leurs personnages réagir en temps réel.",
      ...
      quotes_quote1: "[AI_TRANSLATION]Nomme un programme en ligne, je l'ai essayé. Aucun ne correspond à zgcombat & Ozaria. Tout professeur qui veut que ses élèves apprennent à coder... commence ici !",
      quotes_quote2: "[AI_TRANSLATION] J'ai été surpris de voir à quel point zgcombat rend l'apprentissage de l'informatique facile et intuitif. Les scores à l'examen AP ont été bien plus élevés que prévu et je pense que zgcombat en est la raison.",
      quotes_quote3: '[AI_TRANSLATION]zgcombat a été le plus bénéfique pour enseigner à mes élèves les compétences de codage réelles. Mon mari est ingénieur logiciel et il a testé tous mes programmes. Il a mis ceci en premier choix.  ',
      quotes_quote4: "[AI_TRANSLATION]Les retours ... ont été si positifs que nous structurons une classe d'informatique autour de zgcombat. Le programme engage vraiment les étudiants avec une plateforme de style jeu qui est à la fois divertissante et instructive. Continuez votre bon travail, zgcombat !",
      quotes_quote5: "[AI_TRANSLATION]Même si le cours commence tous les samedis à 7h du matin, mon fils est tellement excité qu'il se réveille avant moi ! zgcombat crée un chemin pour que mon fils développe ses compétences en codage.",
      ...
      teachers_love_codecombat_title: '[AI_TRANSLATION]Les enseignants adorent zgcombat',
      teachers_love_codecombat_blurb1: '[AI_TRANSLATION]Rapporte que leurs étudiants aiment utiliser zgcombat pour apprendre à coder',
      teachers_love_codecombat_blurb2: "[AI_TRANSLATION]Recommanderait zgcombat à d'autres professeurs d'informatique",
      teachers_love_codecombat_blurb3: '[AI_TRANSLATION]Dis que zgcombat aide les étudiants à développer leurs capacités de résolution de problèmes',
      ...
      top_banner_blurb_roblox: '[AI_TRANSLATION]NOUVEAU ! zgcombat arrive sur Roblox !',
      top_banner_blurb_roblox_teachers: "[AI_TRANSLATION]NOUVEAU ! zgcombat s'est associé à Roblox Education !",
      ...
      top_banner_blurb_demo_day_10_20: '[AI_TRANSLATION]Rejoins-nous pour une démonstration spooktacular de zgcombat & Ozaria le jeudi 20 octobre à 16h CDT.',
      ...
      im_an_educator_description: "[AI_TRANSLATION]Enseigne l'informatique avec zgcombat",
      ...
      codecombat_is: "zgcombat est une plateforme <strong>pour les étudiants</strong> afin d'apprendre à programmer tout en jouant.",
      ...
      watch_how: "Regardez comment zgcombat transforme la façon dont les gens apprennent l'informatique",
      ...
      builds_concepts_up: "J'aime la façon dont zgcombat construit les concepts. C'est vraiment facile à comprendre et amusant à comprendre.",
      ...
      agency: "zgcombat est un jeu qui donne aux joueurs cette confiance et détermination à l'aide de notre interpretteur de lignes de code, qui aide les étudiants débutants ainsi qu'avancés à concevoir des programmes bien écrits et valides.",
      ...
      want_coco: 'Voulez-vous zgcombat à votre école?',
      ...
      codecombat: '[AI_TRANSLATION]zgcombat  ',
      ...
      //    ozaria_china_blurb: "",
      try_codecombat: '[AI_TRANSLATION]Essaie zgcombat',
      try_ozaria: '[AI_TRANSLATION]Essaie Ozaria',
      explore_codecombat: '[AI_TRANSLATION]Explore zgcombat',
      ...
      codecombat_live_online_classes: '[AI_TRANSLATION]Cours en Ligne en Direct de zgcombat  ',
      ...
      codecombat_home: '[AI_TRANSLATION]Accueil zgcombat  ',
      ...
      //    for_libraries_blurb: "As an entirely self-paced and self-directed digital resource, zgcombat is the best integration for libraries that want to empower their members of all ages to learn how to code. Our platform offers everything learners need to experience a high-level coding education through a uniquely exciting, game-based curriculum. Perfect for learners in third grade all the way up to adults who want to master college-level coding concepts.",
      ...
      meta_keywords_podcast: '[AI_TRANSLATION]zgcombat, python, javascript, Coding Games, podcast, edtech\n',
      coco_worlds_header: '[AI_TRANSLATION]Mondes de zgcombat  ',
      coco_worlds_description: '[AI_TRANSLATION]Embarque dans une aventure de codage en 3D sur Roblox, où tu peux programmer des animaux de compagnie, jouer avec des amis et développer des jeux tout en jouant. Rejoins la communauté zgcombat et libère ta créativité dans le metaverse!',
      coco_worlds_button: '[AI_TRANSLATION]Explore les Mondes de zgcombat',
      //    promo_modal_title: "zgcombat Home",
    ...
    nav: {
      ...
      return_coco: '[AI_TRANSLATION]Retourner à zgcombat',
      ...
      codecombat_classroom: '[AI_TRANSLATION]Salle de Classe zgcombat  ',
      ...
      codecombat_dashboard: '[AI_TRANSLATION]Tableau de Bord de zgcombat  ',
      codecombat_teacher_dashboard: '[AI_TRANSLATION]Tableau de Bord Enseignant de zgcombat  ',
      codecombat_admin_dashboard: '[AI_TRANSLATION]Tableau de Bord Admin de zgcombat  ',
      ...
      codecombat_worlds_on_roblox: '[AI_TRANSLATION]Mondes de zgcombat sur Roblox  ',
      //    pricing: "Pricing",
      ...
      coco_junior_beta: '[AI_TRANSLATION]Junior zgcombat (Beta)  ',
      //    coco_junior: "zgcombat Junior",
    ...
    new_home_faq: {
      ...
      main_curriculum: '[AI_TRANSLATION]Puis-je utiliser zgcombat ou Ozaria comme mon programme principal ?',
      main_curriculum_blurb: "[AI_TRANSLATION]Absolument ! Nous avons passé du temps à consulter des spécialistes de l'éducation pour concevoir des programmes et du matériel de classe spécifiquement pour les profs utilisant zgcombat ou Ozaria sans aucune expérience préalable en informatique. De nombreuses écoles mettent en œuvre zgcombat et/ou Ozaria comme principal programme de sciences informatiques.",
      clever_instant_login: '[AI_TRANSLATION]Est-ce que zgcombat et Ozaria supportent le Clever Instant Login ?',
      ...
      ai_bot_faq_blurb: "[AI_TRANSLATION]Le niveau d'aide du bot en IA dans zgcombat offre des indices pilotés par l'IA pour les défis de codage, garantissant une expérience d'apprentissage guidée mais indépendante. La sécurité est primordiale, car l'IA filtre les données personnelles et est formée pour gérer les demandes inappropriées.",
    },

    play: {
      title: '[AI_TRANSLATION]Jouer aux Niveaux de zgcombat - Apprendre Python, JavaScript et HTML',
      ...
      level_title: '[AI_TRANSLATION]__level__ - zgcombat',
      ...
      anon_signup_title_1: 'zgcombat possède une',
      ...
      get_more_codecombat: 'Plus de zgcombat',
      ...
      play_codecombat: '[AI_TRANSLATION]Jouer à zgcombat',
      play_codecombat_junior: '[AI_TRANSLATION]Jouer à zgcombat Junior',
      ...
      //    cchome_button_hover: "Original zgcombat Adventure",
    ...
    share_progress_modal: {
      blurb: 'Vous faites beaucoup de progrès ! Partagez ce que vous avez appris grâce à zgcombat avec vos amis !',
    ...
    login: {
      ...
      already_have_account1: '[AI_TRANSLATION]Tu as déjà un compte Enseignant ou Élève zgcombat ?',
      ...
      individual_users_not_supported: '[AI_TRANSLATION]Ozaria est uniquement pour les salles de classe ! Veuillez visiter zgcombat pour continuer à jouer !\n',
    ...
    signup: {
      ...
      email_announcements: 'Recevoir les annonces à propos de nouveaux niveaux et fonctionnalités de zgcombat!',
      ...
      teacher_type_1: 'Enseignez la programmation avec zgcombat!',
      ...
      want_codecombat_in_school: 'Avez-vous envie de jouer à zgcombat tout le temps ?',
      eu_confirmation: "J'autorise zgcombat à stocker mes données sur des serveurs américains.",
      ...
      already_have_account: '[AI_TRANSLATION]Tu as déjà un compte zgcombat ou Ozaria ?',
      ...
      //    with: "with",
      want_to_play_codecombat: '[AI_TRANSLATION]Non, je n’en ai pas mais je veux jouer à zgcombat !',
    ...
    common: {
      default_title_coco: '[AI_TRANSLATION]zgcombat - Jeux de codage pour apprendre Python et JavaScript  ',
    ...
    play_level: {
      ...
      explore_codecombat: 'Explorez zgcombat',
      ...
      tip_open_source: 'zgcombat est 100% open source !',
      tip_tell_friends: 'Vous aimez zgcombat? Parlez de nous à vos amis !',
      tip_beta_launch: 'La beta de zgcombat a été lancée en Octobre 2013',
      ...
      tip_open_source_contribute: "Vous pouvez aider zgcombat à s'améliorer !",
    ...
    subscribe: {
      ...
      confirmation: 'Félicitations! Vous avez maintenant souscrit à zgcombat Premium !',
      premium_already_subscribed: "Vous avez déjà souscrit à l'option Premium!",
      subscribe_modal_title: 'zgcombat Premium',
      comparison_blurb: 'Aiguisez vos compétences avec un abonnement zgcombat !',
      ...
      thank_you: 'Merci de supporter zgcombat.',
      ...
      //    feature_all_products: "4-in-1: zgcombat Home, zgcombat Junior, zgcombat Worlds on Roblox, and zgcombat AI HackStack",
      //    feature_products: "Access zgcombat Junior, zgcombat & AI HackStack",
      ...
      support_part2: 'support@flsong.iok.la',
    ...
    premium_features: {
      get_premium: 'Abonnes-toi à <br>zgcombat<br>Premium',
      ...
      everything_in_premium: 'Tout ce que tu auras avec zgcombat Premium:',
      ...
      ai_bot_description: "[AI_TRANSLATION]La fonctionnalité d’indices alimentés par l'IA de zgcombat peut évaluer le code, signaler les erreurs et expliquer comment les corriger. Plus important encore, elle fournit tout le contexte nécessaire pour comprendre le pourquoi, sans fournir la solution complète. Avec uniquement l'assistance actuelle aux problèmes de code disponible, les jeunes apprenants devront encore travailler à travers chaque défi de codage de niveau. Les abonnés premium reçoivent une allocation de <b>10 indices IA par jour</b> pour s'assurer qu'ils ont toujours le soutien dont ils ont besoin.\n",
    ...
    choose_hero: {
      ...
      //    code_format_only_junior: "Only Supported in zgcombat Junior",
    ...
    about: {
      title: '[AI_TRANSLATION]À propos de zgcombat - Engager les étudiants, autonomiser les enseignants, inspirer la création',
      ...
      main_description: "Chez zgcombat, notre but est d'assurer que tu le fasses avec un sourire.",
      mission_link: 'Mission',
      team_link: 'Equipe',
      story_link: 'Histoire',
      press_link: 'Presse',
      mission_title: 'Notre mission: faire en sorte que la programmation soit accessible à chaque élève sur la Terre.',
      mission_description_1: "<strong>La programmation est de la Magie</strong>. C'est la capacité de créer des choses issues de ta propre imagination. Nous avons crée zgcombat pour donner à ceux qui apprennent la sensation de détenir un pouvoir de sorcellerie sous leurs doigts avec du <strong>code typé</strong>.",
      ...
      team_title: "Rencontrez l'équipe zgcombat.",
      ...
      run_title: '[AI_TRANSLATION]Directeur des Opérations, zgcombat Grande Chine',
      lance_title: '[AI_TRANSLATION]Directeur de la Technologie, zgcombat Grande Chine',
      zhiran_title: '[AI_TRANSLATION]Directeur de Programme, zgcombat Grande Chine',
      yuqiang_title: '[AI_TRANSLATION]Directeur de l’Innovation, zgcombat Grande Chine',
      ...
      bill_title: '[AI_TRANSLATION]Directeur Général, zgcombat Grande Chine',
      ...
      story_subtitle: 'Depuis 2013, zgcombat a grandi de quelques croquis à un réel, jeu passionant.',
      story_statistic_1a: 'plus de 20,000,000',
      story_statistic_1b: 'joueurs au total',
      story_statistic_1c: 'ont commencé leur aventure dans la programmation via zgcombat',
      ...
      jobs_title: "Viens travaillier avec nous et aider nous à écrire l'histoire de zgcombat!",
      ...
      jobs_custom_description: "Es-tu passionné de zgcombat mais ne voit pas un travail listé correspondant à tes qualifications? Écris-nous et montres-nous comment tu penses pouvoir contribuer à notre équipe. Nous aimerions t'entendre !",
      ...
      about_codecombat: 'À propose de zgcombat',
      logo: 'Logo',
    ...
    teachers: {
      ...
      free_course_blurb_junior: "[AI_TRANSLATION]Idéal pour les classes K-5, zgcombat Junior peut s'ajuster à des options basées sur des blocs et mobiles pour les pré-lecteurs, jusqu'au code texte Python ou JavaScript pour l'école élémentaire supérieure, ou à des blocs et codes parallèles pour aider à la transition.",
      'free_course_blurb_introduction-to-computer-science': "[AI_TRANSLATION]Parfait pour les classes de 6e à 12e, les cours de CS de base de zgcombat vont de l'introduction conviviale à l'informatique, au cours de principes d'informatique AP, et au-delà vers des cours avancés. Commence ici pour les collégiens et lycéens.",
    ...
    teachers_quote: {
      ...
      state: 'État',
      country: 'Pays',
      num_students_help: "Combien d'étudiants utiliseront zgcombat?",
      ...
      anything_else: 'Quel genre de classe utilisera zgcombat?',
      //    anything_else_helper: "",
      thanks_header: 'Demande Reçue!',
      thanks_sub_header_coco: "Merci d'avoir exprimé votre intérêt dans zgcombat pour votre école.",
      thanks_sub_header_ozar: "Merci d'avoir exprimé votre intérêt dans zgcombat pour votre école.",
    ...
    contact: {
      ...
      subscribe: 'achetez un abonnement zgcombat',
      subscribe_suffix: 'et nous seront ravis de vous aider avec votre code.',
      subscriber_support: 'Etant donné que vous êtes abonné à zgcombat, votre message sera traité en priorité par notre support.',
      screenshot_included: "Capture d'écran ajoutée.",
      where_reply: 'Où devons-nous répondre ?',
      send: 'Envoyer un commentaire',
      //    ooo_blurb: "The zgcombat team will be out of the office from June 5th to June 9th, and during this time will have limited access to emails. We will respond to your inquiry as soon as possible, please be aware of the anticipated wait time.",
    },
    ...
    account_settings: {
      ...
      roblox_not_connected: '[AI_TRANSLATION]Connecte tes comptes zgcombat et Roblox.',
      //    roblox_not_connected_other_user: "Connect the student's zgcombat and Roblox accounts.",
      ...
      email_announcements_description: 'Recevoir des e-mails sur les dernières actualités et sur le développement de zgcombat.',
      email_notifications: 'Notifications',
      email_notifications_summary: "Commandes pour personaliser les notifications automatiques d'e-mail liées à votre activité sur zgcombat.",
    ...
    community: {
      main_title: 'Communauté zgcombat',
      ...
      level_editor_prefix: 'Utiliser le zgcombat',
      ...
      thang_editor_suffix: "pour modifier l'illustration de la source de zgcombat. Permettre aux unités de lancer des projectiles, de modifier la direction de l'animation, de changer les points de vie d'une unité, ou de télécharger vos propres sprites vectorielles.",
      ...
      article_editor_suffix: 'et aidez les joueurs zgcombat à tirer le meilleur parti de leur temps de jeu.',
      find_us: 'Trouvez-nous sur ces sites',
      social_github: 'Venez voir tous les codes sources sur Github',
      //    social_reddit: "Join the zgcombat community on Reddit",
      social_blog: 'Lire le blog zgcombat sur Sett',
      social_discource: 'Participez à la discussion sur notre forum Discourse',
      social_facebook: 'Aimer zgcombat sur Facebook',
      social_twitter: 'Suivre zgcombat sur Twitter',
      social_slack: 'Bavardez avec nous sur la chaîne publique Slack de zgcombat.',
      contribute_to_the_project: 'Contribuer au projet',
    },

    clans: {
      title: '[AI_TRANSLATION]Rejoins les Clans zgcombat - Apprends à coder en Python, JavaScript, et HTML',
      clan_title: '[AI_TRANSLATION]__clan__ - Rejoignez les Clans de zgcombat et apprenez à coder',
    ...
    courses: {
      ...
      ask_teacher_for_code_coco: "Demandez à votre professeur si vous avez un code de classe zgcombat ! Si c'est le cas, veuillez l'entrer ci-dessous :",
      ask_teacher_for_code_ozar: "Demandez à votre professeur si vous avez un code de classe zgcombat ! Si c'est le cas, veuillez l'entrer ci-dessous :",
      ...
      update_account_individuals_warning_ozaria: '[AI_TRANSLATION]Attention : les comptes individuels ne peuvent pas jouer à Ozaria, seulement à zgcombat.  ',
      ...
      update_account_confirm_update_student2: 'Vous ne pourrez pas gérer les classes que vous avez déjà créées ou en créer de nouvelles. Vos classes précédemment créées seront supprimées de zgcombat et ne pourront pas être restaurées.',
      instructor: 'Instructeur : ',
      youve_been_invited_1: 'Vous avez été invité à rejoindre ',
      youve_been_invited_2: ', où vous apprendrez ',
      youve_been_invited_3: ' avec tes camarades de classe dans zgcombat.',
      ...
      license_required_to_play_coco: 'Demandez à votre professeur de vous attribuer une licence pour que vous puissiez continuer à jouer à zgcombat !',
      license_required_to_play_ozar: 'Demandez à votre professeur de vous attribuer une licence pour que vous puissiez continuer à jouer à zgcombat !',
      ...
      //    play_ccw_on_roblox: "Play zgcombat Worlds on Roblox",
    ...
    teacher: {
      ...
      teacher_account_explanation: "Un compte zgcombat pour enseignants vous permet de créer des salles de classe, de suivre les progrès des élèves tout au long de leurs cours, de gérer les licences et d'accéder à des ressources pour vous aider à élaborer votre programme.",
      ...
      pacing_guides_desc: 'Apprenez comment incorporer toutes les ressources de zgcombat pour planifier votre année scolaire !',
      ...
      educator_faq_desc: "Foire aux questions sur l'utilisation de zgcombat dans votre classe ou école.",
      teacher_getting_started: "Guide de démarrage à l'intention de l'enseignant",
      teacher_getting_started_desc: 'Nouveau sur zgcombat ? Téléchargez ce guide de démarrage pour créer votre compte, créer votre première classe et inviter les élèves au premier cours.',
      student_getting_started: "Guide de démarrage rapide de l'élève",
      student_getting_started_desc: "Vous pouvez distribuer ce guide à vos étudiants avant de commencer zgcombat pourqu'ils se familiarisent avec léditeur de code. Ce guide peut être utilisé pour les classes de  Python et de JavaScript.",
      ...
      hoc_meta_description: "[AI_TRANSLATION]Crée ton propre jeu ou code pour sortir d'un donjon ! zgcombat propose quatre activités Heure de Code différentes et plus de 60 niveaux pour apprendre, jouer et créer.",
      hoc_intro: "Il y a trois façons pour votre classede participer à l'heure de code avec zgcombat",
      hoc_self_led: 'Jeu autodirigé',
      hoc_self_led_desc: 'Les élèves peuvent jouer à deux heures de Code zgcombat tutoriels par leurs propres moyens.',
      ...
      hoc_additional_desc1: "Pour d'autres ressources et activités zgcombat, voir notre",
      ...
      teacher_quest_teach_methods_step2: "[AI_TRANSLATION]Imprime le [Guide de Démarrage Rapide pour Étudiants](https://files.flsong.iok.la/docs/resources/StudentQuickStartGuide.pdf) dans la boite à outils de l'enseignant.",
      ...
      teacher_quest_kithgard_gates_100_step2: '[AI_TRANSLATION]Aide les élèves à réfléchir aux problèmes difficiles en utilisant le [Engineering Cycle Worksheet](https://files.flsong.iok.la/docs/resources/EngineeringCycleWorksheet.pdf).',
      ...
      teacher_quest_done: "Voulez-vous que vos étudiants apprennent encore plus à coder? Restez en contact avec nos [spécialistes scolaires](mailto:schools@flsong.iok.la) aujourd'hui!",
    ...
    teacher_ozaria_encouragement_modal: {
      ...
      sub_title: "[AI_TRANSLATION]Tu es invité à essayer le nouveau jeu d'aventure de zgcombat",
      cancel: '[AI_TRANSLATION]Retour à zgcombat',
      ...
      you_can_return: '[AI_TRANSLATION]Tu peux toujours retourner à zgcombat',
    },
    ...
    educator_signup_ozaria_encouragement: {
      ...
      educators_continue_coco: '[AI_TRANSLATION]Enseignants qui veulent continuer à utiliser zgcombat dans leur classe',
      continue_coco: '[AI_TRANSLATION]Continuez avec zgcombat',
    },
    ...
    classes: {
      ...
      archmage_summary: 'Si vous êtes développeur, intéréssé par le développement de jeux éducatifs, devenez un Archimage et aidez-nous à construire zgcombat !',
      ...
      diplomat_summary: 'zgcombat est traduit dans plus de 45 langues par nos Diplomates. Aidez-nous, et contribuez à ces traductions.',
      ambassador_title: 'Ambassadeur',
      ambassador_title_description: '(Aide)',
      ambassador_summary: "Domptez les membres du forum, et guidez ceux qui ont besoin d'aide. Nos ambassadeurs représentent zgcombat face au monde.",
      teacher_title: 'Professeur',
    },

    editor: {
      main_title: 'Éditeurs zgcombat',
    ...
    contribute: {
      ...
      diplomat_introduction_suf: "c'est qu'il y a un intérêt considérable pour zgcombat dans d'autres pays, particulièrement au Brésil ! Nous créons une équipe de traducteurs pour changer une liste de mots en une autre pour que zgcombat soit le plus accessible possible à travers le monde. Si vous souhaitez avoir un aperçu des prochains contenus et avoir les niveaux dans votre langue le plus tôt possible, alors cette classe est faite pour vous.",
    ...
    user: {
      user_title: '[AI_TRANSLATION]__name__ - Apprenez à coder avec zgcombat',
      stats: 'Stats',
    ...
    account: {
      ...
      status_unsubscribed: "Obtenez l'accès à de nouveaux niveaux, héros, objets et gemmes en bonus avec une inscription à zgcombat !",
      ...
      unsubscribe_from_marketing: 'Se désabonner __email__ de tous les emails marketing zgcombat ?',
    ...
    account_prepaid: {
      ...
      purchase_code1: "Les codes d'abonnement peuvent seulement être racheter pour ajouter des comptes prenium à un ou plusieurs comptes de zgcombat",
      purchase_code2: "Chaque compte zgcombat ne peut échanger qu'une seule fois un Code d'Abonnement particulier.",
      purchase_code3: "Les mois de code d'abonnement seront ajoutés à la fin de tout abonnement existant sur le compte.",
      purchase_code4: "Les codes d'abonnement sont pour les comptes jouant la version Home de zgcombat, ils ne peuvent pas être utilisés à la place des licences étudiants pour la version Classroom.",
    ...
    impact: {
      ...
      teacher_quote: "[AI_TRANSLATION]Quand j'ai mis la main sur zgcombat et commencé à le faire utiliser par mes élèves, ça a été une révélation. Ça n'avait rien à voir avec tous les autres programmes qu'on avait utilisés. Ils ne sont même pas comparables.",
      ...
      ozaria_impact_blurb: "[AI_TRANSLATION]Le programme sœur de zgcombat, Ozaria, a prouvé qu'il avait un impact positif sur les résultats d'apprentissage des élèves qui comptent le plus pour les étudiants et les éducateurs.\n",
    ...
    anonymous_teacher: {
      ...
      teacher_notified: 'Nous avons informé votre professeur que vous voulez jouer plus de zgcombat dans votre classe',
    },
    ...
    legal: {
      ...
      opensource_introduction: 'zgcombat fait partie de la communauté open source.',
      opensource_description_prefix: 'Regardez ',
      github_url: 'notre GitHub',
      opensource_description_center: 'et aidez nous si vous voulez ! zgcombat est construit sur plusieurs projets open source, et nous les aimons. Regardez ',
      ...
      cost_title: 'Coût',
      cost_description: '[AI_TRANSLATION]zgcombat est gratuit pour ses niveaux introductifs, avec un abonnement à $__price__ USD/mo pour accéder à des niveaux supplémentaires et des __gems__ bonus gemmes par mois. Vous pouvez annuler en un clic, et nous offrons une garantie de remboursement à 100%.',
      ...
      code_title: 'Code - MIT',
      client_code_description_prefix: 'Tout le code côté client de flsong.iok.la dans le référentiel public GitHub et dans la base de données de flsong.iok.la, est sous licence en vertu de la norme',
      mit_license_url: 'MIT',
      code_description_suffix: 'Cela inclut le code dans Systèmes et Composants qui est rendu disponible par zgcombat dans le but de créer des niveaux.',
      ...
      art_description_suffix: 'Le contenu commun est tout ce qui est rendu disponible par zgcombat afin de créer des niveaux. Cela inclut :',
      ...
      art_paragraph_1: "Pour l'attribution, s'il vous plaît, nommez et référencez flsong.iok.la près de la source utilisée ou dans un endroit approprié. Par exemple :",
      use_list_1: 'Si utilisé dans un film ou un autre jeu, incluez flsong.iok.la dans le générique.',
      use_list_2: "Si utilisé sur un site web, incluez un lien près de l'utilisation, par exemple sous une image, ou sur une page d'attribution générale où vous pourrez aussi mentionner les autres travaux en Creative Commons et les logiciels open source utilisés sur votre site. Quelque chose qui fait clairement référence à zgcombat, comme un article de blog mentionnant zgcombat, n'a pas besoin d'attribution séparée.",
      art_paragraph_2: "Si le contenu utilisé n'est pas créé par zgcombat mais par un autre utilisateur de flsong.iok.la, attribuez-le à cet utilisateur, et suivez les recommandations fournies dans la ressource de la description s'il y en a.",
      ...
      third_party_description: 'zgcombat utilise les services tiers suivants, entre autres :',
      cookies_message: 'zgcombat utilise quelques cookies essentiels et non essentiels.',
    ...
    ladder_prizes: {
      ...
      in_cash: 'en espèces',
      custom_wizard: 'Magicien zgcombat personnalisé',
      custom_avatar: 'Avatar zgcombat personnalisé',
    ...
    apcsp: {
      ...
      meta_description: '[AI_TRANSLATION]Le programme complet de zgcombat et le programme de développement professionnel sont tout ce dont vous avez besoin pour offrir le nouveau cours de sciences informatiques du College Board à vos élèves.  ',
      syllabus: '[AI_TRANSLATION]AP CS Principles Syllabus',
      syllabus_description: "Utilisez cette ressource pour planifier le programme d'études zgcombat pour votre cours sur les principes de l'informatique de l'AP.",
    ...
    apcsp_marketing: {
      ...
      icons_coding_levels: '[AI_TRANSLATION] 150+ niveaux de codage zgcombat',
      ...
      course_outline_description: '[AI_TRANSLATION]Les descriptions suivantes donnent un aperçu du contenu exploré dans le cours AP CSP de zgcombat.',
      ...
      professional_development: '[AI_TRANSLATION]Développement Professionnel',
      professional_development_description: "[AI_TRANSLATION]zgcombat propose un cours de développement professionnel en ligne, autonome et à rythme libre, pour les éducateurs de tous niveaux d'expertise en AP CSP. Les participants exploreront le programme zgcombat et apprendront comment il peut être utilisé pour préparer les étudiants à réussir l'examen AP CSP. Grâce à des discussions asynchrones avec d'autres enseignants et des vidéoconférences avec des concepteurs d'apprentissage de zgcombat, vous serez équipé des outils et techniques nécessaires pour soutenir tous vos élèves en AP CSP. À la fin du cours, vous obtiendrez un certificat de réussite pouvant être utilisé pour le renouvellement de votre diplôme d'enseignement.\n",
      ...
      question_2: '[AI_TRANSLATION]Quelles sont les exigences technologiques pour le programme AP CSP de zgcombat ?',
      ...
      //    outcomes: "outcomes",
      coco_requirements: '[AI_TRANSLATION]Les exigences système de zgcombat',
      coco_recognized_blurb: "[AI_TRANSLATION]zgcombat est reconnu par le College Board comme un fournisseur approuvé de programmes et de développement professionnel pour les Principes de Science Informatique AP® (AP CSP). Cette approbation affirme que le programme de zgcombat est aligné sur toutes les normes du Cadre Curriculaire AP et sur l'évaluation AP CSP. Cela permet aux écoles d'accéder à des ressources, y compris un programme AP CSP pré-approuvé par l'Audit de Cours du College Board, et un développement professionnel officiellement reconnu qui prépare les enseignants à enseigner ce programme.",
    ...
    apcsp_curriculum: {
      ...
      professional_development_description: "[AI_TRANSLATION]zgcombat propose un cours de développement professionnel en ligne et à son rythme pour les éducateurs de tous niveaux d'expertise en AP CSP. Les participants exploreront le programme de zgcombat et apprendront comment il peut être utilisé pour préparer les élèves à réussir l'examen AP CSP. Grâce à des discussions asynchrones avec d'autres enseignants et des vidéoconférences avec les développeurs du programme zgcombat, vous serez équipé des outils et techniques nécessaires pour soutenir tous vos élèves en AP CSP. À la fin du cours, vous recevrez un Certificat de Réussite pouvant être utilisé pour le renouvellement de votre accréditation d'enseignement. Notre programme est proposé sur __edapp__.  ",
      ...
      no_license: '[AI_TRANSLATION]Notre programme AP CSP nécessite une licence payante pour être consulté. Pour en savoir plus sur le programme AP CSP de zgcombat, visitez notre page À propos, liée ci-dessous.',
      ...
      step_1_subtitle: "[AI_TRANSLATION]Upload du syllabus AP CSP de zgcombat à l'audit de cours du College Board.",
    ...
    hoc_2019: {
      ...
      already_have_account: '[AI_TRANSLATION]Tu as déjà un compte zgcombat ou Ozaria ? Connecte-toi.',
    ...
    parents_landing_1: {
      ...
      codecombat_intro: "[AI_TRANSLATION]zgcombat combine la puissance du jeu et de l'instruction personnalisée pour proposer des cours de codage en ligne auxquels ton enfant attendra avec impatience chaque semaine !  ",
      ...
      quote_1: "[AI_TRANSLATION]Même si le cours commence tous les samedis à 7h du matin, mon fils est tellement excité qu'il se réveille avant moi ! zgcombat crée un chemin pour que mon fils développe ses compétences en codage.",
      ...
      private_instructions: "[AI_TRANSLATION]Toutes les classes offrent une instruction privée et individualisée. Pour inscrire un groupe d'élèves, contactez <a href=\"mailto:classes@flsong.iok.la\">classes@flsong.iok.la</a> pour un plan personnalisé.",
      ...
      benefit_3: '[AI_TRANSLATION]Licence premium zgcombat incluse\n',
      ...
      grit_description: '[AI_TRANSLATION]zgcombat défie les étudiants à accepter et apprendre de leurs erreurs. Des indices intégrés aident les étudiants à identifier et corriger les bugs, ce qui augmente leur confiance en codage.  ',
      ...
      other_questions: "[AI_TRANSLATION]Si tu as d'autres questions sur nos cours en ligne, <a href=\"mailto:classes@flsong.iok.la\">contacte-nous.</a>",
    },
    ...
    parents_landing_2: {
      ...
      live_classes_offered: "[AI_TRANSLATION]zgcombat propose maintenant des cours d'informatique en ligne en direct pour les étudiants apprenant à la maison. Idéal pour les étudiants qui travaillent mieux en tête-à-tête ou en petits groupes où les résultats d'apprentissage sont adaptés à leurs besoins.",
      ...
      best_value: '[AI_TRANSLATION]Meilleure Valeur',
      //    codecombat_premium: "zgcombat Premium",
      ...
      premium_need_help: "[AI_TRANSLATION]Besoin d'aide ou tu préfères Paypal ? Envoie un email à <a href=\"mailto:support@flsong.iok.la\">support@flsong.iok.la</a>",
      not_sure_kid: '[AI_TRANSLATION]Pas sûr que zgcombat soit fait pour ton enfant ? Demande-lui !',
      ...
      why_kids_love: '[AI_TRANSLATION]Pourquoi les enfants adorent zgcombat',
      ...
      why_parents_love: '[AI_TRANSLATION]Pourquoi les parents adorent zgcombat',
      ...
      critical_skills_detail: "[AI_TRANSLATION]Ton enfant apprendra à naviguer et à devenir citoyen dans le monde numérique. zgcombat est une solution qui améliore la pensée critique, la créativité et la résilience de ton enfant, en lui donnant les compétences dont il a besoin pour n'importe quel secteur.  ",
      parent_support: '[AI_TRANSLATION]Soutenu par des parents comme vous',
      parent_support_detail: "[AI_TRANSLATION]Chez zgcombat, nous sommes des parents. Nous sommes des codeurs. Nous sommes des éducateurs. Mais surtout, nous sommes des gens qui croient en offrant à nos enfants les meilleures opportunités de réussir dans ce qu'ils décident de faire.",
      ...
      quotes_title: '[AI_TRANSLATION]Ce que les parents et les enfants disent de zgcombat',
      ...
      quote_3: '[AI_TRANSLATION]"Oliver progresse bien en Python. Il utilise zgcombat pour créer ses propres jeux vidéo. Il me défie de jouer à ses jeux, puis rigole quand je perds."',
      quote_4: '[AI_TRANSLATION]"C’est l’une de mes activités préférées. Chaque matin, je me réveille et je joue à zgcombat. Si je devais donner une note à zgcombat de 1 à 10, je lui donnerais un 10 !"',
      //    parent: "Parent",
      //    student: "Student",
      grade: '[AI_TRANSLATION]Niveau',
      subscribe_error_user_type: '[AI_TRANSLATION]Il semble que tu as déjà créé un compte. Si tu es intéressé par zgcombat Premium, contacte-nous à team@flsong.iok.la.',
      ...
      live_classes_title: '[AI_TRANSLATION]Cours de codage en direct de zgcombat !',
    ...
    modal_timetap_confirmation: {
      ...
      paragraph_5: "[AI_TRANSLATION]Merci d'avoir choisi zgcombat et bonne chance pour ton parcours en sciences informatiques !",
      back_to_coco: '[AI_TRANSLATION]Retour à zgcombat',
    },
    ...
    hoc_2018: {
      ...
      about: 'A propos de zgcombat :',
      about_copy: "zgcombat est un programme d'informatique basé sur le jeu pour enseigner le vrai Python et JavaScript. Le programme d'études conforme aux normes de zgcombat s'articule autour d'un jeu que les élèves adorent. Plus de 20 millions d'étudiants ont appris à coder sur zgcombat !",
      point1: '✓ Échafaudés',
      point2: '✓ Différencié',
      ...
      featured_title_1: "[AI_TRANSLATION]zgcombat: Goblins 'n' Glory\n",
    ...
    hoc_2018_interstitial: {
      welcome: "[AI_TRANSLATION]Bienvenue à l'Heure du Code de zgcombat !",
    ...
    school_administrator: {
      ...
      add_additional_teacher: "[AI_TRANSLATION]Besoin d'ajouter un enseignant supplémentaire ? Contacte ton gestionnaire de compte zgcombat ou envoie un email à support@flsong.iok.la.",
      ...
      active_students_stat_description: "[AI_TRANSLATION]Les étudiants actifs comptent le nombre d'étudiants qui se sont connectés à zgcombat au cours des 60 derniers jours.",
      ...
      no_teachers: "[AI_TRANSLATION]Tu n'as pas encore d'écoles liées à ton compte. Veuillez contacter ton <strong>District Success Manager</strong> ou <a href=\"mailto:schools@flsong.iok.la\">schools@flsong.iok.la</a> pour configurer ton tableau de bord.",
    ...
    browser_recommendation: {
      title: '[AI_TRANSLATION]zgcombat fonctionne mieux sur Chrome !\n',
      pitch_body: "[AI_TRANSLATION]Pour la meilleure expérience zgcombat, nous recommandons d'utiliser la dernière version de Chrome. Téléchargez la dernière version de Chrome en cliquant sur le bouton ci-dessous !",
    ...
    events: {
      title: '[AI_TRANSLATION]Événements zgcombat  ',
      main_title: '[AI_TRANSLATION]Événements zgcombat  ',
      main_description: '[AI_TRANSLATION]Les événements importants de zgcombat en Chine',
      ...
      sync_to_google_desc: '[AI_TRANSLATION]Synchronise cet événement avec TON agenda Google, au lieu de celui du propriétaire. Et fonctionne uniquement avec un compte Gmail zgcombat',
    ...
    teacher_dashboard: {
      ...
      want_to_save_tooltip_coco: "[AI_TRANSLATION]<h3>Tu veux sauvegarder ta progression ?</h3><p>Merci de créer un compte étudiant, ou va dans <i>Mon compte / Tester en tant qu'étudiant</i> et joue à zgcombat en tant qu'étudiant si tu veux sauvegarder ta progression.</p>",
      ...
      ozaria_hs_modal_title: '[AI_TRANSLATION]Accéder AI Hackstack Exclusivement sur zgcombat  ',
      ozaria_hs_modal_blurb: "[AI_TRANSLATION]Les éducateurs peuvent désormais accéder directement à AI Hackstack sur **[https://flsong.iok.la/teachers/classes]zgcombat** en utilisant les mêmes identifiants qu'Ozaria. Pour plus de commodité, vous pouvez facilement importer vos classes d'Ozaria dans zgcombat.  ",
      //    ozaria_ai_league_modal_title: "Access AI League Exclusively on zgcombat",
      //    ozaria_ai_league_modal_blurb: "Educators can now access AI League directly on **[https://flsong.iok.la/teachers/ai-league]zgcombat** using the same credentials as Ozaria. For added convenience, you can easily import your classes from Ozaria into zgcombat.",
    ...
    outcomes: {
      ...
      using_codecombat: "[AI_TRANSLATION]En utilisant le moteur d'apprentissage personnalisé de zgcombat...",
      //    wrote: "wrote...",
    ...
    efficacy: {
      ...
      commitment_title: "[AI_TRANSLATION]Engagement de zgcombat envers l'efficacité\n",
      ...
      teachers_love_codecombat: '[AI_TRANSLATION]Les enseignants adorent zgcombat',
      teachers_love_description: "[AI_TRANSLATION]Explore l'impact de notre produit sœur, zgcombat, sur l'enseignement et l'apprentissage de l'informatique!",
      teachers_love_box1: '[AI_TRANSLATION]Rapporte que leurs étudiants aiment utiliser zgcombat pour apprendre à coder',
      teachers_love_box2: "[AI_TRANSLATION]Recommanderait zgcombat à d'autres professeurs d'informatique",
      teachers_love_box3: '[AI_TRANSLATION]Dis que zgcombat aide les étudiants à développer leurs capacités de résolution de problèmes',
    ...
    league: {
      ...
      summary: '[AI_TRANSLATION]La Ligue AI de zgcombat est à la fois un simulateur de bataille AI compétitif et un moteur de jeu pour apprendre le vrai code Python et JavaScript.',
      join_now: '[AI_TRANSLATION]Rejoins Maintenant',
      tagline: '[AI_TRANSLATION]La Ligue AI de zgcombat combine notre programme aligné sur les standards projet par projet, notre jeu de codage basé sur des aventures engageantes, et notre tournoi mondial annuel de codage AI dans une compétition académique organisée unique en son genre.',
      ...
      comprehensive_curr_subheader: "[AI_TRANSLATION]zgcombat est une solution d'informatique alignée sur les standards qui aide les éducateurs à enseigner le vrai codage en JavaScript et Python, peu importe leur expérience.",
      ...
      season1_prize_3: '[AI_TRANSLATION]Avatar zgcombat Personnalisé',
      season1_prize_4: '[AI_TRANSLATION]Et plus encore !',
      season1_prize_hyperx: '[AI_TRANSLATION]HyperX Périphériques Premium',
      codecombat_ai_league: '[AI_TRANSLATION]Ligue IA de zgcombat  ',
      register: "[AI_TRANSLATION]S'inscrire",
      ...
      coco_reserves: '[AI_TRANSLATION]zgcombat se réserve\n',
      ...
      contact_sales_custom: "[AI_TRANSLATION]Ton tournoi personnalisé t'attend. Choisis l'arène que tu veux utiliser pour ton tournoi personnalisé et contacte ton représentant commercial zgcombat pour confirmer les détails d'installation et de programmation.",
      ...
      codecombat_ai_league_description: '[AI_TRANSLATION]La Ligue AI de zgcombat combine notre programme aligné sur les standards projet par projet, notre jeu de codage basé sur des aventures engageantes, et notre tournoi mondial annuel de codage AI dans une compétition académique unique en son genre.',
    ...
    //    ai_league_desc: "The zgcombat AI League is uniquely both a competitive AI battle simulator and game engine for learning real Python or JavaScript code.",
    ...
    //    codecombat_reserves: "zgcombat reserves",
    ...
    payments: {
      ...
      most_popular: '[AI_TRANSLATION]Le plus populaire',
      best_value: '[AI_TRANSLATION]Meilleure Valeur',
      purchase_licenses: '[AI_TRANSLATION]Achetez des licences facilement pour obtenir un accès complet à zgcombat et Ozaria',
      ...
      implementation_info: "[AI_TRANSLATION]60 min de Formation d'Intégration sur comment utiliser zgcombat et Ozaria pour soutenir des objectifs institutionnels et didactiques spécifiques.",
      ...
      full_access_coco: '[AI_TRANSLATION]Accès complet à la fois à zgcombat',
      ...
      bd_subheading: '[AI_TRANSLATION]Pour les Partenaires commerciaux avec au moins 10 élèves, obtenez un accès premium aux jeux de science informatique et de codage de zgcombat :',
      bd_info_list_heading: "[AI_TRANSLATION]zgcombat est le partenaire privilégié de dizaines d'entreprises d'éducation au codage parce que :",
      ...
      bd_info_list_2: "[AI_TRANSLATION]n'importe qui peut apprendre à coder avec zgcombat ; le jeu est le principal enseignant et nous fournissons de nombreuses ressources de soutien",
      //    bd_info_list_3: "you will receive over 200 hours of curriculum, providing years of educational content for your business",
      bd_includes_1: '[AI_TRANSLATION]Accès complet à zgcombat et à Ozaria avec plus de 200 heures de contenu de jeu premium',
    ...
    partners: {
      ...
      below_headline_blurb: "[AI_TRANSLATION]Chez zgcombat, nous avons développé des outils complets qui rendent l'apprentissage du code amusant et l'enseignement de la programmation facile. Nos solutions clés en main peuvent être utilisées de multiples façons.",
    ...
    podcast: {
      ...
      learn_more_coco: '[AI_TRANSLATION]Tu veux en apprendre plus sur les expériences de codage zgcombat ?',
      //    subscribe: "Subscribe",
      explore_coco: '[AI_TRANSLATION]Explore zgcombat',
    ...
    library: {
      ...
      communication_limit_blurb: "[AI_TRANSLATION]Pour assurer la sécurité de tes membres, nous n'offrons pas de chat en jeu ou d'autres fonctionnalités de communication entre les joueurs. Cependant, nous permettons aux membres de partager en toute sécurité leurs projets de codage avec des amis, la famille et la communauté zgcombat. Nous restreignons tout message de vente ou de marketing pour offrir une expérience ininterrompue à tes utilisateurs.",
      ...
      library_signup_promotion: "[AI_TRANSLATION]Inscris-toi pour sauvegarder ta progression et continuer là où tu t'es arrêté sur zgcombat !!",
    ...
    related_accounts: {
      subtitle: '[AI_TRANSLATION]Ajoute des connexions entre différents comptes zgcombat pour pouvoir basculer rapidement entre eux. Par exemple, en tant que parent, tu pourrais passer à la vue zgcombat de tes enfants. Ou, en tant que professeur, tu pourrais ajouter un compte élève test pour toi-même afin de voir ce que voient tes élèves.',
    ...
    modal_free_class: {
      paragraph_1: "[AI_TRANSLATION]Merci d'avoir choisi zgcombat.",
    ...
    roblox_landing: {
      meta_title: '[AI_TRANSLATION]Mondes de zgcombat sur Roblox : Joue, Code et Crée  ',
      ...
      box_play_blurb_player: "[AI_TRANSLATION]Explore l'expérience immersive en 3D de zgcombat Worlds. Programme tes animaux de compagnie et aventure-toi dans un univers de créativité et d'expériences partagées avec des amis.",
      ...
      bottom_blurb_parent: '[AI_TRANSLATION]Pas besoin d’attendre - __sign-up__ pour nos cours en ligne en direct pour que ton enfant commence à coder dès aujourd’hui ! Qu’ils commencent avec zgcombat web pour être les premiers à accéder à l’expérience zgcombat Worlds Roblox.',
      bottom_blurb_sign_up: '[AI_TRANSLATION]Inscris-toi',
      bottom_blurb_partner: "[AI_TRANSLATION]Veux-tu utiliser la nouvelle expérience zgcombat Worlds sur Roblox pour ton entreprise éducative, ton initiative à impact social ou une opportunité de distribution internationale ? __reach-out__ pour discuter d'un partenariat dès aujourd'hui.",
      ...
      connect_button_blurb: '[AI_TRANSLATION]Lie ton compte zgcombat et Roblox pour une expérience fluide !',
      ...
      faq_bottom: "[AI_TRANSLATION]Voir plus de <a href=\"https://codecombat.zendesk.com/hc/en-us/categories/18084251471383-zgcombat-Worlds-Roblox-\" target=\"_blank\">questions fréquemment posées dans notre centre d'aide</a>. <br />Si tu as d'autres questions, <a href=\"mailto:support@flsong.iok.la\">Contacte-nous</a>.  ",
      modal_title: '[AI_TRANSLATION]Mondes de zgcombat<br> Maintenant en Direct sur Roblox !  ',
    ...
    ai: {
      ...
      hackstack_promotion_blurb: "[AI_TRANSLATION]Nouveau dans l'IA ? Explore <b>zgcombat AI HackStack</b> – la voie la plus simple vers l'alphabétisation en IA. Déverrouille le potentiel de ChatGPT-4, Claude, Stable Diffusion, et DALL-E. Cet outil innovant offre une formation AI pratique, rendant la création sans effort.",
    ...
    home_v3: {
      ...
      testimonals_2_title: "[AI_TRANSLATION]\"Nomme n'importe quel programme en ligne, je l'ai essayé. Aucun d'eux ne se compare à zgcombat & Ozaria. Tous les profs qui veulent que leurs élèves apprennent à coder... commencez ici !\"",
      ...
      testimonals_4_title: "[AI_TRANSLATION]\"Ce que j'aime le plus dans zgcombat, c'est que cela ne simplifie pas le codage. Les étudiants apprennent à écrire du code réel, tout en s'amusant.\"",
      ...
      engaging_boxes_2_title: '[AI_TRANSLATION]Salle de Classe zgcombat  ',
      engaging_boxes_2_text: "[AI_TRANSLATION]Un programme complet de CS qui part des concepts de base jusqu'au développement web, de jeux et **[https://flsong.iok.la/apcsp]AP CSP**.",
      engaging_boxes_3_title: '[AI_TRANSLATION]Mondes de zgcombat sur Roblox  ',
      ...
      engaging_boxes_4_title: '[AI_TRANSLATION]Ligue Esports de zgcombat IA  ',
      ...
      engaging_boxes_5_title: '[AI_TRANSLATION]zgcombat IA HackStack  ',
      ...
      engaging_boxes_6_title: '[AI_TRANSLATION]Accueil zgcombat  ',
      ...
      young_learners_1_title: '[AI_TRANSLATION]Junior zgcombat  ',
    ...
    schools_page: {
      meta_title: "[AI_TRANSLATION]zgcombat : la solution d'informatique la plus efficace pour les écoles\n",
      ...
      flexible_standards_aligned_curriculum_text: "[AI_TRANSLATION]Notre approche par paliers couvre les fondamentaux de l'informatique jusqu'aux cours avancés et comprend **[https://flsong.iok.la/apcsp]le cours AP CSP approuvé par le College Board**, le développement web et de jeux. Nous créons des parcours personnalisés pour offrir une expérience d'apprentissage personnalisée qui répond aux **[https://flsong.iok.la/standards]normes CSTA, ISTE et Common Core State Standards**. Le programme flexible permet d'enseigner Python, JavaScript, C++, Luau et plus encore.",
      ...
      codecombat_jr: '[AI_TRANSLATION]Junior zgcombat  ',
      ai_hacksstack_jr: '[AI_TRANSLATION]AI Junior',
      codecombat_worlds: '[AI_TRANSLATION]Mondes de zgcombat  ',
      k: '[AI_TRANSLATION]K',
      ...
      //    testimonials_3_quote: "“zgcombat was one of the easiest to implement programs we’ve piloted and student engagement was extremely high. The way the content is designed, scaffolds perfectly and allows students to quickly move into high level programming skills far beyond anything we could have hoped for.”",
      ...
      //    testimonials_5_quote: "“zgcombat has transformed how I teach coding...I utilize the great teacher resources including Curriculum Guides, Project Guides, and Solutions. Using zgcombat has helped me to teach fairly advanced concepts in a way the students enjoy and understand. What I love the most about zgcombat is that it does not simplify coding. The students are learning to write actual code, yet doing it in such a way that they are having fun.”",
      ...
      faq_1_answer: "[AI_TRANSLATION]Les programmes d'éducation technique et professionnelle (CTE) aux États-Unis visent à équiper les élèves avec des compétences valorisées par l'industrie et peuvent mener à une école de métiers ou une éducation universitaire. Exigés par les lois étatiques et fédérales, les programmes CTE doivent offrir aux étudiants des crédits post-diplôme, des certifications industrielles ou des heures de stage. Alors que certains domaines, comme la cybersécurité, offrent des examens de certification valorisés, d'autres comme l'ingénierie logicielle prioritisent les diplômes de quatre ans par rapport à ces examens. Cependant, réussir l'examen AP Computer Science Principles sert de voie reconnue pour obtenir des crédits post-secondaires, permettant aux étudiants de contourner les exigences coûteuses et chronophages du collège. Pour aider à préparer les étudiants, zgcombat propose un **[https://flsong.iok.la/apcsp]cours AP CSP**, approuvé par le College Board.  ",
      ...
      faq_6_answer: "[AI_TRANSLATION]L'enseignement de l'informatique est devenu une composante essentielle du parcours académique des étudiants, mais de nombreuses écoles rencontrent des défis pour obtenir les ressources nécessaires afin de fournir un programme complet. Chez zgcombat, nous comprenons les obstacles financiers auxquels les écoles font face et sommes passionnés par l'idée de les aider à les surmonter. Les subventions peuvent être une ressource précieuse mais difficile à trouver et à demander. Consultez notre **[https://flsong.iok.la/grants]guide des subventions** ou parlez avec notre équipe pour en savoir plus.",
      ...
      core_curriculum_2_title: '[AI_TRANSLATION]Salle de Classe zgcombat  ',
      core_curriculum_2_text: "[AI_TRANSLATION]Un programme complet de CS qui part des concepts de base jusqu'au développement web, de jeux et **[http://flsong.iok.la/apcsp]AP CSP**.",
      core_curriculum_2_link_text: '[AI_TRANSLATION]Essaie maintenant',
      practice_enrichment_1_title: '[AI_TRANSLATION]Ligue Esports de zgcombat IA  ',
      ...
      practice_enrichment_2_title: '[AI_TRANSLATION]Mondes de zgcombat sur Roblox  ',
      ...
      student_acceleration_1_title: '[AI_TRANSLATION]zgcombat IA HackStack  ',
      ...
      young_learners_1_title: '[AI_TRANSLATION]Junior zgcombat  ',
      //    young_learners_1_title_classroom: "zgcombat Junior Classroom",
      young_learners_1_text: "[AI_TRANSLATION]Notre programme phare pour les élèves du primaire (K-5) propose une progression de niveaux d'apprentissage qui enseignent les concepts de codage de base à un rythme plus lent, spécialement conçu pour les élèves du primaire.",
    ...
    //    faq_4_answer: "Computer science education has become a vital component of a student's academic journey, however, many schools face challenges in securing the necessary resources to provide their students with comprehensive computer science programs. At zgcombat, we understand the funding hurdles that schools encounter and are passionate about helping them overcome these obstacles. Grants can be a valuable resource but difficult to discover and apply for. Check out our comprehensive **[https://flsong.iok.la/grants]guide to grant funding** or **[mailto:team@flsong.iok.la]speak with our team** to learn more.",
    ...
    codequest_page: {
      ...
      core_curriculum_title_23: '[AI_TRANSLATION]Nick Winter, PDG, zgcombat',
      core_curriculum_text_23: "[AI_TRANSLATION]Nick est le fondateur et PDG de zgcombat. Leader reconnu dans l'industrie edtech, Nick allie sa passion pour l'éducation à son expertise technologique pour rendre l'apprentissage de la programmation plus accessible et engageant pour les étudiants du monde entier. Avant zgcombat, il a co-fondé Skritter, une plateforme d'apprentissage des caractères chinois et japonais. Avec un fort engagement à révolutionner le secteur de l'éducation, Nick contribue activement à faire du codage une compétence fondamentale pour la future génération. Sa dévotion et sa vision continuent d'inspirer et d'impacter le domaine de l'edtech.",
    ...
    hackstack: {
      ...
      'HowItWorksPage_codecombat-ai-hackstack-is-an-all-in-one': "[AI_TRANSLATION]zgcombat IA HackStack est un outil IA tout-en-un pour créer des jeux, des œuvres d'art, des chansons, des applications et bien plus encore en discutant simplement. Il gère tout pour toi, héberge tes projets et t'aide à coder. Le mode CORE est gratuit et t'enseigne via des invites à choix multiples. Le mode PRO+ est à 9,99 $/mois pour des invites en forme libre. Les projets sont sécurisés et ne nourrissent pas les grandes entreprises technologiques. C'est fait par l'équipe zgcombat pour rendre l'IA accessible à tous. Maintenant, commençons à créer.  ",
      ...
      'HowItWorksPage_learn-anything-create-something-do-every': "[AI_TRANSLATION]Apprends TOUT, crée QUELQUE CHOSE, fais TOUT avec zgcombat AI HackStack. L'empowerment de l'IA pour tous !",
      ...
      //    NewProjectPage_: "▲",
      'NewProjectPage_codecombat-ai': '[AI_TRANSLATION]zgcombat IA  ',
      ...
      'NewProjectPage_prompt-the-ai-to-create-websites-games-w': "[AI_TRANSLATION]Invite l'IA à créer des sites web, des jeux, des applications web, des histoires, de l'art et plus encore avec le zgcombat AI HackStack.",
      'NewScenarioPage_a-webpage': '[AI_TRANSLATION]une page web',
      'NewScenarioPage_codecombat-ai': '[AI_TRANSLATION]zgcombat IA  ',
    ...
    //    carousel_items_1_text: "For learners with little to no coding experience, most sessions will start in zgcombat Junior to build foundational skills before progressing to zgcombat for deeper programming knowledge. AI HackStack will accelerate learning and showcase real-world applications of coding and AI. zgcombat Worlds and AI League provide additional opportunities for practice, creativity, and fun.",
    //    carousel_items_2_text: "If you love games and want to create them, our game development-focused curriculum is the perfect fit. You'll start building interactive projects with zgcombat, then bring your ideas to life in zgcombat Worlds, where you can design and publish real games on the Roblox platform. AI League offers a competitive edge by deepening your understanding of game dynamics, while AI HackStack helps refine and enhance your creations through iterative development.",
    //    carousel_items_3_text: "Web development is constantly evolving, and staying ahead of the curve is essential. In this curriculum, foundational web development activities will be conducted in zgcombat, while zgcombat Junior provides an accessible starting point for younger learners. AI HackStack will serve as the primary platform for building and publishing projects, with limited use of zgcombat Worlds and AI League to reinforce key coding concepts in an engaging way.",
    //    carousel_items_4_text: "Esports enthusiasts will love the competitive spirit of this learning experience. Starting with zgcombat Junior and zgcombat, learners will build a strong coding foundation before taking on the challenge of our AI League global esports tournaments, where scholarships and prizes are up for grabs year-round. With a focus on creative coding and iteration, they’ll also harness the power of AI HackStack to level up their skills and gain a competitive edge.",
    //    carousel_items_5_title: "AI Literacy",
    //    carousel_items_5_text: "AI is shaping the future, and those who can harness its power will unlock endless opportunities. This learning experience starts with zgcombat Junior and zgcombat. It expands into AI HackStack, where learners will master the art of crafting effective AI prompts and using the latest generative AI tools in a safe and secure environment. ",
    ...
    //    premium_page_title: "zgcombat Premium",
    //  },
    ...
    parents_v2: {
      ...
      //    testimonials_3_quote: "Even though the class starts every Saturday at 7am, my son is so excited that he wakes up before me! zgcombat creates a pathway for my son to advance his coding skills.",
      ...
      //    grid_codecombat: "zgcombat",
      //    grid_ozaria: "Ozaria",
      //    grid_ai_league: "AI League",
      //    grid_codecombat_worlds: "zgcombat Worlds",
      ...
      grid_ai_hints_allowance: '[AI_TRANSLATION]zgcombat AI Indices Autorisation (Quotidienne)***  ',
      grid_prompts_allowance: '[AI_TRANSLATION]zgcombat AI HackStack Prompts Autorisation (Mensuelle)***  ',
      ...
      enroll_now: '[AI_TRANSLATION]Ou, **[https://flsong.iok.la/payments/initial-online-classes-71]Inscris-toi Maintenant**  ',
      ...
      //    codecombat_worlds_title: "zgcombat Worlds",
      ...
      carousel_items_1_text: "[AI_TRANSLATION]Pour les élèves avec peu ou pas d'expérience en codage, la plupart des sessions se feront dans Ozaria pour construire une base, puis dans zgcombat pour approfondir la connaissance de la programmation. AI HackStack sera utilisé pour accélérer les capacités de codage de votre enfant et montrer des applications réelles de ses nouvelles compétences. zgcombat Worlds et AI League offriront des opportunités occasionnelles de pratique et de jeu créatif.  ",
      carousel_items_2_title: '[AI_TRANSLATION]Développement de Jeu[NEWLINE]  ',
      carousel_items_2_title_prefix: '[AI_TRANSLATION]**Focus :**',
      carousel_items_2_text: '[AI_TRANSLATION]Si ton enfant adore les jeux et veut en créer, alors notre programme axé sur le développement de jeux mettra zgcombat au cœur des activités et projets de développement de jeux. En un rien de temps, ton enfant travaillera dans les Mondes zgcombat en construisant et publiant de vrais jeux sur la plateforme Roblox. Participer à notre AI League offre des idées supplémentaires sur les dynamiques et le développement de jeux réussis, tandis que AI HackStack sera un outil puissant pour le développement itératif de jeux.  ',
      carousel_items_3_title: '[AI_TRANSLATION]Développement Web[NEWLINE]',
      carousel_items_3_title_prefix: '[AI_TRANSLATION]**Focus :**',
      carousel_items_3_text: "[AI_TRANSLATION]Développer pour le web évolue constamment, et il est important de rester à la pointe. Dans ce programme, les activités initiales de développement web seront conduites dans zgcombat, tandis qu'Ozaria sera utilisé pour ceux qui débutent le codage. AI HackStack sera largement utilisé comme plateforme pour construire et publier sur le web, avec une utilisation limitée de zgcombat Worlds et AI League pour aider à renforcer les concepts clés du codage.  ",
      carousel_items_4_title: '[AI_TRANSLATION]Code compétitif\nEsports de codage',
      carousel_items_4_title_prefix: '[AI_TRANSLATION]**Focus :**',
      carousel_items_4_text: "[AI_TRANSLATION]Les fans d'esports vont adorer l'esprit de compétition de cet enseignement. Grâce à une base construite avec zgcombat, ton enfant participera toute l'année à nos tournois mondiaux d'esports AI League avec des bourses et des prix à gagner. Avec un accent sur le codage créatif et l'itération, ton enfant apprendra à utiliser notre outil AI HackStack pour booster ses capacités en compétition.  ",
      //    carousel_items_5_title: "AI[NEWLINE]Applications",
      carousel_items_5_title_prefix: '[AI_TRANSLATION]**Focus :**',
      carousel_items_5_text: "[AI_TRANSLATION]L'IA est partout et ceux qui peuvent exploiter sa puissance pourront maximiser leur potentiel. Ce programme se concentre sur zgcombat mais c’est AI HackStack qui aidera à enseigner l'art de rédiger les meilleures invites d'IA et comment utiliser tous les derniers outils d'IA génératif dans un environnement sûr et sécurisé. La fonctionnalité d'IA génératif intégrée dans zgcombat Worlds offrira une autre occasion concrète de voir ce que votre enfant peut faire avec l'IA.",
      ...
      faq_5_answer: "[AI_TRANSLATION]Ton achat d'abonnement est sans risque à 100% dans les 30 premiers jours. Si, pour une raison quelconque, tu décides de ne pas continuer, contacte-nous simplement à **[mailto:classes@flsong.iok.la]classes@flsong.iok.la** dans les 30 jours suivant l'achat, et nous te rembourserons 100% de ton achat, sans poser de questions.",
      //    faq_6_question: "What if I need to reschedule a class?",
      //    faq_6_answer: "Once you have booked a weekly class with us, we have reserved time in our schedule exclusively for you, so we require 48 hours' advance notice for rescheduling classes. You can reschedule your class by emailing **[mailto:classes@flsong.iok.la]classes@flsong.iok.la**. Classes missed or canceled with less than 48 hours' notice will not be rescheduled or refunded.",
    ...
    roblox: {
      ...
      //    link_reward_desc: "Link your zgcombat and Roblox accounts to unlock features and rewards",
      ...
      //    play_title: "Play",
      play_desc: "[AI_TRANSLATION]Explore l'expérience immersive en 3D de zgcombat Worlds. Programme tes animaux de compagnie et aventure-toi dans un univers de créativité et d'expériences partagées avec des amis.",
      //    code_title: "Code",
      ...
      faq_3_answer: '[AI_TRANSLATION]Oui. Les joueurs peuvent partager leurs expériences dans zgcombat Worlds et importer leurs expériences dans Studio pour les publier via un plugin, en maintenant la compatibilité avec Studio.  ',
      faq_4_question: "[AI_TRANSLATION]Ai-je besoin d'un compte Roblox ?  ",
      faq_4_answer: "[AI_TRANSLATION]Oui. Tous les joueurs peuvent s'inscrire gratuitement sur roblox.com. N'oublie pas de lier ton compte zgcombat et ton compte Roblox pour accéder à toutes les fonctionnalités et récompenses.  ",
      faq_5_question: '[AI_TRANSLATION]Est-ce que ça marche sur mon Chromebook ou mon portable ?  ',
      faq_5_answer: '[AI_TRANSLATION]Oui. zgcombat Worlds permet de jouer, taper du vrai code et créer des jeux sur PC, Mac, Chromebooks, tablettes, téléphones et consoles.  ',
      //    promo_modal_title: "Discover zgcombat Worlds",
      //    promo_modal_text: "**Want to build a Roblox game but can’t code?** Jump into **zgcombat Worlds** — where you’ll learn by playing! Start in Rift Village, coding your pets to harvest, and battle. Then tackle Lua (the coding language of Roblox) in the Learning Levels, and finally unleash your ideas in Creative Mode to craft immersive Roblox games. The power to create is in your hands!",
    ...
    pd_page: {
      ...
      ap_csp_professional_development_title: '[AI_TRANSLATION]Développement Professionnel AP CSP[NEWLINE](Avec zgcombat)  ',
      ap_csp_professional_development_blurb: "[AI_TRANSLATION]Ce cours en ligne de plus de 40 heures, principalement autodidacte, est idéal pour tout éducateur voulant préparer ses élèves à réussir l'examen AP Computer Science Principles avec zgcombat.",
      //    list_7: "Both this course and the zgcombat AP CSP curriculum are endorsed by the College Board. The hours completed in this course can be used to qualify for valuable professional education credit.",
      ...
      list_9: "[AI_TRANSLATION]Grâce au partenariat de zgcombat avec l'Université Southern New Hampshire (SNHU), tu peux gagner jusqu'à 3 heures de crédit de niveau supérieur tout en apprenant à préparer au mieux tes étudiants pour l'examen AP CSP.",
    ...
    //  junior_page: {
    //    testimonials_1_quote: "The future is programmable and you will need to be able to code to participate… I think zgcombat has the best CS curriculum on the market… the teacher toolkit is what sets it apart.",
    ...
    //    no_matter_the_coding_experience: "No matter the coding experience, zgcombat Junior **meets students where they’re at.** They can code with icon blocks, word blocks, blocks and text code in parallel, or text-based coding with industry standard languages.",
    ...
    //    meta_title: "zgcombat Junior: K-5 Computer Science for Schools",
    //    our_comprehensive_implementation: "Our comprehensive implementation",
    //    trends_1_title: "Kickstarting CS in K-5 Classrooms",
    //    trends_1_text: "Watch as zgcombat's Director of Education, Charlotte Cheng, and STEM Program Director, Jacob Kaminski, explore how to integrate **zgcombat Junior** and **zgcombat Worlds** into your classroom. They share practical strategies, success stories, and answer questions from fellow educators.",
    //    trends_1_linkText: "Learn more",
    //    trends_2_title: "zgcombat Junior: A New Dynamic Approach to K-5 Coding",
    //    trends_2_text: "Learn more about how **zgcombat Junior** can bring coding education to K-5 classrooms. From drag-and-drop icon-based block coding to text-based coding in Python and JavaScript, this adaptable platform supports students at every stage. With over 1,100 levels and more in development, zgcombat Junior offers endless opportunities.",
    //    trends_2_linkText: "Read the blog",
    //    get_a_headstart: "Get a Headstart from Home",
    //    parents_junior_perfect: "Parents, zgcombat Junior is the perfect way to start introducing your child not only to computer science but all the benefits, including problem solving, logic and reasoning, persistence, computational thinking and creative exploration.",
    ...
    //    hoai_activities_esports_title: "zgcombat: AI Esports",
    ...
    //    latest_activities_2_title: "zgcombat Junior",
    ...
    //    goblins_glory_title: "zgcombat: Goblins 'n' Glory",
