module.exports = {
  ...
  translation: {
    ...
    new_home: {
      ...
      codecombat_is: 'Το zgcombat είναι μια πλατφόρμα <strong>για μαθητές</strong> για να μάθουν την επιστήμη των υπολογιστών ενώ παίζουν ένα πραγματικό παιχνίδι.',
      ...
      watch_how: 'Παρακολουθήστε πώς το zgcombat αλλάζει τον τρόπο με τον οποίο οι άνθρωποι μαθαίνουν την επιστήμη των υπολογιστών.',
      ...
      agency: 'Το zgcombat είναι ένα παιχνίδι που δίνει στους παίκτες αυτή την δυνατότητα δράσης και σιγουριάς με την ισχυρή μας μηχανή πληκτρολόγησης κώδικα, η οποία βοηθά τους αρχάριους και τους προχωρημένους μαθητές να γράφουν σωστό και έγκυρο κώδικα.',
      ...
      want_coco: 'Θέλετε το zgcombat στο σχολείο σας;',
      //    educator: "Educator",
      //    student: "Student",
    ...
    diplomat_suggestion: {
      title: 'Βοηθήστε στην μετάφραση του zgcombat!',
      sub_heading: 'Χρειαζόμαστε τις γλωσσικές σας δεξιότητες.',
      pitch_body: 'Αναπτύσσουμε το zgcombat στα αγγλικά, αλλά ήδη έχουμε παίκτες από όλο τον κόσμο. Πολλοί από αυτούς θέλουν να παίξουν στα ελληνικά, αλλά δεν μιλούν αγγλικά. Εάν έχετε ευχέρεια και στις δύο γλώσσες, αγγλική κι ελληνική, παρακαλούμε να εγγραφείτε ως Διπλωμάτης και να συμβάλετε στην απόδοση της ιστοσελίδας zgcombat και όλων των επιπέδων στην ελληνική γλώσσα.',
    ...
    play: {
      ...
      available: 'Διαθέσιμο',
      skills_granted: 'Παρεχόμενες Ικανότητες',
      heroes: 'Ήρωες',
      //    pets: "Pets",
      ...
      get_more_codecombat: 'Περισσότερο zgcombat',
    ...
    share_progress_modal: {
      blurb: 'Κάνεις σημαντική πρόοδο! Πες τους γονείς σου πόσα έχεις μάθει με το zgcombat.',
    ...
    signup: {
      ...
      email_announcements: 'Λάβετε ειδοποιήσεις σχετικά με τα νέα επίπεδα και τα χαρακτηριστικά του zgcombat!',
      ...
      teacher_type_1: 'Δίδαξε προγραμματισμό χρησιμοποιώντας το zgcombat!',
      ...
      want_codecombat_in_school: 'Θέλεις να παίζεις το zgcombat όλη την ώρα;',
    ...
    play_level: {
      ...
      explore_codecombat: 'Εξερεύνησε το zgcombat',
      ...
      tip_open_source: 'Το zgcombat είναι 100% ανοικτού κώδικα!',
      tip_tell_friends: 'Σου αρέσει το zgcombat; Πες στους φίλους σου για αυτό!',
      tip_beta_launch: 'Το zgcombat ξεκίνησε τη δοκιμαστική του μορφή τον Οκτώβριο του 2013.',
      ...
      tip_open_source_contribute: 'Μπορείς να βοηθήσεις το zgcombat να βελτιωθεί!',
    ...
    play_game_dev_level: {
      ...
      play_more_codecombat: 'Παίξτε περισσότερο zgcombat',
    ...
    subscribe: {
      ...
      confirmation: 'Συγχαρητήρια! Τώρα έχετε Προνομιακή Συνδρομή στο zgcombat!',
      premium_already_subscribed: 'Έχετε ήδη κάνει Προνομιακή συνδρομή!',
      subscribe_modal_title: 'Προνομιακό zgcombat',
      ...
      thank_you: 'Ευχαριστούμε που υποστηρίζετε το zgcombat.',
    ...
    announcement: {
      ...
      cuddly_companions: 'Χνουδωτοί Σύντροφοι!',
    ...
    premium_features: {
      get_premium: 'Πάρε <br>zgcombat<br> Προνομιακό',
      ...
      everything_in_premium: 'Κάθε τι που παίρνετε στο Προνομιακό zgcombat:',
    ...
    about: {
      ...
      main_description: 'Στο zgcombat, η δουλειά μας είναι να βεβαιωθούμε ότι το κάνετε αυτό με ένα χαμόγελο στο πρόσωπό σας.',
      mission_link: 'Αποστολή',
      team_link: 'Ομάδα',
      story_link: 'Ιστορία',
      press_link: 'Τύπος',
      mission_title: 'Η αποστολή μας: να κάνουμε τον προγραμματισμό προσβάσιμο σε κάθε μαθητή στη Γη.',
      mission_description_1: '<strong>Ο προγραμματισμός είναι μαγικός</strong>. Είναι η δυνατότητα να δημιουργήσετε πράγματα από καθαρή φαντασία. Ξεκινήσαμε το zgcombat για να δώσουμε στους εκπαιδευόμενους την αίσθηση της μαγικής δύναμης των δακτύλων τους χρησιμοποιώντας <strong>ήδη γραμμένο κώδικα</strong>.',
      ...
      team_title: 'Γνωρίστε την ομάδα του zgcombat',
      ...
      story_subtitle: 'Από το 2013, το zgcombat έχει αναπτυχθεί από ένα απλό σύνολο σκίτσων σε ένα ζωντανό, ακμάζον παιχνίδι.',
      story_statistic_1a: '20,000,000+',
      story_statistic_1b: 'συνολικά παίχτες',
      story_statistic_1c: 'έχουν αρχίσει το ταξί τους στον προγραμματισμό μέσα από το zgcombat',
      ...
      jobs_title: 'Ελάτε να συνεργαστείτε μαζί μας και να γράψετε την ιστορία του zgcombat!',
      ...
      jobs_custom_description: 'Είστε παθιασμένοι με το zgcombat αλλά δεν βλέπετε μια θέση εργασίας που να αντιστοιχεί στα προσόντα σας; Γράψτε και δείξτε μας πώς νομίζετε ότι μπορείτε να συμβάλλετε στην ομάδα μας. Θα θέλαμε να σας ακούσουμε!',
      ...
      about_codecombat: 'Περί zgcombat',
      logo: 'Λογότυπο',
    ...
    teachers_quote: {
      ...
      state: 'Πολιτεία',
      country: 'Χώρα',
      num_students_help: 'Για πόσους μαθητές προορίζετε το zgcombat;',
      ...
      referrer_web: 'Google',
      referrer_other: 'Άλλο',
      anything_else: 'Τι είδους τάξη ενδιαφέρεστε να χρησιμοποιήσετε στο zgcombat;',
      //    anything_else_helper: "",
      thanks_header: 'Το Αίτημα Ελήφθη!',
      thanks_sub_header_coco: 'Ευχαριστώ που εκφράσατε ενδιαφέρον για το zgcombat για το σχολείο σας.',
      thanks_sub_header_ozar: 'Ευχαριστώ που εκφράσατε ενδιαφέρον για το zgcombat για το σχολείο σας.',
    ...
    contact: {
      ...
      subscribe: 'αγοράστε μια συνδρομή στο zgcombat',
      subscribe_suffix: 'και θα χαρούμε πολύ να σας βοηθήσουμε με τον κώδικά σας.',
      subscriber_support: 'Αφού είστε συνδρομητής στο zgcombat, θα έχετε προνομιακή υποστήριξη μέσω ηλεκτρονικού ταχυδρομείου.',
    ...
    account_settings: {
      ...
      email_announcements_description: 'Λάβετε emails για τα τελευταία νέα και τις εξελίξεις του zgcombat.',
      email_notifications: 'Ειδοποιήσεις',
      email_notifications_summary: 'Έλεγχοι για προσωποποιημένη, αυτόματη ειδοποίηση μέσω ηλεκτρονικού ταχυδρομείου σχετικά με τη δραστηριότητά σου στο zgcombat.',
    ...
    community: {
      main_title: 'Κοινότητα του zgcombat',
      ...
      level_editor_prefix: 'Χρησιμοποίησε το zgcombat',
      ...
      thang_editor_suffix: 'για να αλλάξεις τα γραφικά του zgcombat. Επέτρεψε στις μονάδες να ρίχνουν βλήματα, άλλαξε την κατεύθυνση του animation, άλλαξε τους πόντους κτυπήματος μιας μονάδα, ή ανέβασε τα δικά σου γραφικά.',
      article_editor_prefix: 'Είδες ένα λάθος στην τεκμηρίωσή μας; Θέλεις να γράψεις οδηγίες για τις δημιουργίες σου; Κοίταξε το',
      article_editor_suffix: 'και βοήθησε άλλους παίκτες του zgcombat να εκμεταλλευτούν το χρόνο τους όσο το δυνατόν καλύτερα.',
      ...
      social_blog: 'Διάβασε το ιστολόγιο του zgcombat στο Sett',
      social_discource: 'Μπείτε στη συζήτηση στο φόρουμ μας που είναι βασισμένο στο Discourse',
      social_facebook: 'Κάντε Like στο zgcombat στο Facebook',
      social_twitter: 'Ακολουθείστε το zgcombat στο Twitter',
      social_slack: 'Συζητήστε μαζί μας στο δημόσιο κανάλι του zgcombat στο Slack',
    ...
    courses: {
      ...
      ask_teacher_for_code_coco: 'Ζήτα από το δάσκαλο σου, εάν έχει ένα κωδικό τάξης για το zgcombat! Εάν έχει, πληκτρολόγησε τον παρακάτω:',
      ask_teacher_for_code_ozar: 'Ζήτα από το δάσκαλο σου, εάν έχει ένα κωδικό τάξης για το zgcombat! Εάν έχει, πληκτρολόγησε τον παρακάτω:',
      ...
      subtitle: 'Ελέγξτε τις επισκοπήσεις των μαθημάτων και τα επίπεδα',
      ...
      language_select: 'Επιλογή μίας γλώσσας',
      ...
      update_account_confirm_update_student2: 'Δεν θα μπορείτε να διαχειριστείτε τάξεις που έχετε δημιουργήσει ή να δημιουργήσετε νέες τάξεις. Οι κατηγορίες που δημιουργήσατε προηγουμένως θα αφαιρεθούν από το zgcombat και δεν μπορούν να επανακτηθούν.',
      instructor: 'Εγγραφή: ',
      youve_been_invited_1: 'Έχετε προσκληθεί να συμμετάσχετε στο zgcombat',
      ...
      license_required_to_play_coco: 'Ζητήστε από τον δάσκαλό σας να σας εκχωρήσει μια άδεια για να μπορείτε να συνεχίσετε να παίζετε zgcombat!',
      license_required_to_play_ozar: 'Ζητήστε από τον δάσκαλό σας να σας εκχωρήσει μια άδεια για να μπορείτε να συνεχίσετε να παίζετε zgcombat!',
    ...
    teacher: {
      ...
      teacher_dashboard: 'Πίνακας Ελέγχου Δασκάλου',
      my_classes: 'Οι Τάξεις Μου',
      ...
      create_new_class: 'Δημιουργία Νέας Τάξης',
      class_overview: 'Επισκόπηση Τάξης',
      ...
      show_students_from: 'Εμφάνιση μαθητών από',
      ...
      pacing_guides_desc: 'Μάθετε πώς να ενσωματώσετε όλους τους πόρους του zgcombat για να σχεδιάσετε το σχολικό έτος!',
      ...
      educator_faq_desc: 'Συχνές ερωτήσεις σχετικά με τη χρήση του zgcombat στην τάξη ή στο σχολείο σας.',
      teacher_getting_started: 'Οδηγός Ξεκινήματος Εκπαιδευτικού',
      teacher_getting_started_desc: 'Καινούριος στο zgcombat; Κάντε λήψη αυτού του Οδηγού Ξεκινήματος Εκπαιδευτικού για να ρυθμίσετε το λογαριασμό σας, να δημιουργήσετε την πρώτη σας τάξη και να προσκαλέσετε τους μαθητές στο πρώτο μάθημα.',
      student_getting_started: 'Οδηγός Γρήγορης Εκκίνησης Μαθητή',
      student_getting_started_desc: 'Μπορείτε να διανείμετε αυτόν τον οδηγό στους σπουδαστές σας πριν ξεκινήσετε το zgcombat έτσι ώστε να μπορέσουν να εξοικειωθούν με τον επεξεργαστή κώδικα. Αυτός ο οδηγός μπορεί να χρησιμοποιηθεί για τις τάξεις Python και JavaScript.',
      ...
      hoc_intro: 'Υπάρχουν τρεις τρόποι με τους οποίους η τάξη σας μπορεί να συμμετάσχει στην Ώρα του Κώδικα με το zgcombat',
      hoc_self_led: 'Αυτόνομο Παιχνίδι',
      hoc_self_led_desc: 'Οι μαθητές μπορούν να εξασκηθούν στην Ώρα του Κώδικα στο zgcombat στη δικιά τους',
      ...
      hoc_additional_desc1: 'Για επιπλέον υλικό και δραστηριότητες του zgcombat, δείτε τις',
      ...
      teacher_quest_teach_methods_step2: 'Εκτυπώστε τον [Οδηγός Γρήγορης Εκκίνησης Μαθητή](https://files.flsong.iok.la/docs/resources/StudentQuickStartGuide.pdf) στο Κέντρο Υλικού.',
      ...
      teacher_quest_kithgard_gates_100_step2: 'Κατευθύνετε τους μαθητές να επεξεργάζονται δύσκολα προβλήματα χρησιμοποιώντας το [Φύλλο Εργασίας Μηχανικού Κύκλου](https://files.flsong.iok.la/docs/resources/EngineeringCycleWorksheet.pdf).',
      ...
      teacher_quest_done: 'Θέλετε οι μαθητές σας να μάθουν περισσότερο κώδικα; Ελάτε σε επικοινωνία με τους [ειδικούς του σχολείου](mailto:schools@flsong.iok.la) σήμερα!',
    ...
    classes: {
      ...
      archmage_summary: 'Αν είσαι προγραμματιστής που σε ενδιαφέρουν τα εκπαιδευτικά παιχνίδια, γίνε Αρχιμάγος για να μας βοηθήσεις να φτιάξουμε το zgcombat!',
      ...
      diplomat_summary: 'Το zgcombat έχει μεταφραστεί σε πάνω από 45 γλώσσες από τους Διπλωμάτες μας. Βοήθησέ μας συνεισφέροντας στις μεταφράσεις.',
      ambassador_title: 'Πρεσβευτής',
      ambassador_title_description: '(Υποστήριξη)',
      ambassador_summary: 'Βοήθησε τους χρήστες στο φόρουμ μας και δώσε οδηγίες σε αυτούς που έχουν ερωτήσεις. Οι Πρεσβευτές μας αντιπροσωπεύουν το zgcombat στον κόσμο.',
      teacher_title: 'Δάσκαλος',
    },

    editor: {
      main_title: 'Συντάκτες στο zgcombat',
    ...
    contribute: {
      ...
      intro_blurb: 'Το zgcombat είναι 100% ανοικτού κώδικα! Εκατοντάδες αφοσιωμένοι παίκτες μας βοήθησαν να κτίσουμε το παιχνίδι σε αυτό που είναι σήμερα. Ελάτε μαζί μας και γράψτε το επόμενο κεφάλαιο στην αναζήτηση του zgcombat να μάθει τον κόσμο να προγραμματίζει!',
      ...
      archmage_introduction: 'Ένα από τα καλύτερα μέρη της δημιουργίας παιχνιδιών είναι ότι περιέχουν πολλά πράγματα. Γραφικά, ήχο, δικτύωση σε πραγματικό χρόνο, κοινωνική μηχανική, και φυσικά πολλές συνηθισμένες απόψεις προγραμματισμού, από χαμηλού επιπέδου διαχείριση βάσεων δεδομένων και διαχείριση συστήματος μέχρι σχεδιασμό και υλοποίηση διεπαφής χρήστη. Υπάρχουν πολλά πράγματα να γίνουν, και αν είσαι έμπειρος προγραμματιστής με λαχτάρα να κολυμπήσεις στα βαθιά του κώδικα του zgcombat, αυτή η τάξη μπορεί να είναι για σένα. Θα χαρούμε να βοηθήσεις να φτιάξουμε το καλύτερο παιχνίδι που έγινε ποτέ.',
      ...
      diplomat_introduction_suf: 'είναι ότι υπάρχει υπολογίσιμο ενδιαφέρον για το zgcombat σε άλλα κράτη! Φτιάχνουμε μια ομάδα μεταφραστών, που να είναι πρόθυμοι να μεταφράζουν για να κάνουν το  zgcombat όσο πιο προσβάσιμο στην υφήλιο γίνεται. Αν θέλεις να ρίχνεις κλεφτές ματιές σε μελλοντικό περιεχόμενο και να φέρνεις αυτά τα επίπεδα στους συμπατριώτες όσο το δυνατό γρηγορότερα, τότε αυτή η τάξη ίσως να είναι για σένα.',
    ...
    ladder: {
      ...
      winners: 'Νικητές',
      league: 'Πρωτάθλημα',
      red_ai: 'Ο Κόκκινος Επεξεργαστής',
    ...
    account: {
      ...
      status_unsubscribed: 'Με μια συνδρομή στο zgcombat θα έχεις πρόσβαση σε νέα επίπεδα, ήρωες, αντικείμενα, και έξτρα πετράδια!',
    ...
    account_prepaid: {
      ...
      purchase_code1: 'Οι Κωδικοί Συνδρομής μπορούν να εξαργυρωθούν για να προστεθεί προνομιακός χρόνος συνδρομής σε έναν ή περισσότερους λογαριασμούς για την Βασική έκδοση του zgcombat.',
      purchase_code2: 'Κάθε λογαριασμός zgcombat μπορεί να εξαργυρώσει μόνο έναν συγκεκριμένο Κωδικό Συνδρομής και για μία φορά.',
      ...
      purchase_code4: 'Οι Κωδικοί Συνδρομής είναι για λογαριασμούς που παίζουν την Βασική έκδοση του zgcombat, δεν μπορούν να χρησιμοποιηθούν στη θέση των Αδειών Μαθητών για την έκδοση Τάξης.',
    ...
    anonymous_teacher: {
      ...
      teacher_notified: 'Έχουμε ειδοποιήσει τον δάσκαλό σας ότι θέλετε να παίξετε περισσότερο zgcombat στην τάξη σας!',
    },
    ...
    legal: {
      ...
      github_url: 'GitHub',
      opensource_description_center: 'και βοηθήστε μας αν θέλετε! Το zgcombat είναι κτισμένο πάνω σε δεκάδες εφαρμογές ανοικτού κώδικα, τις οποίες αγαπάμε. Δες ',
      ...
      code_description_suffix: 'Περιλαμβάνει όλον τον κώδικα στα Συστήματα και Δομικά Στοιχεία που είναι διαθέσιμα από το zgcombat με σκοπό τη δημιουργία επιπέδων.',
      ...
      art_description_suffix: 'Κοινό περιεχόμενο είναι ο,τιδήποτε έγινε γενικά διαθέσιμο από το zgcombat με σκοπό τη δημιουργία Επιπέδων. Αυτό περιλαμβάνει:',
      art_music: 'Μουσική',
      art_sound: 'Ήχος',
      art_artwork: 'Γραφικά',
      ...
      art_paragraph_1: 'Για την απόδοση, παρακαλούμε αναφέρετε και βάλτε ένα σύνδεσμο προς το flsong.iok.la κοντά στο σημείο που χρησιμοποιείτε το μέσο ή που είναι κατάλληλο. Για παράδειγμα:',
      use_list_1: 'Αν χρησιμοποιηθεί σε μια ταινία ή άλλο παιχνίδι, συμπεριλάβετε το flsong.iok.la στη λίστα συντελεστών.',
      use_list_2: 'Αν χρησιμοποιηθεί σε μια ιστοσελίδα, συμπεριλάβετε ένα σύνδεσμο κοντά εκεί που χρησιμοποιείται, για παράδειγμα κάτω από μια εικόνα, ή σε μια γενική σελίδα σελίδα αναφορών, στην οποία μπορεί να αναφέρετε εργασίες με Αναφορά Δημιουργού και λογισμικό ανοικτού κώδικα που χρησιμοποιείται στη σελίδα. Κάτι που ήδη ξεκάθαρα κάνει αναφορά στο zgcombat, όπως ένα άρθρο σε ένα ιστολόγιο που αναφέρει το zgcombat, δε χρειάζεται να έχει ξεχωριστή αναφορά.',
      art_paragraph_2: 'Αν το περιεχόμενο που χρησιμοποιείται δε δημιουργήθηκε από το zgcombat αλλά από ένα χρήστη του flsong.iok.la, αναφέρετε αυτούς ως δημιουργούς, και ακολουθείστε τις οδηγίες αναφοράς δημιουργού που παρέχονται στην περιγραφή του περιεχομένου, αν έχει κάτι τέτοιο.',
      ...
      nutshell_description: 'Όλες οι πηγές που παρέχουμε στο Διορθωτή Επιπέδων είναι ελεύθερα να τα χρησιμοποιήσετε όπως θέλετε για τη δημιουργία επιπέδων. Αλλά διατηρούμε το δικαίωμα να περιορίσουμε τη διανομή των ίδιων των επιπέδων (που δημιουργήθηκαν στο flsong.iok.la) ώστε να είναι επί πληρωμή στο μέλλον, αν αυτό καταλήξει να γίνει.',
      ...
      third_party_description: 'Το zgcombat χρησιμοποιεί τις ακόλουθες υπηρεσίες τρίτων (μεταξύ άλλων):',
    ...
    ladder_prizes: {
      ...
      in_cash: 'σε μετρητά',
      custom_wizard: 'Προσαρμοσμένος Μάγος zgcombat',
      custom_avatar: 'Προσαρμοσμένα άβαταρ zgcombat',
    ...
    esper: {
      ...
      unable_to_get_property: "Δεν είναι δυνατή η πρόσβαση στην ιδιότητα '$1' από απροσδιόριστη ή κενή αναφορά",
      ...
      there_is_no_enemy: 'Δεν υπάρχει κανένα `$1`. Χρησιμοποίησε το `$2` πρώτα..',
