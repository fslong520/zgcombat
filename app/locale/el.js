module.exports = {
  ...
  translation: {
    ...
    legal: {
      ...
      art_paragraph_2: 'Αν το περιεχόμενο που χρησιμοποιείται δε δημιουργήθηκε από το zgcombat αλλά από ένα χρήστη του codecombat.com, αναφέρετε αυτούς ως δημιουργούς, και ακολουθείστε τις οδηγίες αναφοράς δημιουργού που παρέχονται στην περιγραφή του περιεχομένου, αν έχει κάτι τέτοιο.',
