module.exports = {
  ...
  translation: {
    ...
    new_home: {
      title_coco: 'zgcombat - Programmér spil mens du lærer Python og JavaScript',
      title_ozar: 'zgcombat - Programmér spil mens du lærer Python og JavaScript',
      ...
      built_for_teachers_blurb: 'At undervise børn i at programmere, kan nogle gange føles overvældende. zgcombat hjælper alle lærere med at undervise elever i programmering af enten JavaScript eller Python - to af de mest populære programmeringssprog. Med udgangspunkt i et omfattende pensum, som inkluderer seks datalogi-moduler og som understøtter læring gennem projektbaseret spiludvikling og webudvikling, vil børnene komme på en rejse gående fra grundlæggende syntaks mod rekursion!',
      ...
      codecombat_is: 'zgcombat er en platform <strong> for studerende </strong> for at lære datalogi mens du nyder et rigtigt spil.',
      ...
      agency: 'zgcombat er et spil, der giver spillerne rammerne og en tillid til vores robuste kodefortolkermotor, som hjælper begyndere og avancerede elever med både skrive ordentligt og korrekt kode.',
      ...
      want_coco: 'Ønsker du zgcombat på din skole?',
      //    educator: "Educator",
      student: 'Elev',
    ...
    diplomat_suggestion: {
      title: 'Hjælp med at oversætte zgcombat!',
      sub_heading: 'Vi har brug for dine sprogfærdigheder.',
      pitch_body: 'Vi udvikler zgcombat på engelsk, men vi har allerede spillere over hele verden. Mange af dem vil gerne spille på dansk, men taler ikke engelsk, så hvis du kan begge, så overvej gerne at melde dig som Diplomat og hjælp med at oversætte både zgcombat hjemmesiden og alle niveauer til dansk.',
    ...
    share_progress_modal: {
      blurb: 'Du gør godt fremskridt! Fortæl din forælder hvor meget du har lært med zgcombat.',
    ...
    play_level: {
      ...
      explore_codecombat: 'Udforsk zgcombat',
      ...
      tip_open_source: 'zgcombat er 100% open source!',
      tip_tell_friends: 'Kan du lide zgcombat? Fortæl dine venner om os!',
      tip_beta_launch: 'zgcombat søsatte sin beta i oktober, 2013.',
      ...
      tip_open_source_contribute: 'Du kan hjælpe med at forbedre zgcombat!',
    ...
    subscribe: {
      ...
      comparison_blurb: 'Skærp dine færdigheder med et zgcombat abonnement!',
      ...
      thank_you: 'Tak for at støtte zgcombat.',
    ...
    about: {
      ...
      main_description: 'Hos zgcombat er vores opgave at sikre, at du gør det med et smil på læben.',
      mission_link: 'Mission',
      team_link: 'Hold',
      story_link: 'Baggrund',
      press_link: 'Pressen',
      mission_title: 'Vores mission: At gøre programmering tilgængelig for alle elever på Jorden.',
      mission_description_1: '<strong>Programmering er magi</strong>. Det er evnen til at skabe ting fra ren fantasi. Vi startede zgcombat for at give eleverne en fornemmelse af troldmandsmagt lige ved hånden ved hjælp af <strong>indtastet kode</strong>.',
      ...
      team_title: 'Mød zgcombat teamet',
      ...
      story_subtitle: 'Siden 2013 er zgcombat vokset fra et simpelt sæt skitser til et levende, blomstrende spil.',
      story_statistic_1a: '20.000.000+',
      story_statistic_1b: 'spillere',
      story_statistic_1c: 'har startet deres programmeringsrejse med zgcombat',
      ...
      jobs_title: 'Kom og arbejd hos os og hjælp med at skrive zgcombat historie!',
      ...
      jobs_custom_description: 'Brænder du for zgcombat men kan ikke se et ledigt job, der matcher dine kvalifikationer? Skriv til os og vis, hvordan du tror, ​​du kan bidrage til vores team. Vi vil meget gerne høre fra dig!',
    ...
    teachers_quote: {
      ...
      state: 'Stat',
      country: 'Land',
      num_students_help: 'Hvor mange forventer du at indskrive i zgcombat?',
    ...
    contact: {
      ...
      subscribe: 'købe et zgcombat abonnement',
      subscribe_suffix: 'og vi vil med glæde hjælpe dig med din kode.',
      subscriber_support: 'Eftersom du er en zgcombat abonnent, vil din email få prima-support.',
    ...
    account_settings: {
      ...
      email_announcements_description: 'Få emails om de seneste nyheder og udvikling på zgcombat.',
      email_notifications: 'Notifikationer',
      email_notifications_summary: 'Indstillinger for personlig, automatiske email notifikationer relateret til din zgcombat aktivitet.',
    ...
    community: {
      main_title: 'zgcombat Fællesskab',
      ...
      level_editor_prefix: 'Brug zgcombat',
      ...
      thang_editor_suffix: "at ændre zgcombat's eget artwork. Tillad enheder at kaste projektiler, ændre retningen af ​​en animation, ændre en enheds livspoints, eller upload dine egne vektorgrafik sprites.",
      ...
      article_editor_suffix: 'og hjælp zgcombat spillere med at få mest muligt ud af deres spilletid.',
      ...
      social_blog: 'Læs zgcombat-bloggen på Sett',
      social_discource: 'Deltag i diskussionen på vores Discourse-forum',
      social_facebook: 'Like zgcombat på Facebook',
      social_twitter: 'Følg zgcombat på Twitter',
    ...
    courses: {
      ...
      ask_teacher_for_code_coco: 'Spørg din lærer om du har en zgcombat-klassekode! Hvis det er tilfældet, angiv den nedenfor:',
      ask_teacher_for_code_ozar: 'Spørg din lærer om du har en zgcombat-klassekode! Hvis det er tilfældet, angiv den nedenfor:',
    ...
    classes: {
      ...
      archmage_summary: 'Hvis du er en udvikler som er interesseret i programmering af pædagogiske spil, så bliv en Ærkemager for at hjælpe os med at skabe zgcombat!',
      ...
      diplomat_summary: 'zgcombat er oversat til 45+ sprog af vores Diplomater. Hjælp os ved at bidrage med oversættelser.',
      ambassador_title: 'Ambassadør',
      ambassador_title_description: '(Brugerstøtte)',
      ambassador_summary: 'Tæm vores forumbrugere og guide dem imod svar til deres spørgsmål. Vores ambassadører repræsenterer zgcombat for verdenen.',
      teacher_title: 'Lærer',
    },

    editor: {
      main_title: 'zgcombat Editorer',
    ...
    contribute: {
      page_title: 'Bidrager',
      intro_blurb: "zgcombat er 100% open source! Hundredvis af dedikerede spillere har hjulpet os med at bygge spillet op til hvad det er i dag. Kom og skrive det næste kapitel i zgcombat's søgen efter at lære verden at kode!",
      alert_account_message_intro: 'Hej med dig!',
      alert_account_message: 'For at modtage klasse-emails, skal du først være logget ind.',
      archmage_introduction: 'En af de bedste ting ved at bygge spil er, at de kombinerer så mange forskellige ting. Grafik, lyd, netværk, sociale netværk, og selvfølgelig mange af de mere almindelige aspekter af programmering, fra low-level database management og server administration til at brugerinteraktionsdesign og bygning af grænseflader. Der er meget at gøre, og hvis du er en erfaren programmør med flair for virkelig at dykke ned i de små dele af zgcombat, kan denne klasse være lige noget for dig. Vi ville elske at have din hjælp til at opbygge det bedste programmeringsspil nogensinde.',
      ...
      scribe_introduction_pref: 'zgcombat bliver ikke kun et sæt baner. Det vil også være en vidensressource, en wiki for programmeringsbegreber som baner kan gøre brug af. På den måde kan hver Artisan undgå at skulle lave en detaljeret beskrivelse af, hvad en sammenligningsoperator er, og istedet linke deres bane til en artikel der beskriver den. Noget i retning af hvad ',
      ...
      diplomat_introduction_suf: 'så er det, at der er betydelig interesse i zgcombat i andre lande! Vi bygger et korps af oversættere ivrige efter at vende ét sæt ord om til et andet sæt ord for at gøre zgcombat så tilgængelig i hele verden som muligt. Hvis du kan lide snigpremierer på kommende indhold og få disse baner ud til dine landsmænd ASAP, så er denne klasse noget for dig.',
      ...
      ambassador_introduction: 'Dette er et fællesskab, som vi er ved at bygge, og du har kontakterne. Vi har fora, emails og sociale netværk med masser af mennesker at tale med, at hjælpe med at bruge spillet og lære fra. Hvis du vil hjælpe med at få folk involveret og have det sjovt, og med at få en god fornemmelse af zgcombat og hvor vi skal hen, så kan denne klasse være noget for dig.',
    ...
    account: {
      ...
      status_unsubscribed: 'Få adgang til nye baner, helte, sager og bonus ædelstene med et zgcombat-abonnement!',
    ...
    account_prepaid: {
      ...
      purchase_code1: 'Abonnementskoder kan indløses for tilføje premium abonnementstid til en eller flere zgcombat-konti.',
      purchase_code2: 'Hver zgcombat-konto kan kun indløse en bestemt abonnementskode en gang.',
    ...
    legal: {
      ...
      opensource_description_center: 'og hjælp, hvis du har lyst! zgcombat er bygget på snesevis af open source-projekter, og vi elsker dem. Se ',
      ...
      code_description_suffix: 'Dette omfatter al kode i systemer og komponenter, der er stillet til rådighed af zgcombat med det formål at skabe baner.',
      art_title: 'Art/Musik - Creative Commons ',
      art_description_prefix: 'Alt fælles indhold er tilgængelig under',
      cc_license_url: 'Creative Commons Attribution 4.0 International License',
      art_description_suffix: 'Fælles indhold er alt som er gjort tilgængelig af zgcombat med det formål at skabe baner. Dette omfatter:',
      art_music: 'Musik',
      art_sound: 'Lyd',
      art_artwork: 'Artwork',
      art_sprites: 'Sprites',
      ...
      art_paragraph_1: 'For tilskrivning, bedes navn og link til flsong.iok.la i nærheden af ​​hvor koden anvendes eller hvor det ellers passer for mediet. For eksempel:',
      use_list_1: 'Hvis det bruges i en film eller et andet spil, omfat flsong.iok.la i credits.',
      use_list_2: 'Hvis det bruges på en hjemmeside, indsæt et link nær brug, for eksempel under et billede, eller i en generel tilskrivningsside, hvor du også kan nævne andre Creative Commons aktiver og open source software, der bruges på sitet. Noget, der allerede klart refererer zgcombat, såsom et blogindlæg der nævner zgcombat behøver for nogle separate tilskrivninger.',
      art_paragraph_2: 'Hvis indholdet brugt ikke er skabt af zgcombat men i stedet af en bruger af flsong.iok.la, tilskrives de i stedet, og følg henføringsmetoder som anvist i ressource-beskrivelsen, hvis der er en sådan.',
      ...
      third_party_description: 'zgcombat bruger følgende tredjeparts-tjenester (blandt andre):',
    ...
    ladder_prizes: {
      ...
      in_cash: 'i kontanter',
      custom_wizard: 'Brugerdefineret zgcombat Troldmand',
      custom_avatar: 'Brugerdefineret zgcombat avatar',
