module.exports = {
  ...
  translation: {
    ...
    new_home: {
      ...
      codecombat_is: 'zgcombat е платформа <strong>за ученици</strong> за учене на компютърни науки с истинска игра.',
      ...
      agency: 'zgcombat е игра, която дава на играчите тази самостоятелност и увереност посредством каления ни процесор за типизиран код, който помага еднакво добре на начинаещи и напреднали ученици да пишат хубав, валиден код.',
      ...
      want_coco: 'Искаш ли zgcombat в училището си?',
      //    educator: "Educator",
      //    student: "Student",
    ...
    diplomat_suggestion: {
      title: 'Помогни да преведем zgcombat!',
      sub_heading: 'Имаме нужда от твоите езикови познания!',
      pitch_body: 'Ние разработихме zgcombat на английски, но имаме играчи от целият свят. Много от тях искат да играят на български, защото не знаят английски, така че ако знаете и двата езика можете да се регистрирате като Дипломат и да помогнете в българският превод както на сайта на zgcombat, така и на всички нива.',
    ...
    share_progress_modal: {
      blurb: 'Справяш се чудесно! Сподели с родителите си, колко много научи чрез zgcombat.',
    ...
    play_level: {
      ...
      tip_open_source: 'zgcombat e 100% проект с отворен код!',
      tip_tell_friends: 'Насладихте ли се на zgcombat? Разкажете на приятелите си за нас!',
      tip_beta_launch: 'zgcombat стартира своята beta през Октомври, 2013.',
      ...
      tip_open_source_contribute: 'И Вие можете да помогнете за подобряването на zgcombat!',
    ...
    subscribe: {
      ...
      comparison_blurb: 'Изостри уменията си в zgcombat с абонамент!',
      ...
      thank_you: 'Благодарим ви че подкрепихте zgcombat.',
