module.exports = {
  ...
  translation: {
    ...
    new_home: {
      title_coco: 'zgcombat - Programmeringsspill som lærer deg Python og JavaScript',
      title_ozar: 'zgcombat - Programmeringsspill som lærer deg Python og JavaScript',
      //    title_cn_home: "zgcombat|Python, Javascript",
      meta_keywords_coco: 'zgcombat, python, javascript, programmeringsspill',
      meta_keywords_ozar: 'zgcombat, python, javascript, programmeringsspill',
    ...
    diplomat_suggestion: {
      title: 'Hjelp til å oversette zgcombat!',
      sub_heading: 'Vi trenger dine språkkunnskaper.',
      pitch_body: 'Vi utvikler zgcombat på engelsk, men vi har allerede spillere over hele verden. Mange av dem vil spille på norsk, men snakker ikke engelsk, så hvis du kan snakke begge språk, vennligst vurder å meld deg på som Diplomat og hjelp å oversette både zgcombat websiden og alle brettene til norsk.',
    ...
    share_progress_modal: {
      blurb: 'Du gjør fantastisk fremgang! Fortell noen hvor mye du har lært gjennom zgcombat.',
    ...
    signup: {
      ...
      email_announcements: 'Motta kunngjøringer på e-post',
      ...
      teacher_type_1: 'Lær bort programmering med zgcombat!',
    ...
    play_level: {
      ...
      tip_open_source: 'zgcombat er en 100% åpen kildekode!',
      tip_tell_friends: 'Liker du zgcombat? Fortell vennene dine om oss!',
      tip_beta_launch: 'zgcombat ble lansert i betautgave i oktober 2013.',
      ...
      tip_open_source_contribute: 'Du kan hjelpe zgcombat med å bli bedre!',
    ...
    subscribe: {
      ...
      comparison_blurb: 'Spiss dine kunnskaper med et zgcombat-abonnement!',
      ...
      thank_you: 'Takk for at du støttet zgcombat.',
    ...
    options: {
      ...
      editor_config_title_coco: 'Editor Oopsett',
      editor_config_title_ozar: 'Editor Oopsett',
    ...
    contact: {
      ...
      subscribe: 'kjøp et abonnement på zgcombat',
      subscribe_suffix: 'og vi hjelper deg gjerne med koden din.',
      subscriber_support: 'Siden du er en zgcombat-abonnent, vil din e-post få fortrinn hos kundestøtte.',
    ...
    account_settings: {
      ...
      email_announcements_description: 'Få e-post om siste nytt og utvikling fra zgcombat.',
      email_notifications: 'Varsler',
      email_notifications_summary: 'Innstillinger for personlige, automatiske e-postvarsler relatert til din zgcombat aktivitet.',
    ...
    community: {
      main_title: 'zgcombat Fellesskapet',
      ...
      level_editor_prefix: "Bruk zgcombat's",
      ...
      article_editor_suffix: 'og hjelp zgcombat spillere til å få mest mulig ut av spillet.',
      ...
      social_blog: 'Les zgcombat bloggen på Sett',
      social_discource: 'Diskuter zgcombat i forumet vårt på Discourse',
      social_facebook: 'Lik zgcombat på Facebook',
    ...
    classes: {
      ...
      archmage_summary: 'Hvis du er en utvikler som er interessert i å lage utdanningsrettede spill, bli en erketrollmann, og hjelp oss bygge zgcombat!',
      ...
      diplomat_summary: 'zgcombat er oversatt til 45+ språk av våre diplomater. Hjelp oss ved å bidra med oversettelser.',
      ambassador_title: 'Ambassadør',
      ambassador_title_description: '(Brukerstøtte)',
      ambassador_summary: 'Temm våre forumbrukere og tilby hjelp for de med spørsmål. Våre ambassadører representerer zgcombat ute i verden.',
      teacher_title: 'Lærer',
    },
    ...
    contribute: {
      page_title: 'Bidra',
      intro_blurb: 'zgcombat er 100% åpen kildekode! Hundrevis av dedikerte spillere har hjulpet oss å bygge spillet til det det er blitt i dag. Foren deg med oss og bli med og skriv neste kapittel i zgcombat sin søken etter å lære hele verden koding!',
      alert_account_message_intro: 'Heisann!',
      alert_account_message: 'For å abonnere på klasse-e-poster må du være logget inn først.',
      archmage_introduction: 'En av de beste tingene med å lage spill er at det består av så mye forskjellig. Grafikk, lyd, sanntidsnettverk, sosiale nettverk, og selvfølgelig mange av de vanlige aspektene ved programmering, fra lav-nivå database drift og serveradministrasjon til design og bygging av brukergrensesnitt. Det er mye å gjøre og hvis du er en erfaren utvikler som har lyst til å dykke ned i de tekniske detaljene i zgcombat, da er dette kanskje klassen for deg. Vi vil veldig gjerne ha din hjelp til å lage det beste programmeringsspillet noensinne.',
      ...
      diplomat_introduction_suf: 'så er det at det er stor interesse for zgcombat i andre land! Vi bygger et korps av oversettere som er ivrige etter å gjøre om ett sett av ord til et annet sett av ord, slik at zgcombat blir tilgengelig i så store deler av verden som mulig. Hvis du liker å få sniktitte på kommende innhold og å bringe disse brettene til dine lansdmenn fortere enn svint, da er denne klassen kanskje for deg.',
      ...
      ambassador_introduction: 'Det er et felleskap vi prøver å bygge her, og dere er bindeleddene. Vi har forum, chat, e-post, og sosiale nettverk med mange mennesker å snakke med, og hjelpe til å bli bedre kjent med spillet, og lære fra. Hvis du vil hjelpe folk å bli mer involvert og ha det gøy, og får en god følelse av stemningen i zgcombat og hva vi prøver å få til, da er denne klassen kanskje for deg..',
    ...
    account: {
      ...
      status_unsubscribed: 'Få tilgang til nye nivåer, helter, gjenstander og flere juveler med et zgcombat-abonnement!',
      ...
      unsubscribe_from_marketing: 'Avmeld __email__ fra alle e-poster om zgcombat-markedsføring?',
    ...
    legal: {
      ...
      github_url: 'GitHub',
      opensource_description_center: 'og hjelp gjerne til hvis du har lyst! zgcombat er basert på dusinvis av åpen kildekode-prosjekter og vi er veldig glade i dem. Se ',
      ...
      code_description_suffix: 'Dette inkluderer alle kode i Systemer og Komponenter som er gjort tilgjengelig av zgcombat til bruk når man lager Brett.',
      art_title: 'Grafikk og Musikk - Creative Commons',
      art_description_prefix: 'Alt felles innhold er tilgjengelig under',
      cc_license_url: 'Creative Commons Attribution 4.0 International License',
      art_description_suffix: 'Felles innhold er alt innhold som er gjort tilgjengelig av zgcombat til bruk når man lager Brett. Dette inkluderer:',
      art_music: 'Musikk',
      art_sound: 'Lyd',
      ...
      art_paragraph_1: 'Ved navngiving oppgi flsong.iok.la og link til oss i nærheten av stedet hvor ressursen er brukt eller på et sted som egner seg for mediet. For eksempel:',
      use_list_1: 'Hvis brukt i en film eller et annet spill, inkluder flsong.iok.la i rulleteksten.',
      use_list_2: 'Hvis brukt på en nettside, inkluder en link i nærheten av bruksstedet, for eksempel under et bilde, eller på en egen side hvor du kansje også navngir andre Creative Commons kilder og åpen kildekode-prosjekter som blir brukt på siden. Noe som allerede tydelig refererer til zgcombat, som f.eks. i et blogginnlegg om zgcombat, trenger ingen egen navngiving.',
      art_paragraph_2: 'Hvis innholdet som blir brukt ikke er laget av zgcombat, men av en bruker på flsong.iok.la, navngi dem i stedet og følg navngivings anvisningene gitt i ressursens beskrivelse hvis tilgjengelig.',
      ...
      rights_unit: 'Oopsett av enheter',
