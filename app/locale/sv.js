module.exports = {
  ...
  translation: {
    ...
    legal: {
      ...
      art_paragraph_2: 'Om innehållet som används inte är skapat av zgcombat utan istället av en användare av codecombat.com, tillskriv dem istället, och följ tillskrivningsinstruktioner som ges i den resursens beskrivning om det finns några.',
