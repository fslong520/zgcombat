module.exports = {
  ...
  translation: {
    ...
    new_home: {
      title_coco: 'zgcombat - Kodspel för att läsa sig Python och JavaScript',
      title_ozar: 'zgcombat - Kodspel för att läsa sig Python och JavaScript',
      //    title_cn_home: "zgcombat|Python, Javascript",
      meta_keywords_coco: 'zgcombat, python, javascript, Kodspel',
      meta_keywords_ozar: 'zgcombat, python, javascript, Kodspel',
      ...
      century_skills_subblurb1: 'Med kodande pussel som naturligt är mer utmanande, säkerställer zgcombats programmeringsspel att barn alltid tränar kritiskt tänkade.',
      ...
      century_skills_subblurb2: 'zgcombat uppmuntrar eleverna att visa upp sin kreativitet genom att bygga och dela sina egna spel och webbsidor.',
      ...
      creativity_rigor_blurb2: 'Varje zgcombat-nivå ställs ut baserat på miljontals datapunkter och optimeras för att anpassas till varje elev. Övningsnivåer och tips hjälper eleverna när de fastnar, och utmaningsnivåer bedömer elevernas lärande genom hela spelet.',
      creativity_rigor_subtitle3: 'Byggd för alla lärare, oavsett erfarenhet',
      creativity_rigor_blurb3: 'zgcombats egenutvecklade, standardinriktade läroplan gör undervisning i datavetenskap möjlig för alla. zgcombat utrustar lärare med utbildning, instruktionsresurser och dedikerat stöd för att känna sig självsäkra och framgångsrika i klassrummet.',
      ...
      for_leaders_subblurb3: 'Oavsett om du vill bygga ett kodningsval för mellanstadiet eller lära en introduktion till datavetenskap, är zgcombat skräddarsydd för att passa dina behov.',
      ...
      game_based_blurb: 'zgcombat är ett spelbaserat datavetenskapsprogram där studenter skriver riktig kod och ser deras karaktärer reagera i realtid.',
      ...
      quotes_quote1: 'Namnge ett program online, jag har provat det. Ingen av dem matchar zgcombat. Alla lärare som vill att eleverna ska lära sig att koda ... börja här!',
      quotes_quote2: 'Jag blev förvånad över hur enkelt och intuitivt zgcombat gör lärandet i datavetenskap. Poängen på AP-examen var mycket högre än jag förväntade mig och jag tror att zgcombat är anledningen till att så var fallet.',
      quotes_quote3: 'zgcombat har varit det mest fördelaktiga för att lära mina elever att få verkliga kodningskunskaper. Min man är mjukvaruutvecklare och han har testat alla mina program. Han satte detta som sitt bästa val.',
      quotes_quote4: 'Feedbacken ... har varit så positiv att vi strukturerar en datavetenskapskurs kring zgcombat. Programmet engagerar verkligen eleverna med en plattform för spelstil som är underhållande och instruktiv samtidigt. Fortsätt det goda arbetet, zgcombat!',
      ...
      teachers_love_codecombat_title: 'Lärare älskar zgcombat',
      teachers_love_codecombat_blurb1: 'De har rapporterat att deras elever tycker om att använda zgcombat för att lära sig att koda',
      teachers_love_codecombat_blurb2: 'Skulle rekommendera zgcombat till andra datavetenskapslärare',
      teachers_love_codecombat_blurb3: 'Säger att zgcombat hjälper dem att stödja elevernas förmåga att lösa problem',
      ...
      codecombat_is: 'zgcombat är en platform <strong>för elever</strong> att lära sig datavetenskap när de spelar igenom ett riktigt spel.',
      ...
      watch_how: 'Se hur zgcombat förändrar hur människor lär sig datavetenskap.',
      ...
      builds_concepts_up: 'Jag gillar hur zgcombat bygger upp koncepten. Det är väldigt lätt att förstå och roligt att räkna ut.',
      ...
      agency: 'zgcombat är ett spel som ger spelare den styrka och förtroende med vår robusta typ hanterande kodsmotor, som hjälper både nybörjare och avancerade studenter att skriva rätt och giltig kod.',
      ...
      want_coco: 'Vill du ha zgcombat på din skola?',
      educator: 'Lärare',
      student: 'Elev',
      ...
      //    ozaria_china_blurb: "",
      try_codecombat: 'Prova på zgcombat',
    ...
    diplomat_suggestion: {
      title: 'Hjälp till att översätta zgcombat!',
      sub_heading: 'Vi behöver dina språkliga kunskaper.',
      pitch_body: 'Vi utvecklar zgcombat på engelska, men vi har redan spelare världen över. Många av dem vill spela på svenska eftersom de inte talar engelska. Om du talar båda språken, fundera på att registrera dig som Diplomat och hjälp till med översättningen av både hemsidan och alla nivåer till svenska.',
    ...
    play: {
      title: 'Spela zgcombat nivåer - Lär dig Python, JavaScript och HTML',
      ...
      anon_signup_title_1: 'zgcombat har en',
      ...
      get_more_codecombat: 'Få mer zgcombat',
    ...
    share_progress_modal: {
      blurb: 'Du gör stora framsteg! Berätta för dina föräldrar hur mycket du lärt dig tack vare zgcombat.',
    ...
    signup: {
      ...
      teacher_type_1: 'Lär ut programmering med zgcombat!',
      ...
      want_codecombat_in_school: 'Vill du spela zgcombat hela tiden?',
      eu_confirmation: 'Jag samtycker till att zgcombat lagrar min data på amerikanska servrar.',
      ...
      with: 'med',
      want_to_play_codecombat: 'Nej, jag har ingen men vill spela zgcombat!',
    ...
    common: {
      default_title_coco: 'zgcombat - Kodningsspel för att lära dig Python och JavaScript',
      default_title_ozar: 'zgcombat - Kodningsspel för att lära dig Python och JavaScript',
      //    ozaria: "Ozaria",
    ...
    play_level: {
      ...
      explore_codecombat: 'Utforska zgcombat',
      ...
      tip_open_source: 'zgcombat är 100% öppen källkod!',
      tip_tell_friends: 'Gillar du zgcombat? Tipsa dina vänner om oss!',
      tip_beta_launch: 'zgcombat startade sin beta i oktober 2013.',
      ...
      tip_open_source_contribute: 'Du kan få zgcombat att bli ännu bättre!',
    ...
    play_game_dev_level: {
      ...
      play: 'Spela nivå',
      play_more_codecombat: 'Spela mer zgcombat',
    ...
    subscribe: {
      ...
      confirmation: 'Grattis! Du har nu en zgcombat Premium-prenumeration!',
      ...
      thank_you: 'Tack för att du stöder zgcombat.',
    ...
    premium_features: {
      get_premium: 'Skaffa<br>zgcombat<br>Premium',
      ...
      everything_in_premium: 'Allt du får med zgcombat Premium:',
    ...
    about: {
      title: 'Om zgcombat - Engagerande studenter, stärka lärare, inspirerande skapelse',
      ...
      main_description: 'PÅ zgcombat, vårt jobb är att se till att du gör det med ett leende på läpparna.',
      ...
      mission_description_1: '<strong>Programmering är magiskt</strong>. Det är förmågan att skapa saker från ren fantasi. Vi startade zgcombat för att ge eleverna en känsla av trolldomskraft vid sina fingertoppar genom att använda <strong>kod</strong>.',
      ...
      team_title: 'Möt zgcombat-teamet',
      ...
      shan_title: 'Chef för marknadsföring, zgcombat Kina',
      run_title: 'Verksamhetschef, zgcombat Kina',
      lance_title: 'Teknikchef, zgcombat Kina',
      zhiran_title: 'Chef för läroplanen, zgcombat Kina',
      yuqiang_title: 'Innovationschef, zgcombat Kina',
      ...
      bill_title: 'General Manager, zgcombat Kina',
      ...
      story_subtitle: 'Sedan 2013 har zgcombat vuxit från bara en uppsättning skisser till ett levande, blomstrande spel.',
      story_statistic_1a: '20.000.000+',
      story_statistic_1b: 'totalt antal spelare',
      story_statistic_1c: 'Har börjat sin programmeringsresa genom zgcombat',
      ...
      jobs_title: 'Kom och arbeta med oss och hjälp med att skriva zgcombat-historia!',
      ...
      jobs_custom_description: 'Brinner du för zgcombat men ser inte ett jobb som matchar dina kvalifikationer? Skriv oss och visa hur du tror att du kan bidra till vårt team. Vi skulle älska att höra från dig!',
    ...
    teachers_quote: {
      subtitle_coco: 'Lär dig mer om zgcombat med en interaktiv genomgång av produkten, prissättning och implementering!',
      ...
      state: 'Län / region',
      country: 'Land / region',
      num_students_help: 'Hur många elever kommer att använda zgcombat?',
      ...
      anything_else: 'Vilken typ av klass räknar du med att använda zgcombat för?',
      //    anything_else_helper: "",
      thanks_header: 'Förfrågan mottagen!',
      thanks_sub_header_coco: 'Tack för att du uttryckte intresse för zgcombat för din skola.',
      ...
      learn_more_modal: 'Lärarkonton på zgcombat har möjlighet att överse elevernas framsteg, tilldela licenser och hantera klassrum. Lärarkonton kan inte vara en del av ett klassrum - om du för närvarande är registrerad i en klass med det här kontot kommer du inte längre att kunna komma åt det när du har uppdaterat till ett lärarkonto.',
      create_account: 'Skapa ett lärarkonto',
      create_account_subtitle: 'Få tillgång till lärarverktyg för att använda zgcombat i klassrummet. <strong>Konfigurera en klass</strong>, lägg till dina elever och <strong>överse deras framsteg</strong>!',
    ...
    contact: {
      ...
      subscribe: 'köp en zgcombat prenumeration.',
      subscribe_suffix: 'Sedan hjälper vi dig gärna med din kod.',
      subscriber_support: 'Eftersom du är en zgcombat-prenumerant kommer ditt mejl att bli prioriterat.',
    ...
    account_settings: {
      ...
      email_announcements_description: 'Få mejl med de senaste nyheterna och utvecklingen på zgcombat.',
      email_notifications: 'Underrättelser',
      email_notifications_summary: 'Kontroller för personliga, automatiska mejlunderrättelser relaterade till din aktivitet på zgcombat.',
    ...
    community: {
      ...
      thang_editor_suffix: 'till att ändra zgcombats grafik. Låt enheter kasta saker, ändra riktningen på animeringar, ändra en enhets livslängd eller ladda upp din egen vektorgrafik.',
      ...
      article_editor_suffix: 'och hjälp zgcombatspelare att få så mycket ut från sin speltid som möjligt.',
      find_us: 'Här hittar du oss',
      social_github: 'Kolla in all vår kod på GitHub',
      //    social_reddit: "Join the zgcombat community on Reddit",
      social_blog: 'Läs zgcombatbloggen på Sett',
      social_discource: 'Gå med i diskussionerna i vårt forum',
      social_facebook: 'Gilla zgcombat på Facebook',
      social_twitter: 'Följ zgcombat på Twitter',
      social_slack: 'Chatta med oss i den offentliga zgcombat Slack-kanalen',
      contribute_to_the_project: 'Bidra till projektet',
    },

    clans: {
      title: 'Gå med i zgcombat-klaner - Lär dig att koda i Python, JavaScript och HTML',
      clan_title: '__clan__ - Gå med i zgcombat-klaner och lär dig att koda',
    ...
    classes: {
      ...
      archmage_summary: 'Om du är en utvecklare som är intresserad av att koda utbildningsspel, bli då en ärkemagiker och hjälp oss bygga zgcombat!',
      ...
      diplomat_summary: 'zgcombat är översätts till över 45 språk av våra diplomater. Hjälp oss genom att göra översättningar.',
      ambassador_title: 'Ambassadör',
      ambassador_title_description: '(Support)',
      ambassador_summary: 'Tämj forumanvändarna och hjälp dem som har frågor. Ambassadörerna representerar zgcombat ute i världen.',
      teacher_title: 'Lärare',
    },

    editor: {
      main_title: 'Redigerare: zgcombat',
    ...
    contribute: {
      ...
      intro_blurb: 'zgcombat är 100% öppen källkod! Hundratals hängivna spelare har hjälpt till att skapa det spel du ser idag. Häng med oss och skriv nästa kapitel i zgcombats uppdrag att lära världen att koda!',
      alert_account_message_intro: 'Hej där!',
      alert_account_message: 'För att prenumerera på klassmejl behöver du vara inloggad först.',
      archmage_introduction: 'En av de bästa delarna med att bygga spel är att de syntetiserar så många olika saker. Grafik, ljud, realtidsnätverkande, socialt netvärkande och så klart många av de vanligare aspekterna av programmering, från databashantering och serveradministration på låg nivå till användargränssnitt och gränsnittsbyggande. Det finns mycket att göra, och om du är en erfaren programmerare som längtar efter att dyka ner i zgcombats detaljer kan den här klassen vara för dig. Vi skulle älska din hjälp med att bygga det bästa programmeringsspelet någonsin.',
      ...
      diplomat_introduction_suf: 'är det att det finns ett stort intresse för zgcombat i andra länder! Vi bygger en kår av översättare ivriga att förvandla en samling ord till en annan samling ord för att få zgcombat så tillgänglig i världen som möjligt. Om du gillar att få tjuvkikar på kommande innehåll och att få dessa nivåer till de andra i ditt land så snart som möjligt är det här kanske klassen för dig.',
    ...
    legal: {
      ...
      opensource_description_center: ' och hjälp till om du vill! zgcombat är byggt på dussintals projekt med öppen källkod, och vi älskar dem. Se ',
      ...
      code_description_suffix: 'Detta inkluderar all kod i system och komponenter som gjorts tillgänglig för zgcombat i syftet att skapa nivåer.',
      ...
      art_description_suffix: 'Gemensamt innehåll är vad som helst som gjorts allmänt tillgängligt för zgcombat i syfte att skapa nivåer. Detta inkluderar:',
      art_music: 'Musik',
      art_sound: 'Ljud',
      ...
      art_paragraph_1: 'För tillskrivning, var vänlig namnge och länka till flsong.iok.la i närheten av var källan används eller där det är passande för mediet. Till exempel:',
      use_list_1: 'Om det används i en film eller ett annat spel, inkludera flsong.iok.la i eftertexterna.',
      use_list_2: 'Om det används på en webbplats, inkludera en länk nära användandet, till exempel under en bild eller i en allmän tilldelningssida där du också kan nämna andra Create Commons-resurser och öppen programvara som används på webbplatsen. Någonting som redan tydligt refererar till zgcombat, exempelvis en bloggpost som nämner zgcombat, behöver ingen separat tillskrivning.',
      art_paragraph_2: 'Om innehållet som används inte är skapat av zgcombat utan istället av en användare av flsong.iok.la, tillskriv dem istället, och följ tillskrivningsinstruktioner som ges i den resursens beskrivning om det finns några.',
      ...
      nutshell_description: 'Alla resurser vi tillhandahåller i nivåredigeraren är gratis att använda som du vill för att skapa nivåer. Men vi reserverar oss rättigheten att begränsa distribution av nivåerna själva (som skapas på flsong.iok.la) så att de kan tas betalt för i framtiden, om det är så det blir.',
