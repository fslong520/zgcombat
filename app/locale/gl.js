module.exports = {
  ...
  translation: {
    ...
    diplomat_suggestion: {
      title: 'Axuda a traducir zgcombat!',
      sub_heading: 'Necesitamos das túas habilidades lingüisticas.',
      pitch_body: 'Nós desenvolvemos zgcombat en inglés, pero xa temos xogadores de todo o mundo. Moitos deles queren xogar en galego porque non falan inglés, así que si falas ambos idiomas, inscríbete como Diplomático e axuda a traducir a web e todos os niveis de zgcombat ao galego.',
    ...
    play_level: {
      ...
      tip_beta_launch: 'zgcombat lanzou a súa beta en Outubro de 2014.',
    ...
    account_settings: {
      ...
      email_announcements_description: 'Recibe correos electrónicos coas últimas novas e desenvolvementos de zgcombat.',
      email_notifications: 'Notificacións',
      email_notifications_summary: 'Controles para personalizar as notificacións antomáticas por correo electrónico, relacionadas coa túa actividade en zgcombat.',
    ...
    community: {
      main_title: 'Comunidade de zgcombat',
      ...
      social_blog: 'Lee o blog de zgcombat en Sett',
      social_discource: 'Únete á discusion no noso foro',
      social_facebook: 'Dalle a Gústame a zgcombat en Facebook',
      social_twitter: 'Segue a zgcombat en Twitter',
    ...
    editor: {
      main_title: 'Editores de zgcombat',
    ...
    contribute: {
      ...
      diplomat_introduction_suf: 'hai un interés considerable en zgcombat en outros paises, ¡especialmente no Brasil! Estamos formando un corpo de tradutores con ganas de traducir un grupo de palabras tras outro para facer zgcombat tan accesible para todo o mundo como sexa posible. Se queres recibir avances dos próximos contdos e se queeres poñer esos niveis á disposición dos que comparten o teu idioma tan pronto como sexa posible, entón esta Clase é para ti.',
      ...
      ambassador_introduction: 'Esta é unha comunidade en construcción e ti es parte das conexións. Temos chat Olark, correos electrónicos e as redes sociais cunha gran cantidade de persoas con quen falar, axudar a familiarizarse co xogo e aprender. Se queres axudar á xente a que se involucre, se divirta e teña boas sensacións sobre zgcombat e cara onde vamos, entón esta clase é para ti.',
    ...
    legal: {
      ...
      opensource_description_center: 'e axúdanos se queres. zgcombat está desenvolvido sobre ducias de proxectos de código aberto, e estamos encantados. Mira ',
      ...
      code_description_suffix: 'Esto inclúe todo o código en Sistemas y Compoñentes posto a disposición por zgcombat para a creación de niveis.',
      ...
      art_description_suffix: 'Contido común é calqueira cousa posta a disposición por zgcombat co propósito da creación de niveis. Esto inclúe:',
      art_music: 'Música',
      art_sound: 'Son',
      art_artwork: 'Arte',
      ...
      art_paragraph_1: 'Para a atribución, por favor pon o teu nome e liga a flsong.iok.la preto do lugar onde se utiliza a fonte ou no seu caso para o medio. Por exemplo:',
      use_list_1: 'Se se usa nunha película ou outro xogo, inclúe flsong.iok.la nos créditos.',
      use_list_2: 'Se se usa nunha páxina web, inclúe unha ligazón preto de onde se use, por exemplo baixo unha imaxe, ou nunha páxina xeral de atribucións onde tamén menciones outros traballos Creative Commons e software de código aberto que uses na túa web. Se xa se fai clara referencia a zgcombat, como no post de un blog mencionando a zgcombat, non é precisa unha atribución do contido por separado.',
      art_paragraph_2: 'Se o contido usado foi creado non por zgcombat senón por un usuario de flsong.iok.la, deberá serlle atribuido a dito usuario e seguir as directrices de atribución proporcionadas na descripción do recurso, se as hai.',
    ...
    ladder_prizes: {
      ...
      in_cash: 'en diñeiro',
      custom_wizard: 'Persoaliza o teu Mago de zgcombat',
      custom_avatar: 'Persoaliza o teu avatar de zgcombat',
