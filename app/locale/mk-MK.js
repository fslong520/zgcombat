module.exports = {
  ...
  translation: {
    ...
    diplomat_suggestion: {
      title: 'Помогни да се преведе zgcombat!',
      sub_heading: 'Ни требаат твоите јазични вештини.',
      pitch_body: 'Ние ја развиваме zgcombat на англиски, но веќе имаме играчи низ целиот свет. Многу од нив сакаат да играат на македонски, а не разбираат англиски, па ако ги зборуваш и двата јазика, размисли дали би сакал/а да се зачлениш како Дипломат и да помогнеш да се преведат на македонски zgcombat веб сајтот и сите нивоа од играта.',
    ...
    play: {
      title: 'Играј zgcombat Нивоа - Научи Python, JavaScript и HTML',
      ...
      anon_signup_title_1: 'zgcombat има',
      ...
      get_more_codecombat: 'Повеќе zgcombat',
    ...
    share_progress_modal: {
      blurb: 'Одлично напредуваш! Кажи му на родителот колку имаш научено со zgcombat.',
    ...
    play_level: {
      ...
      tip_open_source: 'zgcombat е 100% open source!',
      tip_tell_friends: 'Уживаш во zgcombat? Кажи им на пријателите за нас!',
      tip_beta_launch: 'zgcombat ја пушти својата бета верзија во октомври, 2013.',
      ...
      tip_open_source_contribute: 'Можеш да помогнеш да се подобри zgcombat!',
    ...
    subscribe: {
      ...
      thank_you: 'Фала што ја поддржуваш zgcombat.',
