      ...
      return Promise.resolve()
        .then(() => {
          ...
          if (this.gplusAttrs) {
            ...
            trackerCalls.push(
              window.tracker != null
                ? window.tracker.trackEvent('Google Login', { category: 'Signup', label: loginMethod })
                : undefined)
          } else if (this.facebookAttrs) {
            loginMethod = 'Facebook'
            trackerCalls.push(
              window.tracker != null
                ? window.tracker.trackEvent('Facebook Login', { category: 'Signup', label: loginMethod })
                : undefined)
          }
