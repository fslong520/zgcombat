...
module.exports = class CourseVictoryModal extends ModalView
  ...
  onNextLevel: ->
    ...
    if me.isSessionless()
      link = "/play/level/#{@nextLevel.get('slug')}?course=#{@courseID}&codeLanguage=#{codeLanguage}"
    else
      link = "/play/level/#{@nextLevel.get('slug')}?course=#{@courseID}&course-instance=#{@courseInstanceID}&codeLanguage=#{codeLanguage}"
