...
if (isCodeCombat) {
  ...
  otherCourseIDs = OZ_COURSE_IDS_MAP
...
const HACKSTACK_COURSE_IDS = [
  ...
  ...Object.values(HACKSTACK_COURSE_IDS_MAP),
]
const OZ_COURSE_IDS = [
  OZ_COURSE_IDS_MAP.CHAPTER_ONE,
  OZ_COURSE_IDS_MAP.CHAPTER_TWO,
  OZ_COURSE_IDS_MAP.CHAPTER_THREE,
...
const AILeagueSeasons = [
  ...
  { number: 16, championshipType: 'cup', image: '/images/pages/league/devour-dash-cup.webp', imagePath: '/images/pages/league/devour-dash-results.png', topMatchUrlPath: '/play/spectate/devour-dash?session-one=6a1a86f5c4e2186e3b6c3f1f&session-two=696ad86714dbf6bc7d4d58fa&tournament=6a22ab6d78e6f30412322011' },
  { number: 17, championshipType: 'arena', image: '/images/pages/league/ail_practice_arena.webp', video: '', videoThumbnailTime: '', restSeason: true },
