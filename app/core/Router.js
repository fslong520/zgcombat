...
module.exports = (CocoRouter = (function () {
  CocoRouter = class CocoRouter extends Backbone.Router {
      ...
      this.prototype.routes = {
        ...
        'play/:campaign' (campaign) {
          if (utils.isCodeCombat) {
            ...
            if (slug === 'ai') {
              return this.routeDirectly('play/CampaignView', [slug])
            }
    ...
    redirectHome () {
      delete window.alreadyLoadedView
      console.trace('redirectHome called')
      const homeUrl = (() => {
        switch (false) {
    ...
    navigate (fragment, options) {
      if (fragment === '/students' || fragment.includes('/students')) {
        console.trace('NAVIGATE TO /students from:', fragment)
      } else {
